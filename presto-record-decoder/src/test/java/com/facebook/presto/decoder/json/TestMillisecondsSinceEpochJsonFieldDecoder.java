...
public class TestMillisecondsSinceEpochJsonFieldDecoder
{
    ...
    public void testBasicFormatting()
    {
        ...
        DecoderTestColumnHandle column3 = new DecoderTestColumnHandle(2, "column3", BigintType.BIGINT, "a_number", MillisecondsSinceEpochJsonFieldDecoder.NAME, null, false, false, false);
        DecoderTestColumnHandle column4 = new DecoderTestColumnHandle(3, "column4", BigintType.BIGINT, "a_string", MillisecondsSinceEpochJsonFieldDecoder.NAME, null, false, false, false);

        DecoderTestColumnHandle column5 = new DecoderTestColumnHandle(4, "column5", createVarcharType(100), "a_number", MillisecondsSinceEpochJsonFieldDecoder.NAME, null, false, false, false);
        DecoderTestColumnHandle column6 = new DecoderTestColumnHandle(5, "column6", createVarcharType(100), "a_string", MillisecondsSinceEpochJsonFieldDecoder.NAME, null, false, false, false);
    ...
    public void testNullValues()
    {
        ...
        // sanity checks
        checkIsNull(decodedRow.get(), column1);
        checkIsNull(decodedRow.get(), column2);
        checkIsNull(decodedRow.get(), column3);
        checkIsNull(decodedRow.get(), column4);
        checkIsNull(decodedRow.get(), column5);
        checkIsNull(decodedRow.get(), column6);
    }
}
