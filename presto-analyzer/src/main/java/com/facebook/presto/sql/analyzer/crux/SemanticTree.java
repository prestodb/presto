...
{
    private final SemanticTreeKind semanticTreeKind;
    private final CodeLocation location;

    protected SemanticTree(SemanticTreeKind semanticTreeKind, CodeLocation location)
    {
        this.semanticTreeKind = requireNonNull(semanticTreeKind, "semanticTreeKind is null");
    ...
    public SemanticTreeKind getSemanticTreeKind()
    {
        return semanticTreeKind;
    }
}
