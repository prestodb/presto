...
//TODO: Better name? AnalyzerProvider?
public class AnalyzerClient
{
    ...
    @Inject
    public AnalyzerClient(BuiltInQueryPreparer builtInQueryPreparer, NativeQueryPreparer nativeInQueryPreparer)
    {
