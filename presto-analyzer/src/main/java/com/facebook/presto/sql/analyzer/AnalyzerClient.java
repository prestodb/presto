...
public class AnalyzerClient
{
    ...
    private QueryPreparer nativeQueryPreparer;

    @Inject
    public AnalyzerClient(BuiltInQueryPreparer builtInQueryPreparer, NativeQueryPreparer nativeQueryPreparer)
    {
        this.builtInQueryPreparer = requireNonNull(builtInQueryPreparer, "builtInQueryPreparer is null");
        this.nativeQueryPreparer = requireNonNull(nativeQueryPreparer, "nativeQueryPreparer is null");
    }
    ...
    public QueryPreparer getQueryPreparer(AnalyzerType analyzerType)
    {
        ...
        if (analyzerType == BUILTIN) {
            return builtInQueryPreparer;
        }
        if (analyzerType == NATIVE) {
            return nativeQueryPreparer;
        }
