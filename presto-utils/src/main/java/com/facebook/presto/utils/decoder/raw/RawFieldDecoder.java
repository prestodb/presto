        ...
        implements FieldDecoder<byte[]>
{
    ...
    @Override
    public FieldValueProvider decode(byte[] value, DecodableColumnHandle columnHandle)
    {
            ...
            extends FieldValueProvider
    {
        ...
        public RawValueProvider(ByteBuffer value, DecodableColumnHandle columnHandle, FieldType fieldType)
        {
