...
/**
 * The row decoder for the 'dummy' format. For an unstructured row format (bag of bytes), a specific decoder for a topic must exist. To start developing such a decoder,
 ...
 * that are exposed by Presto.
 * By adding a table name to the catalog configuration file and not having and specific topic description JSON file (or by omitting the 'dataFormat' field in the table description file),
 * this decoder should be selected by the appropriate connector.
 */
