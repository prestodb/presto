...
import static com.facebook.presto.utils.decoder.json.RFC2822JsonFieldDecoder.FORMATTER;
...
public class TestRFC2822JsonFieldDecoder
{
    ...
    private static Map<DecodableColumnHandle, FieldDecoder<?>> map(List<DecodableColumnHandle> columns)
    {
