 ...
 */
package com.facebook.presto.utils.decoder.raw;
...
public class TestRawDecoder
{
    ...
    public void testSimple()
    {
        ...
        List<DecodableColumnHandle> columns = ImmutableList.of(row1, row2, row3, row4, row5);
    ...
    public void testFixedWithString()
    {
        ...
        List<DecodableColumnHandle> columns = ImmutableList.of(row1, row2, row3, row4);
        Set<FieldValueProvider> providers = new HashSet<>();
    ...
    public void testFloatStuff()
    {
        ...
        List<DecodableColumnHandle> columns = ImmutableList.of(row1, row2);
        Set<FieldValueProvider> providers = new HashSet<>();
    ...
    public void testBooleanStuff()
    {
        ...
        List<DecodableColumnHandle> columns = ImmutableList.of(row01,
                row02,
                row03,
                row04,
                row11,
