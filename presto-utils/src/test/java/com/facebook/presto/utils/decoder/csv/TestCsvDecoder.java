...
public class TestCsvDecoder
{
    ...
    public void testSimple()
    {
        ...
        List<DecodableColumnHandle> columns = ImmutableList.of(row1, row2, row3, row4, row5, row6, row7);
    ...
    public void testBoolean()
    {
        ...
        List<DecodableColumnHandle> columns = ImmutableList.of(row1, row2, row3, row4, row5, row6, row7, row8);
