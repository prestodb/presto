...
public class BenchmarkApproximateDoublePercentileAggregations
{
    @State(Scope.Thread)
    public static class Context
    {
                ...
                throws IOException
        {
            ...
            queryRunner.execute(format("CREATE TABLE memory.default.testingtable AS SELECT totalprice from tpch.%s.orders", scalingFactor));
        }
    ...
    @Benchmark
    public MaterializedResult benchmarkDoublePercentileAggregation(Context context)
    {
            ...
            throws Exception
    {
        Options options = new OptionsBuilder()
                .include(".*" + BenchmarkApproximateDoublePercentileAggregations.class.getSimpleName() + ".*")
                .build();
