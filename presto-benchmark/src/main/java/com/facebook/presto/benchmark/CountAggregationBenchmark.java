        ...
        extends AbstractSimpleOperatorBenchmark
{
    ...
    protected List<? extends OperatorFactory> createOperatorFactories()
    {
        ...
        TypeAndFunctionManager typeAndFunctionManager = localQueryRunner.getMetadata().getTypeAndFunctionManager();
        InternalAggregationFunction countFunction = typeAndFunctionManager.getAggregateFunctionImplementation(
                typeAndFunctionManager.lookupFunction("count", fromTypes(BIGINT)));
