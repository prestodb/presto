        ...
        extends AbstractBenchmark
{
    ...
    protected final OperatorFactory createHashProjectOperator(int operatorId, PlanNodeId planNodeId, List<Type> types)
    {
        ...
        Optional<RowExpression> hashExpression = HashGenerationOptimizer.getHashExpression(localQueryRunner.getMetadata().getTypeAndFunctionManager(), variables.build());
