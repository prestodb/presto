...
public class SqlArrayTransformBenchmark
        extends AbstractSqlBenchmark
{
    public SqlArrayTransformBenchmark(LocalQueryRunner localQueryRunner, String query, String name)
    {
