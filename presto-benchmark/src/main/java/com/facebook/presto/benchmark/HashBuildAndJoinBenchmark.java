        ...
        extends AbstractOperatorBenchmark
{
    ...
    protected List<Driver> createDrivers(TaskContext taskContext)
    {
        ...
        // hash build
        HashBuilderOperatorFactory hashBuilder = new HashBuilderOperatorFactory(2, new PlanNodeId("test"), source.getTypes(), ImmutableMap.of(), Ints.asList(0), hashChannel, Optional.empty(), 1_500_000);
        ...
        OperatorFactory joinOperator = LookupJoinOperators.innerJoin(2, new PlanNodeId("test"), hashBuilder.getLookupSourceSupplier(), source.getTypes(), Ints.asList(0), hashChannel, Optional.empty());
