        ...
        extends AbstractOperatorBenchmark
{
    ...
    protected List<Driver> createDrivers(TaskContext taskContext)
    {
        ...
        // hash build
        HashBuilderOperatorFactory hashBuilder = new HashBuilderOperatorFactory(2, new PlanNodeId("test"), source.getTypes(), ImmutableList.of(0, 1), ImmutableMap.of(), Ints.asList(0), hashChannel, false, Optional.empty(), Optional.empty(), Optional.empty(), 1_500_000, 1, new PagesIndex.TestingFactory());
