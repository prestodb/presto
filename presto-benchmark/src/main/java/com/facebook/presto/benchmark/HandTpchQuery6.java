        ...
        extends AbstractSimpleOperatorBenchmark
{
    ...
    protected List<? extends OperatorFactory> createOperatorFactories()
    {
        ...
        List<Supplier<PageProjectionWithOutputs>> projection = new PageFunctionCompiler(localQueryRunner.getMetadata(), 0).compileProjections(session.getSqlFunctionProperties(), ImmutableList.of(field(0, BIGINT)), false, Optional.empty());
