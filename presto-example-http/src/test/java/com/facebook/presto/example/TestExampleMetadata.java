...
public class TestExampleMetadata
{
    ...
    public void getTableMetadata()
    {
        ...
        assertEquals(tableMetadata.getColumns(), ImmutableList.of(
                ColumnMetadata.builder("text", createUnboundedVarcharType()).build(),
                ColumnMetadata.builder("value", BIGINT).build()));
    ...
    public void testCreateTable()
    {
        metadata.createTable(
                ...
                new ConnectorTableMetadata(
                        ...
                        ImmutableList.of(ColumnMetadata.builder("text", createUnboundedVarcharType()).build())),
                false);
    }
