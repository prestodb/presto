...
import static com.facebook.presto.plugin.prometheus.PrometheusServer.BASIC_AUTH_MIN_VERSION;
        ...
        extends AbstractTestQueryFramework
{
    ...
    protected QueryRunner createQueryRunner()
            throws Exception
    {
        this.server = new PrometheusServer(BASIC_AUTH_MIN_VERSION, true);
