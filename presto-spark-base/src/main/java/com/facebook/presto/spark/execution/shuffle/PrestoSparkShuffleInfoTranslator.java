 ...
 */
public interface PrestoSparkShuffleInfoTranslator<R1 extends PrestoSparkShuffleWriteInfo, R2 extends PrestoSparkShuffleReadInfo>
{
    R1 createShuffleWriteInfo(PrestoSparkShuffleWriteDescriptor writeDescriptor);
