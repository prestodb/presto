...
public class PrestoSparkLocalShuffleInfoTranslator
        implements PrestoSparkShuffleInfoTranslator<PrestoSparkLocalShuffleWriteInfo, PrestoSparkLocalShuffleReadInfo>
{
    ...
    {
        return new PrestoSparkLocalShuffleWriteInfo(0, writeDescriptor.getNumberOfPartition(), localShuffleRootPath);
    }
    ...
    public PrestoSparkLocalShuffleReadInfo createShuffleReadInfo(PrestoSparkShuffleReadDescriptor readDescriptor)
    {
        return new PrestoSparkLocalShuffleReadInfo(
                ...
                readDescriptor.getNumberOfPartition(),
