...
public class TestPrestoSparkExecutionExceptionFactory
{
    ...
    public void testRoundTrip()
    {
        ...
        PrestoSparkExecutionException executionException = factory.translate(prestoException);

        Optional<ExecutionFailureInfo> failure = factory.tryDecode(executionException);
        ...
        failure = factory.tryDecode(sparkException);
        assertTrue(failure.isPresent());
        assertFailure(failure.get().toFailure(), prestoException);
    }
