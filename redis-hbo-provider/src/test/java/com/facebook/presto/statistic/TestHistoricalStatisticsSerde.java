...
public class TestHistoricalStatisticsSerde
{
    ...
    public void testSimpleHistoricalStatisticsEncoderDecoder()
    {
        HistoricalPlanStatistics samplePlanStatistics = new HistoricalPlanStatistics(ImmutableList.of(new HistoricalPlanStatisticsEntry(
                ...
                ImmutableList.of(new PlanStatistics(Estimate.of(15000), Estimate.unknown(), 1, Estimate.unknown(), Estimate.unknown(), JoinNodeStatistics.empty())))));
    ...
    public void testHistoricalPlanStatisticsEntryList()
    {
        ...
        for (int i = 0; i < 50; i++) {
            historicalPlanStatisticsEntryList.add(new HistoricalPlanStatisticsEntry(new PlanStatistics(Estimate.of(i * 5), Estimate.of(i * 5), 1, Estimate.unknown(), Estimate.unknown(), JoinNodeStatistics.empty()),
                    ImmutableList.of(new PlanStatistics(Estimate.of(100), Estimate.of(i), 0, Estimate.unknown(), Estimate.unknown(), JoinNodeStatistics.empty()))));
        }
    ...
    public void testPlanStatisticsList()
    {
        ...
        for (int i = 0; i < 50; i++) {
            planStatisticsEntryList.add(new PlanStatistics(Estimate.of(i * 5), Estimate.of(i * 5), 1, Estimate.unknown(), Estimate.unknown(), JoinNodeStatistics.empty()));
        }
        List<HistoricalPlanStatisticsEntry> historicalPlanStatisticsEntryList = new ArrayList<>();
        for (int i = 0; i < 50; i++) {
            historicalPlanStatisticsEntryList.add(new HistoricalPlanStatisticsEntry(new PlanStatistics(Estimate.of(i * 5), Estimate.of(i * 5), 1, Estimate.unknown(), Estimate.unknown(), JoinNodeStatistics.empty()),
