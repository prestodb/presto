...
public class NativeArrowFederationConnectorUtils
{
    ...
    public static Optional<BiFunction<Integer, URI, Process>> getExternalWorkerLauncher(String prestoServerPath, int flightServerPort, String connectorId)
    {
...
//                                "arrow-flight.server-ssl-certificate=%s\n",
    ...
    public static QueryRunner createQueryRunner(String connectorId, int port)
            throws Exception
    {
        ...
        DistributedQueryRunner queryRunner = queryRunnerBuilder
                ...
                .setExternalWorkerLauncher(
                        getExternalWorkerLauncher(prestoServerPath.toString(), port, connectorId))
                .build();
            ...
            throws Exception
    {
        ...
        Injector injector = FlightShimServer.initialize(getFlightServerShimConfig(pluginBundles, false), testModule);
