        ...
        extends AbstractTestFlightShimPlugins
{
    ...
    protected ExpectedQueryRunner createExpectedQueryRunner()
    {
        Session session = testSessionBuilder()
                ...
                .setSchema("tiny")
                .build();
        return new TestLocalQueryRunner(session);
    }
    ...
    {
        public TestLocalQueryRunner(Session defaultSession)
        {
        ...
        {
            // LocalQueryRunner returns SqlDate instead of LocalDate.
            // Override to convert results to valid test types.
            return super.execute(session, sql).toTestTypes();
        }
    }
}
