        ...
        extends AbstractTestFunctions
{
    ...
    public void testStContains()
    {
        ...
        assertRelation("ST_Contains", "'POLYGON ((0 0, 0 4, 4 4, 4 0))'", "'POLYGON ((1 1, 1 2, 2 2, 2 1))'", true);
        assertRelation("ST_Contains", "'POLYGON ((0 0, 0 4, 4 4, 4 0))'", "'POLYGON ((-1 -1, -1 2, 2 2, 2 -1))'", false);
        assertRelation("ST_Contains", "'MULTIPOLYGON (((0 0 , 0 2, 2 2, 2 0)), ((2 2, 2 4, 4 4, 4 2)))'", "'POLYGON ((2 2, 2 3, 3 3, 3 2))'", true);
        assertRelation("ST_Contains", "'LINESTRING (20 20, 30 30)'", "'POLYGON ((0 0, 0 4, 4 4, 4 0))'", false);
        assertRelation("ST_Contains", "'LINESTRING EMPTY'", "'POLYGON ((0 0, 0 4, 4 4, 4 0))'", false);
    ...
    public void testSTCrosses()
    {
        ...
        assertRelation("ST_Crosses", "'POLYGON ((1 1, 1 4, 4 4, 4 1))'", "'POLYGON ((2 2, 2 5, 5 5, 5 2))'", false);
        assertRelation("ST_Crosses", "'MULTIPOLYGON (((0 0 , 0 2, 2 2, 2 0)), ((2 2, 2 4, 4 4, 4 2)))'", "'POLYGON ((2 2, 2 3, 3 3, 3 2))'", false);
        assertRelation("ST_Crosses", "'LINESTRING (-2 -2, 6 6)'", "'POLYGON ((0 0, 0 4, 4 4, 4 0))'", true);
        assertRelation("ST_Crosses", "'POINT (20 20)'", "'POINT (20 20)'", false);
        assertRelation("ST_Crosses", "'POLYGON ((0 0, 0 4, 4 4, 4 0))'", "'POLYGON ((0 0, 0 4, 4 4, 4 0))'", false);
        assertRelation("ST_Crosses", "'POLYGON ((0 0, 0 4, 4 4, 4 0))'", "'LINESTRING (0 0, 0 4, 4 4, 4 0)'", false);
    }
    ...
    public void testSTDisjoint()
    {
        ...
        assertRelation("ST_Disjoint", "'POLYGON ((1 1, 1 3, 3 3, 3 1))'", "'POLYGON ((4 4, 4 5, 5 5, 5 4))'", true);
        assertRelation("ST_Disjoint", "'MULTIPOLYGON (((1 1, 1 3, 3 3, 3 1)), ((0 0, 0 2, 2 2, 2 0)))'", "'POLYGON ((0 1, 3 1, 3 3, 0 3))'", false);
    }
    ...
    public void testSTEquals()
    {
        ...
        assertRelation("ST_Equals", "'POLYGON ((1 1, 1 3, 3 3, 3 1))'", "'POLYGON ((3 3, 3 1, 1 1, 1 3))'", true);
        assertRelation("ST_Equals", "'MULTIPOLYGON (((1 1, 1 3, 3 3, 3 1)), ((0 0, 0 2, 2 2, 2 0)))'", "'POLYGON ((0 1, 3 1, 3 3, 0 3))'", false);
    }
    ...
    public void testSTIntersects()
    {
        ...
        assertRelation("ST_Intersects", "'POLYGON ((1 1, 1 3, 3 3, 3 1))'", "'POLYGON ((4 4, 4 5, 5 5, 5 4))'", false);
        assertRelation("ST_Intersects", "'MULTIPOLYGON (((1 1, 1 3, 3 3, 3 1)), ((0 0, 0 2, 2 2, 2 0)))'", "'POLYGON ((0 1, 3 1, 3 3, 0 3))'", true);
        assertRelation("ST_Intersects", "'POLYGON ((16.5 54, 16.5 54.1, 16.51 54.1, 16.8 54))'", "'LINESTRING (16.6 53, 16.6 56)'", true);
        assertRelation("ST_Intersects", "'POLYGON ((16.5 54, 16.5 54.1, 16.51 54.1, 16.8 54))'", "'LINESTRING (16.6667 54.05, 16.8667 54.05)'", false);
        assertRelation("ST_Intersects", "'POLYGON ((16.5 54, 16.5 54.1, 16.51 54.1, 16.8 54))'", "'LINESTRING (16.6667 54.25, 16.8667 54.25)'", false);
    }
    ...
    public void testSTOverlaps()
    {
        ...
        assertRelation("ST_Overlaps", "'POLYGON ((1 1, 1 4, 4 4, 4 1))'", "'POLYGON ((3 3, 3 5, 5 5, 5 3))'", true);
        assertRelation("ST_Overlaps", "'POLYGON ((1 1, 1 4, 4 4, 4 1))'", "'POLYGON ((1 1, 1 4, 4 4, 4 1))'", false);
        assertRelation("ST_Overlaps", "'POLYGON ((1 1, 1 4, 4 4, 4 1))'", "'LINESTRING (1 1, 4 4)'", false);
        assertRelation("ST_Overlaps", "'POLYGON ((1 1, 1 3, 3 3, 3 1))'", "'POLYGON ((4 4, 4 5, 5 5, 5 4))'", false);
        assertRelation("ST_Overlaps", "'MULTIPOLYGON (((1 1, 1 3, 3 3, 3 1)), ((0 0, 0 2, 2 2, 2 0)))'", "'POLYGON ((0 1, 3 1, 3 3, 0 3))'", true);
    }
    ...
    public void testSTTouches()
    {
        ...
        assertRelation("ST_Touches", "'POINT (1 2)'", "'POLYGON ((1 1, 1 4, 4 4, 4 1))'", true);
        assertRelation("ST_Touches", "'POLYGON ((1 1, 1 3, 3 3, 3 1))'", "'POLYGON ((4 4, 4 5, 5 5, 5 4))'", false);
        assertRelation("ST_Touches", "'POLYGON ((1 1, 1 3, 3 3, 3 1))'", "'LINESTRING (0 0, 1 1)'", true);
        assertRelation("ST_Touches", "'POLYGON ((1 1, 1 3, 3 3, 3 1))'", "'POLYGON ((3 3, 3 5, 5 5, 5 3))'", true);
        assertRelation("ST_Touches", "'MULTIPOLYGON (((1 1, 1 3, 3 3, 3 1)), ((0 0, 0 2, 2 2, 2 0)))'", "'POLYGON ((0 1, 3 1, 3 3, 0 3))'", false);
    }
    ...
    public void testSTWithin()
    {
        ...
        assertRelation("ST_Within", "'POINT (3 2)'", "'POLYGON ((1 1, 1 4, 4 4, 4 1))'", true);
        assertRelation("ST_Within", "'POLYGON ((1 1, 1 3, 3 3, 3 1))'", "'POLYGON ((0 0, 0 4, 4 4, 4 0))'", true);
