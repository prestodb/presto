...
--!
insert into ${mutableTables.hive.datatype} select count(*), cast(1.1 as double), 'a', cast('2016-01-01' as date), cast('2015-01-01 03:15:16 UTC' as timestamp), FALSE from datatype group by c_bigint;
