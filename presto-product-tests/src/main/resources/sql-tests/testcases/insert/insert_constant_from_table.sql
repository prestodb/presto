...
--!
insert into ${mutableTables.hive.datatype} select 1, cast(2.2 as double), 'abc', cast('2014-01-01' as date), cast('2015-01-01 03:15:16 UTC' as timestamp), false from datatype;
