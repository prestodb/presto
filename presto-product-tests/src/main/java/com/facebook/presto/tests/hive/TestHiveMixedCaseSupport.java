        ...
        extends ProductTest
{
    ...
    public void testInsertDataWithMixedCaseNames()
    {
        ...
        query("INSERT INTO " + SCHEMA_NAME + ".testtable VALUES ('amy', 112), ('mia', 123)"); //hivemixedcaseon
        query("INSERT INTO " + SCHEMA_NAME + ".TESTTABLE2 VALUES ('ann', 112), ('mary', 123)"); // hivemixedcaseon
        query("INSERT INTO " + SCHEMA_NAME_UPPER + ".testtable02 VALUES ('emma', 112, 200.002), ('mark', 123, 300.003)"); // HIVEMIXEDCASEON1
        query("INSERT INTO " + SCHEMA_NAME_UPPER + ".TESTTABLE3 VALUES ('emma', 112, 200.002), ('mark', 123, 300.003)"); // HIVEMIXEDCASEON1

        query("INSERT INTO " + SCHEMA_NAME_MIXED + ".testtable VALUES ('amy1', 112)"); // HiveMixedCase
        query("INSERT INTO " + SCHEMA_NAME_MIXED + ".TestTable VALUES ('mary1', 123)"); // HiveMixedCase
        query("INSERT INTO \"" + SCHEMA_NAME_MIXED + "\".testtable VALUES ('amy2', 112)"); // HiveMixedCase
        query("INSERT INTO \"" + SCHEMA_NAME_MIXED + "\".TestTable VALUES ('mary2', 123)"); // HiveMixedCase
        query("INSERT INTO " + SCHEMA_NAME_MIXED + ".\"testtable\" VALUES ('amy3', 112)"); // HiveMixedCase
        query("INSERT INTO " + SCHEMA_NAME_MIXED + ".\"TestTable\" VALUES ('mary3', 123)"); // HiveMixedCase
