...
public class MultiColumnKeyTableDefinition
{
    ...
    static {
        RelationalDataSource dataSource = () -> ImmutableList.<List<Object>>of(
                ImmutableList.of("Alice", "a1", OffsetDateTime.of(2015, 1, 1, 1, 1, 1, 0, ZoneOffset.UTC).toInstant(), "Test value 1"),
                ImmutableList.of("Bob", "b1", OffsetDateTime.of(2014, 2, 2, 3, 4, 5, 0, ZoneOffset.UTC).toInstant(), "Test value 2")
        ).iterator();
