        ...
        extends ProductTest
{
    ...
    public Object[][] avroSchemaLocations()
    {
        return new Object[][] {
                ...
                // TODO {"hdfs:///user/hive/warehouse/TestAvroSchemaUrl/schemas/original_schema.avsc"},
                // TODO {"/user/hive/warehouse/TestAvroSchemaUrl/schemas/original_schema.avsc"}, // `avro.schema.url` can actually be path on HDFS (not URL)
        };
    }
