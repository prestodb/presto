...
public class TestPinotConfig
{
    ...
    public void testDefaults()
    {
        ConfigAssertions.assertRecordedDefaults(
                ConfigAssertions.recordDefaults(PinotConfig.class)
                        ...
                        .setPushdownDynamicFilter(true)
                        .setMaxPushdownDynamicFilterSize(PinotConfig.DEFAULT_MAX_PUSHDOWN_DYNAMIC_FILTER_SIZE)
    ...
    public void testExplicitPropertyMappings()
    {
        Map<String, String> properties = new ImmutableMap.Builder<String, String>()
                ...
                .put("pinot.pushdown-dynamic-filter", "false")
                .put("pinot.forbid-segment-queries", "true")
                .put("pinot.max-pushdown-dynamic-filter-size", "50")
        ...
        PinotConfig expected = new PinotConfig()
                ...
                .setPushdownDynamicFilter(false)
                .setMaxPushdownDynamicFilterSize(50)
