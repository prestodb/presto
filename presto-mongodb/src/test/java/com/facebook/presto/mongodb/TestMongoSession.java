...
{
    private static final MongoColumnHandle COL1 = new MongoColumnHandle("Col1", "col1", BIGINT, false);
    private static final MongoColumnHandle COL2 = new MongoColumnHandle("Col2", "col2", createUnboundedVarcharType(), false);
