...
@SwiftGenerated
@com.facebook.swift.codec.ThriftStruct(value="ThriftTpchSplit", builder=ThriftTpchSplit.Builder.class)
public final class ThriftTpchSplit implements com.facebook.thrift.payload.ThriftSerializable {
    @ThriftConstructor
    public ThriftTpchSplit(
        @com.facebook.swift.codec.ThriftField(value=1, name="tableHandle", requiredness=Requiredness.NONE) final com.facebook.presto.common.experimental.auto_gen.ThriftTpchTableHandle tableHandle,
        ...
        @com.facebook.swift.codec.ThriftField(value=5, name="predicate", requiredness=Requiredness.NONE) final com.facebook.presto.common.experimental.auto_gen.ThriftTupleDomain predicate
    ) {
    ...
    public static Builder builder(ThriftTpchSplit other) {
      return new Builder(other);
    }

    public static class Builder {
        private com.facebook.presto.common.experimental.auto_gen.ThriftTpchTableHandle tableHandle = null;
        private int totalParts = 0;
        private int partNumber = 0;
        private List<com.facebook.presto.common.experimental.auto_gen.ThriftHostAddress> addresses = null;
        private com.facebook.presto.common.experimental.auto_gen.ThriftTupleDomain predicate = null;
    
        @com.facebook.swift.codec.ThriftField(value=1, name="tableHandle", requiredness=Requiredness.NONE)    public Builder setTableHandle(com.facebook.presto.common.experimental.auto_gen.ThriftTpchTableHandle tableHandle) {
            this.tableHandle = tableHandle;
            return this;
        }
    
        public com.facebook.presto.common.experimental.auto_gen.ThriftTpchTableHandle getTableHandle() { return tableHandle; }
        ...
        public List<com.facebook.presto.common.experimental.auto_gen.ThriftHostAddress> getAddresses() { return addresses; }
            ...
            @com.facebook.swift.codec.ThriftField(value=5, name="predicate", requiredness=Requiredness.NONE)    public Builder setPredicate(com.facebook.presto.common.experimental.auto_gen.ThriftTupleDomain predicate) {
            this.predicate = predicate;
            return this;
        }
    
        public com.facebook.presto.common.experimental.auto_gen.ThriftTupleDomain getPredicate() { return predicate; }
    
        public Builder() { }
        public Builder(ThriftTpchSplit other) {
        ...
        @ThriftConstructor
        public ThriftTpchSplit build() {
            ThriftTpchSplit result = new ThriftTpchSplit (
                this.tableHandle,
                this.totalParts,
                this.partNumber,
                this.addresses,
    ...
    private static final TStruct STRUCT_DESC = new TStruct("ThriftTpchSplit");
    private final com.facebook.presto.common.experimental.auto_gen.ThriftTpchTableHandle tableHandle;
    ...
    private static final TField ADDRESSES_FIELD_DESC = new TField("addresses", TType.LIST, (short)4);
        private final com.facebook.presto.common.experimental.auto_gen.ThriftTupleDomain predicate;
    public static final int _PREDICATE = 5;
    private static final TField PREDICATE_FIELD_DESC = new TField("predicate", TType.STRUCT, (short)5);
    static {
      ...
      NAMES_TO_IDS.put("predicate", 5);
      THRIFT_NAMES_TO_IDS.put("predicate", 5);
      FIELD_METADATA.put(5, PREDICATE_FIELD_DESC);
    }
    ...
    @Nullable
    @com.facebook.swift.codec.ThriftField(value=5, name="predicate", requiredness=Requiredness.NONE)
    public com.facebook.presto.common.experimental.auto_gen.ThriftTupleDomain getPredicate() { return predicate; }
    ...
    public String toString() {
        ...
        helper.add("predicate", predicate);
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ThriftTpchSplit other = (ThriftTpchSplit)o;
    ...
    public static com.facebook.thrift.payload.Reader<ThriftTpchSplit> asReader() {
      return ThriftTpchSplit::read0;
    }
    
    public static ThriftTpchSplit read0(TProtocol oprot) throws TException {
      TField __field;
      oprot.readStructBegin(ThriftTpchSplit.NAMES_TO_IDS, ThriftTpchSplit.THRIFT_NAMES_TO_IDS, ThriftTpchSplit.FIELD_METADATA);
      ThriftTpchSplit.Builder builder = new ThriftTpchSplit.Builder();
      while (true) {
        ...
        case _TABLEHANDLE:
          if (__field.type == TType.STRUCT) {
            com.facebook.presto.common.experimental.auto_gen.ThriftTpchTableHandle tableHandle = com.facebook.presto.common.experimental.auto_gen.ThriftTpchTableHandle.read0(oprot);
        ...
        case _PREDICATE:
          if (__field.type == TType.STRUCT) {
            com.facebook.presto.common.experimental.auto_gen.ThriftTupleDomain predicate = com.facebook.presto.common.experimental.auto_gen.ThriftTupleDomain.read0(oprot);
    ...
    private static class _ThriftTpchSplitLazy {
        private static final ThriftTpchSplit _DEFAULT = new ThriftTpchSplit.Builder().build();
    }
    
    public static ThriftTpchSplit defaultInstance() {
        return  _ThriftTpchSplitLazy._DEFAULT;
    }
}
