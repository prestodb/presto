...
public class ConnectorTableHandleAdapter
{
    ...
    public static byte[] serialize(Object obj)
    {
        if (obj instanceof ThriftSerializable) {
            ...
            return FbThriftUtils.serialize(ThriftConnectorTableHandle.builder()
                    .setType(serializable.getImplementationType())
                    .setSerializedConnectorTableHandle(bytes).build());
        }
    ...
    {
        return fromThrift(FbThriftUtils.deserialize(ThriftConnectorTableHandle.class, bytes));
    }
