...
public class ValueSetAdapter
{
    ...
    public static byte[] serialize(Object obj)
    {
        if (obj instanceof ThriftSerializable) {
            ...
            return FbThriftUtils.serialize(ThriftValueSet.builder()
                    .setType(serializable.getImplementationType())
                    .setSerializedValueSet(bytes).build());
        }
    ...
    {
        return fromThrift(FbThriftUtils.deserialize(ThriftValueSet.class, bytes));
    }
