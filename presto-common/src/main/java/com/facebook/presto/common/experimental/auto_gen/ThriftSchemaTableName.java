...
@SwiftGenerated
@com.facebook.swift.codec.ThriftStruct(value="ThriftSchemaTableName", builder=ThriftSchemaTableName.Builder.class)
public final class ThriftSchemaTableName implements com.facebook.thrift.payload.ThriftSerializable {
    @ThriftConstructor
    ...
    @ThriftConstructor
    protected ThriftSchemaTableName() {
    ...
    public static Builder builder(ThriftSchemaTableName other) {
    ...
    public static class Builder {
        ...
        public Builder() { }
        public Builder(ThriftSchemaTableName other) {
            this.schemaName = other.schemaName;
            this.tableName = other.tableName;
        }
    
        @ThriftConstructor
        public ThriftSchemaTableName build() {
            ThriftSchemaTableName result = new ThriftSchemaTableName (
                this.schemaName,
                this.tableName
            );
            return result;
    ...
    private static final TStruct STRUCT_DESC = new TStruct("ThriftSchemaTableName");
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ThriftSchemaTableName other = (ThriftSchemaTableName)o;
    ...
    public static com.facebook.thrift.payload.Reader<ThriftSchemaTableName> asReader() {
      return ThriftSchemaTableName::read0;
    }
    
    public static ThriftSchemaTableName read0(TProtocol oprot) throws TException {
      TField __field;
      oprot.readStructBegin(ThriftSchemaTableName.NAMES_TO_IDS, ThriftSchemaTableName.THRIFT_NAMES_TO_IDS, ThriftSchemaTableName.FIELD_METADATA);
      ThriftSchemaTableName.Builder builder = new ThriftSchemaTableName.Builder();
      while (true) {
    ...
    private static class _ThriftSchemaTableNameLazy {
        private static final ThriftSchemaTableName _DEFAULT = new ThriftSchemaTableName.Builder().build();
    }
    
    public static ThriftSchemaTableName defaultInstance() {
        return  _ThriftSchemaTableNameLazy._DEFAULT;
    }
}
