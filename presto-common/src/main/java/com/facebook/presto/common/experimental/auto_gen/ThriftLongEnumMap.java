...
@SwiftGenerated
@com.facebook.swift.codec.ThriftStruct(value="ThriftLongEnumMap", builder=ThriftLongEnumMap.Builder.class)
public final class ThriftLongEnumMap implements com.facebook.thrift.payload.ThriftSerializable {
    @ThriftConstructor
    public ThriftLongEnumMap(
        ...
        @com.facebook.swift.codec.ThriftField(value=2, name="enumMap", requiredness=Requiredness.NONE) final Map<String, Long> enumMap
    ) {
    ...
    public static Builder builder(ThriftLongEnumMap other) {
      return new Builder(other);
    }

    public static class Builder {
        private String typeName = null;
        private Map<String, Long> enumMap = null;
        ...
        public String getTypeName() { return typeName; }
            ...
            @com.facebook.swift.codec.ThriftField(value=2, name="enumMap", requiredness=Requiredness.NONE)    public Builder setEnumMap(Map<String, Long> enumMap) {
            this.enumMap = enumMap;
            return this;
        }
    
        public Map<String, Long> getEnumMap() { return enumMap; }
    
        public Builder() { }
        public Builder(ThriftLongEnumMap other) {
            this.typeName = other.typeName;
            this.enumMap = other.enumMap;
        }
    
        @ThriftConstructor
        public ThriftLongEnumMap build() {
            ThriftLongEnumMap result = new ThriftLongEnumMap (
                this.typeName,
                this.enumMap
            );
            return result;
    ...
    private static final TStruct STRUCT_DESC = new TStruct("ThriftLongEnumMap");
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ThriftLongEnumMap other = (ThriftLongEnumMap)o;
    ...
    public static com.facebook.thrift.payload.Reader<ThriftLongEnumMap> asReader() {
      return ThriftLongEnumMap::read0;
    }
    
    public static ThriftLongEnumMap read0(TProtocol oprot) throws TException {
      TField __field;
      oprot.readStructBegin(ThriftLongEnumMap.NAMES_TO_IDS, ThriftLongEnumMap.THRIFT_NAMES_TO_IDS, ThriftLongEnumMap.FIELD_METADATA);
      ThriftLongEnumMap.Builder builder = new ThriftLongEnumMap.Builder();
      while (true) {
        ...
        case _ENUMMAP:
          if (__field.type == TType.MAP) {
            Map<String, Long> enumMap;
                ...
                enumMap = new HashMap<String, Long>(Math.max(0, _map.size));
    ...
    public void write0(TProtocol oprot) throws TException {
      ...
      if (enumMap != null) {
        ...
        Map<String, Long> _iter0 = enumMap;
    ...
    private static class _ThriftLongEnumMapLazy {
        private static final ThriftLongEnumMap _DEFAULT = new ThriftLongEnumMap.Builder().build();
    }
    
    public static ThriftLongEnumMap defaultInstance() {
        return  _ThriftLongEnumMapLazy._DEFAULT;
    }
}
