...
public class RowExpressionAdapter
{
    ...
    public static byte[] serialize(Object obj)
    {
        if (obj instanceof ThriftSerializable) {
            ...
            return FbThriftUtils.serialize(ThriftRowExpression.builder()
                    .setType(serializable.getImplementationType())
                    .setSerializedExpression(bytes).build());
        }
    ...
    {
        return fromThrift(FbThriftUtils.deserialize(ThriftRowExpression.class, bytes));
    }
