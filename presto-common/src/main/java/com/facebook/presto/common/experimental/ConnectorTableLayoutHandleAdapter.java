...
public class ConnectorTableLayoutHandleAdapter
{
    ...
    public static byte[] serialize(Object obj)
    {
        if (obj instanceof ThriftSerializable) {
            ...
            return FbThriftUtils.serialize(ThriftConnectorTableLayoutHandle.builder()
                    .setType(serializable.getImplementationType())
                    .setSerializedConnectorTableLayoutHandle(bytes).build());
        }
    ...
    {
        return fromThrift(FbThriftUtils.deserialize(ThriftConnectorTableLayoutHandle.class, bytes));
    }
