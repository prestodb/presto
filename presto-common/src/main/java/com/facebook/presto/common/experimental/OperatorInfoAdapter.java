...
public class OperatorInfoAdapter
{
    private OperatorInfoAdapter() {}
    ...
    public static byte[] serialize(Object obj)
    {
        if (obj instanceof ThriftSerializable) {
            ...
            return FbThriftUtils.serialize(ThriftOperatorInfo.builder()
                    .setType(serializable.getImplementationType())
                    .setSerializedOperatorInfo(bytes).build());
        }
    ...
    {
        return fromThrift(FbThriftUtils.deserialize(ThriftOperatorInfo.class, bytes));
    }

    public static Object fromThrift(ThriftOperatorInfo thriftInfo)
    {
        return ThriftSerializationRegistry.deserialize(
                thriftInfo.getType(),
                thriftInfo.getSerializedOperatorInfo());
    }
}
