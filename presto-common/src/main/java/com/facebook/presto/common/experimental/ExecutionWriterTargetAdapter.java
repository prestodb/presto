...
public class ExecutionWriterTargetAdapter
{
    ...
    public static byte[] serialize(Object obj)
    {
        if (obj instanceof ThriftSerializable) {
            ...
            return FbThriftUtils.serialize(ThriftExecutionWriterTarget.builder()
                    .setType(serializable.getImplementationType())
                    .setSerializedTarget(bytes).build());
        }
    ...
    {
        return fromThrift(FbThriftUtils.deserialize(ThriftExecutionWriterTarget.class, bytes));
    }
