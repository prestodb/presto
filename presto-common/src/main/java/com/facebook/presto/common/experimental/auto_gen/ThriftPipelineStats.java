...
@SwiftGenerated
@com.facebook.swift.codec.ThriftStruct(value="ThriftPipelineStats", builder=ThriftPipelineStats.Builder.class)
public final class ThriftPipelineStats implements com.facebook.thrift.payload.ThriftSerializable {
    @ThriftConstructor
    public ThriftPipelineStats(
        @com.facebook.swift.codec.ThriftField(value=1, name="pipelineId", requiredness=Requiredness.NONE) final int pipelineId,
        ...
        @com.facebook.swift.codec.ThriftField(value=5, name="inputPipeline", requiredness=Requiredness.NONE) final boolean inputPipeline,
        @com.facebook.swift.codec.ThriftField(value=6, name="outputPipeline", requiredness=Requiredness.NONE) final boolean outputPipeline,
        @com.facebook.swift.codec.ThriftField(value=7, name="totalDrivers", requiredness=Requiredness.NONE) final int totalDrivers,
        @com.facebook.swift.codec.ThriftField(value=8, name="queuedDrivers", requiredness=Requiredness.NONE) final int queuedDrivers,
        @com.facebook.swift.codec.ThriftField(value=9, name="queuedPartitionedDrivers", requiredness=Requiredness.NONE) final int queuedPartitionedDrivers,
        @com.facebook.swift.codec.ThriftField(value=10, name="queuedPartitionedSplitsWeight", requiredness=Requiredness.NONE) final long queuedPartitionedSplitsWeight,
        @com.facebook.swift.codec.ThriftField(value=11, name="runningDrivers", requiredness=Requiredness.NONE) final int runningDrivers,
        @com.facebook.swift.codec.ThriftField(value=12, name="runningPartitionedDrivers", requiredness=Requiredness.NONE) final int runningPartitionedDrivers,
        @com.facebook.swift.codec.ThriftField(value=13, name="runningPartitionedSplitsWeight", requiredness=Requiredness.NONE) final long runningPartitionedSplitsWeight,
        @com.facebook.swift.codec.ThriftField(value=14, name="blockedDrivers", requiredness=Requiredness.NONE) final int blockedDrivers,
        @com.facebook.swift.codec.ThriftField(value=15, name="completedDrivers", requiredness=Requiredness.NONE) final int completedDrivers,
        @com.facebook.swift.codec.ThriftField(value=16, name="userMemoryReservationInBytes", requiredness=Requiredness.NONE) final long userMemoryReservationInBytes,
        @com.facebook.swift.codec.ThriftField(value=17, name="revocableMemoryReservationInBytes", requiredness=Requiredness.NONE) final long revocableMemoryReservationInBytes,
        @com.facebook.swift.codec.ThriftField(value=18, name="systemMemoryReservationInBytes", requiredness=Requiredness.NONE) final long systemMemoryReservationInBytes,
        @com.facebook.swift.codec.ThriftField(value=19, name="queuedTime", requiredness=Requiredness.NONE) final com.facebook.presto.common.experimental.auto_gen.ThriftDistributionSnapshot queuedTime,
        @com.facebook.swift.codec.ThriftField(value=20, name="elapsedTime", requiredness=Requiredness.NONE) final com.facebook.presto.common.experimental.auto_gen.ThriftDistributionSnapshot elapsedTime,
        ...
        @com.facebook.swift.codec.ThriftField(value=34, name="operatorSummaries", requiredness=Requiredness.NONE) final List<com.facebook.presto.common.experimental.auto_gen.ThriftOperatorStats> operatorSummaries,
        @com.facebook.swift.codec.ThriftField(value=35, name="drivers", requiredness=Requiredness.NONE) final List<com.facebook.presto.common.experimental.auto_gen.ThriftDriverStats> drivers
    ) {
    ...
    public static Builder builder(ThriftPipelineStats other) {
    ...
    public static class Builder {
        ...
        private boolean inputPipeline = false;
        private boolean outputPipeline = false;
        ...
        private com.facebook.presto.common.experimental.auto_gen.ThriftDistributionSnapshot queuedTime = null;
        private com.facebook.presto.common.experimental.auto_gen.ThriftDistributionSnapshot elapsedTime = null;
        ...
        private List<com.facebook.presto.common.experimental.auto_gen.ThriftOperatorStats> operatorSummaries = null;
        private List<com.facebook.presto.common.experimental.auto_gen.ThriftDriverStats> drivers = null;
    
        @com.facebook.swift.codec.ThriftField(value=1, name="pipelineId", requiredness=Requiredness.NONE)    public Builder setPipelineId(int pipelineId) {
            this.pipelineId = pipelineId;
            return this;
        }
        ...
        public long getLastEndTimeInMillis() { return lastEndTimeInMillis; }
            ...
            @com.facebook.swift.codec.ThriftField(value=5, name="inputPipeline", requiredness=Requiredness.NONE)    public Builder setInputPipeline(boolean inputPipeline) {
            this.inputPipeline = inputPipeline;
            return this;
        }
    
        public boolean isInputPipeline() { return inputPipeline; }
    
            @com.facebook.swift.codec.ThriftField(value=6, name="outputPipeline", requiredness=Requiredness.NONE)    public Builder setOutputPipeline(boolean outputPipeline) {
            this.outputPipeline = outputPipeline;
            return this;
        }
    
        public boolean isOutputPipeline() { return outputPipeline; }
    
            @com.facebook.swift.codec.ThriftField(value=7, name="totalDrivers", requiredness=Requiredness.NONE)    public Builder setTotalDrivers(int totalDrivers) {
            this.totalDrivers = totalDrivers;
            return this;
        }
        ...
        public int getTotalDrivers() { return totalDrivers; }
            ...
            @com.facebook.swift.codec.ThriftField(value=8, name="queuedDrivers", requiredness=Requiredness.NONE)    public Builder setQueuedDrivers(int queuedDrivers) {
            this.queuedDrivers = queuedDrivers;
            return this;
        }
        ...
        public int getQueuedDrivers() { return queuedDrivers; }
            ...
            @com.facebook.swift.codec.ThriftField(value=9, name="queuedPartitionedDrivers", requiredness=Requiredness.NONE)    public Builder setQueuedPartitionedDrivers(int queuedPartitionedDrivers) {
            this.queuedPartitionedDrivers = queuedPartitionedDrivers;
            return this;
        }
        ...
        public int getQueuedPartitionedDrivers() { return queuedPartitionedDrivers; }
            ...
            @com.facebook.swift.codec.ThriftField(value=10, name="queuedPartitionedSplitsWeight", requiredness=Requiredness.NONE)    public Builder setQueuedPartitionedSplitsWeight(long queuedPartitionedSplitsWeight) {
            this.queuedPartitionedSplitsWeight = queuedPartitionedSplitsWeight;
            return this;
        }
        ...
        public long getQueuedPartitionedSplitsWeight() { return queuedPartitionedSplitsWeight; }
            ...
            @com.facebook.swift.codec.ThriftField(value=11, name="runningDrivers", requiredness=Requiredness.NONE)    public Builder setRunningDrivers(int runningDrivers) {
            this.runningDrivers = runningDrivers;
            return this;
        }
        ...
        public int getRunningDrivers() { return runningDrivers; }
            ...
            @com.facebook.swift.codec.ThriftField(value=12, name="runningPartitionedDrivers", requiredness=Requiredness.NONE)    public Builder setRunningPartitionedDrivers(int runningPartitionedDrivers) {
            this.runningPartitionedDrivers = runningPartitionedDrivers;
            return this;
        }
        ...
        public int getRunningPartitionedDrivers() { return runningPartitionedDrivers; }
            ...
            @com.facebook.swift.codec.ThriftField(value=13, name="runningPartitionedSplitsWeight", requiredness=Requiredness.NONE)    public Builder setRunningPartitionedSplitsWeight(long runningPartitionedSplitsWeight) {
            this.runningPartitionedSplitsWeight = runningPartitionedSplitsWeight;
            return this;
        }
        ...
        public long getRunningPartitionedSplitsWeight() { return runningPartitionedSplitsWeight; }
            ...
            @com.facebook.swift.codec.ThriftField(value=14, name="blockedDrivers", requiredness=Requiredness.NONE)    public Builder setBlockedDrivers(int blockedDrivers) {
            this.blockedDrivers = blockedDrivers;
            return this;
        }
        ...
        public int getBlockedDrivers() { return blockedDrivers; }
            ...
            @com.facebook.swift.codec.ThriftField(value=15, name="completedDrivers", requiredness=Requiredness.NONE)    public Builder setCompletedDrivers(int completedDrivers) {
            this.completedDrivers = completedDrivers;
            return this;
        }
        ...
        public int getCompletedDrivers() { return completedDrivers; }
            ...
            @com.facebook.swift.codec.ThriftField(value=16, name="userMemoryReservationInBytes", requiredness=Requiredness.NONE)    public Builder setUserMemoryReservationInBytes(long userMemoryReservationInBytes) {
            this.userMemoryReservationInBytes = userMemoryReservationInBytes;
            return this;
        }
        ...
        public long getUserMemoryReservationInBytes() { return userMemoryReservationInBytes; }
            ...
            @com.facebook.swift.codec.ThriftField(value=17, name="revocableMemoryReservationInBytes", requiredness=Requiredness.NONE)    public Builder setRevocableMemoryReservationInBytes(long revocableMemoryReservationInBytes) {
            this.revocableMemoryReservationInBytes = revocableMemoryReservationInBytes;
            return this;
        }
        ...
        public long getRevocableMemoryReservationInBytes() { return revocableMemoryReservationInBytes; }
            ...
            @com.facebook.swift.codec.ThriftField(value=18, name="systemMemoryReservationInBytes", requiredness=Requiredness.NONE)    public Builder setSystemMemoryReservationInBytes(long systemMemoryReservationInBytes) {
            this.systemMemoryReservationInBytes = systemMemoryReservationInBytes;
            return this;
        }
        ...
        public long getSystemMemoryReservationInBytes() { return systemMemoryReservationInBytes; }
            ...
            @com.facebook.swift.codec.ThriftField(value=19, name="queuedTime", requiredness=Requiredness.NONE)    public Builder setQueuedTime(com.facebook.presto.common.experimental.auto_gen.ThriftDistributionSnapshot queuedTime) {
            this.queuedTime = queuedTime;
            return this;
        }
    
        public com.facebook.presto.common.experimental.auto_gen.ThriftDistributionSnapshot getQueuedTime() { return queuedTime; }
    
            @com.facebook.swift.codec.ThriftField(value=20, name="elapsedTime", requiredness=Requiredness.NONE)    public Builder setElapsedTime(com.facebook.presto.common.experimental.auto_gen.ThriftDistributionSnapshot elapsedTime) {
            this.elapsedTime = elapsedTime;
            return this;
        }
    
        public com.facebook.presto.common.experimental.auto_gen.ThriftDistributionSnapshot getElapsedTime() { return elapsedTime; }
        ...
        public long getPhysicalWrittenDataSizeInBytes() { return physicalWrittenDataSizeInBytes; }
            ...
            @com.facebook.swift.codec.ThriftField(value=34, name="operatorSummaries", requiredness=Requiredness.NONE)    public Builder setOperatorSummaries(List<com.facebook.presto.common.experimental.auto_gen.ThriftOperatorStats> operatorSummaries) {
            this.operatorSummaries = operatorSummaries;
            return this;
        }
    
        public List<com.facebook.presto.common.experimental.auto_gen.ThriftOperatorStats> getOperatorSummaries() { return operatorSummaries; }
    
            @com.facebook.swift.codec.ThriftField(value=35, name="drivers", requiredness=Requiredness.NONE)    public Builder setDrivers(List<com.facebook.presto.common.experimental.auto_gen.ThriftDriverStats> drivers) {
            this.drivers = drivers;
            return this;
        }
    
        public List<com.facebook.presto.common.experimental.auto_gen.ThriftDriverStats> getDrivers() { return drivers; }
    
        public Builder() { }
        public Builder(ThriftPipelineStats other) {
            ...
            this.inputPipeline = other.inputPipeline;
            this.outputPipeline = other.outputPipeline;
            ...
            this.operatorSummaries = other.operatorSummaries;
            this.drivers = other.drivers;
        }
    
        @ThriftConstructor
        public ThriftPipelineStats build() {
            ThriftPipelineStats result = new ThriftPipelineStats (
                this.pipelineId,
    ...
    private static final TStruct STRUCT_DESC = new TStruct("ThriftPipelineStats");
    private final int pipelineId;
    public static final int _PIPELINEID = 1;
    private static final TField PIPELINE_ID_FIELD_DESC = new TField("pipelineId", TType.I32, (short)1);
    ...
    public static final int _INPUTPIPELINE = 5;
    private static final TField INPUT_PIPELINE_FIELD_DESC = new TField("inputPipeline", TType.BOOL, (short)5);
        private final boolean outputPipeline;
    public static final int _OUTPUTPIPELINE = 6;
    private static final TField OUTPUT_PIPELINE_FIELD_DESC = new TField("outputPipeline", TType.BOOL, (short)6);
        private final int totalDrivers;
    public static final int _TOTALDRIVERS = 7;
    private static final TField TOTAL_DRIVERS_FIELD_DESC = new TField("totalDrivers", TType.I32, (short)7);
        private final int queuedDrivers;
    public static final int _QUEUEDDRIVERS = 8;
    private static final TField QUEUED_DRIVERS_FIELD_DESC = new TField("queuedDrivers", TType.I32, (short)8);
        private final int queuedPartitionedDrivers;
    public static final int _QUEUEDPARTITIONEDDRIVERS = 9;
    private static final TField QUEUED_PARTITIONED_DRIVERS_FIELD_DESC = new TField("queuedPartitionedDrivers", TType.I32, (short)9);
        private final long queuedPartitionedSplitsWeight;
    public static final int _QUEUEDPARTITIONEDSPLITSWEIGHT = 10;
    private static final TField QUEUED_PARTITIONED_SPLITS_WEIGHT_FIELD_DESC = new TField("queuedPartitionedSplitsWeight", TType.I64, (short)10);
        private final int runningDrivers;
    public static final int _RUNNINGDRIVERS = 11;
    private static final TField RUNNING_DRIVERS_FIELD_DESC = new TField("runningDrivers", TType.I32, (short)11);
        private final int runningPartitionedDrivers;
    public static final int _RUNNINGPARTITIONEDDRIVERS = 12;
    private static final TField RUNNING_PARTITIONED_DRIVERS_FIELD_DESC = new TField("runningPartitionedDrivers", TType.I32, (short)12);
        private final long runningPartitionedSplitsWeight;
    public static final int _RUNNINGPARTITIONEDSPLITSWEIGHT = 13;
    private static final TField RUNNING_PARTITIONED_SPLITS_WEIGHT_FIELD_DESC = new TField("runningPartitionedSplitsWeight", TType.I64, (short)13);
        private final int blockedDrivers;
    public static final int _BLOCKEDDRIVERS = 14;
    private static final TField BLOCKED_DRIVERS_FIELD_DESC = new TField("blockedDrivers", TType.I32, (short)14);
        private final int completedDrivers;
    public static final int _COMPLETEDDRIVERS = 15;
    private static final TField COMPLETED_DRIVERS_FIELD_DESC = new TField("completedDrivers", TType.I32, (short)15);
        private final long userMemoryReservationInBytes;
    public static final int _USERMEMORYRESERVATIONINBYTES = 16;
    private static final TField USER_MEMORY_RESERVATION_IN_BYTES_FIELD_DESC = new TField("userMemoryReservationInBytes", TType.I64, (short)16);
        private final long revocableMemoryReservationInBytes;
    public static final int _REVOCABLEMEMORYRESERVATIONINBYTES = 17;
    private static final TField REVOCABLE_MEMORY_RESERVATION_IN_BYTES_FIELD_DESC = new TField("revocableMemoryReservationInBytes", TType.I64, (short)17);
        private final long systemMemoryReservationInBytes;
    public static final int _SYSTEMMEMORYRESERVATIONINBYTES = 18;
    private static final TField SYSTEM_MEMORY_RESERVATION_IN_BYTES_FIELD_DESC = new TField("systemMemoryReservationInBytes", TType.I64, (short)18);
        private final com.facebook.presto.common.experimental.auto_gen.ThriftDistributionSnapshot queuedTime;
    public static final int _QUEUEDTIME = 19;
    private static final TField QUEUED_TIME_FIELD_DESC = new TField("queuedTime", TType.STRUCT, (short)19);
        private final com.facebook.presto.common.experimental.auto_gen.ThriftDistributionSnapshot elapsedTime;
    public static final int _ELAPSEDTIME = 20;
    private static final TField ELAPSED_TIME_FIELD_DESC = new TField("elapsedTime", TType.STRUCT, (short)20);
    ...
    private static final TField PHYSICAL_WRITTEN_DATA_SIZE_IN_BYTES_FIELD_DESC = new TField("physicalWrittenDataSizeInBytes", TType.I64, (short)33);
        private final List<com.facebook.presto.common.experimental.auto_gen.ThriftOperatorStats> operatorSummaries;
    public static final int _OPERATORSUMMARIES = 34;
    private static final TField OPERATOR_SUMMARIES_FIELD_DESC = new TField("operatorSummaries", TType.LIST, (short)34);
        private final List<com.facebook.presto.common.experimental.auto_gen.ThriftDriverStats> drivers;
    public static final int _DRIVERS = 35;
    private static final TField DRIVERS_FIELD_DESC = new TField("drivers", TType.LIST, (short)35);
    static {
      NAMES_TO_IDS.put("pipelineId", 1);
      THRIFT_NAMES_TO_IDS.put("pipelineId", 1);
      FIELD_METADATA.put(1, PIPELINE_ID_FIELD_DESC);
      ...
      NAMES_TO_IDS.put("inputPipeline", 5);
      THRIFT_NAMES_TO_IDS.put("inputPipeline", 5);
      FIELD_METADATA.put(5, INPUT_PIPELINE_FIELD_DESC);
      NAMES_TO_IDS.put("outputPipeline", 6);
      THRIFT_NAMES_TO_IDS.put("outputPipeline", 6);
      FIELD_METADATA.put(6, OUTPUT_PIPELINE_FIELD_DESC);
      NAMES_TO_IDS.put("totalDrivers", 7);
      THRIFT_NAMES_TO_IDS.put("totalDrivers", 7);
      FIELD_METADATA.put(7, TOTAL_DRIVERS_FIELD_DESC);
      NAMES_TO_IDS.put("queuedDrivers", 8);
      THRIFT_NAMES_TO_IDS.put("queuedDrivers", 8);
      FIELD_METADATA.put(8, QUEUED_DRIVERS_FIELD_DESC);
      NAMES_TO_IDS.put("queuedPartitionedDrivers", 9);
      THRIFT_NAMES_TO_IDS.put("queuedPartitionedDrivers", 9);
      FIELD_METADATA.put(9, QUEUED_PARTITIONED_DRIVERS_FIELD_DESC);
      NAMES_TO_IDS.put("queuedPartitionedSplitsWeight", 10);
      THRIFT_NAMES_TO_IDS.put("queuedPartitionedSplitsWeight", 10);
      FIELD_METADATA.put(10, QUEUED_PARTITIONED_SPLITS_WEIGHT_FIELD_DESC);
      NAMES_TO_IDS.put("runningDrivers", 11);
      THRIFT_NAMES_TO_IDS.put("runningDrivers", 11);
      FIELD_METADATA.put(11, RUNNING_DRIVERS_FIELD_DESC);
      NAMES_TO_IDS.put("runningPartitionedDrivers", 12);
      THRIFT_NAMES_TO_IDS.put("runningPartitionedDrivers", 12);
      FIELD_METADATA.put(12, RUNNING_PARTITIONED_DRIVERS_FIELD_DESC);
      NAMES_TO_IDS.put("runningPartitionedSplitsWeight", 13);
      THRIFT_NAMES_TO_IDS.put("runningPartitionedSplitsWeight", 13);
      FIELD_METADATA.put(13, RUNNING_PARTITIONED_SPLITS_WEIGHT_FIELD_DESC);
      NAMES_TO_IDS.put("blockedDrivers", 14);
      THRIFT_NAMES_TO_IDS.put("blockedDrivers", 14);
      FIELD_METADATA.put(14, BLOCKED_DRIVERS_FIELD_DESC);
      NAMES_TO_IDS.put("completedDrivers", 15);
      THRIFT_NAMES_TO_IDS.put("completedDrivers", 15);
      FIELD_METADATA.put(15, COMPLETED_DRIVERS_FIELD_DESC);
      NAMES_TO_IDS.put("userMemoryReservationInBytes", 16);
      THRIFT_NAMES_TO_IDS.put("userMemoryReservationInBytes", 16);
      FIELD_METADATA.put(16, USER_MEMORY_RESERVATION_IN_BYTES_FIELD_DESC);
      NAMES_TO_IDS.put("revocableMemoryReservationInBytes", 17);
      THRIFT_NAMES_TO_IDS.put("revocableMemoryReservationInBytes", 17);
      FIELD_METADATA.put(17, REVOCABLE_MEMORY_RESERVATION_IN_BYTES_FIELD_DESC);
      NAMES_TO_IDS.put("systemMemoryReservationInBytes", 18);
      THRIFT_NAMES_TO_IDS.put("systemMemoryReservationInBytes", 18);
      FIELD_METADATA.put(18, SYSTEM_MEMORY_RESERVATION_IN_BYTES_FIELD_DESC);
      NAMES_TO_IDS.put("queuedTime", 19);
      THRIFT_NAMES_TO_IDS.put("queuedTime", 19);
      FIELD_METADATA.put(19, QUEUED_TIME_FIELD_DESC);
      NAMES_TO_IDS.put("elapsedTime", 20);
      THRIFT_NAMES_TO_IDS.put("elapsedTime", 20);
      FIELD_METADATA.put(20, ELAPSED_TIME_FIELD_DESC);
      ...
      NAMES_TO_IDS.put("operatorSummaries", 34);
      THRIFT_NAMES_TO_IDS.put("operatorSummaries", 34);
      FIELD_METADATA.put(34, OPERATOR_SUMMARIES_FIELD_DESC);
      NAMES_TO_IDS.put("drivers", 35);
      THRIFT_NAMES_TO_IDS.put("drivers", 35);
      FIELD_METADATA.put(35, DRIVERS_FIELD_DESC);
    }
    
    
    @com.facebook.swift.codec.ThriftField(value=1, name="pipelineId", requiredness=Requiredness.NONE)
    public int getPipelineId() { return pipelineId; }
    ...
    @com.facebook.swift.codec.ThriftField(value=5, name="inputPipeline", requiredness=Requiredness.NONE)
    public boolean isInputPipeline() { return inputPipeline; }

    
    
    @com.facebook.swift.codec.ThriftField(value=6, name="outputPipeline", requiredness=Requiredness.NONE)
    public boolean isOutputPipeline() { return outputPipeline; }
    ...
    @com.facebook.swift.codec.ThriftField(value=8, name="queuedDrivers", requiredness=Requiredness.NONE)
    public int getQueuedDrivers() { return queuedDrivers; }

    
    
    @com.facebook.swift.codec.ThriftField(value=9, name="queuedPartitionedDrivers", requiredness=Requiredness.NONE)
    public int getQueuedPartitionedDrivers() { return queuedPartitionedDrivers; }

    
    
    @com.facebook.swift.codec.ThriftField(value=10, name="queuedPartitionedSplitsWeight", requiredness=Requiredness.NONE)
    public long getQueuedPartitionedSplitsWeight() { return queuedPartitionedSplitsWeight; }

    
    
    @com.facebook.swift.codec.ThriftField(value=11, name="runningDrivers", requiredness=Requiredness.NONE)
    public int getRunningDrivers() { return runningDrivers; }

    
    
    @com.facebook.swift.codec.ThriftField(value=12, name="runningPartitionedDrivers", requiredness=Requiredness.NONE)
    public int getRunningPartitionedDrivers() { return runningPartitionedDrivers; }

    
    
    @com.facebook.swift.codec.ThriftField(value=13, name="runningPartitionedSplitsWeight", requiredness=Requiredness.NONE)
    public long getRunningPartitionedSplitsWeight() { return runningPartitionedSplitsWeight; }

    
    
    @com.facebook.swift.codec.ThriftField(value=14, name="blockedDrivers", requiredness=Requiredness.NONE)
    public int getBlockedDrivers() { return blockedDrivers; }

    
    
    @com.facebook.swift.codec.ThriftField(value=15, name="completedDrivers", requiredness=Requiredness.NONE)
    public int getCompletedDrivers() { return completedDrivers; }

    
    
    @com.facebook.swift.codec.ThriftField(value=16, name="userMemoryReservationInBytes", requiredness=Requiredness.NONE)
    public long getUserMemoryReservationInBytes() { return userMemoryReservationInBytes; }

    
    
    @com.facebook.swift.codec.ThriftField(value=17, name="revocableMemoryReservationInBytes", requiredness=Requiredness.NONE)
    public long getRevocableMemoryReservationInBytes() { return revocableMemoryReservationInBytes; }

    
    
    @com.facebook.swift.codec.ThriftField(value=18, name="systemMemoryReservationInBytes", requiredness=Requiredness.NONE)
    public long getSystemMemoryReservationInBytes() { return systemMemoryReservationInBytes; }

    
    @Nullable
    @com.facebook.swift.codec.ThriftField(value=19, name="queuedTime", requiredness=Requiredness.NONE)
    public com.facebook.presto.common.experimental.auto_gen.ThriftDistributionSnapshot getQueuedTime() { return queuedTime; }

    
    @Nullable
    @com.facebook.swift.codec.ThriftField(value=20, name="elapsedTime", requiredness=Requiredness.NONE)
    public com.facebook.presto.common.experimental.auto_gen.ThriftDistributionSnapshot getElapsedTime() { return elapsedTime; }
    ...
    @Nullable
    @com.facebook.swift.codec.ThriftField(value=34, name="operatorSummaries", requiredness=Requiredness.NONE)
    public List<com.facebook.presto.common.experimental.auto_gen.ThriftOperatorStats> getOperatorSummaries() { return operatorSummaries; }

    
    @Nullable
    @com.facebook.swift.codec.ThriftField(value=35, name="drivers", requiredness=Requiredness.NONE)
    public List<com.facebook.presto.common.experimental.auto_gen.ThriftDriverStats> getDrivers() { return drivers; }
    ...
    public String toString() {
        ...
        helper.add("inputPipeline", inputPipeline);
        helper.add("outputPipeline", outputPipeline);
        ...
        helper.add("queuedTime", queuedTime);
        ...
        helper.add("operatorSummaries", operatorSummaries);
        helper.add("drivers", drivers);
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ThriftPipelineStats other = (ThriftPipelineStats)o;
        ...
        return
            ...
            Objects.equals(inputPipeline, other.inputPipeline) &&
            Objects.equals(outputPipeline, other.outputPipeline) &&
            ...
            Objects.equals(operatorSummaries, other.operatorSummaries) &&
    ...
    public static com.facebook.thrift.payload.Reader<ThriftPipelineStats> asReader() {
      return ThriftPipelineStats::read0;
    }
    
    public static ThriftPipelineStats read0(TProtocol oprot) throws TException {
      TField __field;
      oprot.readStructBegin(ThriftPipelineStats.NAMES_TO_IDS, ThriftPipelineStats.THRIFT_NAMES_TO_IDS, ThriftPipelineStats.FIELD_METADATA);
      ThriftPipelineStats.Builder builder = new ThriftPipelineStats.Builder();
      while (true) {
        ...
        case _INPUTPIPELINE:
          if (__field.type == TType.BOOL) {
            boolean inputPipeline = oprot.readBool();
            builder.setInputPipeline(inputPipeline);
          } else {
            TProtocolUtil.skip(oprot, __field.type);
          }
          break;
        case _OUTPUTPIPELINE:
          if (__field.type == TType.BOOL) {
            boolean outputPipeline = oprot.readBool();
            builder.setOutputPipeline(outputPipeline);
          } else {
            TProtocolUtil.skip(oprot, __field.type);
          }
          break;
        ...
        case _QUEUEDTIME:
          if (__field.type == TType.STRUCT) {
            com.facebook.presto.common.experimental.auto_gen.ThriftDistributionSnapshot queuedTime = com.facebook.presto.common.experimental.auto_gen.ThriftDistributionSnapshot.read0(oprot);
            builder.setQueuedTime(queuedTime);
          } else {
            TProtocolUtil.skip(oprot, __field.type);
          }
          break;
        case _ELAPSEDTIME:
          if (__field.type == TType.STRUCT) {
            com.facebook.presto.common.experimental.auto_gen.ThriftDistributionSnapshot elapsedTime = com.facebook.presto.common.experimental.auto_gen.ThriftDistributionSnapshot.read0(oprot);
            builder.setElapsedTime(elapsedTime);
          } else {
            TProtocolUtil.skip(oprot, __field.type);
          }
          break;
        ...
        case _PHYSICALWRITTENDATASIZEINBYTES:
          ...
          break;
        case _OPERATORSUMMARIES:
          if (__field.type == TType.LIST) {
            List<com.facebook.presto.common.experimental.auto_gen.ThriftOperatorStats> operatorSummaries;
                {
                TList _list = oprot.readListBegin();
                operatorSummaries = new ArrayList<com.facebook.presto.common.experimental.auto_gen.ThriftOperatorStats>(Math.max(0, _list.size));
                for (int _i = 0; (_list.size < 0) ? oprot.peekList() : (_i < _list.size); _i++) {
                    ...
                    operatorSummaries.add(_value1);
                }
                oprot.readListEnd();
                }
            builder.setOperatorSummaries(operatorSummaries);
          } else {
            TProtocolUtil.skip(oprot, __field.type);
          }
          break;
        case _DRIVERS:
          if (__field.type == TType.LIST) {
            List<com.facebook.presto.common.experimental.auto_gen.ThriftDriverStats> drivers;
                {
                TList _list = oprot.readListBegin();
                drivers = new ArrayList<com.facebook.presto.common.experimental.auto_gen.ThriftDriverStats>(Math.max(0, _list.size));
                for (int _i = 0; (_list.size < 0) ? oprot.peekList() : (_i < _list.size); _i++) {
                    
                    com.facebook.presto.common.experimental.auto_gen.ThriftDriverStats _value1 = com.facebook.presto.common.experimental.auto_gen.ThriftDriverStats.read0(oprot);
                    drivers.add(_value1);
                }
                oprot.readListEnd();
                }
            builder.setDrivers(drivers);
          } else {
            TProtocolUtil.skip(oprot, __field.type);
          }
          break;
    ...
    public void write0(TProtocol oprot) throws TException {
      ...
      oprot.writeFieldEnd();
      oprot.writeFieldBegin(INPUT_PIPELINE_FIELD_DESC);
      oprot.writeBool(this.inputPipeline);
      oprot.writeFieldEnd();
      oprot.writeFieldBegin(OUTPUT_PIPELINE_FIELD_DESC);
      oprot.writeBool(this.outputPipeline);
      oprot.writeFieldEnd();
      ...
      oprot.writeFieldEnd();
      if (queuedTime != null) {
        oprot.writeFieldBegin(QUEUED_TIME_FIELD_DESC);
        this.queuedTime.write0(oprot);
        oprot.writeFieldEnd();
      }
      if (elapsedTime != null) {
        oprot.writeFieldBegin(ELAPSED_TIME_FIELD_DESC);
        this.elapsedTime.write0(oprot);
        oprot.writeFieldEnd();
      }
      ...
      oprot.writeFieldEnd();
      if (operatorSummaries != null) {
        oprot.writeFieldBegin(OPERATOR_SUMMARIES_FIELD_DESC);
        List<com.facebook.presto.common.experimental.auto_gen.ThriftOperatorStats> _iter0 = operatorSummaries;
      ...
      if (drivers != null) {
        oprot.writeFieldBegin(DRIVERS_FIELD_DESC);
        List<com.facebook.presto.common.experimental.auto_gen.ThriftDriverStats> _iter0 = drivers;
        oprot.writeListBegin(new TList(TType.STRUCT, _iter0.size()));
            for (com.facebook.presto.common.experimental.auto_gen.ThriftDriverStats _iter1 : _iter0) {
              _iter1.write0(oprot);
            }
            oprot.writeListEnd();
        oprot.writeFieldEnd();
    ...
    private static class _ThriftPipelineStatsLazy {
        private static final ThriftPipelineStats _DEFAULT = new ThriftPipelineStats.Builder().build();
    }
    
    public static ThriftPipelineStats defaultInstance() {
        return  _ThriftPipelineStatsLazy._DEFAULT;
    }
}
