...
public class ConnectorOutputTableHandleAdapter
{
    ...
    public static byte[] serialize(Object obj)
    {
        if (obj instanceof ThriftSerializable) {
            ...
            return FbThriftUtils.serialize(ThriftConnectorOutputTableHandle.builder()
                    .setType(serializable.getImplementationType())
                    .setSerializedOutputTableHandle(bytes).build());
        }
    ...
    {
        return fromThrift(FbThriftUtils.deserialize(ThriftConnectorOutputTableHandle.class, bytes));
    }
