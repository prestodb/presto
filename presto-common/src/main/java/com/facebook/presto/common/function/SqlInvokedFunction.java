...
public class SqlInvokedFunction
        implements com.facebook.presto.common.function.SqlFunction
{
    private final List<com.facebook.presto.common.function.Parameter> parameters;
    private final String description;
    private final com.facebook.presto.common.function.RoutineCharacteristics routineCharacteristics;
    private final String body;

    private final com.facebook.presto.common.function.Signature signature;
    private final com.facebook.presto.common.function.SqlFunctionId functionId;
    private final com.facebook.presto.common.function.FunctionVersion functionVersion;
