...
public class TestLongTimestamp
{
    ...
    {
        LongTimestamp ts = new LongTimestamp(0L, MAX_PICOS_OF_MICRO);
        assertEquals(ts.getPicosOfMicro(), MAX_PICOS_OF_MICRO);
    }
    ...
    {
        expectThrows(IllegalArgumentException.class, () -> new LongTimestamp(0L, MAX_PICOS_OF_MICRO + 1));
    }
