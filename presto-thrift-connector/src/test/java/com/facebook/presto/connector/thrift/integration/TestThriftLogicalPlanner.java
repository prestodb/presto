        ...
        extends AbstractTestQueryFramework
{
    ...
    {
        Session nativeExecution = Session.builder(getSession())
        ...
        assertPlan(sql,
                anyTree(
                        indexJoin(
                                exchange(project(filter(tableScan("lineitem")))),
                                project(filter(indexSource("orders"))))));

        assertPlan(nativeExecution, sql,
                anyTree(
                        indexJoin(
