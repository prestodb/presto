    ...
    public Page getNextPage()
    {
        ...
        try {
            ...
            if (split.isKnnSearch()) {
                ...
                java.util.Set<String> topLevelFields = new java.util.HashSet<>();
        ...
        for (int columnIndex = 0; columnIndex < columns.size(); columnIndex++) {
            ...
            for (Map<String, Object> document : documents) {
                ...
                if (column.isNestedField()) {
                    ...
                    // If value is a Map or List (nested object/array) and column type is VARCHAR,
                    // convert to JSON string for parent object columns
