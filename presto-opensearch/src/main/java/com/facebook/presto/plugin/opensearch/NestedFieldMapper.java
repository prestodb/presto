            ...
            if (isLeaf) {
                ...
                if (fieldProps.containsKey("properties")) {
                    ...
                    NestedFieldInfo fieldInfo = new NestedFieldInfo(
                            ...
                            newPathList);
                    result.put(fieldPath, fieldInfo);
                    log.debug("Discovered parent field: %s (type: %s, ROW type: %s, depth: %d)",
                             fieldPath, fieldType, prestoType, depth);
                    ...
                    // Object with no properties - still add it to result with fallback type
                    ...
                    NestedFieldInfo fieldInfo = new NestedFieldInfo(
                            ...
                            newPathList);
                    result.put(fieldPath, fieldInfo);
                    log.debug("Discovered parent field without properties: %s (type: %s, depth: %d)",
                             fieldPath, fieldType, depth);
                }
            }
        }
