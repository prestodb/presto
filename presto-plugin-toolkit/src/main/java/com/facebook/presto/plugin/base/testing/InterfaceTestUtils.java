 ...
 */
package com.facebook.presto.plugin.base.testing;
...
public final class InterfaceTestUtils
{
    ...
    // Note: this should be in sync with com.facebook.presto.testing.InterfaceTestUtils#checkEverythingImplemented
