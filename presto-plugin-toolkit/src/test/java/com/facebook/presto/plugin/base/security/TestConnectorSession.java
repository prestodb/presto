...
public class TestConnectorSession
        implements ConnectorSession
{
    ...
    public TestConnectorSession(String userName)
    {
        this(userName, Optional.of("test"), UTC_KEY, ENGLISH, System.currentTimeMillis(), ImmutableList.of(), ImmutableMap.of(), true);
    }

    public TestConnectorSession(
            String user,
