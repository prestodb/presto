...
statement
    ...
    | ALTER TABLE (IF EXISTS)? tableName=qualifiedName
        ALTER COLUMN (IF EXISTS)? column=identifier SET NOT NULL       #alterColumnSetNotNull
    | ALTER TABLE (IF EXISTS)? tableName=qualifiedName
        ALTER COLUMN (IF EXISTS)? column=identifier DROP NOT NULL      #alterColumnDropNotNull
