...
import static com.facebook.presto.spi.analyzer.UpdateType.REFRESH_MATERIALIZED_VIEW;
        ...
        extends Statement
{
    ...
    {
        return new UpdateInfo(REFRESH_MATERIALIZED_VIEW, target.getName().toString());
    }
