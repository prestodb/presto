        ...
        extends SqlBaseBaseVisitor<Node>
{
    ...
    {
        return new ShowCreate(getLocation(context), ShowCreate.Type.TABLE, getQualifiedNameWithCase(context.qualifiedName()));
    }
    ...
    {
        return new ShowCreate(getLocation(context), ShowCreate.Type.VIEW, getQualifiedNameWithCase(context.qualifiedName()));
    }

    @Override
    public Node visitShowCreateMaterializedView(SqlBaseParser.ShowCreateMaterializedViewContext context)
    {
        return new ShowCreate(getLocation(context), ShowCreate.Type.MATERIALIZED_VIEW, getQualifiedNameWithCase(context.qualifiedName()));
    }
    ...
    public Node visitShowGrants(SqlBaseParser.ShowGrantsContext context)
    {
        ...
        if (context.qualifiedName() != null) {
            tableName = Optional.of(getQualifiedNameWithCase(context.qualifiedName()));
        }
