        ...
        extends SqlBaseBaseVisitor<Node>
{
    ...
    {
        return new CreateTableAsSelect(getLocation(context), getQualifiedName(context.qualifiedName()), (Query) visit(context.query()), processTableProperties(context.tableProperties()), context.NO() == null, context.REFRESH() != null);
    }
