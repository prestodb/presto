        ...
        extends Expression
{
    ...
    public Identifier(SourceLocation location, String value, boolean delimited)
    {
    ...
    private Identifier(Optional<SourceLocation> location, String value, boolean delimited)
    {
        super(location);
        this.value = value;
