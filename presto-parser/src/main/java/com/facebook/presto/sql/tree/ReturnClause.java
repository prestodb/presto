        ...
        extends Node
{
    ...
    public ReturnClause(NodeLocation location, String returnType, Optional<String> castFromType)
    {
        this(Optional.of(location), returnType, castFromType);
    }

    public ReturnClause(Optional<NodeLocation> location, String returnType, Optional<String> castFromType)
    {
        super(location);
