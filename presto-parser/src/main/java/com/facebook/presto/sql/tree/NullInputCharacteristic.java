        ...
        extends RoutineCharacteristic
{
    ...
    {
        this(Optional.empty(), returningNull);
    }

    public NullInputCharacteristic(NodeLocation location, boolean returningNull)
    {
        this(Optional.of(location), returningNull);
    }

    public NullInputCharacteristic(Optional<NodeLocation> location, boolean returningNull)
    {
        super(location);
