    ...
    extends Statement
{
    ...
    public ShowRoleGrants(Optional<String> catalog)
    {
        this(Optional.empty(), catalog);
    }

    public ShowRoleGrants(NodeLocation location, Optional<String> catalog)
    {
        this(Optional.of(location), catalog);
    }

    public ShowRoleGrants(Optional<NodeLocation> location, Optional<String> catalog)
    {
        super(location);
