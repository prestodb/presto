        ...
        extends Node
{
    ...
    public Property(SourceLocation location, Identifier name, Expression value)
    {
        this(Optional.of(location), name, value);
    }

    private Property(Optional<SourceLocation> location, Identifier name, Expression value)
    {
        super(location);
