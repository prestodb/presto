        ...
        extends ControlStatement
{
    ...
    public AssignmentStatement(NodeLocation location, List<QualifiedName> targets, Expression value)
    {
        this(Optional.of(location), targets, value);
    }

    public AssignmentStatement(Optional<NodeLocation> location, List<QualifiedName> targets, Expression value)
    {
        super(location);
