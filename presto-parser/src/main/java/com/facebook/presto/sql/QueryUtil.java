...
public final class QueryUtil
{
    ...
    public static Query simpleQuery(Select select, Relation from, Optional<Expression> where, Optional<GroupByClause> groupBy, Optional<Expression> having, List<SortItem> ordering, Optional<String> limit)
    {
