...
public class SqlParser
{
            ...
            extends SqlBaseBaseListener
    {
        ...
        @Override
        public void exitUnquotedLabel(@NotNull SqlBaseParser.UnquotedLabelContext context)
        {
        ...
        @Override
        public void exitBackQuotedLabel(@NotNull SqlBaseParser.BackQuotedLabelContext context)
        {
            checkBackQuotedIdentifier(context.BACKQUOTED_IDENTIFIER());
        }

        @Override
        public void exitDigitLabel(@NotNull SqlBaseParser.DigitLabelContext context)
        {
            checkDigitIdentifier(context.DIGIT_IDENTIFIER());
        }

        private void checkForTrailingColon(@NotNull String text, Token token)
        {
            if (!text.endsWith(":")) {
        ...
        private void checkUnquotedIdentifier(@NotNull String identifier, Token token)
        {
        ...
        private void checkBackQuotedIdentifier(@NotNull TerminalNode node)
        {
        ...
        private void checkDigitIdentifier(@NotNull TerminalNode node)
        {
            Token token = node.getSymbol();
            throw new ParsingException(
