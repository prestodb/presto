        ...
        extends Expression
{
    ...
    public ArrayConstructor(SourceLocation location, List<Expression> values)
    {
        this(Optional.of(location), values);
    }

    private ArrayConstructor(Optional<SourceLocation> location, List<Expression> values)
    {
        super(location);
