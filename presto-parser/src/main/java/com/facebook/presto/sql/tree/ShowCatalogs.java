        ...
        extends Statement
{
    ...
    public ShowCatalogs(SourceLocation location, Optional<String> likePattern)
    {
        this(Optional.of(location), likePattern);
    }

    public ShowCatalogs(Optional<SourceLocation> location, Optional<String> likePattern)
    {
        super(location);
