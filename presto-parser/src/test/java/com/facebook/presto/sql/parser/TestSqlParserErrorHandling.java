...
public class TestSqlParserErrorHandling
{
    ...
    public Object[][] getStatements()
    {
        return new Object[][] {
                ...
                {"select ,",
                 "line 1:8: mismatched input ','. Expecting: '*', 'ALL', 'DISTINCT', <expression>, <identifier>"},
                {"select 1,2,,",
                 "line 1:12: mismatched input ','. Expecting: 'EXCEPT', 'FETCH', 'FROM', 'GROUP', 'HAVING', 'INTERSECT', 'LIMIT', 'OFFSET', 'ORDER', 'UNION', 'WHERE', <EOF>"},
                {"select foo(DISTINCT)",
                ...
                {"SELECT grouping(a+2) FROM (VALUES (1)) AS t (a) GROUP BY a+2",
                 "line 1:18: mismatched input '+'. Expecting: ',', <expression>"},
