...
public class TestSqlParser
{
    ...
    public void testAlterColumnAddDropNotNullConstraints()
    {
        assertStatement("ALTER TABLE foo.t ALTER COLUMN b SET NOT NULL", new AlterColumnNotNull(QualifiedName.of("foo", "t"),
                identifier("b"), false, false, false));
        assertStatement("ALTER TABLE foo.t ALTER COLUMN b DROP NOT NULL", new AlterColumnNotNull(QualifiedName.of("foo", "t"),
                identifier("b"), false, false, true));
        assertStatement("ALTER TABLE IF EXISTS foo.t ALTER COLUMN b SET NOT NULL", new AlterColumnNotNull(QualifiedName.of("foo", "t"),
                identifier("b"), true, false, false));
        assertStatement("ALTER TABLE foo.t ALTER COLUMN IF EXISTS b DROP NOT NULL", new AlterColumnNotNull(QualifiedName.of("foo", "t"),
                identifier("b"), false, true, true));
        assertStatement("ALTER TABLE IF EXISTS foo.t ALTER COLUMN IF EXISTS b DROP NOT NULL", new AlterColumnNotNull(QualifiedName.of("foo", "t"),
                identifier("b"), true, true, true));
    }
