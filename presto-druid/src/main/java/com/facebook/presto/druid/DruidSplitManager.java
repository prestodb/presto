        ...
        implements ConnectorSplitManager
{
            ...
            SplitSchedulingContext splitSchedulingContext)
    {
        ...
        if (isComputePushdownEnabled(session) || (table.getDql().isPresent() && table.getDql().orElseThrow().getPushdown())) {
            return new FixedSplitSource(ImmutableList.of(createBrokerSplit(table.getDql().orElseThrow())));
        }
