        ...
        for (VariableReferenceExpression outputColumn : aggregationNode.getOutputVariables()) {
            ...
            if (aggregation != null) {
                ...
                if (aggregation.getMask().isPresent()) {
                    ...
                    if (aggregation.getCall().getDisplayName().equalsIgnoreCase(COUNT_FUNCTION_NAME) && aggregation.getMask().orElseThrow().getName().equalsIgnoreCase(aggregation.getArguments().get(0) + DISTINCT_MASK)) {
