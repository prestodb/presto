        ...
        implements RecordSet
{
    ...
    public LocalFileRecordSet(LocalFileSplit split, List<LocalFileColumnHandle> columns)
    {
        ...
        address = Iterables.getOnlyElement(split.getAddresses());
        try {
    ...
    {
        return new LocalFileRecordCursor(columns, byteSource, address);
    }
}
