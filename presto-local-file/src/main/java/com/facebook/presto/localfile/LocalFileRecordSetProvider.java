        ...
        implements ConnectorRecordSetProvider
{
    ...
    @Inject
    public LocalFileRecordSetProvider(LocalFileConnectorId connectorId)
    {
    ...
    public RecordSet getRecordSet(ConnectorSession session, ConnectorSplit split, List<? extends ColumnHandle> columns)
    {
        ...
        LocalFileSplit exampleSplit = checkType(split, LocalFileSplit.class, "split");
        ...
        return new LocalFileRecordSet(exampleSplit, handles.build());
    }
}
