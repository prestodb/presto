...
public class OracleQueryRunner
{
    ...
    public static DistributedQueryRunner createOracleQueryRunner(
            ...
            throws Exception
    {
        return createOracleQueryRunner(server, catalogName, extraConnectorProperties, tables, 4);
    }
            ...
            throws Exception
    {
        ...
        try {
            Session session = testSessionBuilder()
                    ...
                    .build();
            queryRunner = DistributedQueryRunner.builder(session).setNodeCount(nodeCount).build();
