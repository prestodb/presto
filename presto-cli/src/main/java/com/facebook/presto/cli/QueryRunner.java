...
import com.facebook.presto.client.SpnegoInterceptor;
        ...
        implements Closeable
{
            ...
            boolean kerberosEnabled)
    {
        ...
        if (kerberosEnabled) {
            builder.addInterceptor(new SpnegoInterceptor(
                    ...
                    kerberosRemoteServiceName.orElseThrow(() ->
                            new IllegalArgumentException("Kerberos remote service name must be set")),
