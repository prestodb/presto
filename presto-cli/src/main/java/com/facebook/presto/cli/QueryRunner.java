        ...
        implements Closeable
{
            ...
            Boolean authenticationEnabled)
    {
        ...
        if (keystorePath.isPresent()) {
            httpClientConfig.setKeyStorePath(keystorePath.get());
        }

        if (keystorePassword.isPresent()) {
            httpClientConfig.setKeyStorePassword(keystorePassword.get());
        }

        if (kerberosPrincipal.isPresent()) {
            httpClientConfig.setKerberosPrincipal(kerberosPrincipal.get());
        }

        if (kerberosRemoteServiceName.isPresent()) {
            httpClientConfig.setKerberosRemoteServiceName(kerberosRemoteServiceName.get());
        }
