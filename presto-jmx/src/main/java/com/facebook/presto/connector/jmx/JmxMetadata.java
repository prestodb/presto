...
{
    public static final String JMX_SCHEMA_NAME = "jmx";
    ...
    private JmxTableHandle getJmxTableHandle(SchemaTableName tableName)
    {
        try {
            ...
            columns.add(new JmxColumnHandle(connectorId, NODE_COLUMN_NAME, VARCHAR));
    ...
    public List<SchemaTableName> listTables(ConnectorSession session, String schemaNameOrNull)
    {
        if (JMX_SCHEMA_NAME.equals(schemaNameOrNull)) {
            ...
            return jmxHistoryHolder.getTables().stream()
