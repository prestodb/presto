...
public class TestJmxStatsHolder
{
    ...
    {
        JmxHistoricalData jmxHistoricalData = new JmxHistoricalData(EVICTION_LIMIT, ImmutableSet.of(TABLE_NAME));
        ...
        jmxHistoricalData.addRow(TABLE_NAME, ImmutableList.<Object>of(42, "ala"));
        jmxHistoricalData.addRow(TABLE_NAME, ImmutableList.<Object>of(42, "ala"));
        assertEquals(jmxHistoricalData.getRows(TABLE_NAME, bothColumns).size(), EVICTION_LIMIT);
    }
}
