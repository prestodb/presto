        ...
        implements EventListenerFactory
{
    ...
    public static final String QUERY_EVENT_FILTERING_ENABLE = "watsonx.queryevent.filter.enabled";
    public static final String QUERY_EVENT_FILTERING_CATALOGS = "watsonx.queryevent.filter.catalogs";
    public static final String QUERY_EVENT_FILTERING_SCHEMAS = "watsonx.queryevent.filter.schemas";
    public static final String QUERY_EVENT_FILTERING_KEYWORD = "watsonx.queryevent.filter.keyword";
    public static final String QUERY_EVENT_FILTERING_QUERY_ACTION_TYPE = "watsonx.queryevent.filter.queryactiontype";
    public static final String QUERY_EVENT_FILTERING_QUERY_ACTION_TYPE_ENABLED = "watsonx.queryevent.filter.queryactiontype.enabled";
    public static final String QUERY_EVENT_FILTERING_CONTEXT_SOURCE = "watsonx.queryevent.filter.context.source";
    public static final String QUERY_EVENT_FILTERING_CONTEXT_SOURCE_ENABLED = "watsonx.queryevent.filter.context.source.enabled";
    public static final String QUERY_EVENT_FILTERING_CONTEXT_ENVIRONMENT = "watsonx.queryevent.filter.context.environment";
    public static final String QUERY_EVENT_FILTERING_CONTEXT_ENVIRONMENT_ENABLED = "watsonx.queryevent.filter.context.environment.enabled";
