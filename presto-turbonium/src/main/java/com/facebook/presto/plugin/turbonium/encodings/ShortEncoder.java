...
import com.facebook.presto.plugin.turbonium.storage.ShortSegments.AllValues;
import com.facebook.presto.plugin.turbonium.storage.ShortSegments.Delta;
import com.facebook.presto.plugin.turbonium.storage.ShortSegments.Dictionary;
import com.facebook.presto.plugin.turbonium.storage.ShortSegments.Rle;
import com.facebook.presto.plugin.turbonium.storage.ShortSegments.RleWithNulls;
import com.facebook.presto.plugin.turbonium.storage.ShortSegments.SortedDictionary;
    ...
    extends AbstractEncoder<Short>
{
    ...
    public ShortEncoder(boolean disableEncoding, Stats<Short> stats, Type type, BitSet isNull, short[] values)
    {
