...
public final class TurboniumQueryRunner
{
    private TurboniumQueryRunner() {}
            ...
            throws Exception
    {
        Session session = testSessionBuilder()
                .setCatalog("turbo")
                .setSchema(TurboniumMetadata.SCHEMA_NAME)
                .build();

        DistributedQueryRunner queryRunner = new DistributedQueryRunner(session, 4, extraProperties);

        try {
            queryRunner.installPlugin(new TurboniumPlugin());
            queryRunner.createCatalog("turbo", "turbonium", ImmutableMap.of());
            ...
            throws Exception
    {
        ...
        Logger log = Logger.get(TurboniumQueryRunner.class);
