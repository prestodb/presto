...
public class TestOpenLineageEventListenerPlugin
{
    @Test
    public void testCreateConsoleEventListener()
    {
        OpenLineageEventListenerPlugin plugin = new OpenLineageEventListenerPlugin();

        EventListenerFactory factory = getOnlyElement(plugin.getEventListenerFactories());
        factory.create(
                ImmutableMap.<String, String>builder()
                        .put("openlineage-event-listener.presto.uri", "http://localhost:8080")
                        .put("openlineage-event-listener.transport.type", "console")
                        .build());
    }

    @Test
    public void testCreateHttpEventListener()
    {
        OpenLineageEventListenerPlugin plugin = new OpenLineageEventListenerPlugin();
