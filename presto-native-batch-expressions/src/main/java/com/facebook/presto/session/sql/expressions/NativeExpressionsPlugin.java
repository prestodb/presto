...
{
    @Override
    public Iterable<RowExpressionInterpreterServiceFactory> getRowExpressionInterpreterServiceFactories()
    {
        return ImmutableList.of(new NativeRowExpressionInterpreterServiceFactory(getClassLoader()));
    }
