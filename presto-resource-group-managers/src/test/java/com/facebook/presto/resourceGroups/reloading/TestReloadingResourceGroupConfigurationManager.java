...
public class TestReloadingResourceGroupConfigurationManager
{
    ...
    public void testConfiguration()
    {
        ...
        assertEqualsResourceGroup(global, "1MB", 1000, 100, 100, WEIGHTED, DEFAULT_WEIGHT, true, new Duration(1, HOURS), new Duration(1, DAYS), new ResourceGroupQueryLimits(Optional.of(new Duration(1, HOURS)), Optional.of(new DataSize(1, DataSize.Unit.MEGABYTE)), Optional.of(new Duration(1, HOURS))));
        exported.set(false);
        ...
        assertEqualsResourceGroup(sub, "2MB", 4, 3, 3, FAIR, 5, false, new Duration(Long.MAX_VALUE, MILLISECONDS), new Duration(Long.MAX_VALUE, MILLISECONDS), new ResourceGroupQueryLimits(Optional.of(new Duration(Long.MAX_VALUE, MILLISECONDS)), Optional.of(new DataSize(Long.MAX_VALUE, DataSize.Unit.BYTE)), Optional.of(new Duration(Long.MAX_VALUE, MILLISECONDS))));
    }
            ...
            throws Exception
    {
        ...
        assertEqualsResourceGroup(globalSub, "2MB", 4, 3, 3, FAIR, 5, false, new Duration(Long.MAX_VALUE, MILLISECONDS), new Duration(Long.MAX_VALUE, MILLISECONDS), new ResourceGroupQueryLimits(Optional.of(new Duration(1, HOURS)), Optional.of(new DataSize(1, DataSize.Unit.MEGABYTE)), Optional.of(new Duration(1, HOURS))));
        ...
        // Verify update
        assertEqualsResourceGroup(globalSub, "3MB", 2, 1, 1, WEIGHTED, 6, true, new Duration(1, HOURS), new Duration(1, DAYS), new ResourceGroupQueryLimits(Optional.of(new Duration(1, HOURS)), Optional.of(new DataSize(1, DataSize.Unit.MEGABYTE)), Optional.of(new Duration(30, MINUTES))));
        // Verify delete
