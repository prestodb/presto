...
public class TestResourceGroupIdTemplate
{
    ...
    public void testExtraction()
    {
        ...
        SelectionCriteria context = new SelectionCriteria(true, "user", Optional.of("scheduler.important.testpipeline[5]"), ImmutableSet.of(), Optional.empty(), EMPTY_RESOURCE_ESTIMATES, Optional.empty());
    ...
    public void testNoSource()
    {
        ...
        SelectionCriteria context = new SelectionCriteria(true, "scheduler.important.testpipeline[5]", Optional.empty(), ImmutableSet.of(), Optional.empty(), EMPTY_RESOURCE_ESTIMATES, Optional.empty());
    ...
    public void testNoMatch()
    {
        ...
        Pattern sourcePattern = Pattern.compile("scheduler.important.(?<pipeline>[^\\[]*).*");
        StaticSelector selector = new StaticSelector(Optional.empty(), Optional.of(sourcePattern), Optional.empty(), Optional.empty(), Optional.empty(), Optional.empty(), template);
        SelectionCriteria context = new SelectionCriteria(true, "user", Optional.of("scheduler.testpipeline[5]"), ImmutableSet.of(), Optional.empty(), EMPTY_RESOURCE_ESTIMATES, Optional.empty());
