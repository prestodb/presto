        ...
        extends ResourceGroupsDao
{
    ...
    @SqlUpdate("INSERT INTO resource_groups\n" +
            "(resource_group_id, name, soft_memory_limit, max_queued, soft_concurrency_limit, hard_concurrency_limit, scheduling_policy, scheduling_weight, jmx_export, soft_cpu_limit, hard_cpu_limit, per_query_execution_time, per_query_total_memory_limit, per_query_cpu_time, parent, environment)\n" +
            "VALUES (:resource_group_id, :name, :soft_memory_limit, :max_queued, :soft_concurrency_limit, :hard_concurrency_limit, :scheduling_policy, :scheduling_weight, :jmx_export, :soft_cpu_limit, :hard_cpu_limit, :per_query_execution_time, :per_query_total_memory_limit, :per_query_cpu_time, :parent, :environment)")
    void insertResourceGroup(
            ...
            @Bind("per_query_execution_time") String perQueryExecutionTime,
            @Bind("per_query_total_memory_limit") String perQueryTotalMemoryTime,
            @Bind("per_query_cpu_time") String perQueryCpuTime,
    ...
    @SqlUpdate("UPDATE resource_groups SET\n" +
            ...
            ", per_query_execution_time = :per_query_execution_time\n" +
            ", per_query_total_memory_limit = :per_query_total_memory_limit\n" +
            ", per_query_cpu_time = :per_query_cpu_time\n" +
            ", parent = :parent\n" +
