...
public interface ResourceGroupsDao
{
    ...
    @SqlUpdate("CREATE TABLE IF NOT EXISTS resource_groups (\n" +
            ...
            "  per_query_execution_time VARCHAR(128) NULL,\n" +
            "  per_query_total_memory_limit VARCHAR(128), \n" +
            "  per_query_cpu_time VARCHAR(128), \n" +
            "  parent BIGINT NULL,\n" +
    ...
    @SqlQuery("SELECT resource_group_id, name, soft_memory_limit, max_queued, soft_concurrency_limit, " +
            ...
            "  hard_cpu_limit, per_query_execution_time, per_query_total_memory_limit, per_query_cpu_time, parent\n" +
