...
public interface ResourceGroupsDao
{
    ...
    @SqlQuery("SELECT resource_group_id, name, soft_memory_limit, max_queued, target_running, max_running," +
            "  scheduling_policy, scheduling_weight, burst_scheduling_weight, jmx_export, soft_cpu_limit, " +
