...
public class ResourceGroupSpecBuilder
{
    ...
    ResourceGroupSpecBuilder(
            ...
            Optional<String> perQueryExecutionTime,
            Optional<String> perQueryTotalMemoryLimit,
            Optional<String> perQueryCpuTime,
            Optional<Long> parentId)
    {
        ...
        Optional<Duration> maxExecutionTime = requireNonNull(perQueryExecutionTime, "perQueryExecutionTime is null").map(Duration::valueOf);
        Optional<DataSize> maxTotalMemoryLimit = requireNonNull(perQueryTotalMemoryLimit, "perQueryTotalMemoryLimit is null").map(DataSize::valueOf);
        Optional<Duration> maxCpuTime = requireNonNull(perQueryCpuTime, "perQueryCpuTime is null").map(Duration::valueOf);
        this.perQueryLimits = Optional.of(new ResourceGroupQueryLimits(maxExecutionTime, maxTotalMemoryLimit, maxCpuTime));
            ...
            implements RowMapper<ResourceGroupSpecBuilder>
    {
                ...
                throws SQLException
        {
            ...
            Optional<String> perQueryExecutionTime = Optional.ofNullable(resultSet.getString("per_query_execution_time"));
            Optional<String> perQueryTotalMemoryLimit = Optional.ofNullable(resultSet.getString("per_query_total_memory_limit"));
            Optional<String> perQueryCpuTime = Optional.ofNullable(resultSet.getString("per_query_cpu_time"));
