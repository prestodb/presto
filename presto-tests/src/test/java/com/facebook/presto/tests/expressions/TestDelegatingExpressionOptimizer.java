...
{
    private FunctionResolution resolution = new FunctionResolution(getMetadata().getFunctionAndTypeManager().getFunctionAndTypeResolver());
    private ExpressionOptimizer expressionOptimizer = new DelegatingRowExpressionOptimizer(getMetadata(), new InMemoryExpressionOptimizerProvider(getMetadata()), 1);
