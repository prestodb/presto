        ...
        extends AbstractTestQueryFramework
{
    ...
    public void testCheckQueryIntegrityCalls()
    {
        ...
        assertAccessDenied("explain analyze orders", ".*Query integrity check failed.*");
        ...
        assertQueryFails("CREATE TABLE test_empty (a BIGINT)", ".*This connector does not support creating tables.*");
        assertQuerySucceeds("use tpch.tiny");
    }
}
