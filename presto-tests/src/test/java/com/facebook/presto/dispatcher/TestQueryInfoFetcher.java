    ...
    private QueryInfoFetcherFactory createQueryInfoFetcherFactory(RemoteQueryStats remoteQueryStats)
    {
        ...
        Injector injector = app
                ...
                .setRequiredConfigurationProperties(ImmutableMap.<String, String>builder()
                        .put("dispatcher.experimental.remote-query-info.min-error-duration", "5s")
                        .put("dispatcher.experimental.remote-query-info.update-interval", "1ms")
                        .put("dispatcher.experimental.remote-query-info.refresh-max-wait", "5s")
                        .build())
                .quiet()
                .initialize();
