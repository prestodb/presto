...
public class DbSessionPropertyManagerConfig
{
    ...
    private String jdbcDataSource = "mysql";
    ...
    @Config("session-property-manager.db.database-data-source-name")
    public DbSessionPropertyManagerConfig setJdbcDataSource(String jdbcDataSource)
    {
