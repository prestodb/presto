...
import static com.facebook.presto.session.db.util.SessionPropertiesDaoUtil.CLIENT_TAGS_TABLE;
import static com.facebook.presto.session.db.util.SessionPropertiesDaoUtil.PROPERTIES_TABLE;
import static com.facebook.presto.session.db.util.SessionPropertiesDaoUtil.SESSION_SPECS_TABLE;
