...
public class ChunkRange
{
    ...
    public static ChunkRange of(Tuple min, Tuple max)
    {
        return new ChunkRange(min, max);
    }

    private ChunkRange(Tuple minTuple, Tuple maxTuple)
    {
