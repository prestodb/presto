...
public class TestFloatingPointUtil
{
    ...
    public void testDoubleComparison()
    {
        ...
        List<Double> sorted = values.stream()
                .sorted(comparingLong(FloatingPointUtil::doubleToSortableLong))
                .collect(toList());
    ...
    {
        List<Float> values = ImmutableList.of(
        ...
        List<Float> sorted = values.stream()
                .sorted(comparingInt(FloatingPointUtil::floatToSortableInt))
                .collect(toList());
