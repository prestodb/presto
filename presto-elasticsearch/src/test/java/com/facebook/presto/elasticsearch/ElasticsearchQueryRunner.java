...
public final class ElasticsearchQueryRunner
{
    ...
    private static void installElasticsearchPlugin(EmbeddedElasticsearchNode embeddedElasticsearch, QueryRunner queryRunner, Iterable<TpchTable<?>> tables, Map<SchemaTableName, ElasticsearchTableDescription> tableDescriptions)
            throws Exception
    {
    ...
    {
        Logging.initialize();
        DistributedQueryRunner queryRunner = createElasticsearchQueryRunner(EmbeddedElasticsearchNode.createEmbeddedElasticsearch(), TpchTable.getTables());
        Thread.sleep(10);
