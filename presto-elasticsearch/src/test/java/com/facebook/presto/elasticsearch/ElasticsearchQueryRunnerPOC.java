...
public final class ElasticsearchQueryRunnerPOC
{
    private ElasticsearchQueryRunnerPOC() {}

    private static final Logger LOG = Logger.get(ElasticsearchQueryRunnerPOC.class);
...
//            LOG.info("Loading complete in %s", nanosSince(startTime).toString(SECONDS));
            ...
            throws Exception
    {
        ...
        Thread.sleep(10);
        Logger log = Logger.get(ElasticsearchQueryRunnerPOC.class);
