...
/**
 * Presto plugin to use Elasticsearch as a data source.
 */
        ...
        implements Plugin
{
    ...
    @VisibleForTesting
    public synchronized void setTableDescriptionSupplier(Supplier<Map<SchemaTableName, ElasticsearchTableDescription>> tableDescriptionSupplier)
    {
    ...
    {
        return ImmutableList.of(new ElasticsearchConnectorFactory(tableDescriptionSupplier));
    }
}
