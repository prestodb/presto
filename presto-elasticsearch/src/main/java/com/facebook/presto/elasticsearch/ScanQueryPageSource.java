        ...
        implements ConnectorPageSource
{
            ...
            List<ElasticsearchColumnHandle> columns)
    {
        ...
        SearchResponse<JsonData> searchResponse = client.beginSearch(
                split.getIndex(),
                split.getShard(),
    ...
    public Page getNextPage()
    {
        ...
        while (size < PageBuilderStatus.DEFAULT_MAX_PAGE_SIZE_IN_BYTES && iterator.hasNext()) {
            ...
            try {
                ...
                throw new RuntimeException("Failed to parse document source", e);
            }
            ...
            if (hit.source() != null) {
                try {
                    ...
                    throw new RuntimeException("Failed to serialize document source", e);
                }
            }
            ...
            extends AbstractIterator<Hit>
    {
        ...
        protected Hit computeNext()
        {
            if (scrollId == null) {
                ...
                long start = System.nanoTime();
                ScrollResponse<JsonData> response = client.nextPage(scrollId);
                readTimeNanos += System.nanoTime() - start;
                reset(response);
            }
