...
/**
 * Json description to parse a single column from a HBase table row. See {@link com.facebook.presto.hbase.HBaseTableDescription} for more details.
 */
public final class HBaseTableFieldDescription
{
    ...
    @JsonCreator
    public HBaseTableFieldDescription(
    ...
    HBaseColumnHandle getColumnHandle(String connectorId, boolean keyDecoder, int index)
    {
    ...
    public boolean equals(Object obj)
    {
        ...
        HBaseTableFieldDescription other = (HBaseTableFieldDescription) obj;
