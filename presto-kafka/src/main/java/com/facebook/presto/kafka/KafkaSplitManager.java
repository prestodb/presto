        ...
        implements ConnectorSplitManager
{
                ...
                for (PartitionMetadata part : metadata.partitionsMetadata()) {
                    ...
                    if (leader == null) { // Leader election going on...
                        ...
                        builder.add(new KafkaPartition(metadata.topic(),
                                ...
                                ImmutableList.copyOf(Lists.transform(part.isr(), getBrokerToHostAddressFunction()))));
                    }
                }
            }
    ...
    private long[] findAllOffsets(SimpleConsumer consumer, KafkaPartition partition)
    {
