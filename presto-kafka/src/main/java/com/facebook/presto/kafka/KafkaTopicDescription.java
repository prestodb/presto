...
public class KafkaTopicDescription
{
    ...
    public SchemaTableName toSchemaTableName(String defaultSchemaName)
    {
        checkNotNull(defaultSchemaName, "defaultSchemaName is null");
        return new SchemaTableName(Objects.firstNonNull(getSchemaName(), defaultSchemaName), getTableName());
    }
