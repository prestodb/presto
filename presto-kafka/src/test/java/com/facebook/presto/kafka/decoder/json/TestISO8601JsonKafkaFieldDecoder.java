...
public class TestISO8601JsonKafkaFieldDecoder
{
    private static final Map<String, JsonKafkaFieldDecoder> DECODERS = ImmutableMap.of(DEFAULT_FIELD_DECODER_NAME, new JsonKafkaFieldDecoder(),
            ISO8601JsonKafkaFieldDecoder.NAME, new ISO8601JsonKafkaFieldDecoder());
            ...
            throws Exception
    {
        ...
        KafkaColumnHandle row3 = new KafkaColumnHandle("", 2, "row3", BigintType.BIGINT, "a_number", ISO8601JsonKafkaFieldDecoder.NAME, null, false, false, false);
        KafkaColumnHandle row4 = new KafkaColumnHandle("", 3, "row4", BigintType.BIGINT, "a_string", ISO8601JsonKafkaFieldDecoder.NAME, null, false, false, false);

        KafkaColumnHandle row5 = new KafkaColumnHandle("", 4, "row5", VarcharType.VARCHAR, "a_number", ISO8601JsonKafkaFieldDecoder.NAME, null, false, false, false);
        KafkaColumnHandle row6 = new KafkaColumnHandle("", 5, "row6", VarcharType.VARCHAR, "a_string", ISO8601JsonKafkaFieldDecoder.NAME, null, false, false, false);
