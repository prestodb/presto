        ...
        extends AbstractTestIntegrationSmokeTest
{
    ...
    public void startKafka()
            throws Exception
    {
        embeddedKafka = CLOSER.register(EmbeddedKafka.createEmbeddedKafka());
        embeddedKafka.start();
        ...
        Map<SchemaTableName, KafkaTopicDescription> topicDescriptions = ImmutableMap.<SchemaTableName, KafkaTopicDescription>builder()
                .put(TestUtils.loadTpchTopicDescription(topicDescriptionJsonCodec, TPCH_TOPIC, new SchemaTableName(TPCH_NAME, "orders")))
                .build();
        ...
        TestUtils.loadTpchTopic(embeddedKafka, queryRunner().getClient(), TPCH_TOPIC, new QualifiedTableName(TPCH_NAME, TpchMetadata.TINY_SCHEMA_NAME, "orders"));
    ...
    private static QueryRunner createQueryRunner()
            throws Exception
    {
        DistributedQueryRunner queryRunner = CLOSER.register(new DistributedQueryRunner(TPCH_SESSION, 2));
