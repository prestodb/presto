...
public class TestMillisecondsSinceEpochJsonKafkaFieldDecoder
{
    private static final Map<String, JsonKafkaFieldDecoder> DECODERS = ImmutableMap.of(DEFAULT_FIELD_DECODER_NAME, new JsonKafkaFieldDecoder(),
            MillisecondsSinceEpochJsonKafkaFieldDecoder.NAME, new MillisecondsSinceEpochJsonKafkaFieldDecoder());
