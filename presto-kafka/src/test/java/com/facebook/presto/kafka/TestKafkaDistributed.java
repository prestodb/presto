        ...
        extends AbstractTestDistributedQueries
{
            ...
            throws Exception
    {
        ...
        for (TpchTable<?> table : TpchTable.getTables()) {
            ...
            topicDescriptionBuilder.put(TestUtils.loadTpchTopicDescription(topicDescriptionJsonCodec, tpchTable.toString(), tpchTable));
            TestUtils.loadTpchTopic(embeddedKafka, queryRunner().getClient(), tpchTable.toString(), new QualifiedTableName(TPCH_NAME, TpchMetadata.TINY_SCHEMA_NAME, tableName));
        }
    ...
    private static QueryRunner createQueryRunner()
            throws Exception
    {
        DistributedQueryRunner queryRunner = CLOSER.register(new DistributedQueryRunner(TPCH_SESSION, 4));
