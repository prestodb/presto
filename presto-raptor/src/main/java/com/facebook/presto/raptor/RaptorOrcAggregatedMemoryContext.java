        ...
        implements OrcAggregatedMemoryContext
{
    ...
    {
        return new RaptorOrcAggregatedMemoryContext(delegate.newAggregatedMemoryContext());
    }

    @Override
    public OrcLocalMemoryContext newOrcLocalMemoryContext(String allocationTag)
    {
        return new RaptorOrcLocalMemoryContext(delegate.newLocalMemoryContext(allocationTag));
    }
