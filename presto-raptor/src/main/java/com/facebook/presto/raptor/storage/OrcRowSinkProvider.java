        ...
        implements RowSinkProvider
{
    ...
    public OrcRowSinkProvider(List<Long> columnIds, List<Type> columnTypes, StorageService storageService)
    {
    ...
    public RowSink getRowSink()
    {
        ...
        return new OrcRowSink(columnIds, columnTypes, stagingFile);
    }
