        ...
        implements ConnectorMetadata
{
    ...
    @Override
    public Optional<ConnectorOutputMetadata> finishCreateTable(ConnectorSession session, ConnectorOutputTableHandle outputTableHandle, Collection<Slice> fragments, List<ComputedStatistics> computedStatistics)
    {
