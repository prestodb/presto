        ...
        implements ColumnHandle
{
    ...
    public static final int SHARD_UUID_LENGTH = 36;
    ...
    {
        return new RaptorColumnHandle(connectorId, SHARD_UUID_COLUMN_NAME, SHARD_UUID_COLUMN_ID, createVarcharType(SHARD_UUID_LENGTH));
    }
}
