        ...
        implements Plugin
{
    ...
    {
        this(info.getName(), info.getMetadataModule(), info.getEventClientModule(), info.getBackupProviders());
    }

    public RaptorPlugin(String name, Module metadataModule, Module eventClientModule, Map<String, Module> backupProviders)
    {
    ...
    {
        return ImmutableList.of(new RaptorConnectorFactory(name, metadataModule, eventClientModule, backupProviders));
    }
