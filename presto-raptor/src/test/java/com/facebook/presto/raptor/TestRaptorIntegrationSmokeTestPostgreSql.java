...
@Test
public class TestRaptorIntegrationSmokeTestPostgreSql
        extends TestRaptorIntegrationSmokeTest
{
    private final TestingPostgreSqlServer postgresqlServer;

    public TestRaptorIntegrationSmokeTestPostgreSql()
            throws Exception
    {
        this(new TestingPostgreSqlServer("testuser", "testdb"));
    }

    private TestRaptorIntegrationSmokeTestPostgreSql(TestingPostgreSqlServer postgresqlServer)
            throws Exception
    {
