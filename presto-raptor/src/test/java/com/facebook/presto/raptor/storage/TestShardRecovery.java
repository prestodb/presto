...
public class TestShardRecovery
{
            ...
            throws Exception
    {
        ...
        recoveryManager = new ShardRecoveryManager(storageService, new InMemoryNodeManager(), shardManager, new ShardRecoveryStats(), new Duration(5, TimeUnit.MINUTES), 10);
    }
