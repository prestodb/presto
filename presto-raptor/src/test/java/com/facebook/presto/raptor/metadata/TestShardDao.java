...
public class TestShardDao
{
    ...
    public void testNodeShards()
    {
        ...
        long plainTableId = metadataDao.insertTable("test", "plain", false, false, null, 0, "SNAPPY");
        long bucketedTableId = metadataDao.insertTable("test", "bucketed", false, false, distributionId, 0, "SNAPPY");
