...
public class TestShardDao
{
            ...
            throws Exception
    {
        ...
        long plainTableId = metadataDao.insertTable("test", "plain", false, false, null, 0, null);
        long bucketedTableId = metadataDao.insertTable("test", "bucketed", false, false, distributionId, 0, null);
