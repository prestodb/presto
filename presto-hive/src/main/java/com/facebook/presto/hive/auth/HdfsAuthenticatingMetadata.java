        ...
        implements HiveMetadata
{
    ...
    @Inject
    public HdfsAuthenticatingMetadata(@ForHdfs HadoopAuthentication authentication, HiveMetadata targetMetadata)
    {
    ...
    {
        authentication.doAsVoid(session.getUser(), () -> targetMetadata.createTable(session, tableMetadata));
    }

    @Override
    public void dropTable(ConnectorSession session, ConnectorTableHandle tableHandle)
    {
        authentication.doAsVoid(session.getUser(), () -> targetMetadata.dropTable(session, tableHandle));
    }

    @Override
    public void renameTable(ConnectorSession session, ConnectorTableHandle tableHandle, SchemaTableName newTableName)
    {
        authentication.doAsVoid(session.getUser(), () -> targetMetadata.renameTable(session, tableHandle, newTableName));
    }

    @Override
    public void addColumn(ConnectorSession session, ConnectorTableHandle tableHandle, ColumnMetadata column)
    {
        authentication.doAsVoid(session.getUser(), () -> targetMetadata.addColumn(session, tableHandle, column));
    }

    @Override
    public void renameColumn(ConnectorSession session, ConnectorTableHandle tableHandle, ColumnHandle source, String target)
    {
        authentication.doAsVoid(session.getUser(), () -> targetMetadata.renameColumn(session, tableHandle, source, target));
    }

    @Override
    public Optional<ConnectorNewTableLayout> getNewTableLayout(ConnectorSession session, ConnectorTableMetadata tableMetadata)
    {
        return authentication.doAs(session.getUser(), () -> targetMetadata.getNewTableLayout(session, tableMetadata));
    }
    ...
    {
        authentication.doAsVoid(session.getUser(), () -> targetMetadata.finishCreateTable(session, tableHandle, fragments));
    }

    @Override
    public void finishInsert(ConnectorSession session, ConnectorInsertTableHandle insertHandle, Collection<Slice> fragments)
    {
        authentication.doAsVoid(session.getUser(), () -> targetMetadata.finishInsert(session, insertHandle, fragments));
    }

    @Override
    public void finishDelete(ConnectorSession session, ConnectorTableHandle tableHandle, Collection<Slice> fragments)
    {
        authentication.doAsVoid(session.getUser(), () -> targetMetadata.finishDelete(session, tableHandle, fragments));
    }

    @Override
    public Optional<ConnectorResolvedIndex> resolveIndex(ConnectorSession session, ConnectorTableHandle tableHandle, Set<ColumnHandle> indexableColumns, Set<ColumnHandle> outputColumns, TupleDomain<ColumnHandle> tupleDomain)
    {
        return authentication.doAs(session.getUser(), () -> targetMetadata.resolveIndex(session, tableHandle, indexableColumns, outputColumns, tupleDomain));
    }
    ...
    {
        authentication.doAsVoid(session.getUser(), () -> targetMetadata.grantTablePrivileges(session, tableName, privileges, grantee, grantOption));
    }
    ...
    {
        authentication.doAsVoid(session.getUser(), () -> targetMetadata.createView(session, viewName, viewData, replace));
    }

    @Override
    public void dropView(ConnectorSession session, SchemaTableName viewName)
    {
        authentication.doAsVoid(session.getUser(), () -> targetMetadata.dropView(session, viewName));
    }
