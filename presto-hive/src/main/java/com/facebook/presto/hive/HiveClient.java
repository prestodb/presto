        ...
        implements ConnectorMetadata, ConnectorSplitManager, ConnectorRecordSetProvider, ConnectorRecordSinkProvider, ConnectorHandleResolver, ConnectorOutputHandleResolver
{
    ...
    public ConnectorTableHandle createTable(ConnectorSession session, ConnectorTableMetadata tableMetadata)
    {
        ...
        if (tableMetadata.getSerde() != null) {
            serdeInfo.setSerializationLib(tableMetadata.getSerde());
        }
        else {
        ...
        if (tableMetadata.getLocation() != null) {
            sd.setLocation(tableMetadata.getLocation());
        }
        else {
        ...
        if (tableMetadata.getInputFormat() != null) {
            sd.setInputFormat(tableMetadata.getInputFormat());
        }
        else {
            sd.setInputFormat(RCFileInputFormat.class.getName());
        }

        if (tableMetadata.getOutputFormat() != null) {
            sd.setOutputFormat(tableMetadata.getOutputFormat());
        }
        else {
