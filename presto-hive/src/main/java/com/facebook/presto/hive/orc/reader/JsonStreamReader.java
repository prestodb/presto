        ...
        implements StreamReader
{
    ...
    public JsonStreamReader(StreamDescriptor streamDescriptor, DateTimeZone sessionTimeZone)
    {
        this.streamDescriptor = checkNotNull(streamDescriptor, "stream is null");
        this.jsonReader = createJsonReader(streamDescriptor, false, sessionTimeZone);
    }
