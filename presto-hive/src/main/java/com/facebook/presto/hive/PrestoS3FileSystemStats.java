...
{
    private static final PrestoS3FileSystemStats instance = new PrestoS3FileSystemStats();

    private PrestoS3FileSystemStats() {}

    public static PrestoS3FileSystemStats getInstance()
    {
        return instance;
    }
