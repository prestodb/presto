        ...
        implements Provider<Procedure>
{
    ...
    public void invalidateMetastoreCache(ConnectorSession session, String schemaName, String tableName, List<Object> partitionColumnNames, List<Object> partitionValues)
    {
            ...
            List<Object> partitionValues)
    {
        ...
        List<String> partitionStringColumnNames = partitionColumnNames.stream()
        ...
        if (!schemaName.isPresent() && !tableName.isPresent() && partitionColumnNames.isEmpty()) {
            ...
            inMemoryCachingHiveMetastore.get().invalidateCache(
                    ...
                    schemaName.get(),
                    tableName.get(),
                    partitionStringColumnNames,
                    partitionStringValues);
        }
        else {
