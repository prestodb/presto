        ...
        implements JsonReader
{
    ...
    public StructJsonReader(StreamDescriptor streamDescriptor, boolean checkForNulls, DateTimeZone hiveStorageTimeZone, DateTimeZone sessionTimeZone)
    {
        ...
        for (int i = 0; i < nestedStreams.size(); i++) {
            ...
            this.structFields[i] = createJsonReader(nestedStream, true, hiveStorageTimeZone, sessionTimeZone);
