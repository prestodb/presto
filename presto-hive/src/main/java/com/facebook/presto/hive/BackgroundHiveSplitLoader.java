        ...
        implements HiveSplitLoader
{
            ...
            throws IOException
    {
            ...
            for (Path targetPath : getTargetPathsFromSymlink(fs, path)) {
                ...
                for (InputSplit inputSplit : targetSplits) {
                    ...
                    hiveSplitSource.addToQueue(createHiveSplits(
                            ...
                            OptionalInt.empty(),
                            effectivePredicate,
                            partition.getMismatchColumnTypes()));
                    if (stopped) {
                        return;
                    }
                }
        ...
        HiveFileIterator iterator = new HiveFileIterator(path, fs, directoryLister, namenodeStats, partitionName, inputFormat, schema, partitionKeys, effectivePredicate, partition.getMismatchColumnTypes());
        if (bucket.isPresent()) {
