        ...
        extends ParquetDataPage
{
    ...
    public ParquetDataPageV1(Slice slice, int valueCount, int uncompressedSize, Statistics<?> statistics, ParquetEncoding repetitionLevelEncoding, ParquetEncoding definitionLevelEncoding, ParquetEncoding valuesEncoding)
    {
