...
{
    private final Multimap<String, HivePrivilegeInfo> userPrivileges;
    private final Multimap<String, HivePrivilegeInfo> rolePrivileges;
    ...
    {
        this.userPrivileges = ImmutableMultimap.copyOf(requireNonNull(userPrivileges, "userPrivileges is null"));
        this.rolePrivileges = ImmutableMultimap.copyOf(requireNonNull(rolePrivileges, "rolePrivileges is null"));
    }

    public Multimap<String, HivePrivilegeInfo> getUserPrivileges()
    {
        return userPrivileges;
    }

    public Multimap<String, HivePrivilegeInfo> getRolePrivileges()
    {
