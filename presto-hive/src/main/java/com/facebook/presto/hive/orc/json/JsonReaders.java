...
public final class JsonReaders
{
    ...
    public static JsonMapKeyReader createJsonMapKeyReader(StreamDescriptor streamDescriptor, DateTimeZone sessionTimeZone)
    {
        switch (streamDescriptor.getStreamType()) {
            ...
            case TIMESTAMP:
                return new TimestampJsonReader(streamDescriptor, sessionTimeZone);
            case STRUCT:
            case LIST:
            case MAP:
            case UNION:
    ...
    public static JsonReader createJsonReader(StreamDescriptor streamDescriptor, boolean checkForNulls, DateTimeZone sessionTimeZone)
    {
        switch (streamDescriptor.getStreamType()) {
            case BOOLEAN:
                return new BooleanJsonReader(streamDescriptor);
            ...
            case STRUCT:
                return new StructJsonReader(streamDescriptor, checkForNulls, sessionTimeZone);
            case LIST:
                return new ListJsonReader(streamDescriptor, checkForNulls, sessionTimeZone);
            case MAP:
                return new MapJsonReader(streamDescriptor, checkForNulls, sessionTimeZone);
            case UNION:
            case DECIMAL:
            case VARCHAR:
            case CHAR:
