        ...
        implements JsonMapKeyReader
{
    ...
    public TimestampJsonReader(StreamDescriptor streamDescriptor, DateTimeZone sessionTimeZone)
    {
            ...
            throws IOException
    {
        ...
        long timestamp = decodeTimestamp(secondsStream.next(), nanosStream.next());
