        ...
        extends FileSystem
{
            ...
            throws IOException
    {
        ...
        } while (absolutePath != null && absolutePath.toString().equals(workingDirectory.toString()) == false);
    ...
    private static LocatedFileStatus createLocatedFileStatus(FileStatus status)
    {
        try {
            return new LocatedFileStatus(status, new BlockLocation[] {});
        }
        catch (IOException e) {
            throw propagate(e);
        }
        ...
        public synchronized void close() throws IOException
        {
            ...
            try {
                ...
                try {
                    ...
                    PutObjectRequest request = new PutObjectRequest(host, key, in, metadata);
                    ...
                    if (in != null) {
                        try {
                            ...
                            log.info("Get Exception when trying to close", e);
                        }
                    }
                }
            }
