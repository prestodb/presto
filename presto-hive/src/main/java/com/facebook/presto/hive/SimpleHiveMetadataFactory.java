...
public class SimpleHiveMetadataFactory
        implements HiveMetadataFactory
{
    private static final Logger log = Logger.get(SimpleHiveMetadataFactory.class);
    ...
    public SimpleHiveMetadataFactory(
