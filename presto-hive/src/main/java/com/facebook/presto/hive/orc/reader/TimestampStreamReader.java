        ...
        implements StreamReader
{
    ...
    private static final long BASE_TIMESTAMP = Timestamp.valueOf("2015-01-01 00:00:00").getTime() / MILLIS_PER_SECOND;
            ...
            throws IOException
    {
        ...
        for (int i = 0; i < nextBatchSize; i++) {
            longVector.vector[i] = decodeTimestamp(longVector.vector[i], nanosVector[i]);
        }
    ...
    public static long decodeTimestamp(long seconds, long serializedNanos)
    {
        long ms = (seconds + BASE_TIMESTAMP) * MILLIS_PER_SECOND;
