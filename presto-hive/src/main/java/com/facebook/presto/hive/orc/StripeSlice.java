...
public final class StripeSlice
{
    ...
    public static Slice getSlice(DiskRange diskRange, List<StripeSlice> stripeSlices)
    {
        ...
        checkArgument(stripeSlice != null, "No buffer for stream " + diskRange);

        return stripeSlice.slice(offset, length);
    }
}
