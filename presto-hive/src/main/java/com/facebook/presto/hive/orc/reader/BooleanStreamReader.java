        ...
        implements StreamReader
{
    ...
    private BooleanStreamSource dataStreamSource;
            ...
            throws IOException
    {
        ...
        if (presentStream == null) {
            ...
            presentStream.getUnsetBits(nextBatchSize, booleanVector.isNull);
            ...
            throws IOException
    {
        ...
        dataStreamSource = dataStreamSources.getStreamSource(streamDescriptor, DATA, BooleanStreamSource.class);
