...
public final class HiveSessionProperties
{
    ...
    private static final String ORDER_BASED_EXECUTION_ENABLED = "order_based_execution_enabled";
    ...
    public HiveSessionProperties(HiveClientConfig hiveClientConfig, OrcFileWriterConfig orcFileWriterConfig, ParquetFileWriterConfig parquetFileWriterConfig, CacheConfig cacheConfig)
    {
        sessionProperties = ImmutableList.of(
                ...
                booleanProperty(
                        ...
                        "Order-based execution (currently only supports streaming aggregation) is enabled. When this is true, a file is not splittable",
