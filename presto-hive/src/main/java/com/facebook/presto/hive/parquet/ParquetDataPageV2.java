        ...
        extends ParquetDataPage
{
    ...
    public ParquetDataPageV2(int rowCount, int nullCount, int valueCount, Slice repetitionLevels, Slice definitionLevels,
            ParquetEncoding dataEncoding, Slice slice, int uncompressedSize, Statistics<?> statistics, boolean isCompressed)
    {
