        ...
        implements TransactionalMetadata
{
            ...
            MetastoreContext metastoreContext)
    {
        ...
        ImmutableMap.Builder tableParameters = ImmutableMap.<String, String>builder()
    ...
    {
        ImmutableMap.Builder existingPartitions = ImmutableMap.builder();
        ...
        return ImmutableList.of(new ConnectorTableLayoutResult(
                getTableLayout(
                        ...
                        new HiveTableLayoutHandle.Builder()
                                ...
                                .setDomainPredicate(domainPredicate).setRemainingPredicate(TRUE_CONSTANT)
    ...
    static Function<HiveColumnHandle, ColumnMetadata> columnMetadataGetter(Table table, TypeManager typeManager, ColumnConverter columnConverter)
    {
        ...
        ImmutableMap.Builder typeMetadataBuilder = ImmutableMap.builder();
        ...
        builder.put(FILE_SPLIT_COLUMN_NAME, Optional.empty());
