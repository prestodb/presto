...
public enum ParquetEncoding
{
    ...
    DELTA_BYTE_ARRAY
            {
                ...
                public ValuesReader getValuesReader(ColumnDescriptor descriptor, ParquetValuesType valuesType)
                {
                    checkArgument(descriptor.getType() == BINARY || descriptor.getType() == FIXED_LEN_BYTE_ARRAY,
    ...
    int getMaxLevel(ColumnDescriptor descriptor, ParquetValuesType valuesType)
    {
        switch (valuesType) {
