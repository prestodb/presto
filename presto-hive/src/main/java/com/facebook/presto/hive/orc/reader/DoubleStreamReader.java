        ...
        implements StreamReader
{
    ...
    private DoubleStreamSource dataStreamSource;
            ...
            throws IOException
    {
        ...
        if (presentStream == null) {
            ...
            presentStream.getUnsetBits(nextBatchSize, doubleVector.isNull);
            ...
            throws IOException
    {
        ...
        dataStreamSource = dataStreamSources.getStreamSource(streamDescriptor, DATA, DoubleStreamSource.class);
