...
public class ParquetLongBuilder
        extends ParquetBlockBuilder
{
    public ParquetLongBuilder(int size, ColumnDescriptor descriptor)
    {
        super(descriptor, BIGINT.createBlockBuilder(new BlockBuilderStatus(), size));
    }
