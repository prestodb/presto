...
public class ParquetBooleanBuilder
        extends ParquetBlockBuilder
{
    public ParquetBooleanBuilder(int size, ColumnDescriptor descriptor)
    {
        super(descriptor, BOOLEAN.createBlockBuilder(new BlockBuilderStatus(), size));
    }
