    ...
    protected void setupHive(String connectorId, String databaseName, String timeZoneId)
    {
        ...
        List<HivePartition> partitions = ImmutableList.<HivePartition>builder()
                .add(new HivePartition(tablePartitionFormat,
                        ...
                        ImmutableMap.<ColumnHandle, SerializableNativeValue>builder()
                                ...
                                .put(dummyLongDecimalColumn, new SerializableNativeValue(Slice.class, longDecimal("111111111111111111111")))
                                .build(),
                        Optional.empty()))
                .add(new HivePartition(tablePartitionFormat,
                        TupleDomain.<HiveColumnHandle>all(),
                        ...
                        ImmutableMap.<ColumnHandle, SerializableNativeValue>builder()
                                ...
                                .put(dummyLongDecimalColumn, new SerializableNativeValue(Slice.class, longDecimal("222222222222222222222")))
                                .build(),
                        Optional.empty()))
                .add(new HivePartition(tablePartitionFormat,
                        TupleDomain.<HiveColumnHandle>all(),
                        ...
                        ImmutableMap.<ColumnHandle, SerializableNativeValue>builder()
                                ...
                                .put(dummyLongDecimalColumn, new SerializableNativeValue(Slice.class, longDecimal("333333333333333333333")))
                                .build(),
                        Optional.empty()))
                .add(new HivePartition(tablePartitionFormat,
                        TupleDomain.<HiveColumnHandle>all(),
                        ...
                        ImmutableMap.<ColumnHandle, SerializableNativeValue>builder()
                                ...
                                .put(dummyLongDecimalColumn, new SerializableNativeValue(Slice.class, longDecimal("444444444444444444444")))
                                .build(),
                        Optional.empty()))
                .build();
        ...
        tableLayout = new ConnectorTableLayout(
                ...
                TupleDomain.withColumnDomains(ImmutableMap.of(
                        ...
                        dummyShortDecimalColumn, Domain.create(SortedRangeSet.of(Range.equal(11000000000L), Range.equal(22000000000L), Range.equal(33000000000L), Range.equal(44000000000L)), false),
                        dummyLongDecimalColumn, Domain.create(SortedRangeSet.of(Range.equal(longDecimal("111111111111111111111")), Range.equal(longDecimal("222222222222222222222")), Range.equal(longDecimal("333333333333333333333")), Range.equal(longDecimal("444444444444444444444"))), false))),
                Optional.empty(),
                Optional.of(ImmutableList.of(
                        TupleDomain.withColumnDomains(ImmutableMap.of(
                                ...
                                dummyShortDecimalColumn, Domain.create(SortedRangeSet.of(Range.equal(11000000000L)), false),
                                dummyLongDecimalColumn, Domain.create(SortedRangeSet.of(Range.equal(longDecimal("111111111111111111111"))), false))),
                        TupleDomain.withColumnDomains(ImmutableMap.of(
                                dsColumn, Domain.create(SortedRangeSet.of(Range.equal(utf8Slice("2012-12-29"))), false),
                                ...
                                dummyShortDecimalColumn, Domain.create(SortedRangeSet.of(Range.equal(22000000000L)), false),
                                dummyLongDecimalColumn, Domain.create(SortedRangeSet.of(Range.equal(longDecimal("222222222222222222222"))), false))),
                        TupleDomain.withColumnDomains(ImmutableMap.of(
                                dsColumn, Domain.create(SortedRangeSet.of(Range.equal(utf8Slice("2012-12-29"))), false),
                                ...
                                dummyShortDecimalColumn, Domain.create(SortedRangeSet.of(Range.equal(33000000000L)), false),
                                dummyLongDecimalColumn, Domain.create(SortedRangeSet.of(Range.equal(longDecimal("333333333333333333333"))), false))),
                        TupleDomain.withColumnDomains(ImmutableMap.of(
                                dsColumn, Domain.create(SortedRangeSet.of(Range.equal(utf8Slice("2012-12-29"))), false),
                                ...
                                dummyShortDecimalColumn, Domain.create(SortedRangeSet.of(Range.equal(44000000000L)), false),
                                dummyLongDecimalColumn, Domain.create(SortedRangeSet.of(Range.equal(longDecimal("444444444444444444444"))), false)))
                        )),
                ImmutableList.of());
