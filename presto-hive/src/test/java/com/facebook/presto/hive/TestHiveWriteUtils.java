...
public class TestHiveWriteUtils
{
    ...
    public void testIsS3FileSystem()
    {
        ...
        assertEquals(isS3FileSystem("user", hdfsEnvironment, new Path("s3://test-bucket/test-folder")), true);
        assertEquals(isS3FileSystem("user", hdfsEnvironment, new Path("/test-dir/test-folder")), false);
    }
}
