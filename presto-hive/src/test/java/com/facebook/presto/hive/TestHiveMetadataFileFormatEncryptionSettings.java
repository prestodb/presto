...
public class TestHiveMetadataFileFormatEncryptionSettings
{
    ...
    public void testCreateTableAsSelectWithColumnKeyReference()
    {
        ...
        try {
            ...
            Optional<Table> tableOptional = metastore.getTable(METASTORE_CONTEXT, TEST_DB_NAME, tableName);
            Map<String, Optional<Partition>> partitions = metastore.getPartitionsByNames(METASTORE_CONTEXT, tableOptional.get(), ImmutableList.of("ds=2020-06-26", "ds=2020-06-27"));
    ...
    public void testInsertIntoPartitionedTable()
    {
        ...
        try {
            ...
            partitions = metastore.getPartitionsByNames(METASTORE_CONTEXT, tableOptional.get(), ImmutableList.of("ds=2020-06-26"));
