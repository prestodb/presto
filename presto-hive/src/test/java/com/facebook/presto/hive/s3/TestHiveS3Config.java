...
public class TestHiveS3Config
{
    ...
    public void testDefaults()
    {
        assertRecordedDefaults(recordDefaults(HiveS3Config.class)
                ...
                .setS3ReadMaxConnections(400)
                .setS3WriteMaxConnections(100)
    ...
    public void testExplicitPropertyMappings()
    {
        Map<String, String> properties = new ImmutableMap.Builder<String, String>()
                ...
                .put("hive.s3.read.max-connections", "77")
                .put("hive.s3.write.max-connections", "77")
        ...
        HiveS3Config expected = new HiveS3Config()
                ...
                .setS3ReadMaxConnections(77)
                .setS3WriteMaxConnections(77)
