...
public class TestHiveClientConfig
{
    ...
    public void testDefaults()
    {
        ConfigAssertions.assertRecordedDefaults(ConfigAssertions.recordDefaults(HiveClientConfig.class)
                ...
                .setMetastoreCacheGetAllDatabasesTtl(null)
                .setMetastoreCacheGetAllDatabasesRefreshInterval(null)
                .setMetastoreCacheGetAllTablesTtl(null)
                .setMetastoreCacheGetAllTablesRefreshInterval(null)
                .setMetastoreCacheGetDatabaseTtl(null)
                .setMetastoreCacheGetDatabaseRefreshInterval(null)
                .setMetastoreCacheGetPartitionByNameTtl(null)
                .setMetastoreCacheGetPartitionByNameRefreshInterval(null)
                .setMetastoreCacheGetPartitionNamesByPartsTtl(null)
                .setMetastoreCacheGetPartitionNamesByPartsRefreshInterval(null)
                .setMetastoreCacheGetPartitionNamesTtl(null)
                .setMetastoreCacheGetPartitionNamesRefreshInterval(null)
                .setMetastoreCacheGetTableTtl(null)
                .setMetastoreCacheGetTableRefreshInterval(null)
                .setMetastoreCacheLoadViewsTtl(null)
                .setMetastoreCacheLoadViewsRefreshInterval(null)
    ...
    public void testExplicitPropertyMappings()
    {
        Map<String, String> properties = new ImmutableMap.Builder<String, String>()
                ...
                .put("hive.metastore-getalldatabases-cache-ttl", "2h")
                .put("hive.metastore-getalldatabases-refresh-interval", "30m")
                .put("hive.metastore-getdatabase-cache-ttl", "2h")
                .put("hive.metastore-getdatabase-refresh-interval", "30m")
                .put("hive.metastore-getalltables-cache-ttl", "2h")
                .put("hive.metastore-getalltables-refresh-interval", "30m")
                .put("hive.metastore-gettable-cache-ttl", "2h")
                .put("hive.metastore-gettable-refresh-interval", "30m")
                .put("hive.metastore-getpartitionnames-cache-ttl", "2h")
                .put("hive.metastore-getpartitionnames-refresh-interval", "30m")
                .put("hive.metastore-getpartitionnamesbyparts-cache-ttl", "2h")
                .put("hive.metastore-getpartitionnamesbyparts-refresh-interval", "30m")
                .put("hive.metastore-getpartitionbyname-cache-ttl", "2h")
                .put("hive.metastore-getpartitionbyname-refresh-interval", "30m")
                .put("hive.metastore-loadviews-cache-ttl", "2h")
                .put("hive.metastore-loadviews-refresh-interval", "30m")
        ...
        HiveClientConfig expected = new HiveClientConfig()
                ...
                .setMetastoreCacheGetAllDatabasesTtl(new Duration(2, TimeUnit.HOURS))
                .setMetastoreCacheGetAllDatabasesRefreshInterval(new Duration(30, TimeUnit.MINUTES))
                .setMetastoreCacheGetAllTablesTtl(new Duration(2, TimeUnit.HOURS))
                .setMetastoreCacheGetAllTablesRefreshInterval(new Duration(30, TimeUnit.MINUTES))
                .setMetastoreCacheGetDatabaseTtl(new Duration(2, TimeUnit.HOURS))
                .setMetastoreCacheGetDatabaseRefreshInterval(new Duration(30, TimeUnit.MINUTES))
                .setMetastoreCacheGetPartitionByNameTtl(new Duration(2, TimeUnit.HOURS))
                .setMetastoreCacheGetPartitionByNameRefreshInterval(new Duration(30, TimeUnit.MINUTES))
                .setMetastoreCacheGetPartitionNamesByPartsTtl(new Duration(2, TimeUnit.HOURS))
                .setMetastoreCacheGetPartitionNamesByPartsRefreshInterval(new Duration(30, TimeUnit.MINUTES))
                .setMetastoreCacheGetPartitionNamesTtl(new Duration(2, TimeUnit.HOURS))
                .setMetastoreCacheGetPartitionNamesRefreshInterval(new Duration(30, TimeUnit.MINUTES))
                .setMetastoreCacheGetTableTtl(new Duration(2, TimeUnit.HOURS))
                .setMetastoreCacheGetTableRefreshInterval(new Duration(30, TimeUnit.MINUTES))
                .setMetastoreCacheLoadViewsTtl(new Duration(2, TimeUnit.HOURS))
                .setMetastoreCacheLoadViewsRefreshInterval(new Duration(30, TimeUnit.MINUTES))
