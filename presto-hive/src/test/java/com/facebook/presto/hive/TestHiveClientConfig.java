...
public class TestHiveClientConfig
{
    ...
    public void testExplicitPropertyMappings()
    {
        Map<String, String> properties = new ImmutableMap.Builder<String, String>()
                ...
                .put("hive.metastore-partition-batch-load-interval", "15m")
                .put("hive.metastore-partition-batch-load-size", "50")
        ...
        HiveClientConfig expected = new HiveClientConfig()
                ...
                .setMetastoreBatchPartitionLoadInterval(new Duration(15, TimeUnit.MINUTES))
                .setMetastoreBatchPartitionLoadSize(50)
