...
public class TestHiveClientConfig
{
    ...
    public void testDefaults()
    {
        ConfigAssertions.assertRecordedDefaults(ConfigAssertions.recordDefaults(HiveClientConfig.class)
                ...
                .setQuickStatsNdvEnabled(true)
                .setQuickStatsProvableEmptyEnabled(true)
    ...
    public void testExplicitPropertyMappings()
    {
        Map<String, String> properties = new ImmutableMap.Builder<String, String>()
                ...
                .put("hive.quick-stats.ndv-enabled", "false")
                .put("hive.quick-stats.provable-empty-enabled", "false")
        ...
        HiveClientConfig expected = new HiveClientConfig()
                ...
                .setQuickStatsNdvEnabled(false)
                .setQuickStatsProvableEmptyEnabled(false)
