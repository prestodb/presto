            ...
            throws Exception
    {
        ...
        for (int i = 0; i < LOOPS; i++) {
            ...
            while (rows.hasNext()) {
                ...
                LongWritable bigintValue = (LongWritable) OrcUtil.getFieldValue(row, fieldIndex);
                if (bigintValue != null) {
            ...
            throws Exception
    {
        ...
        for (int i = 0; i < LOOPS; i++) {
            ...
            while (rows.hasNext()) {
                ...
                DoubleWritable doubleValue = (DoubleWritable) OrcUtil.getFieldValue(row, fieldIndex);
                if (doubleValue != null) {
            ...
            throws Exception
    {
        ...
        for (int i = 0; i < LOOPS; i++) {
            ...
            while (rows.hasNext()) {
                ...
                Text stringText = (Text) OrcUtil.getFieldValue(row, fieldIndex);
                if (stringText != null) {
            ...
            throws Exception
    {
        ...
        for (int i = 0; i < LOOPS; i++) {
            ...
            while (rows.hasNext()) {
                ...
                LongWritable quantityValue = (LongWritable) OrcUtil.getFieldValue(row, quantityFieldIndex);
                if (quantityValue != null) {
                    quantitySum += quantityValue.get();
                }

                DoubleWritable extendedPriceValue = (DoubleWritable) OrcUtil.getFieldValue(row, extendedPriceFieldIndex);
                if (extendedPriceValue != null) {
                    extendedPriceSum += extendedPriceValue.get();
                }

                DoubleWritable discountValue = (DoubleWritable) OrcUtil.getFieldValue(row, discountFieldIndex);
                if (discountValue != null) {
                    discountSum += discountValue.get();
                }

                DoubleWritable taxValue = (DoubleWritable) OrcUtil.getFieldValue(row, taxFieldIndex);
                if (taxValue != null) {
                    taxSum += taxValue.get();
                }

                Text returnFlagText = (Text) OrcUtil.getFieldValue(row, returnFlagFieldIndex);
                ...
                Text lineStatusText = (Text) OrcUtil.getFieldValue(row, lineStatusFieldIndex);
                ...
                Text shipDateText = (Text) OrcUtil.getFieldValue(row, shipDateFieldIndex);
            ...
            throws Exception
    {
        ...
        for (int i = 0; i < LOOPS; i++) {
            ...
            while (rows.hasNext()) {
                ...
                LongWritable orderKeyValue = (LongWritable) OrcUtil.getFieldValue(row, orderKeyFieldIndex);
                if (orderKeyValue != null) {
                    orderKeySum += orderKeyValue.get();
                }

                LongWritable partKeyValue = (LongWritable) OrcUtil.getFieldValue(row, partKeyFieldIndex);
                if (partKeyValue != null) {
                    partKeySum += partKeyValue.get();
                }

                LongWritable supplierKeyValue = (LongWritable) OrcUtil.getFieldValue(row, supplierKeyFieldIndex);
                if (supplierKeyValue != null) {
                    supplierKeySum += supplierKeyValue.get();
                }

                LongWritable lineNumberValue = (LongWritable) OrcUtil.getFieldValue(row, lineNumberFieldIndex);
                ...
                Text commitDateText = (Text) OrcUtil.getFieldValue(row, commitDateFieldIndex);
                ...
                Text receiptDateText = (Text) OrcUtil.getFieldValue(row, receiptDateFieldIndex);
                ...
                Text shipInstructionsText = (Text) OrcUtil.getFieldValue(row, shipInstructionsFieldIndex);
                ...
                Text shipModeText = (Text) OrcUtil.getFieldValue(row, shipModeFieldIndex);
                ...
                Text commentText = (Text) OrcUtil.getFieldValue(row, commentFieldIndex);
                if (commentText != null) {
