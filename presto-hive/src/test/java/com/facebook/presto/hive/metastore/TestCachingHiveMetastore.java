...
public class TestCachingHiveMetastore
{
    ...
    public void testInvalidGetPartitionsByNames()
            throws Exception
    {
        assertFalse(metastore.getPartitionsByNames(BAD_DATABASE, TEST_TABLE, ImmutableList.of(TEST_PARTITION1)).isPresent());
    }
