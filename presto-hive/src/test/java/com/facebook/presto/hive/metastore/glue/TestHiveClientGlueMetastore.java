            ...
            throws Exception
    {
        ...
        try {
            ...
            List<ColumnMetadata> columns = ImmutableList.<ColumnMetadata>builder()
                    .add(ColumnMetadata.builder("t_string", createUnboundedVarcharType()).build())
                    .add(ColumnMetadata.builder(reservedKeywordPartitionColumnName, createUnboundedVarcharType()).build())
                    .add(ColumnMetadata.builder(regularColumnPartitionName, BIGINT).build())
                    .build();
