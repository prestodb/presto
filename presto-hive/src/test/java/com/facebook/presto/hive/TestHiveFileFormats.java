        ...
        extends AbstractTestHiveFileFormats
{
            ...
            throws Exception
    {
        ...
        assertThatFileFormat(PARQUET)
                ...
                .isReadableByPageSource(new ParquetPageSourceFactory(FUNCTION_AND_TYPE_MANAGER, FUNCTION_RESOLUTION, HDFS_ENVIRONMENT, STATS, METADATA_READER, new HiveClientConfig().setTimeZone(HIVE_STORAGE_TIME_ZONE.getID())));
    }
            ...
            throws Exception
    {
        ...
        assertThatFileFormat(PARQUET)
                .withColumns(columns)
                .withSession(parquetPageSourceSession)
                .isFailingForPageSource(new ParquetPageSourceFactory(FUNCTION_AND_TYPE_MANAGER, FUNCTION_RESOLUTION, HDFS_ENVIRONMENT, STATS, METADATA_READER, new HiveClientConfig().setTimeZone(HIVE_STORAGE_TIME_ZONE.getID())), expectedErrorCode, expectedMessage);
            ...
            throws Exception
    {
        ...
        assertThatFileFormat(PARQUET)
                ...
                .withReadColumns(ImmutableList.of(longColumn))
                .withSession(parquetPageSourceSession)
                .isFailingForPageSource(new ParquetPageSourceFactory(FUNCTION_AND_TYPE_MANAGER, FUNCTION_RESOLUTION, HDFS_ENVIRONMENT, STATS, METADATA_READER, new HiveClientConfig().setTimeZone(HIVE_STORAGE_TIME_ZONE.getID())), expectedErrorCode, expectedMessageDoubleLong);
        ...
        assertThatFileFormat(PARQUET)
                ...
                .withSession(parquetPageSourceSession)
                .isFailingForPageSource(new ParquetPageSourceFactory(FUNCTION_AND_TYPE_MANAGER, FUNCTION_RESOLUTION, HDFS_ENVIRONMENT, STATS, METADATA_READER, new HiveClientConfig()), expectedErrorCode, expectedMessageFloatInt);
        ...
        assertThatFileFormat(PARQUET)
                ...
                .withSession(parquetPageSourceSession)
                .isFailingForPageSource(new ParquetPageSourceFactory(FUNCTION_AND_TYPE_MANAGER, FUNCTION_RESOLUTION, HDFS_ENVIRONMENT, STATS, METADATA_READER, new HiveClientConfig().setTimeZone(HIVE_STORAGE_TIME_ZONE.getID())), expectedErrorCode, expectedMessageIntBoolean);
        ...
        assertThatFileFormat(PARQUET)
                ...
                .withSession(parquetPageSourceSession)
                .isFailingForPageSource(new ParquetPageSourceFactory(FUNCTION_AND_TYPE_MANAGER, FUNCTION_RESOLUTION, HDFS_ENVIRONMENT, STATS, METADATA_READER, new HiveClientConfig().setTimeZone(HIVE_STORAGE_TIME_ZONE.getID())), expectedErrorCode, expectedMessageStringLong);
        ...
        assertThatFileFormat(PARQUET)
                ...
                .withReadColumns(ImmutableList.of(intColumn))
                .withSession(parquetPageSourceSession)
                .isFailingForPageSource(new ParquetPageSourceFactory(FUNCTION_AND_TYPE_MANAGER, FUNCTION_RESOLUTION, HDFS_ENVIRONMENT, STATS, METADATA_READER, new HiveClientConfig().setTimeZone(HIVE_STORAGE_TIME_ZONE.getID())), expectedErrorCode, expectedMessageIntString);
        ...
        assertThatFileFormat(PARQUET)
                ...
                .withSession(parquetPageSourceSession)
                .isFailingForPageSource(new ParquetPageSourceFactory(FUNCTION_AND_TYPE_MANAGER, FUNCTION_RESOLUTION, HDFS_ENVIRONMENT, STATS, METADATA_READER, new HiveClientConfig().setTimeZone(HIVE_STORAGE_TIME_ZONE.getID())), expectedErrorCode, expectedMessageMapLongLong);
        ...
        assertThatFileFormat(PARQUET)
                ...
                .withReadColumns(ImmutableList.of(mapLongColumn))
                .withSession(parquetPageSourceSession)
                .isFailingForPageSource(new ParquetPageSourceFactory(FUNCTION_AND_TYPE_MANAGER, FUNCTION_RESOLUTION, HDFS_ENVIRONMENT, STATS, METADATA_READER, new HiveClientConfig().setTimeZone(HIVE_STORAGE_TIME_ZONE.getID())), expectedErrorCode, expectedMessageMapLongMapDouble);
        ...
        assertThatFileFormat(PARQUET)
                ...
                .withSession(parquetPageSourceSession)
                .isFailingForPageSource(new ParquetPageSourceFactory(FUNCTION_AND_TYPE_MANAGER, FUNCTION_RESOLUTION, HDFS_ENVIRONMENT, STATS, METADATA_READER, new HiveClientConfig().setTimeZone(HIVE_STORAGE_TIME_ZONE.getID())), expectedErrorCode, expectedMessageArrayStringArrayBoolean);
        ...
        assertThatFileFormat(PARQUET)
                ...
                .withSession(parquetPageSourceSession)
                .isFailingForPageSource(new ParquetPageSourceFactory(FUNCTION_AND_TYPE_MANAGER, FUNCTION_RESOLUTION, HDFS_ENVIRONMENT, STATS, METADATA_READER, new HiveClientConfig().setTimeZone(HIVE_STORAGE_TIME_ZONE.getID())), expectedErrorCode, expectedMessageBooleanArrayBoolean);
        ...
        assertThatFileFormat(PARQUET)
                ...
                .withReadColumns(ImmutableList.of(longColumn))
                .withSession(parquetPageSourceSession)
                .isFailingForPageSource(new ParquetPageSourceFactory(FUNCTION_AND_TYPE_MANAGER, FUNCTION_RESOLUTION, HDFS_ENVIRONMENT, STATS, METADATA_READER, new HiveClientConfig().setTimeZone(HIVE_STORAGE_TIME_ZONE.getID())), expectedErrorCode, expectedMessageRowLongLong);
        ...
        assertThatFileFormat(PARQUET)
                ...
                .withSession(parquetPageSourceSession)
                .isFailingForPageSource(new ParquetPageSourceFactory(FUNCTION_AND_TYPE_MANAGER, FUNCTION_RESOLUTION, HDFS_ENVIRONMENT, STATS, METADATA_READER, new HiveClientConfig().setTimeZone(HIVE_STORAGE_TIME_ZONE.getID())), expectedErrorCode, expectedMessageRowLongNest);
    }
