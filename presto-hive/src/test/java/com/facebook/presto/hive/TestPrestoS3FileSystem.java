...
public class TestPrestoS3FileSystem
{
    ...
    {
        Configuration config = new Configuration();
        config.set(PrestoS3FileSystem.S3_ENCRYPTION_MATERIALS_PROVIDER, TestEncryptionMaterialsProvider.class.getName());
    ...
    static class TestEncryptionMaterialsProvider implements EncryptionMaterialsProvider
    {
