...
import static com.facebook.presto.spi.block.StructBuilder.arrayBuilder;
import static com.facebook.presto.spi.block.StructBuilder.mapBuilder;
...
//            .add(new TestColumn("p_null_binary", javaByteArrayObjectInspector, HIVE_DEFAULT_DYNAMIC_PARTITION, null, true))
            ...
            .add(new TestColumn("t_map_string",
                    ...
                    singleMap(VARCHAR, VARCHAR, "test", "test")))
            .add(new TestColumn("t_map_tinyint", getStandardMapObjectInspector(javaByteObjectInspector, javaByteObjectInspector), ImmutableMap.of((byte) 1, (byte) 1), singleMap(BIGINT, BIGINT, 1, 1)))
            .add(new TestColumn("t_map_smallint",
                    ...
                    singleMap(BIGINT, BIGINT, 2, 2)))
            .add(new TestColumn("t_map_int", getStandardMapObjectInspector(javaIntObjectInspector, javaIntObjectInspector), ImmutableMap.of(3, 3), singleMap(BIGINT, BIGINT, 3, 3)))
            .add(new TestColumn("t_map_bigint", getStandardMapObjectInspector(javaLongObjectInspector, javaLongObjectInspector), ImmutableMap.of(4L, 4L), singleMap(BIGINT, BIGINT, 4L, 4L)))
            .add(new TestColumn("t_map_float", getStandardMapObjectInspector(javaFloatObjectInspector, javaFloatObjectInspector), ImmutableMap.of(5.0f, 5.0f), singleMap(DOUBLE, DOUBLE, 5.0f, 5.0f)))
            .add(new TestColumn("t_map_double", getStandardMapObjectInspector(javaDoubleObjectInspector, javaDoubleObjectInspector), ImmutableMap.of(6.0, 6.0), singleMap(DOUBLE, DOUBLE, 6.0, 6.0)))
            .add(new TestColumn("t_map_boolean",
                    ...
                    singleMap(BOOLEAN, BOOLEAN, true, true)))
            .add(new TestColumn("t_map_date",
                    ...
                    singleMap(DateType.DATE, DateType.DATE, DATE_DAYS, DATE_DAYS)))
            .add(new TestColumn("t_map_timestamp",
                    ...
                    singleMap(TimestampType.TIMESTAMP, TimestampType.TIMESTAMP, TIMESTAMP, TIMESTAMP)))
            .add(new TestColumn("t_array_string", getStandardListObjectInspector(javaStringObjectInspector), ImmutableList.of("test"), fromArray(VARCHAR, "test")))
            .add(new TestColumn("t_array_tinyint", getStandardListObjectInspector(javaByteObjectInspector), ImmutableList.of((byte) 1), fromArray(BIGINT, 1)))
            .add(new TestColumn("t_array_smallint", getStandardListObjectInspector(javaShortObjectInspector), ImmutableList.of((short) 2), fromArray(BIGINT, 2)))
            .add(new TestColumn("t_array_int", getStandardListObjectInspector(javaIntObjectInspector), ImmutableList.of(3), fromArray(BIGINT, 3)))
            .add(new TestColumn("t_array_bigint", getStandardListObjectInspector(javaLongObjectInspector), ImmutableList.of(4L), fromArray(BIGINT, 4L)))
            .add(new TestColumn("t_array_float", getStandardListObjectInspector(javaFloatObjectInspector), ImmutableList.of(5.0f), fromArray(DOUBLE, 5.0f)))
            .add(new TestColumn("t_array_double", getStandardListObjectInspector(javaDoubleObjectInspector), ImmutableList.of(6.0), fromArray(DOUBLE, 6.0)))
            .add(new TestColumn("t_array_boolean", getStandardListObjectInspector(javaBooleanObjectInspector), ImmutableList.of(true), fromArray(BOOLEAN, true)))
            .add(new TestColumn("t_array_date",
                    getStandardListObjectInspector(javaDateObjectInspector),
                    ImmutableList.of(SQL_DATE),
                    fromArray(DateType.DATE, DATE_DAYS)))
            .add(new TestColumn("t_array_timestamp",
                    ...
                    fromArray(TimestampType.TIMESTAMP, TIMESTAMP)))
            ...
            .add(new TestColumn("t_complex",
                    ...
                    singleMap(VARCHAR, new ArrayType(new ArrayType(BIGINT)), "test", fromArray(new ArrayType(BIGINT), fromArray(BIGINT, 1)))
            ))
            .add(new TestColumn("t_struct_nested", getStandardStructObjectInspector(ImmutableList.of("struct_field"),
                    ...
                    fromArray(new RowType(ImmutableList.of(VARCHAR, VARCHAR, VARCHAR), Optional.empty()), fromArray(VARCHAR, "1", "2", "3"))))
            .add(new TestColumn("t_struct_null", getStandardStructObjectInspector(ImmutableList.of("struct_field"),
                    ...
                    fromArray(UnknownType.UNKNOWN, null)))
            .build();
    ...
    private static Slice fromArray(Type type, Object... values)
    {
        if (values == null) {
            return arrayBuilder(type).add(values).build();
        }
        return arrayBuilder(type).addAll(values).build();
    }

    private static Slice singleMap(Type keyType, Type valueType, Object key, Object value)
    {
        return mapBuilder(keyType, valueType).addAll(key, value).build();
    }
