...
import static com.facebook.presto.hive.s3.security.TestAWSS3SecurityMapping.MappingResult.credentials;
import static com.facebook.presto.hive.s3.security.TestAWSS3SecurityMapping.MappingResult.role;
...
public class TestAWSS3SecurityMapping
{
    ...
    public void testAWSS3SecurityMapping()
    {
        ...
        assertMapping(
                ...
                role("arn:aws:iam::123456789101:role/analyst_and_scientist_role"));

        // matches empty rule at end -- default role used
        assertMapping(
                provider,
                empty().withUser("defaultUser"),
    ...
    public void testFailAWSS3SecurityMapping()
    {
        ...
        assertMappingFails(
                provider,
                empty().withUser("defaultUser"),
                "No matching AWS S3 security mapping");
    }
    ...
    protected static class MappingSelector
    {
        ...
        protected HdfsContext getHdfsContext()
        {
    ...
    {
        protected static MappingResult credentials(String accessKey, String secretKey)
        {
        ...
        protected Optional<String> getAccessKey()
        {
            return accessKey;
        }
        ...
        protected Optional<String> getRole()
        {
            return role;
        }
    }
