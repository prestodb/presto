        ...
        implements BenchmarkLineItemWithPredicatePushdown
{
    ...
    private static final HiveColumnHandle ORDERKEY = new HiveColumnHandle("clientId", "orderkey", 0, HIVE_LONG, HIVE_LONG.getHiveTypeName(), 0, false);
    private static final HiveColumnHandle PARTKEY = new HiveColumnHandle("clientId", "partkey", 1, HIVE_LONG, HIVE_LONG.getHiveTypeName(), 1, false);
    private static final HiveColumnHandle SUPPKEY = new HiveColumnHandle("clientId", "suppkey", 2, HIVE_LONG, HIVE_LONG.getHiveTypeName(), 2, false);
    private static final HiveColumnHandle LINENUMBER = new HiveColumnHandle("clientId", "linenumber", 3, HIVE_LONG, HIVE_LONG.getHiveTypeName(), 3, false);
    private static final HiveColumnHandle QUANTITY = new HiveColumnHandle("clientId", "quantity", 4, HIVE_LONG, HIVE_LONG.getHiveTypeName(), 4, false);
    private static final HiveColumnHandle EXTENDEDPRICE = new HiveColumnHandle("clientId", "extendedprice", 5, HIVE_DOUBLE, HIVE_DOUBLE.getHiveTypeName(), 5, false);
    private static final HiveColumnHandle DISCOUNT = new HiveColumnHandle("clientId", "discount", 6, HIVE_DOUBLE, HIVE_DOUBLE.getHiveTypeName(), 6, false);
    private static final HiveColumnHandle TAX = new HiveColumnHandle("clientId", "tax", 7, HIVE_DOUBLE, HIVE_DOUBLE.getHiveTypeName(), 7, false);
    private static final HiveColumnHandle RETURNFLAG = new HiveColumnHandle("clientId", "returnflag", 8, HIVE_STRING, HIVE_STRING.getHiveTypeName(), 8, false);
    private static final HiveColumnHandle LINESTATUS = new HiveColumnHandle("clientId", "linestatus", 9, HIVE_STRING, HIVE_STRING.getHiveTypeName(), 9, false);
    private static final HiveColumnHandle SHIPDATE = new HiveColumnHandle("clientId", "shipdate", 10, HIVE_STRING, HIVE_STRING.getHiveTypeName(), 10, false);
    private static final HiveColumnHandle COMMITDATE = new HiveColumnHandle("clientId", "commitdate", 11, HIVE_STRING, HIVE_STRING.getHiveTypeName(), 11, false);
    private static final HiveColumnHandle RECEIPTDATE = new HiveColumnHandle("clientId", "receiptdate", 12, HIVE_STRING, HIVE_STRING.getHiveTypeName(), 12, false);
    private static final HiveColumnHandle SHIPINSTRUCT = new HiveColumnHandle("clientId", "shipinstruct", 13, HIVE_STRING, HIVE_STRING.getHiveTypeName(), 13, false);
    private static final HiveColumnHandle SHIPMODE = new HiveColumnHandle("clientId", "shipmode", 14, HIVE_STRING, HIVE_STRING.getHiveTypeName(), 14, false);
    private static final HiveColumnHandle COMMENT = new HiveColumnHandle("clientId", "comment", 15, HIVE_STRING, HIVE_STRING.getHiveTypeName(), 15, false);
    ...
    public static OrcRecordReader createVectorizedRecordReader(
            ...
            throws IOException
    {
        OrcReader orcReader = new OrcReader(new HdfsOrcDataSource(fileSplit.getPath(), fileSystem), new OrcMetadataReader(), TYPE_MANAGER);
