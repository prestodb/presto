        ...
        extends SemiTransactionalHiveMetastore
{
    ...
    public static TestingSemiTransactionalHiveMetastore create()
    {
        ...
        HiveCluster hiveCluster = new TestingHiveCluster(metastoreClientConfig, thriftHiveMetastoreConfig, httpHiveMetastoreConfig, HOST, PORT, new HiveCommonClientConfig(), new StaticMetastoreConfig());        ColumnConverterProvider columnConverterProvider = HiveColumnConverterProvider.DEFAULT_COLUMN_CONVERTER_PROVIDER;
