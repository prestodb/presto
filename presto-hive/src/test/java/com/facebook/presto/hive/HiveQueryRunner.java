...
public final class HiveQueryRunner
{
            ...
            throws Exception
    {
        ...
        DistributedQueryRunner queryRunner = createQueryRunner(TpchTable.getTables(), ImmutableMap.of("http-server.http.port", "8080"), ImmutableMap.of(), "sql-standard", ImmutableMap.of(), Optional.of(10), baseDataDir, Optional.empty());
        Thread.sleep(10);
