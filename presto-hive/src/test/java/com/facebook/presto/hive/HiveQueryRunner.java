...
import static com.facebook.presto.SystemSessionProperties.MATERIALIZE_EXCHANGES_STRATEGY;
...
public final class HiveQueryRunner
{
            ...
            throws Exception
    {
        return createQueryRunner(
                ...
                ImmutableMap.of(
                        ...
                        "query.materialize-exchanges-strategy", "ALL",
                        "query.hash-partition-count", "5",
    ...
    public static Session createMaterializedExchangeSession(Optional<SelectedRole> role)
    {
        return testSessionBuilder()
                .setIdentity(new Identity(
                        "hive",
                        ...
                        role.map(selectedRole -> ImmutableMap.of("hive", selectedRole))
                                .orElse(ImmutableMap.of())))
                .setSystemProperty(PARTITIONING_PROVIDER_CATALOG, HIVE_BUCKETED_CATALOG)
                .setSystemProperty(MATERIALIZE_EXCHANGES_STRATEGY, ALL.toString())
                .setSystemProperty(HASH_PARTITION_COUNT, "5")
