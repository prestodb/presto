        ...
        extends AbstractTestFunctions
{
    ...
    private static FunctionAssertions fieldNameInJsonCastDisabled;
    ...
    public void setUp()
    {
        ...
        fieldNameInJsonCastEnabled = new FunctionAssertions(
                Session.builder(session)
                        ...
                        .build(),
                new FeaturesConfig());
        fieldNameInJsonCastDisabled = new FunctionAssertions(
                Session.builder(session)
    ...
    public final void tearDown()
    {
        ...
        fieldNameInJsonCastDisabled.close();
        fieldNameInJsonCastDisabled = null;
    }
    ...
    {
        fieldNameInJsonCastDisabled.assertFunction("cast(cast (null as ARRAY<BIGINT>) AS JSON)", JSON, null);
        fieldNameInJsonCastDisabled.assertFunction("cast(ARRAY[] AS JSON)", JSON, "[]");
        fieldNameInJsonCastDisabled.assertFunction("cast(ARRAY[null, null] AS JSON)", JSON, "[null,null]");

        fieldNameInJsonCastDisabled.assertFunction("cast(ARRAY[true, false, null] AS JSON)", JSON, "[true,false,null]");

        fieldNameInJsonCastDisabled.assertFunction("cast(cast(ARRAY[1, 2, null] AS ARRAY<TINYINT>) AS JSON)", JSON, "[1,2,null]");
        fieldNameInJsonCastDisabled.assertFunction("cast(cast(ARRAY[12345, -12345, null] AS ARRAY<SMALLINT>) AS JSON)", JSON, "[12345,-12345,null]");
        fieldNameInJsonCastDisabled.assertFunction("cast(cast(ARRAY[123456789, -123456789, null] AS ARRAY<INTEGER>) AS JSON)", JSON, "[123456789,-123456789,null]");
        fieldNameInJsonCastDisabled.assertFunction("cast(cast(ARRAY[1234567890123456789, -1234567890123456789, null] AS ARRAY<BIGINT>) AS JSON)", JSON, "[1234567890123456789,-1234567890123456789,null]");

        fieldNameInJsonCastDisabled.assertFunction("CAST(CAST(ARRAY[3.14E0, nan(), infinity(), -infinity(), null] AS ARRAY<REAL>) AS JSON)", JSON, "[3.14,\"NaN\",\"Infinity\",\"-Infinity\",null]");
        fieldNameInJsonCastDisabled.assertFunction("CAST(ARRAY[3.14E0, 1e-323, 1e308, nan(), infinity(), -infinity(), null] AS JSON)", JSON, "[3.14,1.0E-323,1.0E308,\"NaN\",\"Infinity\",\"-Infinity\",null]");
        fieldNameInJsonCastDisabled.assertFunction("CAST(ARRAY[DECIMAL '3.14', null] AS JSON)", JSON, "[3.14,null]");
        fieldNameInJsonCastDisabled.assertFunction("CAST(ARRAY[DECIMAL '12345678901234567890.123456789012345678', null] AS JSON)", JSON, "[12345678901234567890.123456789012345678,null]");

        fieldNameInJsonCastDisabled.assertFunction("cast(ARRAY['a', 'bb', null] AS JSON)", JSON, "[\"a\",\"bb\",null]");
        fieldNameInJsonCastDisabled.assertFunction(
                "cast(ARRAY[JSON '123', JSON '3.14', JSON 'false', JSON '\"abc\"', JSON '[1, \"a\", null]', JSON '{\"a\": 1, \"b\": \"str\", \"c\": null}', JSON 'null', null] AS JSON)",
                JSON,
                "[123,3.14,false,\"abc\",[1,\"a\",null],{\"a\":1,\"b\":\"str\",\"c\":null},null,null]");
        ...
        fieldNameInJsonCastDisabled.assertFunction(
                ...
                JSON,
                "[[1,2],[3,null],[null,null],null]");
        fieldNameInJsonCastDisabled.assertFunction("CAST(ARRAY [12345.12345, 12345.12345, 3.0] AS JSON)", JSON, "[12345.12345,12345.12345,3.00000]");
        fieldNameInJsonCastDisabled.assertFunction(
                "CAST(ARRAY [123456789012345678901234567890.87654321, 123456789012345678901234567890.12345678] AS JSON)",
                JSON,
                "[123456789012345678901234567890.87654321,123456789012345678901234567890.12345678]");
