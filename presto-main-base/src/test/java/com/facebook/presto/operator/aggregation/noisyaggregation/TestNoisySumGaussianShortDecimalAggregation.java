        ...
        extends AbstractTestFunctions
{
    ...
    {
        JavaAggregationFunctionImplementation noisySumGaussian = getFunction(SHORT_DECIMAL_TYPE, DOUBLE);
    ...
    {
        JavaAggregationFunctionImplementation noisySumGaussian = getFunction(SHORT_DECIMAL_TYPE, DOUBLE, DOUBLE, DOUBLE);
    ...
    {
        // Test with clipping
        JavaAggregationFunctionImplementation noisySumGaussian = getFunction(SHORT_DECIMAL_TYPE, DOUBLE, DOUBLE, DOUBLE, BIGINT);
        ...
        assertAggregation(
                noisySumGaussian,
                equalDoubleAssertion,
                "Test noisy_sum_gaussian(short decimal, noiseScale, lower, upper, randomSeed)",
                new Page(
                        createShortDecimalsBlock(toNullableStringList(values)),
    ...
    {
        JavaAggregationFunctionImplementation noisySumGaussian = getFunction(SHORT_DECIMAL_TYPE, DOUBLE, BIGINT);
