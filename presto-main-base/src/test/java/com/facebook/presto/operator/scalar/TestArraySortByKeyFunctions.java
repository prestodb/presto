        ...
        extends AbstractTestFunctions
{
    ...
    public void testNativeExecutionWithSidecarDisabled()
    {
        ...
        TestArraySortByKeyFunctionsNative nativeTest = new TestArraySortByKeyFunctionsNative();
    ...
    private static class TestArraySortByKeyFunctionsNative
            extends AbstractTestFunctions
    {
        public TestArraySortByKeyFunctionsNative()
        {
        ...
        public void testNativeExecution()
        {
            ...
            assertFunction(
                    ...
                    asList("date", "apple", "banana", "cherry", "elderberry"));
            assertFunction(
                    "array_sort(ARRAY[ARRAY[1, 2, 3], ARRAY[4, 5], ARRAY[6, 7, 8, 9]], x -> cardinality(x))",
                    new ArrayType(new ArrayType(INTEGER)),
                    asList(asList(4, 5), asList(1, 2, 3), asList(6, 7, 8, 9)));
            ...
            // Test array_sort_desc
            assertFunction(
                    "array_sort_desc(ARRAY['apple', NULL, 'banana', NULL, 'cherry'], x -> length(x))",
                    new ArrayType(createVarcharType(6)),
                    asList("banana", "cherry", "apple", null, null));
            assertFunction(
                    "array_sort_desc(ARRAY['apple', 'banana', 'pear'], x -> IF(x = 'banana', NULL, length(x)))",
                    new ArrayType(createVarcharType(6)),
                    asList("apple", "pear", "banana"));
            assertFunction(
                    "array_sort_desc(ARRAY['apple', 'banana', 'cherry', 'date', 'elderberry'], x -> length(x))",
                    new ArrayType(createVarcharType(10)),
                    asList("elderberry", "banana", "cherry", "apple", "date"));
            assertFunction(
                    "array_sort_desc(ARRAY[ARRAY[1, 2, 3], ARRAY[4, 5], ARRAY[6, 7, 8, 9]], x -> cardinality(x))",
                    new ArrayType(new ArrayType(INTEGER)),
                    asList(asList(6, 7, 8, 9), asList(1, 2, 3), asList(4, 5)));
