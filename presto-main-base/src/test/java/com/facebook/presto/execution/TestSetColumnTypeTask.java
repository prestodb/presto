...
public class TestSetColumnTypeTask
{
    ...
    public void testSetDataType()
    {
        ...
        tableHandle = new TableHandle(connectorId, connectorHandle, connectorTransactionHandle, Optional.empty());
    ...
    {
        return new SetColumnTypeTask((Metadata) metadata, context.getTypeManager(), new AllowAllAccessControl())
