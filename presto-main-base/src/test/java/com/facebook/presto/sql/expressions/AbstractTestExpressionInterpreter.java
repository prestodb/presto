...
//                "CAST(3.3 AS DECIMAL(20,10))");
    ...
    public void assertRowExpressionEquals(ExpressionOptimizer.Level level, @Language("SQL") String actual, @Language("SQL") String expected)
    {
    ...
    public abstract Object optimize(RowExpression expression, ExpressionOptimizer.Level level);
