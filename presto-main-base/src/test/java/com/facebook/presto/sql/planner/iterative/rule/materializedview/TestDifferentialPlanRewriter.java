...
public class TestDifferentialPlanRewriter
{
    ...
    public void testTableScanDeltaStructure()
    {
        ...
        DifferentialPlanRewriter.DeltaPlanResult result = builder.buildDeltaPlan(tableScan, identityMapping);

        // Then: Result should be a FilterNode (stale predicate) over TableScan
        assertNotNull(result);
        assertNotNull(result.getPlan());
        assertTrue(result.getPlan() instanceof FilterNode, "Delta should be FilterNode, got: " + result.getPlan().getClass().getSimpleName());

        FilterNode filterNode = (FilterNode) result.getPlan();
    ...
    public void testJoinDeltaProducesUnion()
    {
        ...
        DifferentialPlanRewriter.DeltaPlanResult result = builder.buildDeltaPlan(join, identityMapping);

        // Then: Result should be UnionNode (∆R ⋈ S') ∪ (R ⋈ ∆S)
        assertNotNull(result);
        assertTrue(result.getPlan() instanceof UnionNode, "Join delta should be UnionNode, got: " + result.getPlan().getClass().getSimpleName());

        UnionNode unionNode = (UnionNode) result.getPlan();
    ...
    public void testUnionDeltaIsUnionOfDeltas()
    {
        ...
        DifferentialPlanRewriter.DeltaPlanResult result = builder.buildDeltaPlan(unionNode, identityMapping);

        // Then: Result should be UnionNode (∆R ∪ ∆S)
        assertNotNull(result);
        assertTrue(result.getPlan() instanceof UnionNode, "Union delta should be UnionNode");

        UnionNode resultUnion = (UnionNode) result.getPlan();
    ...
    public void testMappingsAreComposedCorrectly()
    {
        ...
        DifferentialPlanRewriter.DeltaPlanResult result = builder.buildDeltaPlan(tableScan, viewQueryMapping);
