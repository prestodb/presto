...
public class TestBasePlanFragmenterTransportType
{
    ...
    // -----------------------------------------------------------------------
    // Tests for childMayRunOnCoordinator
    // -----------------------------------------------------------------------
    ...
    public void testWorkerTableScanDoesNotRunOnCoordinator()
    {
        ...
        assertFalse(BasePlanFragmenter.childMayRunOnCoordinator(
    ...
    public void testInformationSchemaTableScanRunsOnCoordinator()
    {
        ...
        TableHandle handle = new TableHandle(
                ...
                Optional.empty());
        assertTrue(BasePlanFragmenter.childMayRunOnCoordinator(
    ...
    public void testExplainAnalyzeNodeRunsOnCoordinator()
    {
        ...
        assertTrue(BasePlanFragmenter.childMayRunOnCoordinator(explainAnalyze));
    }
    ...
    public void testValuesNodeDoesNotRunOnCoordinator()
    {
        ...
        assertFalse(BasePlanFragmenter.childMayRunOnCoordinator(planBuilder.values(col)));
    }
    ...
    public void testStopsAtRemoteExchangeBoundary()
    {
        ...
        // (childMayRunOnCoordinator stops at remote exchange boundaries)
        assertFalse(BasePlanFragmenter.childMayRunOnCoordinator(remoteExchange));
    }
    ...
    public void testWalksThroughLocalExchange()
    {
        ...
        assertTrue(BasePlanFragmenter.childMayRunOnCoordinator(localExchange));
    }
    ...
    public void testFragmentPropertiesDefaultsToHttp()
    {
        ...
        assertFalse(props.isRootFragment());
    }
    ...
    @Test
    public void testFragmentPropertiesRootFragment()
    {
        BasePlanFragmenter.FragmentProperties props = new BasePlanFragmenter.FragmentProperties(
                new com.facebook.presto.spi.plan.PartitioningScheme(
                        com.facebook.presto.spi.plan.Partitioning.create(
                                ...
                                ImmutableList.of()),
                        ImmutableList.of(col)));
        props.setRootFragment(true);
        assertTrue(props.isRootFragment());
    }
