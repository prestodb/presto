...
/**
 * When CPP functions are used with system tables, the filter containing
 ...
 */
public class TestPreventCppFunctionPushdownToSystemTables
        extends BasePlanTest
{
    public TestPreventCppFunctionPushdownToSystemTables()
    {
        super(TestPreventCppFunctionPushdownToSystemTables::createTestQueryRunner);
    }
    ...
    private static LocalQueryRunner createTestQueryRunner()
    {
        ...
        parseFunctionDefinitions(BigintOperators.class).stream()
                .map(TestPreventCppFunctionPushdownToSystemTables::convertToSqlInvokedFunction)
