...
public class TestFeaturesConfig
{
    ...
    public void testDefaults()
    {
        assertRecordedDefaults(ConfigAssertions.recordDefaults(FeaturesConfig.class)
                ...
                .setDistributedDynamicFilterExtendedMetrics(false)
                .setDistributedDynamicFilterCardinalityRatioThreshold(0.1)
                .setDistributedDynamicFilterDiscreteValuesLimit(10000)
                .setDistributedDynamicFilterMinProbeSize(new DataSize(256, MEGABYTE))
    ...
    public void testExplicitPropertyMappings()
    {
        Map<String, String> properties = new ImmutableMap.Builder<String, String>()
                ...
                .put("distributed-dynamic-filter.extended-metrics", "true")
                .put("distributed-dynamic-filter.cardinality-ratio-threshold", "0.3")
                .put("distributed-dynamic-filter.discrete-values-limit", "5000")
                .put("distributed-dynamic-filter.min-probe-size", "2GB")
        ...
        FeaturesConfig expected = new FeaturesConfig()
                ...
                .setDistributedDynamicFilterExtendedMetrics(true)
                .setDistributedDynamicFilterCardinalityRatioThreshold(0.3)
                .setDistributedDynamicFilterDiscreteValuesLimit(5000)
                .setDistributedDynamicFilterMinProbeSize(new DataSize(2, GIGABYTE))
