...
public class TestFeaturesConfig
{
    ...
    public void testDefaults()
    {
        assertRecordedDefaults(ConfigAssertions.recordDefaults(FeaturesConfig.class)
                ...
                .setGroupedExecutionWhenCapableEnabled(false)
                ...
                .setQueryTypesEnabledForHbo("SELECT,INSERT")
                ...
                .setOptimizeCascadingFiltersAndProjections(false)
                .setOptimizeJoinFanOut(false)
                ...
                .setPushProjectionThroughCrossJoin(false)
                ...
                .setAlwaysAnalyzeCreateTableQueryEnabled(false)
                ...
                .setMaterializedViewQueryRewriteCostBasedSelectionEnabled(false)
                ...
                .setRewriteApproxDistinctIfToMaskEnabled(false)
                ...
                .setRandomizeNullSourceKeyInSemiJoinStrategy(FeaturesConfig.RandomizeNullSourceKeyInSemiJoinStrategy.DISABLED)
                ...
                .setMergeSumsToVectorSumThreshold(0)
                ...
                .setRewriteSemiJoinAgainstValuesToFilterMaxSize(10000)
                ...
                .setRewriteBucketedSemiJoinToJoin(false)
    ...
    public void testExplicitPropertyMappings()
    {
        Map<String, String> properties = new ImmutableMap.Builder<String, String>()
                ...
                .put("grouped-execution-when-capable-enabled", "true")
                ...
                .put("optimizer.query-types-enabled-for-hbo", "SELECT,INSERT,DELETE")
                ...
                .put("optimizer.optimize-cascading-filters-and-projections", "true")
                .put("optimizer.optimize-join-fan-out", "true")
                ...
                .put("optimizer.push-projection-through-cross-join", "true")
                ...
                .put("always-analyze-create-table-query-enabled", "true")
                ...
                .put("materialized-view-query-rewrite-cost-based-selection-enabled", "true")
                ...
                .put("optimizer.rewrite-approx-distinct-if-to-mask", "true")
                ...
                .put("optimizer.randomize-null-source-key-in-semi-join-strategy", "always")
                ...
                .put("optimizer.merge-sums-to-vector-sum-threshold", "5")
                ...
                .put("optimizer.rewrite-semi-join-against-values-to-filter-max-size", "1234")
                ...
                .put("optimizer.rewrite-bucketed-semi-join-to-join", "true")
        ...
        FeaturesConfig expected = new FeaturesConfig()
                ...
                .setGroupedExecutionWhenCapableEnabled(true)
                ...
                .setQueryTypesEnabledForHbo("SELECT,INSERT,DELETE")
                ...
                .setOptimizeCascadingFiltersAndProjections(true)
                .setOptimizeJoinFanOut(true)
                ...
                .setPushProjectionThroughCrossJoin(true)
                ...
                .setAlwaysAnalyzeCreateTableQueryEnabled(true)
                .setSkipRedundantSort(false)
                ...
                .setMaterializedViewQueryRewriteCostBasedSelectionEnabled(true)
                ...
                .setRewriteApproxDistinctIfToMaskEnabled(true)
                ...
                .setRandomizeNullSourceKeyInSemiJoinStrategy(FeaturesConfig.RandomizeNullSourceKeyInSemiJoinStrategy.ALWAYS)
                ...
                .setMergeSumsToVectorSumThreshold(5)
                ...
                .setRewriteSemiJoinAgainstValuesToFilterMaxSize(1234)
                ...
                .setRewriteBucketedSemiJoinToJoin(true)
