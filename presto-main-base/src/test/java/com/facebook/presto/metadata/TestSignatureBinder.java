...
public class TestSignatureBinder
{
    ...
    {
        // This test simulates the ARRAY_SORT function with different lambda return types
        // ARRAY_SORT can have signatures like:
        // 1. array_sort(array(E), function(E,E,integer)) -> array(E)  [coordinator version]
        // 2. array_sort(array(E), function(E,E,bigint)) -> array(E)   [velox version]
