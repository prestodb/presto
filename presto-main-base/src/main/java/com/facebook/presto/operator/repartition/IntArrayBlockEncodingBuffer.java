        ...
        extends AbstractBlockEncodingBuffer
{
    ...
    private static final long INSTANCE_SIZE = ClassLayout.parseClass(IntArrayBlockEncodingBuffer.class).instanceSize();
    ...
    private void appendValuesToBuffer()
    {
        ...
        if (decodedBlock.mayHaveNull()) {
            for (int i = positionsOffset; i < positionsOffset + batchSize; i++) {
                ...
                int newIndex = setIntUnchecked(valuesBuffer, valuesBufferIndex, value);
            ...
            for (int i = positionsOffset; i < positionsOffset + batchSize; i++) {
                ...
                valuesBufferIndex = setIntUnchecked(valuesBuffer, valuesBufferIndex, value);
            }
        }
    }
}
