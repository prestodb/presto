...
public class NativeSidecarFunctionUtil
{
    private NativeSidecarFunctionUtil() {}

    public static synchronized SqlInvokedFunction createSqlInvokedFunction(String functionName, JsonBasedUdfFunctionMetadata jsonBasedUdfFunctionMetaData)
    {
