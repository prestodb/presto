        ...
        implements RemoteNodeStats
{
    ...
    public ThriftRemoteNodeStats(DriftClient<ThriftServerInfoClient> thriftClient, URI stateInfoUri)
    {
        ...
        if (sinceUpdate.toMillis() > 1_000 && requestInflight.compareAndSet(false, true)) {
            ...
            Futures.addCallback(responseFuture, new FutureCallback<Integer>()
            {
                ...
                public void onSuccess(@Nullable Integer result)
                {
                    ...
                    if (result != null) {
                        NodeStats nodeStats1 = new NodeStats(NodeState.valueOf(result), ImmutableMap.of());
