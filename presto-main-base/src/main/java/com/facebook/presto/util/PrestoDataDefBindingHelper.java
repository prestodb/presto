...
import com.facebook.presto.execution.AddFieldTask;
...
import com.facebook.presto.execution.CreateBranchTask;
...
import com.facebook.presto.execution.CreateTagTask;
...
public class PrestoDataDefBindingHelper
{
    ...
    static {
        ...
        dataDefBuilder.put(AddField.class, AddFieldTask.class);
        ...
        dataDefBuilder.put(CreateBranch.class, CreateBranchTask.class);
        dataDefBuilder.put(CreateTag.class, CreateTagTask.class);
