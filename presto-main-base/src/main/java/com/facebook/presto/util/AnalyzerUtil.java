...
public class AnalyzerUtil
{
    ...
    public static void checkQueryIntegrity(Identity identity, AccessControl accessControl, AccessControlContext accessControlContext, String query, Map<String, String> preparedStatements, ViewDefinitionReferences viewDefinitionReferences)
    {
