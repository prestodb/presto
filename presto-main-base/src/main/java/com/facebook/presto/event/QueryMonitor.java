    ...
    private List<OperatorStatistics> createOperatorStatistics(QueryInfo queryInfo)
    {
        ...
        return queryInfo.getQueryStats().getOperatorSummaries().stream()
                .map(operatorSummary -> new OperatorStatistics(
                        ...
                        operatorSummary.getAddInputWallInNanos(),
                        operatorSummary.getAddInputCpuInNanos(),
                        ...
                        operatorSummary.getGetOutputWallInNanos(),
                        operatorSummary.getGetOutputCpuInNanos(),
                        ...
                        operatorSummary.getBlockedWallInNanos(),
                        operatorSummary.getFinishCalls(),
                        operatorSummary.getFinishWallInNanos(),
                        operatorSummary.getFinishCpuInNanos(),
