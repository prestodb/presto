...
public class PushPartialAggregationThroughJoinRuleSet
{
            ...
            extends BaseRule
    {
        ...
        {
            // TODO : MergeAggregationsWithAndWithoutFilter breaks while pushing masked aggregations through a Project below the join
            return !isMergeAggregationsWithAndWithoutFilter(session)
