...
public class PropertyDerivations
{
    ...
    public static ActualProperties uniqueToGroupProperties(ActualProperties properties)
    {
        ...
        if (localProperty instanceof UniqueProperty) {
            return ActualProperties.builderFrom(properties).local(ImmutableList.of(new GroupingProperty<>(ImmutableList.of(((UniqueProperty<VariableReferenceExpression>) localProperty).getColumn())))).build();
        }
        checkState(localProperty instanceof GroupingProperty);
        return properties;
    }
            ...
            extends InternalPlanVisitor<ActualProperties, List<ActualProperties>>
    {
        ...
        public ActualProperties visitAssignUniqueId(AssignUniqueId node, List<ActualProperties> inputProperties)
        {
            ...
            if (properties.getNodePartitioning().isPresent()) {
                ...
                return ActualProperties.builderFrom(properties)
                        ...
                        .additionalProperty(properties.getPropertiesFromUniqueColumn())
                        .build();
            }
        ...
        public ActualProperties visitGroupId(GroupIdNode node, List<ActualProperties> inputProperties)
        {
            ...
            return ActualProperties.builderFrom(properties.translateVariable(column -> Optional.ofNullable(inputToOutputMappings.get(column))))
                    .additionalProperty(properties.getPropertiesFromUniqueColumn().map(x -> uniqueToGroupProperties(x.translateVariable(column -> Optional.ofNullable(inputToOutputMappings.get(column))))))
                    .build();
        }
        ...
        public ActualProperties visitAggregation(AggregationNode node, List<ActualProperties> inputProperties)
        {
            ...
            return ActualProperties.builderFrom(translated)
                    ...
                    .additionalProperty(uniqueProperties(translated.getPropertiesFromUniqueColumn())).build();
        }
        ...
        public ActualProperties visitTopNRowNumber(TopNRowNumberNode node, List<ActualProperties> inputProperties)
        {
            ...
            return ActualProperties.builderFrom(properties)
                    ...
                    .additionalProperty(uniqueProperties(properties.getPropertiesFromUniqueColumn()))
                    .build();
        }
            ...
            switch (node.getType()) {
                case INNER:
                    ...
                    return ActualProperties.builderFrom(probeProperties)
                            .constants(constants)
                            .additionalProperty(probeProperties.getPropertiesFromUniqueColumn().map(x -> uniqueToGroupProperties(x.translateVariable(column -> filterOrRewrite(outputVariableReferences, node.getCriteria(), column)))))
                            .unordered(unordered)
                            .build();
                case LEFT:
                    return ActualProperties.builderFrom(probeProperties.translateVariable(column -> filterIfMissing(outputVariableReferences, column)))
                            .additionalProperty(probeProperties.getPropertiesFromUniqueColumn().map(x -> uniqueToGroupProperties(x.translateVariable(column -> filterIfMissing(outputVariableReferences, column)))))
                            .unordered(unordered)
                            .build();
                case RIGHT:
                ...
                case INNER:
                    return ActualProperties.builderFrom(probeProperties)
                            .constants(ImmutableMap.<VariableReferenceExpression, ConstantExpression>builder()
                                    ...
                                    .build())
                            .additionalProperty(probeProperties.getPropertiesFromUniqueColumn().map(x -> uniqueToGroupProperties(x)))
                            .build();
                case SOURCE_OUTER:
                    return ActualProperties.builderFrom(probeProperties)
            ...
            switch (node.getType()) {
                case INNER:
                    ...
                    return ActualProperties.builderFrom(leftProperties)
                            .additionalProperty(leftProperties.getPropertiesFromUniqueColumn().map(x -> uniqueToGroupProperties(x.translateVariable(column -> filterOrRewrite(outputVariableReferences, node.getCriteria(), column)))))
                            .constants(constants)
                            .build();
                case LEFT:
                    return ActualProperties.builderFrom(leftProperties.translateVariable(column -> filterIfMissing(outputVariableReferences, column)))
                            .additionalProperty(leftProperties.getPropertiesFromUniqueColumn().map(x -> uniqueToGroupProperties(x.translateVariable(column -> filterIfMissing(outputVariableReferences, column)))))
                            .build();
                case RIGHT:
                    ...
                    return ActualProperties.builderFrom(rightProperties.translateVariable(column -> filterIfMissing(outputVariableReferences, column)))
                            .local(ImmutableList.of())
                            .additionalProperty(rightProperties.getPropertiesFromUniqueColumn().map(x -> uniqueToGroupProperties(x.translateVariable(column -> filterIfMissing(outputVariableReferences, column)))))
                            .unordered(true)
                            .build();
                case FULL:
        ...
        public ActualProperties visitExchange(ExchangeNode node, List<ActualProperties> inputProperties)
        {
            ...
            boolean additionalPropertyIsUnique = inputProperties.size() == 1 && uniqueProperties(translated.getPropertiesFromUniqueColumn()).isPresent();
            ...
            if (node.getScope().isLocal()) {
                ...
                if (additionalPropertyIsUnique) {
                    builder.additionalProperty(translated.getPropertiesFromUniqueColumn());
                }
            ...
            switch (node.getType()) {
                ...
                case REPARTITION: {
                    ...
                    return ActualProperties.builder()
                            .global(globalPartitioning)
                            .constants(constants)
                            .additionalProperty(additionalPropertyIsUnique ? translated.getPropertiesFromUniqueColumn() : Optional.empty())
                            .build();
                }
                case REPLICATE:
        ...
        public ActualProperties visitProject(ProjectNode node, List<ActualProperties> inputProperties)
        {
            ...
            return ActualProperties.builderFrom(translatedProperties)
                    .constants(constants)
                    .additionalProperty(properties.getPropertiesFromUniqueColumn().map(x -> x.translateRowExpression(node.getAssignments().getMap())))
                    .build();
        }
        ...
        public ActualProperties visitTableScan(TableScanNode node, List<ActualProperties> inputProperties)
        {
            ...
            if (isUtilizeUniquePropertyInQueryPlanningEnabled(session) && layout.getUniqueColumn().isPresent() && assignments.containsKey(layout.getUniqueColumn().get())) {
                ...
                ActualProperties.Builder additionalProperties = ActualProperties.builder();
                additionalProperties.global(partitionedOn(ARBITRARY_DISTRIBUTION, ImmutableList.of(uniqueVariable), Optional.empty()));
                additionalProperties.local(LocalProperties.unique(uniqueVariable));
                properties.additionalProperty(Optional.of(additionalProperties.build()));
            }
