        ...
        implements Rule<AggregationNode>
{
    ...
    private boolean canRemoveDistinct(Aggregation aggregation)
    {
        return aggregation.isDistinct()
                && (!functionAndTypeManager.getAggregateFunctionImplementation(aggregation.getFunctionHandle()).isDistinctSensitive())
                && (!functionAndTypeManager.getAggregateFunctionImplementation(aggregation.getFunctionHandle()).isOrderSensitive());
    }
}
