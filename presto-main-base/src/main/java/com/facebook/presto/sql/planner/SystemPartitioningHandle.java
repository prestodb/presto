        ...
        implements ConnectorPartitioningHandle
{
    ...
    public static ExchangeNode roundRobinExchange(PlanNodeId id, ExchangeNode.Scope scope, PlanNode child, int partitionCount)
    {
        ...
        return partitionedExchange(
                ...
                scope,
                child,
                new PartitioningScheme(Partitioning.create(createSystemPartitioning(SystemPartitioning.FIXED, SystemPartitionFunction.ROUND_ROBIN, partitionCount), ImmutableList.of()), child.getOutputVariables()));
    }
