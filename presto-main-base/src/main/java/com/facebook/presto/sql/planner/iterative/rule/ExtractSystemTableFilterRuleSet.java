...
public class ExtractSystemTableFilterRuleSet
{
            ...
            implements Rule<ProjectNode>
    {
        ...
        public Result apply(ProjectNode node, Captures captures, Context context)
        {
            ...
            if (!shouldAddExchange(functionAndTypeManager, Optional.of(filterNode), Optional.of(projectNode))) {
                return Result.empty();
            }

            ExchangeNode exchange = createGatheringExchange(context.getIdAllocator(), tableScanNode);
            ...
            implements Rule<ProjectNode>
    {
        ...
        public Result apply(ProjectNode node, Captures captures, Context context)
        {
            ...
            if (!shouldAddExchange(functionAndTypeManager, Optional.empty(), Optional.of(projectNode))) {
                return Result.empty();
            }
            ...
            implements Rule<FilterNode>
    {
        ...
        public Result apply(FilterNode node, Captures captures, Context context)
        {
            ...
            if (!shouldAddExchange(functionAndTypeManager, Optional.of(filterNode), Optional.empty())) {
                return Result.empty();
            }
    ...
    private static boolean shouldAddExchange(
    ...
    private static ExchangeNode createGatheringExchange(PlanNodeIdAllocator idAllocator, TableScanNode tableScanNode)
    {
