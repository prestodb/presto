...
public class RemoveRedundantExchangeRuleSet
{
            ...
            implements Rule<ExchangeNode>
    {
        ...
        public Pattern<ExchangeNode> getPattern()
        {
            return exchange()
                    ...
                    .matching(RemoveRedundantExchangeRuleSet::isSingleSourceExchange)
        ...
        public Result apply(ExchangeNode node, Captures captures, Context context)
        {
            ...
            if (shouldKeepOuterExchange(functionAndTypeManager, tableScanNode, Optional.of(filterNode), Optional.empty())) {
                return Result.empty();
            }
             ...
             implements Rule<ExchangeNode>
    {
        ...
        public Result apply(ExchangeNode node, Captures captures, Context context)
        {
            ...
            if (shouldKeepOuterExchange(functionAndTypeManager, tableScanNode, Optional.of(filterNode), Optional.of(projectNode))) {
                return Result.empty();
            }
             ...
             implements Rule<ExchangeNode>
    {
        ...
        public Result apply(ExchangeNode node, Captures captures, Context context)
        {
            ...
            if (shouldKeepOuterExchange(functionAndTypeManager, tableScanNode, Optional.empty(), Optional.of(projectNode))) {
                return Result.empty();
            }
    ...
    private static boolean shouldKeepOuterExchange(
    ...
    private static boolean isSingleSourceExchange(ExchangeNode exchange)
    {
