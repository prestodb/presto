...
import static com.facebook.presto.sql.analyzer.UpdateType.ADD_COLUMN;
import static com.facebook.presto.sql.analyzer.UpdateType.ADD_CONSTRAINT;
import static com.facebook.presto.sql.analyzer.UpdateType.ALTER_COLUMN_NOT_NULL;
import static com.facebook.presto.sql.analyzer.UpdateType.ANALYZE;
import static com.facebook.presto.sql.analyzer.UpdateType.CALL;
import static com.facebook.presto.sql.analyzer.UpdateType.CREATE_FUNCTION;
import static com.facebook.presto.sql.analyzer.UpdateType.CREATE_MATERIALIZED_VIEW;
import static com.facebook.presto.sql.analyzer.UpdateType.CREATE_ROLE;
import static com.facebook.presto.sql.analyzer.UpdateType.CREATE_SCHEMA;
import static com.facebook.presto.sql.analyzer.UpdateType.CREATE_TABLE;
import static com.facebook.presto.sql.analyzer.UpdateType.CREATE_TYPE;
import static com.facebook.presto.sql.analyzer.UpdateType.CREATE_VIEW;
import static com.facebook.presto.sql.analyzer.UpdateType.DELTE;
import static com.facebook.presto.sql.analyzer.UpdateType.DROP_COLUMN;
import static com.facebook.presto.sql.analyzer.UpdateType.DROP_CONSTRAINT;
import static com.facebook.presto.sql.analyzer.UpdateType.DROP_MATERIALIZED_VIEW;
import static com.facebook.presto.sql.analyzer.UpdateType.DROP_ROLE;
import static com.facebook.presto.sql.analyzer.UpdateType.DROP_SCHEMA;
import static com.facebook.presto.sql.analyzer.UpdateType.DROP_VIEW;
import static com.facebook.presto.sql.analyzer.UpdateType.GRANT;
import static com.facebook.presto.sql.analyzer.UpdateType.GRANT_ROLE;
import static com.facebook.presto.sql.analyzer.UpdateType.INSERT;
import static com.facebook.presto.sql.analyzer.UpdateType.RENAME_COLUMN;
import static com.facebook.presto.sql.analyzer.UpdateType.RENAME_SCHEMA;
import static com.facebook.presto.sql.analyzer.UpdateType.RENAME_TABLE;
import static com.facebook.presto.sql.analyzer.UpdateType.RENAME_VIEW;
import static com.facebook.presto.sql.analyzer.UpdateType.REVOKE;
import static com.facebook.presto.sql.analyzer.UpdateType.REVOKE_ROLES;
import static com.facebook.presto.sql.analyzer.UpdateType.SET_PROPERTIES;
import static com.facebook.presto.sql.analyzer.UpdateType.SET_ROLE;
import static com.facebook.presto.sql.analyzer.UpdateType.TRUNCATE_TABLE;
...
class StatementAnalyzer
{
            ...
            extends DefaultTraversalVisitor<Scope, Optional<Scope>>
    {
        ...
        protected Scope visitInsert(Insert insert, Optional<Scope> scope)
        {
            ...
            analysis.setUpdateInfo(new UpdateInfo(INSERT.getUpdateType(), targetTable.toString()));
        ...
        protected Scope visitDelete(Delete node, Optional<Scope> scope)
        {
            ...
            analysis.setUpdateInfo(new UpdateInfo(DELTE.getUpdateType(), tableName.toString()));
        ...
        protected Scope visitAnalyze(Analyze node, Optional<Scope> scope)
        {
            ...
            analysis.setUpdateInfo(new UpdateInfo(ANALYZE.getUpdateType(), tableName.toString()));
            MetadataHandle metadataHandle = analysis.getMetadataHandle();
        ...
        {
            analysis.setUpdateInfo(new UpdateInfo(CREATE_TABLE.getUpdateType(), node.getName().toString()));
        ...
        protected Scope visitCreateView(CreateView node, Optional<Scope> scope)
        {
            ...
            analysis.setUpdateInfo(new UpdateInfo(CREATE_VIEW.getUpdateType(), viewName.toString()));
        ...
        {
            QualifiedObjectName viewName = createQualifiedObjectName(session, node, node.getName());
            analysis.setUpdateInfo(new UpdateInfo(CREATE_MATERIALIZED_VIEW.getUpdateType(), viewName.toString()));
        ...
        protected Scope visitRefreshMaterializedView(RefreshMaterializedView node, Optional<Scope> scope)
        {
            ...
            analysis.setUpdateInfo(new UpdateInfo(INSERT.getUpdateType(), viewName.toString()));
        ...
        {
            analysis.setUpdateInfo(new UpdateInfo(CREATE_FUNCTION.getUpdateType(), node.getFunctionName().toString()));
        ...
        {
            analysis.setUpdateInfo(new UpdateInfo(ADD_COLUMN.getUpdateType(), node.getName().toString()));
            return createAndAssignScope(node, scope);
        }
        ...
        {
            analysis.setUpdateInfo(new UpdateInfo(CREATE_SCHEMA.getUpdateType(), node.getSchemaName().toString()));
            validateProperties(node.getProperties(), scope);
            return createAndAssignScope(node, scope);
        }
        ...
        {
            analysis.setUpdateInfo(new UpdateInfo(DROP_SCHEMA.getUpdateType(), node.getSchemaName().toString()));
            return createAndAssignScope(node, scope);
        }
        ...
        {
            analysis.setUpdateInfo(new UpdateInfo(RENAME_SCHEMA.getUpdateType(), node.getSource().toString()));
            return createAndAssignScope(node, scope);
        }
        ...
        {
            analysis.setUpdateInfo(new UpdateInfo(CREATE_ROLE.getUpdateType(), node.getName().toString()));
            return createAndAssignScope(node, scope);
        }
        ...
        {
            analysis.setUpdateInfo(new UpdateInfo(DROP_ROLE.getUpdateType(), node.getName().toString()));
            return createAndAssignScope(node, scope);
        }
        ...
        {
            analysis.setUpdateInfo(new UpdateInfo(SET_ROLE.getUpdateType(), node.toString()));
            return createAndAssignScope(node, scope);
        }
        ...
        {
            analysis.setUpdateInfo(new UpdateInfo(GRANT_ROLE.getUpdateType(), node.toString()));
            return createAndAssignScope(node, scope);
        }
        ...
        {
            analysis.setUpdateInfo(new UpdateInfo(REVOKE_ROLES.getUpdateType(), node.toString()));
            return createAndAssignScope(node, scope);
        }
        ...
        {
            analysis.setUpdateInfo(new UpdateInfo(CREATE_TYPE.getUpdateType(), node.getTypeName().toString()));
            return createAndAssignScope(node, scope);
        }
        ...
        {
            analysis.setUpdateInfo(new UpdateInfo(TRUNCATE_TABLE.getUpdateType(), node.getTableName().toString()));
            return createAndAssignScope(node, scope);
        }
        ...
        {
            analysis.setUpdateInfo(new UpdateInfo(DROP_ROLE.name(), node.getTableName().toString()));
            return createAndAssignScope(node, scope);
        }
        ...
        {
            analysis.setUpdateInfo(new UpdateInfo(RENAME_TABLE.getUpdateType(), node.getTarget().toString()));
            return createAndAssignScope(node, scope);
        }
        ...
        {
            analysis.setUpdateInfo(new UpdateInfo(SET_PROPERTIES.getUpdateType(), node.getTableName().toString()));
            return createAndAssignScope(node, scope);
        }
        ...
        {
            analysis.setUpdateInfo(new UpdateInfo(RENAME_COLUMN.getUpdateType(), node.getTable().toString()));
            return createAndAssignScope(node, scope);
        }
        ...
        {
            analysis.setUpdateInfo(new UpdateInfo(DROP_COLUMN.getUpdateType(), node.getTable().toString()));
            return createAndAssignScope(node, scope);
        }
        ...
        {
            analysis.setUpdateInfo(new UpdateInfo(DROP_CONSTRAINT.getUpdateType(), node.getTableName().toString()));
            return createAndAssignScope(node, scope);
        }
        ...
        {
            analysis.setUpdateInfo(new UpdateInfo(ADD_CONSTRAINT.getUpdateType(), node.getTableName().toString()));
            return createAndAssignScope(node, scope);
        }
        ...
        {
            analysis.setUpdateInfo(new UpdateInfo(ALTER_COLUMN_NOT_NULL.getUpdateType(), node.getTable().toString()));
            return createAndAssignScope(node, scope);
        }
        ...
        {
            analysis.setUpdateInfo(new UpdateInfo(RENAME_VIEW.getUpdateType(), node.getTarget().toString()));
            return createAndAssignScope(node, scope);
        }
        ...
        {
            analysis.setUpdateInfo(new UpdateInfo(DROP_VIEW.getUpdateType(), node.getName().toString()));
            return createAndAssignScope(node, scope);
        }
        ...
        {
            analysis.setUpdateInfo(new UpdateInfo(DROP_MATERIALIZED_VIEW.getUpdateType(), node.getName().toString()));
            return createAndAssignScope(node, scope);
        }
        ...
        {
            analysis.setUpdateInfo(new UpdateInfo(GRANT.getUpdateType(), node.getTableName().toString()));
            return createAndAssignScope(node, scope);
        }
        ...
        {
            analysis.setUpdateInfo(new UpdateInfo(REVOKE.getUpdateType(), node.getTableName().toString()));
            return createAndAssignScope(node, scope);
        }
        ...
        {
            analysis.setUpdateInfo(new UpdateInfo(CALL.getUpdateType(), node.getName().toString()));
            return createAndAssignScope(node, scope);
        }
