        ...
        extends ProjectOffPushDownRule<IndexSourceNode>
{
    ...
    @Override
    protected Optional<PlanNode> pushDownProjectOff(PlanNodeIdAllocator idAllocator, VariableAllocator variableAllocator, IndexSourceNode indexSourceNode, Set<VariableReferenceExpression> referencedOutputs)
    {
