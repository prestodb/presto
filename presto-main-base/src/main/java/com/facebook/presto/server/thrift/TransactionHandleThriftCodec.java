        ...
        extends AbstractTypedThriftCodec<ConnectorTransactionHandle>
{
    ...
    {
        return createThriftType(ConnectorTransactionHandle.class, true);
    }

    @Override
    public ThriftType getType()
    {
        return createThriftType(ConnectorTransactionHandle.class, false);
    }

    @Override
    public ConnectorTransactionHandle readConcreteValue(String connectorId, TProtocolReader reader)
    {
        return connectorThriftCodecManager.getConnectorTransactionHandleThriftCodec(connectorId).deserialize(reader);
    }

    @Override
    public void writeConcreteValue(String connectorId, ConnectorTransactionHandle value, TProtocolWriter writer)
    {
        connectorThriftCodecManager.getConnectorTransactionHandleThriftCodec(connectorId).serialize(value, writer);
    }
}
