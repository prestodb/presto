...
public class TaskResourceUtils
{
    ...
    private static TaskStats convertToThriftTaskStats(TaskStats taskStats)
    {
        ...
        return new TaskStats(
                ...
                taskStats.getTotalNativeDrivers(),
                taskStats.getQueuedNativeDrivers(),
                taskStats.getRunningNativeDrivers(),
                taskStats.getCompletedNativeDrivers(),
                taskStats.getTotalSplits(),
                taskStats.getQueuedSplits(),
                taskStats.getRunningSplits(),
                taskStats.getCompletedSplits(),
    ...
    private static TaskStats convertFromThriftTaskStats(TaskStats thriftTaskStats)
    {
        ...
        return new TaskStats(
                ...
                thriftTaskStats.getTotalNativeDrivers(),
                thriftTaskStats.getQueuedNativeDrivers(),
                thriftTaskStats.getRunningNativeDrivers(),
                thriftTaskStats.getCompletedNativeDrivers(),
                thriftTaskStats.getTotalSplits(),
                thriftTaskStats.getQueuedSplits(),
                thriftTaskStats.getRunningSplits(),
                thriftTaskStats.getCompletedSplits(),
