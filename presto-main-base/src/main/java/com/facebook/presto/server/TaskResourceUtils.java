...
public class TaskResourceUtils
{
    ...
    private static TaskStats convertToThriftTaskStats(TaskStats taskStats)
    {
        ...
        return new TaskStats(
                ...
                taskStats.getTotalNewDrivers(),
                taskStats.getQueuedNewDrivers(),
                taskStats.getRunningNewDrivers(),
                taskStats.getCompletedNewDrivers(),
    ...
    private static TaskStats convertFromThriftTaskStats(TaskStats thriftTaskStats)
    {
        ...
        return new TaskStats(
                ...
                thriftTaskStats.getTotalNewDrivers(),
                thriftTaskStats.getQueuedNewDrivers(),
                thriftTaskStats.getRunningNewDrivers(),
                thriftTaskStats.getCompletedNewDrivers(),
