...
public final class SystemSessionProperties
{
    ...
    public static final String OPTIMIZE_CONSTANT_APPROXIMATE_DISTINCT = "optimize_constant_approximate_distinct";
            ...
            HistoryBasedOptimizationConfig historyBasedOptimizationConfig)
    {
        sessionProperties = ImmutableList.of(
                ...
                booleanProperty(ADD_EXCHANGE_BELOW_PARTIAL_AGGREGATION_OVER_GROUP_ID,
                        ...
                        false),
                booleanProperty(
                        OPTIMIZE_CONSTANT_APPROXIMATE_DISTINCT,
                        "Optimize out APPROX_DISTINCT operations over constant values",
                        featuresConfig.isOptimizeConstantApproxDistinct(),
                        false),
                new PropertyMetadata<>(
    ...
    public static boolean isOptimizeConstantApproxDistinctEnabled(Session session)
    {
        return session.getSystemProperty(OPTIMIZE_CONSTANT_APPROXIMATE_DISTINCT, Boolean.class);
    }
}
