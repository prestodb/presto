...
public final class SystemSessionProperties
{
    ...
    public static final String OPTIMIZE_CONDITIONAL_CONST_APPROXIMATE_DISTINCT = "optimize_conditional_const_approximate_distinct";
            ...
            HistoryBasedOptimizationConfig historyBasedOptimizationConfig)
    {
        sessionProperties = ImmutableList.of(
                ...
                booleanProperty(ADD_EXCHANGE_BELOW_PARTIAL_AGGREGATION_OVER_GROUP_ID,
                        ...
                        false),
                booleanProperty(
                        OPTIMIZE_CONDITIONAL_CONST_APPROXIMATE_DISTINCT,
    ...
    {
        return session.getSystemProperty(OPTIMIZE_CONDITIONAL_CONST_APPROXIMATE_DISTINCT, Boolean.class);
    }
}
