...
public final class SystemSessionProperties
{
    ...
    public static final String REWRITE_MAP_SUBSET_WITH_CONSTANT_WITH_ELEMENT_AT = "rewrite_map_subset_with_constant_with_element_at";
            ...
            HistoryBasedOptimizationConfig historyBasedOptimizationConfig)
    {
        sessionProperties = ImmutableList.of(
                ...
                booleanProperty(
                        ...
                        false),
                booleanProperty(
                        REWRITE_MAP_SUBSET_WITH_CONSTANT_WITH_ELEMENT_AT,
                        "Rewrite map_subset(feature, array[constant...]) to map_filter(map(array[constant], array[alement_at(feature, constant)]), (k, v) -> v is not null)",
                        true,
                        false),
                booleanProperty(
    ...
    public static boolean isRewriteMapSubsetWithConstantWithElementAt(Session session)
    {
        return session.getSystemProperty(REWRITE_MAP_SUBSET_WITH_CONSTANT_WITH_ELEMENT_AT, Boolean.class);
    }
