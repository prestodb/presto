...
public final class SystemSessionProperties
{
    ...
    public static final String MERGE_MAX_BY_AGGREGATIONS = "merge_max_by_aggregations";
            ...
            HistoryBasedOptimizationConfig historyBasedOptimizationConfig)
    {
        sessionProperties = ImmutableList.of(
                ...
                booleanProperty(ADD_DISTINCT_BELOW_SEMI_JOIN_BUILD,
                        ...
                        false),
                booleanProperty(MERGE_MAX_BY_AGGREGATIONS,
                    "Merge multiple MAX_BY aggregations with the same comparison key into a single MAX_BY with ROW argument",
                        featuresConfig.isMergeMaxByAggregationsEnabled(),
                        false));
    }
    ...
    public static boolean isMergeMaxByAggregationsEnabled(Session session)
    {
        return session.getSystemProperty(MERGE_MAX_BY_AGGREGATIONS, Boolean.class);
    }
