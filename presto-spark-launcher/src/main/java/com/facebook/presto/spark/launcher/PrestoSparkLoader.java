        ...
        extends URLClassLoader
{
            ...
            List<String> spiPackages)
    {
        this(urls,
                spiClassLoader,
                spiPackages,
                spiPackages.stream().map(PrestoSparkLoader::classNameToResource).collect(toList()));
    }

    private PrestoSparkLoader(
            List<URL> urls,
            ClassLoader spiClassLoader,
            List<String> spiPackages,
            List<String> spiResources)
    {
        ...
        this.spiPackages = unmodifiableList(new ArrayList<>(spiPackages));
        this.spiResources = unmodifiableList(new ArrayList<>(spiResources));
    }
