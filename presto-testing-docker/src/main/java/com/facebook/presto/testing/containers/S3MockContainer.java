        ...
        extends BaseTestContainer
{
            ...
            extends BaseTestContainer.Builder<S3MockContainer.Builder, S3MockContainer>
    {
        private Builder()
        {
            ...
            this.envVars = ImmutableMap.of("SERVER_PORT", String.valueOf(S3_PORT));
        }

        @Override
        public Builder withEnvVars(Map<String, String> envVars)
        {
            // Use a mutable intermediate map so SERVER_PORT always wins, even if caller passes it
            Map<String, String> merged = new LinkedHashMap<>(envVars);
            merged.put("SERVER_PORT", String.valueOf(S3_PORT));
