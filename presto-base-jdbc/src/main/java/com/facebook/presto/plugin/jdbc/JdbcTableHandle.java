        ...
        implements ConnectorTableHandle
{
    ...
    /*
    joinTables holds the all the table handles for the same connector
    which are participating for the join pushdown
    this is using in query builder to generate join query
     */
