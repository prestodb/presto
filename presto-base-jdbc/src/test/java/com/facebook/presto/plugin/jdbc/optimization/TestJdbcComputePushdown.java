...
public class TestJdbcComputePushdown
{
    ...
    @Test
    public void testJdbcComputePushdownPart()
    {
        String table = "test_table";
        String schema = "test_schema";

        // CAST(c1 AS varchar(1024)) = '123' can't pushdown, but c1 + c2 = 3 can.
    ...
    @Test
    public void testJdbcComputePushdownPartWithOr()
    {
        String table = "test_table";
        String schema = "test_schema";

        // CAST(c1 AS varchar(1024)) = '123' can't pushdown, but c1 + c2 = 3 or c1 <> c2 can.
        ...
        JdbcTableLayoutHandle jdbcTableLayoutHandle = new JdbcTableLayoutHandle(
                jdbcTableHandle,
                TupleDomain.none(),
                Optional.of(new JdbcExpression("((((('c1' + 'c2') = ?)) OR (('c1' <> 'c2'))))", ImmutableList.of(new ConstantExpression(Long.valueOf(3), INTEGER)))));
    ...
    @Test
    public void testJdbcComputeNotPushdown()
    {
        String table = "test_table";
        String schema = "test_schema";

        // All filter can't pushdown
