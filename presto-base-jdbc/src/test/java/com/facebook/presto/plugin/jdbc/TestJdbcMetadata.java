...
public class TestJdbcMetadata
{
            ...
            throws Exception
    {
        ...
        metadata = new JdbcMetadata(jdbcMetadataCache, database.getJdbcClient(), false, new DefaultTableLocationProvider(new BaseJdbcConfig()));
    ...
    public void testDropTableTable()
    {
        ...
        metadata = new JdbcMetadata(jdbcMetadataCache, database.getJdbcClient(), true, new DefaultTableLocationProvider(new BaseJdbcConfig()));
        metadata.dropTable(SESSION, tableHandle);
