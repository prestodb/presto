...
public class TestJdbcQueryBuilder
{
            ...
            throws SQLException
    {
        ...
        Connection connection = database.getConnection();
        try (PreparedStatement preparedStatement = new QueryBuilder("\"").buildSql(jdbcClient, session, connection, "", "", "test_table", Optional.empty(), columns, ImmutableMap.of(), tupleDomain, Optional.empty());
