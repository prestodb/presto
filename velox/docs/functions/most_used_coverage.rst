...
.. table::
    ...
    json_format                  array_sort                   :func:`round`                trim                         :func:`md5`                      :func:`max`
    ...
    :func:`to_unixtime`          :func:`filter`               from_iso8601_date            reverse                      truncate                         :func:`min_by`
    :func:`regexp_like`          :func:`sqrt`                 json_extract                 :func:`array_intersect`                                       :func:`stddev`
    array_join                   least                        mod                          repeat                                                        set_agg
    :func:`replace`              json_parse                   array_distinct               st_geometryfromtext                                           histogram
    regexp_replace               map_from_entries             pow                          split_part                                                    set_union
