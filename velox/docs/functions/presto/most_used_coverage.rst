...
.. table::
    ...
    :func:`lower`                :func:`json_extract_scalar`  :func:`abs`                  flatten                      from_big_endian_64               :func:`sum`                      :func:`rank`
    :func:`json_format`          :func:`array_sort`           :func:`round`                :func:`trim`                 :func:`md5`                      :func:`max`                      lag
