...
TEST_F(PrestoQueryReplayRunnerTest, aggregationWithoutTableScan) {
  ...
  const std::vector<std::string> serializedPlanFragments = {
      ...
      /*gathering 2*/
      R"({"task_id":"abc.2.0.0.0","execution_strategy":"UNGROUPED","remote_task_ids":{"15":["abc.3.0.0.0"]},"plan_fragment":{"outputType":{"cTypes":[{"type":"BIGINT","name":"Type"},{"type":"BIGINT","name":"Type"}],"names":["c0","a0"],"type":"ROW","name":"Type"},"serdeKind":"Presto","id":"15","name":"ExchangeNode"}})",
  };
