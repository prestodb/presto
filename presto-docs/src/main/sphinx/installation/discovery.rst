...
`discovery-server-1.14.tar.gz`_, unpack it to create the *installation*
...
.. _discovery-server-1.14.tar.gz: http://search.maven.org/remotecontent?filepath=io/airlift/discovery/discovery-server/1.14/discovery-server-1.14.tar.gz
