...
Table properties can be modified for an Iceberg table using an ALTER TABLE SET PROPERTIES statement. At present, the modifiable table properties include
