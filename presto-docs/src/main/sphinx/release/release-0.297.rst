...
* Add support for constant folding user defined functions in native clusters. `#24602 <https://github.com/prestodb/presto/pull/24602>`_
...
Security Changes
________________
* Fix CSP by removing ``img-src 'http: https:'`` in response to `CWE-693 <https://cwe.mitre.org/data/definitions/693.html>`_. `#26790 <https://github.com/prestodb/presto/pull/26790>`_
...
* Upgrade Druid to version 35.0.1 to address `CVE-2024-53990 <https://github.com/advisories/GHSA-mfj5-cf8g-g2fv>`_ and `CVE-2025-12183 <https://github.com/advisories/GHSA-vqf4-7m7x-wgfc>`__. `#26820 <https://github.com/prestodb/presto/pull/26820>`_
...
* Upgrade lz4-java to version 1.10.2 across connectors to address `CVE-2025-66566 <https://nvd.nist.gov/vuln/detail/CVE-2025-66566>`_ and `CVE-2025-12183 <https://cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2025-12183>`__. `#26931 <https://github.com/prestodb/presto/pull/26931>`_
...
* Upgrade org.apache.logging.log4j:log4j-core from 2.24.3 to 2.25.3 to address `CVE-2025-68161 <https://nvd.nist.gov/vuln/detail/CVE-2025-68161>`_. `#26885 <https://github.com/prestodb/presto/pull/26885>`_
