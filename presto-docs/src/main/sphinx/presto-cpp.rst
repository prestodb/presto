...
coordinator's functionality for native clusters. A Presto C++ sidecar
implements additional REST endpoints to provide the native sidecar plugin
additional worker metadata. See `sidecar`_ for more information.
