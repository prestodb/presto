...
If you wish to use the MariaDb Java driver instead of the MySQL Connector J
driver, you can use the following properties for the ``database-`` fields::
...
Name                                        Description
=========================================== ==================================================================================================
``database-url``                            The JDBC URL of the MySQL database used by the MySQL function namespace manager. If using the MariaDb Java driver, ensure the URL uses the MariaDb connection string format, i.e the string starts with ``jdbc:mariadb:``
