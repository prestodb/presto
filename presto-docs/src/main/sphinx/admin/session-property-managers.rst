...
Change the value of ``session-property-manager.db.url`` to the JDBC URL of a MySQL database.
...
If either the database or tables do not exist, Presto will create them on startup.
