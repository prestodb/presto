...
public final class InMemoryQueryRunner
{
    private InMemoryQueryRunner() {}
            ...
            throws Exception
    {
        ...
        try {
            queryRunner.installPlugin(new InMemoryPlugin());
            queryRunner.createCatalog("inmemory", "inmemory", ImmutableMap.of());
            ...
            throws Exception
    {
        ...
        Thread.sleep(10);
        Logger log = Logger.get(InMemoryQueryRunner.class);
