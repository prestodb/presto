        ...
        extends IcebergDistributedSmokeTestBase
{
    ...
    protected void testCreatePartitionedTableAs(Session session, FileFormat fileFormat)
    {
        ...
        String createTableSql = format("" +
                ...
                getPathBasedOnDataDirectory(getSession().getSchema().get() + "/test_create_partitioned_table_as_" + fileFormat.toString().toLowerCase(ENGLISH)));
    ...
    protected void testCreateTableWithFormatVersion(String formatVersion, String defaultDeleteMode)
    {
        ...
        String createTableSql = format("" +
                ...
                getPathBasedOnDataDirectory(getSession().getSchema().get() + "/test_create_table_with_format_version_" + formatVersion));
