...
public class TestIcebergConfig
{
    ...
    public void testExplicitPropertyMappings()
    {
        Map<String, String> properties = new ImmutableMap.Builder<String, String>()
                ...
                .put("iceberg.hive-statistics-merge-strategy", NUMBER_OF_DISTINCT_VALUES.name() + "," + NUMBER_OF_NON_NULL_VALUES.name())
        ...
        IcebergConfig expected = new IcebergConfig()
                ...
                .setHiveStatisticsMergeFlags("NUMBER_OF_DISTINCT_VALUES,NUMBER_OF_NON_NULL_VALUES")
