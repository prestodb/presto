        ...
        extends AbstractTestQueryFramework
{
            ...
            throws Exception
    {
        ...
        try {
            ...
            catalog.close();
            assertUpdate("DROP VIEW test_show_views_presto");
            assertUpdate("DROP TABLE test_show_views_base");
        }
    }
            ...
            throws Exception
    {
        ...
        try {
            ...
            catalog.close();
            assertUpdate("DROP TABLE test_select_foreign_base");
        }
    }
            ...
            throws Exception
    {
        ...
        try {
            ...
            catalog.close();
            assertUpdate("DROP VIEW test_mixed_presto_view");
            assertUpdate("DROP TABLE test_mixed_base");
        }
    }
            ...
            throws Exception
    {
        ...
        try {
            ...
            catalog.close();
            assertUpdate("DROP TABLE test_spoofed_base");
        }
    }
            ...
            throws Exception
    {
        ...
        try {
            ...
            catalog.close();
            assertUpdate("DROP TABLE test_view_foreign_base");
        }
    }
}
