        ...
        extends AbstractTestQueryFramework
{
    ...
    {
        checkTableProperties(schemaName, tableName, deleteMode, 9, ImmutableMap.of("write.data.path", dataWriteLocation));
    }

    protected void checkTableProperties(String tableName, String deleteMode)
    {
        checkTableProperties("test_schema", tableName, deleteMode, 8, ImmutableMap.of());
    }
