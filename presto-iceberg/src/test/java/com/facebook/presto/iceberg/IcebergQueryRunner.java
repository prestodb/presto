...
public final class IcebergQueryRunner
{
    ...
    public static class Builder
    {
                ...
                throws Exception
        {
            ...
            checkArgument(this.catalogType.name().equals(extraConnectorProperties.getOrDefault("iceberg.catalog.type", this.catalogType.name())),
                    "catalog type must match catalog type in extraConnectorProperties");
            checkArgument(this.format.name().equals(extraConnectorProperties.getOrDefault("iceberg.file-format", this.format.name())),
                    "file format must match iceberg.file-format type in extraConnectorProperties");
