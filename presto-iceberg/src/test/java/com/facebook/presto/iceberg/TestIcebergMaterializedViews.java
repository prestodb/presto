        ...
        extends AbstractTestQueryFramework
{
    ...
    public void testMaterializedViewStaleness()
    {
        ...
        assertUpdate("CREATE MATERIALIZED VIEW test_mv_stale WITH (partitioning = ARRAY['dt']) " +
    ...
    public void testRefreshMaterializedView()
    {
        ...
        assertUpdate("CREATE MATERIALIZED VIEW test_mv_refresh WITH (partitioning = ARRAY['dt']) " +
    ...
    public void testRefreshMaterializedViewWithAggregation()
    {
        ...
        assertUpdate("CREATE MATERIALIZED VIEW test_mv_agg_refresh WITH (partitioning = ARRAY['dt']) AS " +
    ...
    public void testMinimalRefresh()
    {
        ...
        assertUpdate("CREATE MATERIALIZED VIEW minimal_mv WITH (partitioning = ARRAY['dt']) AS SELECT id, dt FROM minimal_table");
    ...
    public void testMultiTableStaleness_ThreeTablesWithTwoStale()
    {
        ...
        assertUpdate("CREATE MATERIALIZED VIEW test_mv_three_tables WITH (partitioning = ARRAY['date1']) AS " +
    ...
    public void testMultiTableStaleness_NonPartitionedAndPartitionedBothStale()
    {
        ...
        assertUpdate("CREATE MATERIALIZED VIEW test_mv_mixed_stale WITH (partitioning = ARRAY['sale_date']) AS " +
    ...
    public void testAggregationMV_MultiTableJoin_BothStale()
    {
        ...
        assertUpdate("CREATE MATERIALIZED VIEW test_multi_agg_mv WITH (partitioning = ARRAY['product_category']) AS " +
    ...
    public void testMultipleAggregatesWithSingleStaleTable()
    {
        ...
        assertUpdate("CREATE MATERIALIZED VIEW test_multi_agg_mv WITH (partitioning = ARRAY['category']) AS " +
                "SELECT category, " +
                "  COUNT(*) as cnt, " +
                "  SUM(value) as total, " +
    ...
    public void testMultipleAggregatesWithMultipleStaleTables()
    {
        ...
        assertUpdate("CREATE MATERIALIZED VIEW test_multi_agg_join_mv WITH (partitioning = ARRAY['category']) AS " +
                "SELECT p.category, " +
    ...
    public void testAggregatesWithNullValues()
    {
        ...
        assertUpdate("CREATE MATERIALIZED VIEW test_agg_nulls_mv WITH (partitioning = ARRAY['category']) AS " +
                "SELECT category, " +
                "  COUNT(*) as total_rows, " +
    ...
    public void testCountDistinctWithStaleTables()
    {
        ...
        assertUpdate("CREATE MATERIALIZED VIEW test_count_distinct_mv WITH (partitioning = ARRAY['category']) AS " +
                "SELECT category, " +
    ...
    public void testWindowFunctionSumPartitionWithSingleStaleTable()
    {
        ...
        assertUpdate("CREATE MATERIALIZED VIEW test_window_stale1_mv WITH (partitioning = ARRAY['category']) AS " +
                "SELECT id, category, value, " +
                "  SUM(value) OVER (PARTITION BY category) as category_total, " +
                "  COUNT(*) OVER (PARTITION BY category) as category_count " +
    ...
    public void testWindowFunctionSumPartitionWithMultipleStaleTables()
    {
        ...
        assertUpdate("CREATE MATERIALIZED VIEW test_window_join_mv WITH (partitioning = ARRAY['category']) AS " +
    ...
    public void testLeftJoinWithLeftTableStale()
    {
        ...
        assertUpdate("CREATE MATERIALIZED VIEW test_left_stale_left_mv WITH (partitioning = ARRAY['hire_date']) AS " +
    ...
    public void testLeftJoinWithRightTableStale()
    {
        ...
        assertUpdate("CREATE MATERIALIZED VIEW test_right_stale_mv WITH (partitioning = ARRAY['hire_date']) AS " +
                "SELECT e.emp_id, e.emp_name, e.dept_id, e.hire_date, d.dept_name, d.location " +
    ...
    public void testLeftJoinWithBothTablesStale()
    {
        ...
        assertUpdate("CREATE MATERIALIZED VIEW test_both_stale_mv WITH (partitioning = ARRAY['hire_date']) AS " +
                "SELECT e.emp_id, e.emp_name, e.dept_id, e.hire_date, d.dept_name, d.location " +
    ...
    public void testLeftJoinWithAggregationAndMultipleStaleTables()
    {
        ...
        assertUpdate("CREATE MATERIALIZED VIEW test_left_agg_mv WITH (partitioning = ARRAY['region']) AS " +
    ...
    public void testLeftJoinWithWhereClauseFilteringNulls()
    {
        ...
        assertUpdate("CREATE MATERIALIZED VIEW test_filter_nulls_mv WITH (partitioning = ARRAY['hire_date']) AS " +
                "SELECT e.emp_id, e.emp_name, e.dept_id, e.hire_date, d.dept_name, d.location " +
    ...
    public void testGroupByHavingWithSingleStaleTable()
    {
        ...
        assertUpdate("CREATE MATERIALIZED VIEW test_having_stale1_mv WITH (partitioning = ARRAY['category']) AS " +
                "SELECT category, SUM(revenue) as total_revenue, COUNT(*) as sale_count " +
    ...
    public void testGroupByHavingWithMultipleStaleTables()
    {
        ...
        assertUpdate("CREATE MATERIALIZED VIEW test_having_join_mv WITH (partitioning = ARRAY['category']) AS " +
    ...
    public void testUnionInMVDefinitionWithSingleStaleTable()
    {
        ...
        // Create MV with UNION
        assertUpdate("CREATE MATERIALIZED VIEW test_union_stale_mv WITH (partitioning = ARRAY['dt']) AS " +
    ...
    public void testUnionInMVDefinitionWithMultipleStaleTables()
    {
        ...
        // Create MV with UNION
        assertUpdate("CREATE MATERIALIZED VIEW test_union_multi_mv WITH (partitioning = ARRAY['dt']) AS " +
    ...
    public void testIntersectInMVDefinition()
    {
        ...
        assertUpdate("CREATE MATERIALIZED VIEW test_intersect_mv WITH (partitioning = ARRAY['dt']) AS " +
    ...
    public void testIntersectInMVDefinitionOneSideStale()
    {
        ...
        // Create MV with INTERSECT - should return only common rows
        assertUpdate("CREATE MATERIALIZED VIEW test_intersect_one_stale_mv WITH (partitioning = ARRAY['dt']) AS " +
    ...
    public void testUnionJoinUnionNesting()
    {
        ...
        assertUpdate("CREATE MATERIALIZED VIEW mv_unju WITH (partitioning = ARRAY['date']) AS " +
    ...
    public void testIntersectJoinIntersectNesting()
    {
        ...
        assertUpdate("CREATE MATERIALIZED VIEW mv_inji WITH (partitioning = ARRAY['date']) AS " +
                "SELECT u1.id, u2.name, u1.date " +
    ...
    public void testUnionJoinUnionTripleNesting()
    {
        ...
        // MV: ((T1 UNION T2) JOIN T3) UNION T4
        assertUpdate("CREATE MATERIALIZED VIEW mv_ujut WITH (partitioning = ARRAY['date']) AS " +
    ...
    public void testNestedJoinsWithUnion()
    {
        ...
        assertUpdate("CREATE MATERIALIZED VIEW mv_njwu WITH (partitioning = ARRAY['date']) AS " +
                "SELECT j.id, j.name, j.date FROM " +
    ...
    public void testAggregationWithUnion()
    {
        ...
        assertUpdate("CREATE MATERIALIZED VIEW mv_awu WITH (partitioning = ARRAY['date']) AS " +
    ...
    public void testJoinExceptJoinWithLeftSideStale()
    {
        ...
        assertUpdate("CREATE MATERIALIZED VIEW mv_jexj WITH (partitioning = ARRAY['dt']) AS " +
    ...
    public void testJoinExceptJoinWithRightSideStale()
    {
        ...
        assertUpdate("CREATE MATERIALIZED VIEW mv_jexjr WITH (partitioning = ARRAY['dt']) AS " +
                "SELECT a.id, b.value, a.dt " +
    ...
    public void testJoinExceptJoinWithBothSidesStale()
    {
        ...
        assertUpdate("CREATE MATERIALIZED VIEW mv_jexjb WITH (partitioning = ARRAY['dt']) AS " +
                "SELECT a.id, b.value, a.dt " +
    ...
    public void testJoinExceptJoinWithSameSideJoinTablesStale()
    {
        ...
        assertUpdate("CREATE MATERIALIZED VIEW mv_jexjs WITH (partitioning = ARRAY['dt']) AS " +
                "SELECT a.id, b.value, a.dt " +
    ...
    public void testJoinIntersectJoinWithLeftSideStale()
    {
        ...
        assertUpdate("CREATE MATERIALIZED VIEW mv_jintl WITH (partitioning = ARRAY['dt']) AS " +
                "SELECT a.id, b.value, a.dt " +
    ...
    public void testJoinIntersectJoinWithRightSideStale()
    {
        ...
        assertUpdate("CREATE MATERIALIZED VIEW mv_jintr WITH (partitioning = ARRAY['dt']) AS " +
                "SELECT a.id, b.value, a.dt " +
    ...
    public void testJoinIntersectJoinWithBothSidesStale()
    {
        ...
        assertUpdate("CREATE MATERIALIZED VIEW mv_jintb WITH (partitioning = ARRAY['dt']) AS " +
                "SELECT a.id, b.value, a.dt " +
    ...
    public void testJoinIntersectJoinWithSameSideJoinTablesStale()
    {
        ...
        assertUpdate("CREATE MATERIALIZED VIEW mv_jints WITH (partitioning = ARRAY['dt']) AS " +
                "SELECT a.id, b.value, a.dt " +
    ...
    private void assertMaterializedViewResultsMatch(String query, boolean assertOrdered)
    {
        ...
        Session withStorageSession = Session.builder(getQueryRunner().getDefaultSession())
                .setSystemProperty("materialized_view_skip_storage", "USE_STITCHING")
                .build();
        ...
        Session skipStorageSession = Session.builder(getQueryRunner().getDefaultSession())
                .setSystemProperty("materialized_view_skip_storage", "USE_VIEW_QUERY")
                .build();
