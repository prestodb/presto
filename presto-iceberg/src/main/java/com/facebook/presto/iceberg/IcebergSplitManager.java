            ...
            SplitSchedulingContext splitSchedulingContext)
    {
        ...
        if (table.getIcebergTableName().getTableType() == INCREMENTAL) {
            ...
            return new IcebergSplitSource(
                    ...
                    icebergTable.snapshot(toSnapshot).sequenceNumber());
        }
            ...
            return new EqualityDeletesSplitSource(session, icebergTable, deleteFiles, icebergTable.snapshot(table.getIcebergTableName().getSnapshotId().get()).sequenceNumber());
        }
        else {
