        ...
        implements ConnectorSplitSource
{
    ...
    private final TupleDomain<IcebergColumnHandle> infoColumnConstraints;
    ...
    public IcebergSplitSource(
            ...
            TupleDomain<IcebergColumnHandle> infoColumnConstraints)
    {
    ...
    public CompletableFuture<ConnectorSplitBatch> getNextBatch(ConnectorPartitionHandle partitionHandle, int maxSize)
    {
        ...
        while (iterator.hasNext()) {
            ...
            if (metadataColumnsMatchPredicates(infoColumnConstraints, icebergSplit.getPath(), icebergSplit.getDataSequenceNumber())) {
