        ...
        implements IcebergMetadataFactory
{
    ...
    {
        return new IcebergNativeMetadata(catalogFactory, typeManager, functionResolution, rowExpressionService, commitTaskCodec, catalogType, nodeVersion, statisticsFileCache);
    }
}
