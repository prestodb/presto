...
public final class IcebergSessionProperties
{
    ...
    public static final String USE_FILE_LIST_CACHE = "use_file_list_cache";
            ...
            NessieConfig nessieConfig)
    {
        sessionProperties = ImmutableList.of(
                ...
                booleanProperty(
                        USE_FILE_LIST_CACHE,
                        "Use file list cache if available when set to true",
                        !icebergConfig.getFileStatusCacheTables().isEmpty(),
                        false));
    }
    ...
    public static boolean isUseFileListCache(ConnectorSession session)
    {
        return session.getProperty(USE_FILE_LIST_CACHE, Boolean.class);
    }
}
