        ...
        implements IcebergFileWriter
{
    ...
    {
        return hdfsEnvironment.doAs(hdfsContext.getIdentity().getUser(), () -> ParquetUtil.fileMetrics(resourceFactory.io().newInputFile(outputPath.toString()), MetricsConfig.getDefault()));
    }
}
