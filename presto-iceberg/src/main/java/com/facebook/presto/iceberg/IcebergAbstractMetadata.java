        ...
        implements ConnectorMetadata
{
    ...
    private boolean hasIdentitySortColumnPresent(SortOrder sortOrder)
    {
        boolean allFieldsAreIdentity = sortOrder.fields().stream()
                .allMatch(sortField -> sortField.transform().isIdentity());

        if (!allFieldsAreIdentity) {
            throw new IllegalArgumentException("Not all sortFields are identity.");
        }

        return allFieldsAreIdentity;
    }
