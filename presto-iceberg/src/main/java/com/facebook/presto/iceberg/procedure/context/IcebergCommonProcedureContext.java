...
public interface IcebergCommonProcedureContext
        extends ConnectorProcedureContext
{
    default Optional<IcebergSplitSource> customizeSplitSource(ConnectorSession session,
                                                             TableScan tableScan,
