...
public final class PartitionFields
{
    ...
    public static PartitionSpec parseIcebergPartitionFields(Schema schema, List<IcebergPartitionField> fields)
    {
    ...
    public static void buildPartitionField(PartitionSpec.Builder builder, IcebergPartitionField field)
    {
        buildPartitionField(builder, field.getName());
    }

    public static void buildPartitionField(PartitionSpec.Builder builder, String field)
    {
    ...
    public static void buildPartitionSpec(PartitionSpec.Builder builder, IcebergPartitionField partitionField)
    {
    ...
    public static List<IcebergPartitionField> toPartitionFields(PartitionSpec spec)
    {
    ...
    private static IcebergPartitionField toPartitionField(PartitionSpec spec, PartitionField field)
    {
