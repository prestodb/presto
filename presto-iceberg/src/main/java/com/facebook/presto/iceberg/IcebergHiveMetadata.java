        ...
        extends IcebergAbstractMetadata
{
    ...
    protected View getIcebergView(ConnectorSession session, SchemaTableName schemaTableName)
    {
        ...
        if (!hiveTable.isPresent()) {
            throw new NoSuchViewException(schemaTableName.toString());
        }

        Table table = hiveTable.get();
        if (isIcebergMaterializedView(table)) {
            return new HiveCatalogIcebergView(table);
        }
            ...
            Map<String, String> properties)
    {
        ...
        // properties already contains PRESTO_MATERIALIZED_VIEW_FORMAT_VERSION and other
        // MV metadata from IcebergAbstractMetadata.createMaterializedView().
        // Here we add Hive metastore-specific properties.
        ImmutableMap.Builder<String, String> tableProperties = ImmutableMap.builder();
        tableProperties.putAll(properties);
        tableProperties.put(PRESTO_MATERIALIZED_VIEW_FLAG, "true");
    ...
    private boolean isIcebergMaterializedView(Table table)
    {
        Map<String, String> params = table.getParameters();
        return params.containsKey(PRESTO_MATERIALIZED_VIEW_FORMAT_VERSION);
    }

    private static class HiveCatalogIcebergView
            implements View
    {
        private final SchemaTableName schemaTableName;
        private final Map<String, String> properties;

        public HiveCatalogIcebergView(Table hiveTable)
        {
            this.schemaTableName = new SchemaTableName(
                    hiveTable.getDatabaseName(),
                    hiveTable.getTableName());
            this.properties = ImmutableMap.copyOf(hiveTable.getParameters());
        }
        ...
        {
            throw new UnsupportedOperationException("schema() not supported for HiveMetastoreView");
        }

        @Override
        public Map<Integer, Schema> schemas()
        {
            throw new UnsupportedOperationException("schemas() not supported for HiveMetastoreView");
        }

        @Override
        public ViewVersion currentVersion()
        {
            throw new UnsupportedOperationException("currentVersion() not supported for HiveMetastoreView");
        }

        @Override
        public Iterable<ViewVersion> versions()
        {
            throw new UnsupportedOperationException("versions() not supported for HiveMetastoreView");
        }

        @Override
        public ViewVersion version(int versionId)
        {
            throw new UnsupportedOperationException("version() not supported for HiveMetastoreView");
        }

        @Override
        public List<ViewHistoryEntry> history()
        {
            throw new UnsupportedOperationException("history() not supported for HiveMetastoreView");
        }

        @Override
        public String location()
        {
            throw new UnsupportedOperationException("location() not supported for HiveMetastoreView");
        }

        @Override
        public SQLViewRepresentation sqlFor(String dialect)
        {
            throw new UnsupportedOperationException("sqlFor() not supported for HiveMetastoreView");
        }

        @Override
        public UpdateViewProperties updateProperties()
        {
            throw new UnsupportedOperationException("updateProperties() not supported for HiveMetastoreView");
        }

        @Override
        public ReplaceViewVersion replaceVersion()
        {
            throw new UnsupportedOperationException("replaceVersion() not supported for HiveMetastoreView");
        }

        @Override
        public UUID uuid()
        {
            throw new UnsupportedOperationException("uuid() not supported for HiveMetastoreView");
        }
    }
}
