...
public class SortParameters
{
    ...
    @Inject
    public SortParameters(IcebergConfig icebergConfig, SortingFileWriterConfig sortingFileWriterConfig, TypeManager typeManager, PageSorter pageSorter, OrcFileWriterFactory orcFileWriterFactory)
    {
