        ...
        extends BaseHiveColumnHandle
{
    ...
    private final Optional<String> initialDefaultValue;
    ...
    public IcebergColumnHandle(
            ...
            @JsonProperty("initialDefaultValue") Optional<String> initialDefaultValue)
    {
    ...
    public IcebergColumnHandle(ColumnIdentity columnIdentity, Type type, Optional<String> comment, ColumnType columnType, Optional<String> initialDefaultValue)
    {
        this(columnIdentity, type, comment, columnType, ImmutableList.of(), initialDefaultValue);
    }
    ...
    public ColumnHandle withRequiredSubfields(List<Subfield> subfields)
    {
        ...
        return new IcebergColumnHandle(columnIdentity, type, getComment(), getColumnType(), subfields, initialDefaultValue);
    }

    @Override
    public int hashCode()
    {
        return Objects.hash(columnIdentity, type, getComment(), getColumnType(), getRequiredSubfields(), initialDefaultValue);
    }
    ...
    public boolean equals(Object obj)
    {
        ...
        return Objects.equals(this.columnIdentity, other.columnIdentity) &&
                ...
                Objects.equals(this.initialDefaultValue, other.initialDefaultValue);
    }
