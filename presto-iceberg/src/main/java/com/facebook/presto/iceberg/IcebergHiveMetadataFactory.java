        ...
        implements IcebergMetadataFactory
{
    ...
    {
        return new IcebergHiveMetadata(metastore, hdfsEnvironment, typeManager, procedureRegistry, functionResolution, rowExpressionService, commitTaskCodec, nodeVersion, filterStatsCalculatorService);
    }
}
