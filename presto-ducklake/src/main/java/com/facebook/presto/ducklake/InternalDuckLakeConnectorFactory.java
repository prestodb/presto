...
public final class InternalDuckLakeConnectorFactory
{
    private InternalDuckLakeConnectorFactory() {}
    ...
    {
        ClassLoader classLoader = InternalDuckLakeConnectorFactory.class.getClassLoader();
        try (ThreadContextClassLoader ignored = new ThreadContextClassLoader(classLoader)) {
            Bootstrap app = new Bootstrap(
                    new EventModule(),
                    new MBeanModule(),
                    new JsonModule(),
                    new DuckLakeCommonModule(catalogName),
                    new DuckLakeCatalogModule(),
            ...
            DuckLakeMetadataFactory metadataFactory = injector.getInstance(DuckLakeMetadataFactory.class);
            ConnectorSplitManager splitManager = injector.getInstance(ConnectorSplitManager.class);
            ConnectorPageSourceProvider pageSourceProvider = injector.getInstance(ConnectorPageSourceProvider.class);
            DuckLakeSessionProperties duckLakeSessionProperties = injector.getInstance(DuckLakeSessionProperties.class);
            ...
            List<PropertyMetadata<?>> allSessionProperties = ImmutableList.<PropertyMetadata<?>>builder()
                    .addAll(duckLakeSessionProperties.getSessionProperties())
                    .addAll(hiveCommonSessionProperties.getSessionProperties())
                    .build();
