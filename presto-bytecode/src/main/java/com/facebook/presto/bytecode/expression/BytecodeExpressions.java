...
public final class BytecodeExpressions
{
    ...
    {
        return newInstance(type(returnType), Streams.stream(parameterTypes).map(ParameterizedType::type).collect(toImmutableList()), ImmutableList.copyOf(requireNonNull(parameters, "parameters is null")));
    }
