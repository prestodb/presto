        ...
        extends DefaultTreeRewriter<FunctionCallRewriter.Context>
{
            ...
            FunctionCall sourceFunctionCall)
    {
        return ExpressionTreeRewriter.rewriteWith(new ExpressionRewriter<Boolean>()
        {
            ...
            @Override
            public Expression rewriteFunctionCall(FunctionCall targetNode, Boolean resolveWindow, ExpressionTreeRewriter<Boolean> treeRewriter)
            {
                ...
                if (resolveWindow && sourceFunctionCall.getWindow().isPresent()) {
                    ...
                    rewrittenWindow = defaultRewrite.getWindow();
                }

                return new FunctionCall(defaultRewrite.getName(), rewrittenWindow, defaultRewrite.getFilter(), defaultRewrite.getOrderBy(), rewrittenDistinct, rewrittenIgnoreNulls, defaultRewrite.getArguments());
            }
        }, expression, true);
    }
