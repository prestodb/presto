...
public class TestPrestoQuerySourceQuerySupplier
{
    ...
    private static final List<SourceQuery> SOURCE_QUERIES = ImmutableList.of(
            new SourceQuery("test", "Q1", "SELECT 1", "SELECT 1", Optional.of("Q1"), Optional.of("T1"), CONTROL_CONFIGURATION, TEST_CONFIGURATION),
            new SourceQuery("test", "Q2", "INSERT INTO test_table SELECT 1", "INSERT INTO test_table SELECT 1", Optional.of("Q2"), Optional.of("T2"), CONTROL_CONFIGURATION,
                    TEST_CONFIGURATION));
