...
public class TestShadowing
{
            ...
            throws Exception
    {
        ...
        Query query = new Query(CATALOG, SCHEMA, ImmutableList.of(), "CREATE TABLE my_test_table AS SELECT 1 column1, 2E0 column2 LIMIT 1", ImmutableList.of(), null, null, ImmutableMap.of());
