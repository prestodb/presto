...
{
    private ConnectorSupplier widgetSupplier;
    private static Map<ConnectorSupplier, AtomicInteger> connectorTestCounts = new HashMap<>();

    protected ConnectorTestFramework(ConnectorSupplier widgetSupplier, int connectorTestCount)
    {
        this.widgetSupplier = requireNonNull(widgetSupplier, "widgetSupplier is null");
