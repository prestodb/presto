        ...
        extends AbstractTestQueryFramework
{
            ...
            throws Exception
    {
        ...
        return ArrowFlightQueryRunner.createQueryRunner(getServerPort(), getNativeWorkerSystemProperties(), coordinatorProperties, getExternalWorkerLauncher(prestoServerPath.toString(), getServerPort(), flightCertPath));
    }
