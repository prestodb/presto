...
import com.facebook.plugin.arrow.testingConnector.QueryArrowTableHandle;
        ...
        implements Provider<ConnectorTableFunction>
{
            ...
            extends AbstractConnectorTableFunction
    {
                ...
                Map<String, Argument> arguments)
        {
            ...
            Descriptor returnedType = new Descriptor(columnHandles.stream()
                    .map(column -> new Descriptor.Field(column.getColumnName(), Optional.of(column.getColumnType()))) // Value: Data type with size //get the type as Type.class
                    .collect(Collectors.toList()));

            Slice query = (Slice) ((ScalarArgument) arguments.get(QUERY)).getValue();

            QueryArrowTableHandle gfsTableHandle = new QueryArrowTableHandle(query.toStringUtf8(), columnHandles);
            QueryFunctionHandle handle = new QueryFunctionHandle(gfsTableHandle);
    ...
    {
        private final QueryArrowTableHandle tableHandle;

        @JsonCreator
        public QueryFunctionHandle(@JsonProperty("tableHandle") QueryArrowTableHandle tableHandle)
        {
            this.tableHandle = requireNonNull(tableHandle, "tableHandle is null");
        }

        @JsonProperty
        public QueryArrowTableHandle getTableHandle()
        {
            return tableHandle;
        }
    }
