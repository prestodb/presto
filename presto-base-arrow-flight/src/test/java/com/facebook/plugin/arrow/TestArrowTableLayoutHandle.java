...
public class TestArrowTableLayoutHandle
{
    ...
    public void testConstructorAndGetters()
    {
        ...
        assertEquals(layoutHandle.getTableHandle(), tableHandle, "Table handle mismatch.");
    ...
    public void testToString()
    {
        ...
        String expectedString = "tableHandle:" + tableHandle + ", columnHandles:" + columnHandles + ", tupleDomain:" + tupleDomain;
    ...
    @Test(expectedExceptions = NullPointerException.class, expectedExceptionsMessageRegExp = "columns are null")
    ...
    @Test(expectedExceptions = NullPointerException.class, expectedExceptionsMessageRegExp = "domain is null")
