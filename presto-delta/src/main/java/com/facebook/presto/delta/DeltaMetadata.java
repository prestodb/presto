        ...
        implements ConnectorMetadata
{
    ...
    private ColumnMetadata getColumnMetadata(ColumnHandle columnHandle)
    {
        ...
        return ColumnMetadata.builder(deltaColumnHandle.getName(), typeManager.getType(deltaColumnHandle.getDataType())).build();
    }
    ...
    {
        return ColumnMetadata.builder(deltaColumn.getName(), typeManager.getType(deltaColumn.getType())).build();
    }
