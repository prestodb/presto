...
public final class DeletionVectors
{
    ...
    public static RoaringBitmapArray readDeletionVectors(FileSystem fileSystem, String location, DeletionVectorEntry deletionVector)
            throws IOException
    {
        switch (deletionVector.getStorageType()) {
            case UUID_MARKER:
                ...
                ByteBuffer uuidBuffer = readDeletionVector(uuidInputFile, deletionVector.getOffset().orElseThrow(), deletionVector.sizeInBytes());
            ...
            case PATH_MARKER:
                ...
                ByteBuffer pathBuffer = readDeletionVector(pathInputFile, deletionVector.getOffset().orElseThrow(), deletionVector.sizeInBytes());
    ...
    private static ByteBuffer readDeletionVector(HadoopInputFile inputFile, int offset, int expectedSize)
            throws IOException
    {
