        ...
        extends AbstractTestQueryFramework
{
    ...
    {
        try {
            debugBuild = parseBoolean(System.getProperty("debugBuild", "false"));
            getLocalPluginDirectory();
        }
        catch (Exception e) {
            ...
            ProcessBuilder builder = new ProcessBuilder("make", debugBuild ? "debug" : "release");
    ...
    private Path getLocalPluginDirectory()
    {
        ...
        return candidates.stream()
                .filter(Files::exists)
                .findFirst()
                .orElseThrow(() -> new IllegalStateException("Could not locate custom tvf functions directory"));
    }
