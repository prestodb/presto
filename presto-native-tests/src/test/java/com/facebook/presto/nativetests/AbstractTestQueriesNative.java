        ...
        extends AbstractTestQueries
{
    ...
    /// These tests are dependent on dynamic function loading support in Presto C++:
    ...
    /// TODO: Lambda test function apply is not supported in Presto C++.
    @Override
    @Test(enabled = false)
    ...
    /// The following approx_set function tests are modified since approx_set returns different results in Presto C++.
    /// See Presto C++ limitations here: https://prestodb.io/docs/current/presto_cpp/limitations.html.
    @Override
    @Test
