...
import static com.facebook.presto.router.scheduler.PlanCheckerRouterPluginPrestoClient.getJavaClusterRedirectRequests;
import static com.facebook.presto.router.scheduler.PlanCheckerRouterPluginPrestoClient.getNativeClusterRedirectRequests;
        ...
        extends AbstractTestQueryFramework
{
            ...
            throws Exception
    {
        ...
        assertEquals(getNativeClusterRedirectRequests().getTotalCount(), queries.size());
    }
            ...
            throws Exception
    {
        ...
        assertEquals(getJavaClusterRedirectRequests().getTotalCount(), queries.size() + getFailingQueriesOnBothClustersProvider().length);
    }
            ...
            throws IOException
    {
        ...
        Files.write(tempPluginSchedulerConfigFile, ImmutableList.of(schedulerName, javaClusterURI, nativeClusterURI));
