...
public class NativeTestsUtils
{
            ...
            throws Exception
    {
        ...
        List<Path> candidates = ImmutableList.of(
                ...
                prestoRoot.resolve("presto-native-execution/_build/debug/presto_cpp/main/dynamic_registry/tests/custom_functions"),
                prestoRoot.resolve("presto-native-execution/_build/release/presto_cpp/main/dynamic_registry/tests/custom_functions"));
