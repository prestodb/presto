...
/**
 * Tests for Iceberg Format Version 3 Geography Type Read Using IcebergImportedTableTestBase to Create Table With Existing Values
 */
public class TestIcebergV3GeographyRead
        extends IcebergImportedTableTestBase
{
    ...
    @Test
    public void nativeReadGeographyType()
    {
