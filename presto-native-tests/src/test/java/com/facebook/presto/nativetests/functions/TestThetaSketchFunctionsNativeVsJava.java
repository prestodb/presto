        ...
        extends AbstractTestFunctions
{
    ...
    {
        MaterializedResult result = nativeQueryRunner.execute(session, "SELECT sketch_theta_estimate(CAST(NULL as VARBINARY))");
    ...
    public void testEstimateEmptySketch()
    {
        ...
        MaterializedResult result = nativeQueryRunner.execute(session, format("SELECT sketch_theta_estimate(CAST(X'%s' as VARBINARY))", sketchBytes));
    ...
    public void testEstimateSingleValue()
    {
        ...
        functionAssertions.assertFunction(
                format("sketch_theta_estimate(CAST(X'%s' as VARBINARY))", sketchBytes),
                DOUBLE,
                result.getOnlyValue());
    }
    ...
    {
        MaterializedResult result = nativeQueryRunner.execute(session, "SELECT sketch_theta_summary(CAST(NULL as VARBINARY))");
        assertTrue(result.getOnlyValue() == null);
    ...
    {
        MaterializedResult result = nativeQueryRunner.execute(session, format("SELECT sketch_theta_summary(CAST(X'%s' as VARBINARY))", sketchBytes));
