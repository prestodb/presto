...
public class LanceTableLayoutHandle
        implements ConnectorTableLayoutHandle
{
    private final LanceTableHandle table;
    private final TupleDomain<ColumnHandle> tupleDomain;

    @JsonCreator
    public LanceTableLayoutHandle(
            @JsonProperty("table") LanceTableHandle table,
    ...
    @JsonProperty
    public LanceTableHandle getTable()
    {
        return table;
    }
    ...
    public boolean equals(Object o)
    {
        ...
        LanceTableLayoutHandle that = (LanceTableLayoutHandle) o;
