...
export default class SqlBaseListener extends antlr4.tree.ParseTreeListener {
	...
	// Enter a parse tree produced by SqlBaseParser#dropBranch.
	enterDropBranch(ctx) {
	}

	// Exit a parse tree produced by SqlBaseParser#dropBranch.
	exitDropBranch(ctx) {
	}


	// Enter a parse tree produced by SqlBaseParser#dropTag.
	enterDropTag(ctx) {
	}

	// Exit a parse tree produced by SqlBaseParser#dropTag.
	exitDropTag(ctx) {
	}
	...
	// Enter a parse tree produced by SqlBaseParser#viewSecurity.
	enterViewSecurity(ctx) {
	}

	// Exit a parse tree produced by SqlBaseParser#viewSecurity.
	exitViewSecurity(ctx) {
	}
