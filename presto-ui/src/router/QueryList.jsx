            ...
            <div className="row">
                ...
                <div className="col-8">
                    ...
                    <div className="row query-row-bottom">
                        <div className="col-12">
                            <pre className="query-snippet"><code className="sql">{stripQueryTextWhitespace(query.query)}</code></pre>
                        </div>
                    </div>
                </div>
            </div>
...
export const QueryList = () => {
    ...
    const renderMaxQueriesListItem = (maxQueries, maxQueriesText) => {
        return (
            <li><a href="#" className={`dropdown-item text-dark ${state.maxQueries === maxQueries ? "active bg-info text-white" : "text-dark"}`} onClick={handleMaxQueriesClick.bind(null, maxQueries)}>{maxQueriesText}</a>
            </li>
        );
    };
    ...
    const renderReorderListItem = (interval, intervalText) => {
        return (
            <li><a href="#" className={`dropdown-item text-dark ${state.reorderInterval === interval ? "active bg-info text-white" : "text-dark"}`} onClick={handleReorderClick.bind(null, interval)}>{intervalText}</a></li>
        );
    };
    ...
    const renderSortListItem = (sortType, sortText) => {
        if (state.currentSortType === sortType) {
            ...
            return (
                <li>
                    <a href="#" className="dropdown-item active bg-info text-white" onClick={handleSortClick.bind(null, sortType)}>
    ...
    const renderErrorTypeListItem = (errorType, errorTypeText) => {
        ...
        return (
            <li>
                <a className="dropdown-item text-dark" href="#" onClick={handleErrorTypeFilterClick.bind(null, errorType)}>
                ...
                <div className="col-12 input-group gap-1 toolbar-col">
                    ...
                    <div className="input-group-prepend">
                        <input type="text" className="form-control search-bar rounded-0" placeholder="User, source, query ID, resource group, or query text"
                            ...
                            onChange={handleSearchStringChange} value={state.searchString} style={{backgroundColor: "white", flex:"0 1 500.586px", width:"500.586px" ,color: 'black', fontSize: '12px', borderColor:"#CCCCCC"}} />
                               </div> 
                        <div className="input-group-prepend">
