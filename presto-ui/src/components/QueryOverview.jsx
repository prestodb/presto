                                ...
                                <table className="stage-table stage-table-memory">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td className="stage-table-stat-text">
                                                {prestoStage.latestAttemptExecutionInfo.stats.userMemoryReservationInBytes}
                                            </td>
                                        </tr>
                                        <tr>
                                            <td className="stage-table-stat-title">
                                        ...
                                        <tr>
                                            ...
                                            <td className="stage-table-stat-text">
                                                {prestoStage.latestAttemptExecutionInfo.stats.peakUserMemoryReservationInBytes}
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
                            ...
                            <table className="table">
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td className="info-text">
                                            {data.queryStats.processedInputDataSizeInBytes}
                                        </td>
                                    </tr>
                                    <tr>
                                        <td className="info-title">
                                    ...
                                    <tr>
                                        ...
                                        <td className="info-text">
                                            {data.queryStats.rawInputDataSizeInBytes}
                                        </td>
                                    </tr>
                                    <tr>
                                        <td className="info-title">
                                    ...
                                    <tr>
                                        ...
                                        <td className="info-text">
                                            {data.queryStats.shuffledDataSizeInBytes}
                                        </td>
                                    </tr>
                                    <tr>
                                        <td className="info-title">
                                        ...
                                        <td className="info-text">
                                            {data.queryStats.peakUserMemoryReservationInBytes}
                                        </td>
                                    </tr>
                                    <tr>
                                        <td className="info-title">
                                        ...
                                        <td className="info-text">
                                            {data.queryStats.peakTotalMemoryReservationInBytes}
                                        </td>
                                    </tr>
                                    <tr>
                                        <td className="info-title">
                                    ...
                                    <tr>
                                        ...
                                        <td className="info-text">
                                            {data.queryStats.writtenOutputLogicalDataSizeInBytes}
                                        </td>
                                    </tr>
                                    <tr>
                                        <td className="info-title">
                                        ...
                                        <td className="info-text">
                                            {data.queryStats.writtenOutputPhysicalDataSizeInBytes}
                                        </td>
                                    </tr>
                                    {(data.queryStats.spilledDataSizeInBytes || 0) > 0 &&
                                        <tr>
                                            ...
                                            <td className="info-text">
                                                {data.queryStats.spilledDataSizeInBytes}
                                            </td>
                                        </tr>
                                    }
                                </tbody>
