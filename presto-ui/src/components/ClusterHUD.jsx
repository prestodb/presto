...
export class ClusterHUD extends React.Component {
    ...
    $.get(
      ...
      function (clusterState) {
        ...
        if (this.state.lastRefresh !== null) {
          const rowsInputSinceRefresh =
            clusterState.totalInputRows - this.state.lastInputRows;
          const bytesInputSinceRefresh =
            clusterState.totalInputBytes - this.state.lastInputBytes;
          const cpuTimeSinceRefresh =
            clusterState.totalCpuTimeSecs - this.state.lastCpuTime;
          const secsSinceRefresh =
            (Date.now() - this.state.lastRefresh) / 1000.0;
        ...
        this.setState({
          // instantaneous stats
          runningQueries: addToHistory(
            clusterState.runningQueries,
            this.state.runningQueries,
          ),
          queuedQueries: addToHistory(
            clusterState.queuedQueries,
            this.state.queuedQueries,
          ),
          blockedQueries: addToHistory(
            clusterState.blockedQueries,
            this.state.blockedQueries,
          ),
          activeWorkers: addToHistory(
            clusterState.activeWorkers,
  ...
  componentDidUpdate() {
    ...
    if (
      this.state.lastRender === null ||
      Date.now() - this.state.lastRender >= 1000
    ) {
          ...
          <div className="row stat-line-end">
            <div className="col-4">
              <div className="stat stat-large">
                <span className="stat-text">
                  {
                    this.state.runningQueries[
                      this.state.runningQueries.length - 1
                    ]
                  }
                </span>
            ...
            <div className="col-4">
              <div className="stat stat-large">
                <span className="stat-text">
                  {
                    this.state.activeWorkers[
                      this.state.activeWorkers.length - 1
                    ]
                  }
                </span>
            ...
            <div className="col-4">
              <div className="stat stat-large">
                <span className="stat-text">
                  {formatCount(
                    this.state.rowInputRate[this.state.rowInputRate.length - 1],
                  )}
                </span>
            ...
            <div className="col-4">
              <div className="stat stat-large">
                <span className="stat-text">
                  {
                    this.state.queuedQueries[
                      this.state.queuedQueries.length - 1
                    ]
                  }
                </span>
            ...
            <div className="col-4">
              <div className="stat stat-large">
                <span className="stat-text">
                  {formatCount(
                    this.state.runningDrivers[
                      this.state.runningDrivers.length - 1
                    ],
                  )}
                </span>
            ...
            <div className="col-4">
              <div className="stat stat-large">
                <span className="stat-text">
                  {formatDataSizeBytes(
                    this.state.byteInputRate[
                      this.state.byteInputRate.length - 1
                    ],
                  )}
                </span>
            ...
            <div className="col-4">
              <div className="stat stat-large">
                <span className="stat-text">
                  {
                    this.state.blockedQueries[
                      this.state.blockedQueries.length - 1
                    ]
                  }
                </span>
            ...
            <div className="col-4">
              <div className="stat stat-large">
                <span className="stat-text">
                  {formatDataSizeBytes(
                    this.state.reservedMemory[
                      this.state.reservedMemory.length - 1
                    ],
                  )}
                </span>
            ...
            <div className="col-4">
              <div className="stat stat-large">
                <span className="stat-text">
                  {formatCount(
                    this.state.perWorkerCpuTimeRate[
                      this.state.perWorkerCpuTimeRate.length - 1
                    ],
                  )}
                </span>
