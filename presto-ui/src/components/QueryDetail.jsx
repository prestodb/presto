                            ...
                            <div className="col-6">
                                ...
                                <table className="table">
                                    ...
                                    <tr>
                                        ...
                                        <td className="info-text">
                                            {formatDataSizeBytes(query.queryStats.processedInputDataSizeInBytes) + " Bytes"}
                                        </td>
                                    </tr>
                                    <tr>
                                        <td className="info-title">
                                    ...
                                    <tr>
                                        ...
                                        <td className="info-text">
                                            {formatDataSizeBytes(query.queryStats.rawInputDataSizeInBytes) + " Bytes"}
                                        </td>
                                    </tr>
                                    <tr>
                                        <td className="info-title">
                                    ...
                                    <tr>
                                        ...
                                        <td className="info-text">
                                            {formatDataSizeBytes(query.queryStats.shuffledDataSizeInBytes) + " Bytes"}
                                        </td>
                                    </tr>
                                    <tr>
                                        <td className="info-title">
                                        ...
                                        <td className="info-text">
                                            {formatDataSizeBytes(query.queryStats.peakUserMemoryReservationInBytes) + " Bytes"}
                                        </td>
                                    </tr>
                                    <tr>
                                        <td className="info-title">
                                        ...
                                        <td className="info-text">
                                            {formatDataSizeBytes(query.queryStats.peakTotalMemoryReservationInBytes) + " Bytes"}
                                        </td>
                                    </tr>
                                    <tr>
                                        <td className="info-title">
                                    ...
                                    <tr>
                                        ...
                                        <td className="info-text">
                                            {formatDataSizeBytes(query.queryStats.cumulativeUserMemory / 1000.0) + " Bytes"}
                                        </td>
                                    </tr>
                                    <tr>
                                        <td className="info-title">
                                        ...
                                        <td className="info-text">
                                            {formatDataSizeBytes(query.queryStats.cumulativeTotalMemory / 1000.0) + " Bytes"}
                                        </td>
                                    </tr>
                                    <tr>
                                        <td className="info-title">
                                    ...
                                    <tr>
                                        ...
                                        <td className="info-text">
                                            {formatDataSizeBytes(query.queryStats.outputDataSizeInBytes) + " Bytes"}
                                        </td>
                                    </tr>
                                    <tr>
                                        <td className="info-title">
                                    ...
                                    <tr>
                                        ...
                                        <td className="info-text">
                                            {formatDataSizeBytes(query.queryStats.writtenOutputLogicalDataSizeInBytes) + " Bytes"}
                                        </td>
                                    </tr>
                                    <tr>
                                        <td className="info-title">
                                        ...
                                        <td className="info-text">
                                            {formatDataSizeBytes(query.queryStats.writtenOutputPhysicalDataSizeInBytes) + " Bytes"}
                                        </td>
                                    </tr>
                                    {query.queryStats.spilledDataSizeInBytes > 0 &&
                                        <tr>
                                            ...
                                            <td className="info-text">
                                                {formatDataSizeBytes(query.queryStats.spilledDataSizeInBytes) + " Bytes"}
                                            </td>
                                        </tr>
                                    }
                                    </tbody>
