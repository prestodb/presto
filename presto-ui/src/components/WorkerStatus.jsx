...
export class WorkerStatus extends React.Component {
  ...
  refreshLoop() {
    ...
    $.get(
      WorkerStatus.getStatusQuery(getFirstParameter(window.location.search)),
      function (serverInfo) {
        this.setState({
          ...
          processCpuLoad: addToHistory(
            serverInfo.processCpuLoad * 100.0,
            this.state.processCpuLoad,
          ),
          systemCpuLoad: addToHistory(
            serverInfo.systemCpuLoad * 100.0,
            this.state.systemCpuLoad,
          ),
          heapPercentUsed: addToHistory(
            (serverInfo.heapUsed * 100.0) / serverInfo.heapAvailable,
            this.state.heapPercentUsed,
          ),
          nonHeapUsed: addToHistory(
            serverInfo.nonHeapUsed,
            this.state.nonHeapUsed,
          ),
        });
  ...
  static renderPoolBar(name, pool) {
    ...
    const percentageReservedNonRevocable =
      reserved - revocable === 0
        ? 0
        : Math.max(Math.round(((reserved - revocable) * 100.0) / size), 15);
    const percentageRevocable =
      revocable === 0
        ? 0
        : Math.max(Math.round((revocable * 100.0) / size), 15);
      ...
      if (this.state.initialized === false) {
        ...
        return (
          <div className="row error-message">
            <div className="col-12">
              <h4 style={{ fontSize: "18px", color: "#999999" }}>
                      ...
                      <tbody>
                        ...
                        <tr className="tr-noborder">
                          <td className="info-sparkline-text">
                            {formatCount(
                              this.state.processCpuLoad[
                                this.state.processCpuLoad.length - 1
                              ],
                            )}
                            %
                          </td>
                        ...
                        <tr className="tr-noborder">
                          <td className="info-sparkline-text">
                            {formatCount(
                              this.state.systemCpuLoad[
                                this.state.systemCpuLoad.length - 1
                              ],
                            )}
                            %
                          </td>
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td rowSpan="2">
                            <div className="query-stats-sparkline-container">
                              <span
                                className="sparkline"
                                id="heap-percent-used-sparkline"
                              >
                                <div className="loader">Loading ...</div>
                              </span>
                            </div>
                        ...
                        <tr className="tr-noborder">
                          <td className="info-sparkline-text">
                            {formatCount(
                              this.state.heapPercentUsed[
                                this.state.heapPercentUsed.length - 1
                              ],
                            )}
                            %
                          </td>
                        ...
                        <tr className="tr-noborder">
                          <td className="info-sparkline-text">
                            {formatDataSize(
                              this.state.nonHeapUsed[
                                this.state.nonHeapUsed.length - 1
                              ],
                            )}
                          </td>
                        </tr>
          ...
          <div className="col-12">
            ...
            <div className="row">
              ...
              <div className="col-6 general-revered-title">
                {WorkerStatus.renderPoolBar(
                  "Reserved",
                  serverInfo.memoryInfo.pools.reserved,
                )}
