        ...
        implements Plugin
{
    ...
    {
        return ImmutableList.of(new MySqlFunctionNamespaceManagerFactory(), new JsonFileBasedFunctionNamespaceManagerFactory(), new NativeFunctionNamespaceManagerFactory());
    }
}
