...
public class FileBasedJsonInMemoryFunctionNameSpaceManagerFactory
        implements FunctionNamespaceManagerFactory
{
    public static final String NAME = "filejson";
    ...
    public FunctionNamespaceManager<?> create(String catalogName, Map<String, String> config, FunctionNamespaceManagerContext context)
    {
        try {
            Bootstrap app = new Bootstrap(
                    new FileBasedJsonInMemoryFunctionNameSpaceManagerModule(catalogName),
            ...
            Injector injector = app
                    ...
                    .initialize();
            return injector.getInstance(FileBasedJsonInMemoryFunctionNameSpaceManager.class);
        }
        catch (Exception e) {
            throwIfUnchecked(e);
