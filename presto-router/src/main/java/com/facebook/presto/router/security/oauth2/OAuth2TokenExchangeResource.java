 ...
 */
package com.facebook.presto.router.security.oauth2;
...
public class OAuth2TokenExchangeResource
{
    ...
    @Inject
    public OAuth2TokenExchangeResource(OAuth2TokenExchange tokenExchange,
                                        OAuth2Service service,
                                        @ForOAuth2 ExecutorService executorService)
    {
        this.tokenExchange = requireNonNull(tokenExchange, "tokenExchange is null");
        this.service = requireNonNull(service, "service is null");
        this.executorService = requireNonNull(executorService, "executorService is null");
        this.responseExecutor = MoreExecutors.listeningDecorator(executorService);
    }
