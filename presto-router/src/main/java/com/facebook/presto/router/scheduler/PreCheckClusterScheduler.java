        ...
        implements Scheduler
{
    ...
    @Inject
    public PreCheckClusterScheduler(Optional<List<URI>> validatorUris)
    {
    ...
    {
        SimplePrestoClient simplePrestoClient = new SimplePrestoClient(getValidatorDestination(requestInfo.getUser()));
        return simplePrestoClient.executeQuery(requestInfo.getServletRequest(), statement);
    }
