 ...
 */
public class RawRedisFieldDecoder
        implements RedisFieldDecoder<byte[]>
{
    ...
    {
        return RawRedisRowDecoder.NAME;
    }
    ...
    @Override
    public RedisFieldValueProvider decode(byte[] value, RedisColumnHandle columnHandle)
    {
        ...
        return new RawRedisValueProvider(ByteBuffer.wrap(value, start, end - start), columnHandle, fieldType);
    }
    ...
    public static class RawRedisValueProvider
            extends RedisFieldValueProvider
    {
        protected final ByteBuffer value;
        protected final RedisColumnHandle columnHandle;
        protected final FieldType fieldType;
        protected final int size;

        public RawRedisValueProvider(ByteBuffer value, RedisColumnHandle columnHandle, FieldType fieldType)
        {
        ...
        @Override
        public final boolean accept(RedisColumnHandle columnHandle)
        {
        ...
        public boolean getBoolean()
        {
            ...
            switch (fieldType) {
                ...
                default:
                    throw new PrestoException(RedisErrorCode.REDIS_CONVERSION_NOT_SUPPORTED, format("conversion %s to boolean not supported", fieldType));
            }
        }
        ...
        public long getLong()
        {
            ...
            switch (fieldType) {
                ...
                default:
                    throw new PrestoException(RedisErrorCode.REDIS_CONVERSION_NOT_SUPPORTED, format("conversion %s to long not supported", fieldType));
            }
        }
        ...
        public double getDouble()
        {
            ...
            switch (fieldType) {
                ...
                default:
                    throw new PrestoException(RedisErrorCode.REDIS_CONVERSION_NOT_SUPPORTED, format("conversion %s to double not supported", fieldType));
            }
        }
        ...
        public Slice getSlice()
        {
            ...
            throw new PrestoException(RedisErrorCode.REDIS_CONVERSION_NOT_SUPPORTED, format("conversion %s to Slice not supported", fieldType));
        }
    }
}
