...
/**
 * Default field decoder for the CSV format. Very simple string based conversion of field values.
 */
public class CsvRedisFieldDecoder
        implements RedisFieldDecoder<String>
{
    ...
    {
        return CsvRedisRowDecoder.NAME;
    }
