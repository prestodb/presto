 ...
 */
public class JsonRedisFieldDecoder
        implements RedisFieldDecoder<JsonNode>
{
    @Override
    ...
    {
        return JsonRedisRowDecoder.NAME;
    }
    ...
    public RedisFieldValueProvider decode(JsonNode value, RedisColumnHandle columnHandle)
    {
        ...
        return new JsonRedisValueProvider(value, columnHandle);
    }
    ...
    public static class JsonRedisValueProvider
            extends RedisFieldValueProvider
    {
        protected final JsonNode value;
        protected final RedisColumnHandle columnHandle;

        public JsonRedisValueProvider(JsonNode value, RedisColumnHandle columnHandle)
        {
            this.value = value;
