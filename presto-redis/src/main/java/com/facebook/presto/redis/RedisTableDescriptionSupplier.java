        ...
        implements Supplier<Map<SchemaTableName, RedisTableDescription>>
{
    ...
    @Inject
    RedisTableDescriptionSupplier(RedisConnectorConfig redisConnectorConfig,
                                  JsonCodec<RedisTableDescription> tableDescriptionCodec)
    {
        this.redisConnectorConfig = checkNotNull(redisConnectorConfig, "redisConnectorConfig is null");
        this.tableDescriptionCodec = checkNotNull(tableDescriptionCodec, "tableDescriptionCodec is null");
    }
