        ...
        implements ConnectorSplit
{
            ...
            @JsonProperty("nodes") List<HostAddress> nodes)
    {
        ...
        this.tableName = checkNotNull(tableName, "dataFormat is null");
        this.keyDataFormat = checkNotNull(keyDataFormat, "KeydataFormat is null");
        this.valueDataFormat = checkNotNull(valueDataFormat, "valueDataFormat is null");
        this.keyName = keyName;
        this.nodes = ImmutableList.copyOf(checkNotNull(nodes, "addresses is null"));
        this.start = start;
        this.end = end;
        this.valueDataType = setRedisDataType(valueDataFormat);
        this.keyDataType = setRedisDataType(keyDataFormat);
    }
    ...
    public RedisDataType setRedisDataType(String dataFormat)
    {
        switch (dataFormat) {
            case "hash": return RedisDataType.HASH;
            case "zset": return RedisDataType.ZSET;
            default: return RedisDataType.STRING;
        }
    }
