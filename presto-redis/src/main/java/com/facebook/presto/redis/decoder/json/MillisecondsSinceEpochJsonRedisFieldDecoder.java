 ...
 */
public class MillisecondsSinceEpochJsonRedisFieldDecoder
        extends JsonRedisFieldDecoder
{
    ...
    public RedisFieldValueProvider decode(JsonNode value, RedisColumnHandle columnHandle)
    {
        ...
        return new MillisecondsSinceEpochJsonRedisValueProvider(value, columnHandle);
    }

    public static class MillisecondsSinceEpochJsonRedisValueProvider
            extends JsonRedisValueProvider
    {
        public MillisecondsSinceEpochJsonRedisValueProvider(JsonNode value, RedisColumnHandle columnHandle)
        {
