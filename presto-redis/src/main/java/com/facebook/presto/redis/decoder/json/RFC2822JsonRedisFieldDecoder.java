 ...
 */
public class RFC2822JsonRedisFieldDecoder
        extends JsonRedisFieldDecoder
{
    ...
    public RedisFieldValueProvider decode(JsonNode value, RedisColumnHandle columnHandle)
    {
        ...
        return new RFC2822JsonRedisValueProvider(value, columnHandle);
    }

    public static class RFC2822JsonRedisValueProvider
            extends JsonRedisValueProvider
    {
        public RFC2822JsonRedisValueProvider(JsonNode value, RedisColumnHandle columnHandle)
        {
