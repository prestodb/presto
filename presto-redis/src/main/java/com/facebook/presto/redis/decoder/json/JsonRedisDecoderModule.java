...
import static com.facebook.presto.redis.decoder.RedisDecoderModule.bindFieldDecoder;
import static com.facebook.presto.redis.decoder.RedisDecoderModule.bindRowDecoder;

/**
 * Guice module for the Json decoder module.
 * <p/>
 ...
 * </ul>
 */
public class JsonRedisDecoderModule
        implements Module
{
    @Override
    public void configure(Binder binder)
    {
        bindRowDecoder(binder, JsonRedisRowDecoder.class);

        bindFieldDecoder(binder, JsonRedisFieldDecoder.class);
        bindFieldDecoder(binder, ISO8601JsonRedisFieldDecoder.class);
        bindFieldDecoder(binder, RFC2822JsonRedisFieldDecoder.class);
        bindFieldDecoder(binder, SecondsSinceEpochJsonRedisFieldDecoder.class);
        bindFieldDecoder(binder, MillisecondsSinceEpochJsonRedisFieldDecoder.class);
        bindFieldDecoder(binder, CustomDateTimeJsonRedisFieldDecoder.class);
    }
}
