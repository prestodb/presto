...
import static com.facebook.presto.redis.decoder.json.RFC2822JsonRedisFieldDecoder.FORMATTER;
//import static com.facebook.presto.redis.decoder.util.DecoderTestUtil.checkValue;
import static java.lang.String.format;
import static org.testng.Assert.assertEquals;
import static org.testng.Assert.assertFalse;

public class TestRFC2822JsonRedisFieldDecoder
{
    private static final Map<String, JsonRedisFieldDecoder> DECODERS = ImmutableMap.of(DEFAULT_FIELD_DECODER_NAME, new JsonRedisFieldDecoder(),
            RFC2822JsonRedisFieldDecoder.NAME, new RFC2822JsonRedisFieldDecoder());

    private static final ObjectMapperProvider PROVIDER = new ObjectMapperProvider();

    private static Map<RedisColumnHandle, RedisFieldDecoder<?>> map(List<RedisColumnHandle> columns)
    {
            ...
            throws Exception
    {
        ...
        RedisColumnHandle row3 = new RedisColumnHandle("", 2, "row3", BigintType.BIGINT, "a_number", RFC2822JsonRedisFieldDecoder.NAME, null, false, false, false);
        RedisColumnHandle row4 = new RedisColumnHandle("", 3, "row4", BigintType.BIGINT, "a_string", RFC2822JsonRedisFieldDecoder.NAME, null, false, false, false);

        RedisColumnHandle row5 = new RedisColumnHandle("", 4, "row5", VarcharType.VARCHAR, "a_number", RFC2822JsonRedisFieldDecoder.NAME, null, false, false, false);
        RedisColumnHandle row6 = new RedisColumnHandle("", 5, "row6", VarcharType.VARCHAR, "a_string", RFC2822JsonRedisFieldDecoder.NAME, null, false, false, false);
