...
public class TestMillisecondsSinceEpochJsonRedisFieldDecoder
{
    private static final Map<String, JsonRedisFieldDecoder> DECODERS = ImmutableMap.of(DEFAULT_FIELD_DECODER_NAME, new JsonRedisFieldDecoder(),
            MillisecondsSinceEpochJsonRedisFieldDecoder.NAME, new MillisecondsSinceEpochJsonRedisFieldDecoder());
            ...
            throws Exception
    {
        ...
        String nowString = MillisecondsSinceEpochJsonRedisFieldDecoder.FORMATTER.print(now);
        ...
        RedisColumnHandle row3 = new RedisColumnHandle("", 2, "row3", BigintType.BIGINT, "a_number", MillisecondsSinceEpochJsonRedisFieldDecoder.NAME, null, false, false, false);
        RedisColumnHandle row4 = new RedisColumnHandle("", 3, "row4", BigintType.BIGINT, "a_string", MillisecondsSinceEpochJsonRedisFieldDecoder.NAME, null, false, false, false);

        RedisColumnHandle row5 = new RedisColumnHandle("", 4, "row5", VarcharType.VARCHAR, "a_number", MillisecondsSinceEpochJsonRedisFieldDecoder.NAME, null, false, false, false);
        RedisColumnHandle row6 = new RedisColumnHandle("", 5, "row6", VarcharType.VARCHAR, "a_string", MillisecondsSinceEpochJsonRedisFieldDecoder.NAME, null, false, false, false);
