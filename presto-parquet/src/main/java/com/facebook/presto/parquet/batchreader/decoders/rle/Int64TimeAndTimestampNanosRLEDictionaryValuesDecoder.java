...
import com.facebook.presto.parquet.batchreader.decoders.ValuesDecoder.PackFunction;
...
public class Int64TimeAndTimestampNanosRLEDictionaryValuesDecoder
        extends BaseRLEBitPackedDecoder
        implements Int64TimeAndTimestampMicrosValuesDecoder
{
    private static final int INSTANCE_SIZE = ClassLayout.parseClass(Int64TimeAndTimestampNanosRLEDictionaryValuesDecoder.class).instanceSize();

    private final LongDictionary dictionary;

    private final PackFunction packFunction;

    public Int64TimeAndTimestampNanosRLEDictionaryValuesDecoder(int bitWidth, InputStream inputStream, LongDictionary dictionary, boolean withTimezone)
    {
    ...
    public Int64TimeAndTimestampNanosRLEDictionaryValuesDecoder(int bitWidth, InputStream inputStream, LongDictionary dictionary)
    {
        ...
        while (remainingToCopy > 0) {
            ...
            switch (mode) {
                case RLE: {
                    ...
                    final long rleDictionaryValue = NANOSECONDS.toMillis(dictionary.decodeToLong(rleValue));
                ...
                case PACKED: {
                    ...
                    for (int srcIndex = currentBuffer.length - currentCount; destinationIndex < endIndex; srcIndex++) {
                        ...
                        long millisValue = NANOSECONDS.toMillis(dictionaryValue);
