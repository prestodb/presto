...
public final class PredicateUtils
{
    ...
    public static boolean predicateMatches(Predicate parquetPredicate, BlockMetaData block, ParquetDataSource dataSource, Map<List<String>, RichColumnDescriptor> descriptorsByPath, TupleDomain<ColumnDescriptor> parquetTupleDomain, ColumnIndexStore columnIndexStore, boolean readColumnIndex)
            throws ParquetCorruptionException
    {
        ...
        if (columnIndexStore != null && readColumnIndex && !parquetPredicate.matches(block.getRowCount(), columnIndexStore)) {
            return false;
        }
