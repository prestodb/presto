...
public class TestParquetCompressionUtils
{
            ...
            throws IOException
    {
        ...
        performTest(CompressionCodecName.ZSTD, 2048);
    }
            ...
            throws IOException
    {
        ...
        performTest(CompressionCodecName.LZ4, 2048);
    }
            ...
            throws IOException
    {
        ...
        if (codec.equals(CompressionCodecName.ZSTD)) {
            compressor = new ZstdCompressor();
        }
        else if (codec.equals(CompressionCodecName.LZ4)) {
