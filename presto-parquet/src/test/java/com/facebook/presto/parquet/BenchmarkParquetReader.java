...
public class BenchmarkParquetReader
{
    ...
    private abstract static class BenchmarkData
    {
                ...
                throws IOException
        {
            ...
            ParquetMetadata parquetMetadata = MetadataReader.readFooter(dataSource, file.length(), null, null).getParquetMetadata();
            ...
            return new ParquetReader(messageColumnIO, parquetMetadata.getBlocks(), dataSource, newSimpleAggregatedMemoryContext(), new DataSize(16, MEGABYTE), enableOptimizedReader, enableVerification, null);
        }
