...
public class TestParquetWriter
{
    ...
    public void testWriteAllNullDataPageAfterRowGroupFlush()
    {
        ...
        try (ParquetWriter parquetWriter = createParquetWriter(parquetFile, types, names, parquetWriterOptions, CompressionCodecName.UNCOMPRESSED)) {
            ...
            ParquetReader parquetReader = new ParquetReader(messageColumnIO, parquetMetadata.getBlocks(), Optional.empty(), dataSource, newSimpleAggregatedMemoryContext(), new DataSize(16, MEGABYTE), false, false, null, null, false, Optional.empty(), DateTimeZone.forID("America/Bahia_Banderas"));
