    ...
    public static final class CustomFunctions
    {
        ...
        public static long customAdd(
                @ScalarPropagateSourceStats(
                        ...
                        nullFraction = ScalarFunctionStatsPropagationBehavior.SUM_ARGUMENTS,
                        distinctValuesCount = ScalarFunctionStatsPropagationBehavior.USE_MAX_ARGUMENT,
                        minValue = ScalarFunctionStatsPropagationBehavior.SUM_ARGUMENTS,
                        maxValue = ScalarFunctionStatsPropagationBehavior.SUM_ARGUMENTS) @SqlType(StandardTypes.BIGINT) long x,
        ...
        public static long customStrLength(
                @ScalarPropagateSourceStats(
                        propagateAllStats = false,
                        nullFraction = ScalarFunctionStatsPropagationBehavior.USE_SOURCE_STATS,
                        distinctValuesCount = ScalarFunctionStatsPropagationBehavior.USE_TYPE_WIDTH_VARCHAR,
                        maxValue = ScalarFunctionStatsPropagationBehavior.USE_TYPE_WIDTH_VARCHAR) @SqlType("varchar(x)") Slice value)
        {
            return value.length();
        }
        ...
        public static long customStrEditDistance(
                @ScalarPropagateSourceStats(
                        propagateAllStats = false,
                        nullFraction = ScalarFunctionStatsPropagationBehavior.USE_MAX_ARGUMENT,
                        distinctValuesCount = ScalarFunctionStatsPropagationBehavior.MAX_TYPE_WIDTH_VARCHAR,
                        maxValue = ScalarFunctionStatsPropagationBehavior.MAX_TYPE_WIDTH_VARCHAR) @SqlType("varchar(x)") Slice str1,
        ...
        public static long customPrng(
                ...
                @ScalarPropagateSourceStats(
                        propagateAllStats = false,
                        distinctValuesCount = ScalarFunctionStatsPropagationBehavior.ROW_COUNT,
                        minValue = ScalarFunctionStatsPropagationBehavior.USE_SOURCE_STATS) @SqlType(StandardTypes.BIGINT) Long min,
                @ScalarPropagateSourceStats(
                        propagateAllStats = false,
                        maxValue = ScalarFunctionStatsPropagationBehavior.USE_SOURCE_STATS
