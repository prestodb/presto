        ...
        extends BaseStatsCalculatorTest
{
    ...
    public void testFilterPositiveNarrowingProjectSemiJoin(boolean toRowExpression)
    {
        tester().assertStatsFor(pb -> {
            ...
            if (toRowExpression) {
                return pb.filter(
                        TRANSLATOR.translateAndOptimize(expression("sjo"), SemanticTypeProvider.copyOf(pb.getTypes())),
    ...
    private StatsCalculatorAssertion getStatsCalculatorAssertion(Expression expression, boolean toRowExpression)
    {
        return tester().assertStatsFor(pb -> {
            ...
            if (toRowExpression) {
                return pb.filter(TRANSLATOR.translateAndOptimize(expression, SemanticTypeProvider.copyOf(pb.getTypes())), semiJoinNode);
            }
