...
public class TestStatsNormalizer
{
    ...
    public void testDropNonOutputSymbols()
    {
        ...
        PlanNodeStatsAssertion.assertThat(normalizer.normalize(estimate, ImmutableList.of(b, c), new TypeProvider(ImmutableMap.of(b, BIGINT, c, BIGINT))))
    ...
    private void testCapDistinctValuesByToDomainRangeLength(Type type, double ndv, Object low, Object high, double expectedNormalizedNdv)
    {
        ...
        assertNormalized(estimate, new TypeProvider(ImmutableMap.of(symbol, type)))
    ...
    {
        TypeProvider types = new TypeProvider(estimate.getSymbolsWithKnownStatistics().stream()
