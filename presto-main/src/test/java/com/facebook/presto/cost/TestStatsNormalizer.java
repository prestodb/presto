...
public class TestStatsNormalizer
{
    ...
    @Test
    public void testCapToDomainRangeLength()
    {
        testCapToDomainRangeLength(INTEGER, 15, 1, 5, 5);
        testCapToDomainRangeLength(INTEGER, 2_0000_000_000., 1, 1_000_000_000, 1_000_000_000);
        testCapToDomainRangeLength(INTEGER, 3, 1, 5, 3);
        testCapToDomainRangeLength(INTEGER, NaN, 1, 5, NaN);

        testCapToDomainRangeLength(BIGINT, 15, 1, 5, 5);
        testCapToDomainRangeLength(SMALLINT, 15, 1, 5, 5);
        testCapToDomainRangeLength(TINYINT, 15, 1, 5, 5);

        testCapToDomainRangeLength(createDecimalType(10, 2), 11, 1, 1, 1);
        testCapToDomainRangeLength(createDecimalType(10, 2), 13, 101, 103, 3);
        testCapToDomainRangeLength(createDecimalType(10, 2), 10, 100, 200, 10);

        testCapToDomainRangeLength(DOUBLE, 42, 10.1, 10.2, 42);
        testCapToDomainRangeLength(DOUBLE, 42, 10.1, 10.1, 1);

        testCapToDomainRangeLength(BOOLEAN, 11, true, true, 1);
        testCapToDomainRangeLength(BOOLEAN, 12, false, true, 2);

        testCapToDomainRangeLength(
                DATE,
                12,
    ...
    private void testCapToDomainRangeLength(Type type, double ndv, Object low, Object high, double expectedNormalizedNdv)
    {
