...
public class TestComparisonStatsCalculator
{
            ...
            throws Exception
    {
        ...
        standardInputStatistics = PlanNodeStatsEstimate.builder()
                ...
                .addVariableStatistics(new VariableReferenceExpression("varchar", new TypeWithName(createVarcharType(10))), varcharStats)
        ...
        types = SemanticTypeProvider.fromVariables(ImmutableList.<VariableReferenceExpression>builder()
                ...
                .add(new VariableReferenceExpression("varchar", new TypeWithName(createVarcharType(10))))
                .build());
    }
    ...
    public void symbolToLiteralEqualStats()
    {
        ...
        assertCalculate(new ComparisonExpression(EQUAL, new SymbolReference("varchar"), new StringLiteral("blah")))
                .outputRowsCount(18.0) // all rows minus nulls divided by distinct values count
                .variableStats(new VariableReferenceExpression("varchar", new TypeWithName(createVarcharType(10))), symbolAssert -> {
                    symbolAssert.averageRowSize(4.0)
                            .distinctValuesCount(1.0)
