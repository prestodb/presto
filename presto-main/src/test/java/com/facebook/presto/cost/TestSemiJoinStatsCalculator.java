...
{
    private SemiJoinStatsCalculator semiJoinStatsCalculator = new SemiJoinStatsCalculator();
    ...
    {
        // overlapping ranges
        assertThat(semiJoinStatsCalculator.computeSemiJoin(inputStatistics, inputStatistics, x, w))
        ...
        assertThat(semiJoinStatsCalculator.computeSemiJoin(inputStatistics, inputStatistics, x, u))
                .symbolStats(x, stats -> stats
                        .lowValue(xStats.getLowValue())
                        .highValue(xStats.getHighValue())
                        .nullsFraction(0)
    ...
    {
        // overlapping ranges
        assertThat(semiJoinStatsCalculator.computeAntiJoin(inputStatistics, inputStatistics, u, x))
        ...
        assertThat(semiJoinStatsCalculator.computeAntiJoin(inputStatistics, inputStatistics, x, u))
                .symbolStats(x, stats -> stats
                        .lowValue(xStats.getLowValue())
                        .highValue(xStats.getHighValue())
                        .nullsFraction(0)
