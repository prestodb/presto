...
public class TestBroadcastOutputBuffer
{
    ...
    public void testSimple()
    {
        ...
        assertBufferResultEquals(TYPES, getBufferResult(buffer, SECOND, 0, sizeOfPagesInBytes(10), NO_WAIT), bufferResult(0, createPage(0),
                createPage(1),
                createPage(2),
                createPage(3),
                createPage(4),
        ...
        assertBufferResultEquals(TYPES, getBufferResult(buffer, FIRST, 4, sizeOfPagesInBytes(1), NO_WAIT), bufferResult(4, createPage(4)));
        ...
        assertBufferResultEquals(TYPES, getBufferResult(buffer, FIRST, 5, sizeOfPagesInBytes(1), NO_WAIT), bufferResult(5, createPage(5)));
        assertQueueState(buffer, FIRST, 9, 5);
        assertQueueState(buffer, SECOND, 4, 10);
        assertFalse(buffer.isFinished());

        // remove all remaining pages from first queue, should not be finished
        BufferResult x = getBufferResult(buffer, FIRST, 6, sizeOfPagesInBytes(10), NO_WAIT);
        ...
        assertBufferResultEquals(TYPES, getBufferResult(buffer, FIRST, 14, sizeOfPagesInBytes(10), NO_WAIT), emptyResults(TASK_INSTANCE_ID, 14, true));
        ...
        assertBufferResultEquals(TYPES, getBufferResult(buffer, SECOND, 10, sizeOfPagesInBytes(10), NO_WAIT), bufferResult(10, createPage(10),
                createPage(11),
                createPage(12),
                createPage(13)));
        assertQueueState(buffer, SECOND, 4, 10);
        assertBufferResultEquals(TYPES, getBufferResult(buffer, SECOND, 14, sizeOfPagesInBytes(10), NO_WAIT), emptyResults(TASK_INSTANCE_ID, 14, true));
        buffer.abort(SECOND);
        assertQueueClosed(buffer, FIRST, 14);
    ...
    public void testSetFinalBuffersWihtoutDeclaringUsedBuffer()
    {
        ...
        assertBufferResultEquals(TYPES, getBufferResult(buffer, FIRST, 1, sizeOfPagesInBytes(10), NO_WAIT), emptyResults(TASK_INSTANCE_ID, 1, true));
        buffer.abort(FIRST);
    ...
    public void testAcknowledgementFreesWriters()
    {
        ...
        buffer.get(FIRST, 2, sizeOfPagesInBytes(10)).cancel(true);
        assertFalse(future.isDone());

        // acknowledge pages for second buffer, which makes space in the buffer
        buffer.get(SECOND, 2, sizeOfPagesInBytes(10)).cancel(true);
    ...
    public void testAbort()
    {
        ...
        assertBufferResultEquals(TYPES, getBufferResult(bufferedBuffer, FIRST, 0, sizeOfPagesInBytes(1), NO_WAIT), bufferResult(0, createPage(0)));
        bufferedBuffer.abort(FIRST);
        assertQueueClosed(bufferedBuffer, FIRST, 0);
        assertBufferResultEquals(TYPES, getBufferResult(bufferedBuffer, FIRST, 1, sizeOfPagesInBytes(1), NO_WAIT), emptyResults(TASK_INSTANCE_ID, 0, true));

        assertBufferResultEquals(TYPES, getBufferResult(bufferedBuffer, SECOND, 0, sizeOfPagesInBytes(1), NO_WAIT), bufferResult(0, createPage(0)));
        bufferedBuffer.abort(SECOND);
        assertQueueClosed(bufferedBuffer, SECOND, 0);
        assertFinished(bufferedBuffer);
        assertBufferResultEquals(TYPES, getBufferResult(bufferedBuffer, SECOND, 1, sizeOfPagesInBytes(1), NO_WAIT), emptyResults(TASK_INSTANCE_ID, 0, true));
    }
