...
public class TestQueryStats
{
    ...
    public void testInputAndOutputStatsCalculation()
    {
        ...
        assertEquals(queryStats.getRawInputDataSize(), 8620);
        assertEquals(queryStats.getRawInputPositions(), 150);
        assertEquals(queryStats.getShuffledDataSize(), 5384);
        assertEquals(queryStats.getShuffledPositions(), 100);
        assertEquals(queryStats.getProcessedInputDataSize(), 13660);
        assertEquals(queryStats.getProcessedInputPositions(), 250);
        assertEquals(queryStats.getOutputDataSize(), 5040);
    ...
    static void assertExpectedQueryStats(QueryStats actual)
    {
        ...
        assertEquals(actual.getUserMemoryReservation(), 18);
        assertEquals(actual.getTotalMemoryReservation(), 19);
        assertEquals(actual.getPeakUserMemoryReservation(), 20);
        assertEquals(actual.getPeakTotalMemoryReservation(), 21);
        assertEquals(actual.getPeakTaskUserMemory(), 22);
        assertEquals(actual.getPeakTaskTotalMemory(), 23);
        assertEquals(actual.getSpilledDataSize(), 690);
        ...
        assertEquals(actual.getTotalAllocation(), 123);

        assertEquals(actual.getRawInputDataSize(), 24);
        assertEquals(actual.getRawInputPositions(), 25);

        assertEquals(actual.getProcessedInputDataSize(), 26);
        assertEquals(actual.getProcessedInputPositions(), 27);

        assertEquals(actual.getShuffledDataSize(), 30);
        assertEquals(actual.getShuffledPositions(), 29);

        assertEquals(actual.getOutputDataSize(), 28);
        assertEquals(actual.getOutputPositions(), 29);

        assertEquals(actual.getWrittenOutputPositions(), 30);

        assertEquals(actual.getWrittenOutputLogicalDataSize(), 31);
        assertEquals(actual.getWrittenOutputPhysicalDataSize(), 32);

        assertEquals(actual.getWrittenIntermediatePhysicalDataSize(), 33);
