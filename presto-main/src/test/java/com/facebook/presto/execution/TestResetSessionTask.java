...
public class TestResetSessionTask
{
            ...
            throws Exception
    {
        ...
        new ResetSessionTask().execute(new ResetSession(QualifiedName.of("catalog", "baz")), session, MetadataManager.createTestMetadataManager(), stateMachine, new SqlQueryManager(null, null, null, null, null, null, null));
