...
public class TestQueryManagerConfig
{
    ...
    public void testDefaults()
    {
        ConfigAssertions.assertRecordedDefaults(ConfigAssertions.recordDefaults(QueryManagerConfig.class)
                ...
                .setRequiredResourceManagersMaxWait(new Duration(5, MINUTES))
    ...
    public void testExplicitPropertyMappings()
    {
        Map<String, String> properties = new ImmutableMap.Builder<String, String>()
                ...
                .put("query-manager.experimental.required-resource-managers", "99")
                .put("query-manager.experimental.required-resource-managers-max-wait", "66m")
        ...
        QueryManagerConfig expected = new QueryManagerConfig()
                ...
                .setRequiredResourceManagers(99)
                .setRequiredResourceManagersMaxWait(new Duration(66, MINUTES))
