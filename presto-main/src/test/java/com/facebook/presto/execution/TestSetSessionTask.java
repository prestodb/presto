...
public class TestSetSessionTask
{
            ...
            throws Exception
    {
        ...
        new SetSessionTask().execute(new SetSession(QualifiedName.of("foo", "bar"), "baz"), TEST_SESSION, MetadataManager.createTestMetadataManager(), stateMachine, new SqlQueryManager(null, null, null, null, null, null, null));
