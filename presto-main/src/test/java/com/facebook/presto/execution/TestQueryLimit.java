...
public class TestQueryLimit
{
    ...
    public void testGetMinimum()
    {
        ...
        assertEquals(getMinimum(QUERY_LIMIT_DURATION, longLimit, shortLimit), Optional.of(shortLimit));
        ...
        assertEquals(getMinimum(QUERY_LIMIT_DATA_SIZE, largeLimit, smallLimit), Optional.of(smallLimit));
    }
}
