        ...
        implements Closeable
{
            ...
            throws InterruptedException
    {
        ...
        TaskSpecification leafSpec = new TaskSpecification(LEAF, "leaf", 0, 16, 30, new AggregatedLeafSplitGenerator());
        controller.addTaskSpecification(leafSpec);

        TaskSpecification slowLeafSpec = new TaskSpecification(LEAF, "slow_leaf", 0, 16, 10, new SlowLeafSplitGenerator());
        controller.addTaskSpecification(slowLeafSpec);

        TaskSpecification intermediateSpec = new TaskSpecification(INTERMEDIATE, "intermediate", 0, 8, 40, new IntermediateSplitGenerator(wakeupExecutor));
            ...
            throws InterruptedException
    {
        ...
        TaskSpecification slowLeafSpec = new TaskSpecification(LEAF, "good_leaf", 0, 16, 4, new L4LeafSplitGenerator());
        controller.addTaskSpecification(slowLeafSpec);

        TaskSpecification misbehavingLeafSpec = new TaskSpecification(LEAF, "bad_leaf", 0, 16, 4, new QuantaExceedingSplitGenerator());
            ...
            throws InterruptedException
    {
        ...
        TaskSpecification longLeafSpec = new TaskSpecification(INTERMEDIATE, "l4_long", 0, 2, 16, new SimpleLeafSplitGenerator(MINUTES.toNanos(4), SECONDS.toNanos(1)));
        controller.addTaskSpecification(longLeafSpec);

        TaskSpecification shortLeafSpec = new TaskSpecification(INTERMEDIATE, "l4_short", 0, 2, 16, new SimpleLeafSplitGenerator(MINUTES.toNanos(2), SECONDS.toNanos(1)));
