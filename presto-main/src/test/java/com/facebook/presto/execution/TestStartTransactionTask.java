...
public class TestStartTransactionTask
{
    ...
    public void testNonTransactionalClient()
    {
        ...
        try {
            getFutureValue(startTransactionTask.execute(new StartTransaction(Collections.emptyList()), transactionManager, metadata, new AllowAllAccessControl(), stateMachine, emptyList()));
            fail();
        }
