...
public class TestClusterSizeMonitor
{
    ...
    ListenableFuture<?> workersFuture;
    ListenableFuture<?> coordinatorsFuture;
    ...
    public void setUp()
    {
        ...
        workersFuture = monitor.waitForMinimumWorkers();
        coordinatorsFuture = monitor.waitForMinimumCoordinators();
            ...
            throws InterruptedException
    {
        ...
        addWorker(nodeManager);
        minWorkersLatch.await(2, SECONDS);
        assertFalse(workersTimeout.get());
