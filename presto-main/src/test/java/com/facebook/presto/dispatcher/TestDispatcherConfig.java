...
public class TestDispatcherConfig
{
    ...
    public void testExplicitPropertyMappings()
    {
        Map<String, String> properties = new ImmutableMap.Builder<String, String>()
                .put("dispatcher.experimental.remote-query-info.min-error-duration", "2m")
                .put("dispatcher.experimental.remote-query-info.update-interval", "10s")
                .put("dispatcher.experimental.remote-query-info.refresh-max-wait", "6s")
                .put("dispatcher.experimental.remote-query.max-callback-threads", "500")
                .build();
