...
public class TestResourceManagerClusterStatusSender
{
    ...
    private MockResourceManagerClient resourceManagerClient;

    @BeforeTest
    public void setup()
    {
        resourceManagerClient = new MockResourceManagerClient();
        InMemoryNodeManager nodeManager = new InMemoryNodeManager();
        nodeManager.addNode(CONNECTOR_ID, new InternalNode("identifier", URI.create("http://localhost:80/identifier"), OptionalInt.of(1), new NodeVersion("1"), false, true));
