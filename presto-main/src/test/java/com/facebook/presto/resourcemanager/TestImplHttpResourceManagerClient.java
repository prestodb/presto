...
public class TestImplHttpResourceManagerClient
{
    ...
    public void setUp()
    {
        ...
        Bootstrap app = new Bootstrap(
                ...
                new Module() {
                    ...
                    InternalNodeManager providesInternalNodeManager()
                    {
                        ...
                        manager.addNode(new ConnectorId("temp"), new InternalNode("rm", URI.create("http://fake.valid/"), new NodeVersion("1"), false, true, false, false));
                    ...
                    @Provides
                    ImplHttpResourceManagerClient provideHttpResourceManagerClient(ResourceManagerResource resourceManagerResource,
                                                                                   InternalNodeManager internalNodeManager,
                                                                                   JsonMapper mapper)
                    {
                        JaxrsTestingHttpProcessor jaxrsTestingHttpProcessor = new JaxrsTestingHttpProcessor(URI.create("http://fake.valid/"), resourceManagerResource, mapper);
                        TestingHttpClient testingHttpClient = new TestingHttpClient(jaxrsTestingHttpProcessor.setTrace(false));
                        return new ImplHttpResourceManagerClient(testingHttpClient, internalNodeManager);
                    }
                });
        ...
        testHttpClient = injector.getInstance(ImplHttpResourceManagerClient.class);
