...
{
    private static final HostAddress TEST_ADDRESS = HostAddress.fromParts("localhost", 8080);
    ...
    public void testQueryHeartbeat()
    {
        ...
        HttpResourceManagerClient client = new HttpResourceManagerClient(httpClient, TEST_ADDRESS);
        BasicQueryInfo queryInfo = createTestQueryInfo("query1", RUNNING);

        client.queryHeartbeat("test-node", queryInfo, 1);
    ...
    public void testGetResourceGroupInfo()
    {
        ...
        List<ResourceGroupRuntimeInfo> result = client.getResourceGroupInfo("test-node");
    ...
    public void testGetMemoryPoolInfo()
    {
        ...
        Map<MemoryPoolId, ClusterMemoryPoolInfo> result = client.getMemoryPoolInfo();
    ...
    public void testResourceGroupRuntimeHeartbeat()
    {
        ...
        client.resourceGroupRuntimeHeartbeat("test-node", runtimeInfo);
    ...
    public void testGetRunningTaskCount()
    {
        ...
        int result = client.getRunningTaskCount();
