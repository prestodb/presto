        ...
        extends AbstractTestDecimalFunctions
{
    ...
    {
        // short short -> short
        assertDecimalFunction("DECIMAL '037.7' + DECIMAL '17.1'", decimal("0054.8"));
    ...
    {
        // short short -> short
        assertDecimalFunction("DECIMAL '037.7' - DECIMAL '17.1'", decimal("0020.6"));
    ...
    {
        // short short -> short
        assertDecimalFunction("DECIMAL '02' * DECIMAL '3'", decimal("006"));
        assertDecimalFunction("DECIMAL '02' * DECIMAL '-3'", decimal("-006"));
        assertDecimalFunction("DECIMAL '-02' * DECIMAL '3'", decimal("-006"));
