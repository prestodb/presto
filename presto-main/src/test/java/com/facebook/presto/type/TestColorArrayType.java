        ...
        extends AbstractTestType
{
    ...
    {
        super(new TypeAndFunctionManager().getType(parseTypeSignature("array(color)")), List.class, createTestBlock(new TypeAndFunctionManager().getType(parseTypeSignature("array(color)"))));
    }
