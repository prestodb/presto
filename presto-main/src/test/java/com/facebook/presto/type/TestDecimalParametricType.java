        ...
        extends AbstractTestDecimalFunctions
{
    ...
    {
        assertInvalidFunction("CAST(1 AS DECIMAL(1,2))", "Invalid DECIMAL scale 2");
        assertInvalidFunction("CAST(-22 AS DECIMAL(20,21))", "Invalid DECIMAL scale 21");
        assertInvalidFunction("CAST(31.41 AS DECIMAL(0,1))", "Invalid DECIMAL precision 0");
    }

    @Test
    public void decimalWithZeroLengthCannotBeCreated()
    {
        assertInvalidFunction("CAST(1 AS DECIMAL(0,0))", "Invalid DECIMAL precision 0");
        assertInvalidFunction("CAST(0 AS DECIMAL(0,0))", "Invalid DECIMAL precision 0");
        assertInvalidFunction("CAST(1 AS DECIMAL(0))", "Invalid DECIMAL precision 0");
        assertInvalidFunction("CAST(0 AS DECIMAL(0))", "Invalid DECIMAL precision 0");
    }
}
