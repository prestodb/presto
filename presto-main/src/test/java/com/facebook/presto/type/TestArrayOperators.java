        ...
        extends AbstractTestFunctions
{
            ...
            throws Exception
    {
        ...
        assertInvalidFunction("SLICE(ARRAY [1, 2, 3, 4], 1, -1)", INVALID_FUNCTION_ARGUMENT.toErrorCode());
        assertInvalidFunction("SLICE(ARRAY [1, 2, 3, 4], 0, 1)", INVALID_FUNCTION_ARGUMENT.toErrorCode());
    }
