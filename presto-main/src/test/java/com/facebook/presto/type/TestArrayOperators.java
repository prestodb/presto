        ...
        extends AbstractTestFunctions
{
            ...
            throws Exception
    {
        ...
        assertFunction("ARRAY [ARRAY [1]] || ARRAY [NULL]", new ArrayType(new ArrayType(INTEGER)), asList(ImmutableList.of(1), null));
            ...
            throws Exception
    {
        ...
        assertInvalidFunction("SEQUENCE(2, -1)", INVALID_FUNCTION_ARGUMENT);
    }
