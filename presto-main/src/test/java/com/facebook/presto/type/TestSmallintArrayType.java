        ...
        extends AbstractTestType
{
    ...
    {
        super(new TypeAndFunctionManager().getType(parseTypeSignature("array(smallint)")), List.class, createTestBlock(new TypeAndFunctionManager().getType(parseTypeSignature("array(smallint)"))));
    }
