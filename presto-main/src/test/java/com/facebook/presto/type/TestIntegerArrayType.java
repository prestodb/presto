        ...
        extends AbstractTestType
{
    ...
    {
        super(new TypeAndFunctionManager().getType(parseTypeSignature("array(integer)")), List.class, createTestBlock(new TypeAndFunctionManager().getType(parseTypeSignature("array(integer)"))));
    }
