        ...
        extends AbstractTestType
{
    ...
    {
        super(new TypeRegistry().getType(parseTypeSignature("map(smallint,varchar)")), Map.class, createTestBlock(new TypeRegistry().getType(parseTypeSignature("map(smallint,varchar)"))));
    }
