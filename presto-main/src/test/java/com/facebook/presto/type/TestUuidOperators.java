        ...
        extends AbstractTestFunctions
{
    ...
    public void testVarbinaryToUUIDCast()
    {
        ...
        assertFunction("CAST(x'E9118675D21F1512595A08E4862A9E8F' AS UUID)", UUID, "e9118675-d21f-1512-595a-08e4862a9e8f");
        assertFunction("CAST(x'533BA1B0AD3304308E4582B5CA9177A9' AS UUID)", UUID, "533ba1b0-ad33-0430-8e45-82b5ca9177a9");
        assertFunction("CAST(x'8C4B12DE994E07D3A6AB9FF7FAB7A1A2' AS UUID)", UUID, "8c4b12de-994e-07d3-a6ab-9ff7fab7a1a2");
        assertFunction("CAST(x'4957266AF8EAA7DFE874DF256033368D' AS UUID)", UUID, "4957266a-f8ea-a7df-e874-df256033368d");
        assertFunction("CAST(x'e9118675d21f1512595a08e4862a9e8f' AS UUID)", UUID, "e9118675-d21f-1512-595a-08e4862a9e8f");
