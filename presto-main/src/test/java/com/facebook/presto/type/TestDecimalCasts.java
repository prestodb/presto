        ...
        extends AbstractTestFunctions
{
    ...
    public void testFloatToDecimalCasts()
    {
        ...
        assertDecimalFunction("CAST(FLOAT '-1234567936' AS DECIMAL(20,10))", decimal("-1234567936.0000000000"));
        assertDecimalFunction("CAST(FLOAT '1234567936' AS DECIMAL(30,20))", decimal("1234567936.00000000000000000000"));
        assertDecimalFunction("CAST(FLOAT '-1234567936' AS DECIMAL(30,20))", decimal("-1234567936.00000000000000000000"));
    ...
    public void testDecimalToFloatCasts()
    {
        ...
        assertFunction("CAST(DECIMAL '1234567890.12345678900000000000' AS FLOAT)", FLOAT, 1234567890.1234567890f);
        assertFunction("CAST(DECIMAL '-1234567890.12345678900000000000' AS FLOAT)", FLOAT, -1234567890.1234567890f);
    }
