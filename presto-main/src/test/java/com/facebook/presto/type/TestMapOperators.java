...
public class TestMapOperators
{
            ...
            throws Exception
    {
        ...
        assertFunction("MAP(ARRAY[1.0,3.0], ARRAY[from_unixtime(1),from_unixtime(100)]) ="
                + "MAP(ARRAY[3.0,1.0], ARRAY[from_unixtime(100),from_unixtime(1)])", true);
        assertFunction("MAP(ARRAY[1.0,3.0], ARRAY[from_unixtime(1),from_unixtime(100)]) ="
                + "MAP(ARRAY[3.0,1.0], ARRAY[from_unixtime(1),from_unixtime(100)])", false);
        assertFunction("MAP(ARRAY[from_unixtime(1),from_unixtime(100)], ARRAY['kittens','puppies']) ="
                + "MAP(ARRAY[from_unixtime(100),from_unixtime(1)], ARRAY['puppies','kittens'])", true);
        assertFunction("MAP(ARRAY[from_unixtime(1),from_unixtime(100)], ARRAY['kittens','puppies']) ="
                + "MAP(ARRAY[from_unixtime(100),from_unixtime(1)], ARRAY['kittens','puppies'])", false);
        assertFunction("MAP(ARRAY[from_unixtime(1),from_unixtime(100)], ARRAY[NULL,FALSE]) ="
                + "MAP(ARRAY[from_unixtime(100),from_unixtime(1)], ARRAY[FALSE,NULL])", null);
        assertFunction("MAP(ARRAY[from_unixtime(1),from_unixtime(100)], ARRAY[TRUE,NULL]) ="
                + "MAP(ARRAY[from_unixtime(100),from_unixtime(1)], ARRAY[TRUE,NULL])", null);
        assertFunction("MAP(ARRAY['kittens','puppies'], ARRAY[ARRAY[1,2],ARRAY[3]]) ="
                + "MAP(ARRAY['kittens','puppies'], ARRAY[ARRAY[1,2],ARRAY[3]])", true);
        assertFunction("MAP(ARRAY['kittens','puppies'], ARRAY[ARRAY[1,2],ARRAY[3]]) ="
                + "MAP(ARRAY['kittens','puppies'], ARRAY[ARRAY[3],ARRAY[1,2]])", false);
        assertFunction("MAP(ARRAY['kittens','puppies'], ARRAY[NULL,3]) ="
                + "MAP(ARRAY['kittens','puppies'], ARRAY[NULL,2])", false);
    }
            ...
            throws Exception
    {
        ...
        assertFunction("MAP(ARRAY[1.0,3.0], ARRAY[from_unixtime(1),from_unixtime(100)]) !="
                + "MAP(ARRAY[3.0,1.0], ARRAY[from_unixtime(100),from_unixtime(1)])", false);
        assertFunction("MAP(ARRAY[1.0,3.0], ARRAY[from_unixtime(1),from_unixtime(100)]) !="
                + "MAP(ARRAY[3.0,1.0], ARRAY[from_unixtime(1),from_unixtime(100)])", true);
        assertFunction("MAP(ARRAY[from_unixtime(1),from_unixtime(100)], ARRAY['kittens','puppies']) !="
                + "MAP(ARRAY[from_unixtime(100),from_unixtime(1)], ARRAY['puppies','kittens'])", false);
        assertFunction("MAP(ARRAY[from_unixtime(1),from_unixtime(100)], ARRAY['kittens','puppies']) !="
                + "MAP(ARRAY[from_unixtime(100),from_unixtime(1)], ARRAY['kittens','puppies'])", true);
        assertFunction("MAP(ARRAY[from_unixtime(1),from_unixtime(100)], ARRAY[NULL,FALSE]) !="
                + "MAP(ARRAY[from_unixtime(100),from_unixtime(1)], ARRAY[FALSE,NULL])", null);
        assertFunction("MAP(ARRAY[from_unixtime(1),from_unixtime(100)], ARRAY[TRUE,NULL]) !="
                + "MAP(ARRAY[from_unixtime(100),from_unixtime(1)], ARRAY[TRUE,NULL])", null);
        assertFunction("MAP(ARRAY['kittens','puppies'], ARRAY[ARRAY[1,2],ARRAY[3]]) !="
                + "MAP(ARRAY['kittens','puppies'], ARRAY[ARRAY[1,2],ARRAY[3]])", false);
        assertFunction("MAP(ARRAY['kittens','puppies'], ARRAY[ARRAY[1,2],ARRAY[3]]) !="
                + "MAP(ARRAY['kittens','puppies'], ARRAY[ARRAY[3],ARRAY[1,2]])", true);
        assertFunction("MAP(ARRAY['kittens','puppies'], ARRAY[NULL,3]) !="
                + "MAP(ARRAY['kittens','puppies'], ARRAY[NULL,2])", true);
    }
}
