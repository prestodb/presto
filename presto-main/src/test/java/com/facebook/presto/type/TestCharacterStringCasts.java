        ...
        extends AbstractTestFunctions
{
    ...
    public void testCharToVarcharCast()
            throws Exception
    {
        assertFunction("cast(cast('bar' as char(5)) as varchar(20))", createVarcharType(20), "bar  ");
    ...
    {
        assertEquals(varcharToCharSaturatedFloorCast(utf8Slice("1234567890"), 10), utf8Slice("1234567890"));
        assertEquals(varcharToCharSaturatedFloorCast(utf8Slice("123456789"), 10), utf8Slice("12345678"));
        assertEquals(varcharToCharSaturatedFloorCast(utf8Slice("12345678901"), 10), utf8Slice("1234567890"));
        assertEquals(varcharToCharSaturatedFloorCast(utf8Slice(""), 10), utf8Slice(""));
    }
}
