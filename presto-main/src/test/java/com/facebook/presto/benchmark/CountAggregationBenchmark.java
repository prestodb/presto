        ...
        extends AbstractSimpleOperatorBenchmark
{
    ...
    protected List<? extends OperatorFactory> createOperatorFactories()
    {
        ...
        AggregationOperatorFactory aggregationOperator = new AggregationOperatorFactory(1, Step.SINGLE, ImmutableList.of(aggregation(COUNT, ImmutableList.of(new Input(0)), Optional.<Input>absent(), Optional.<Input>absent())));
