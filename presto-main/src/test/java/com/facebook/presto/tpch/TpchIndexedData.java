...
public class TpchIndexedData
{
    ...
    private static IndexedTable indexTable(TpchTable table, double scaleFactor, final List<String> outputColumns, List<String> keyColumns)
    {
        ...
        List<ColumnType> outputTypes = recordSet.getColumnTypes();
        List<ColumnType> keyTypes = extractPositionValues(outputTypes, keyPositions);
    ...
    private static List<Object> extractValues(RecordCursor cursor, List<ColumnType> types)
    {
    ...
    private static Object extractObject(RecordCursor cursor, int field, ColumnType type)
    {
    ...
    public static class IndexedTable
    {
        ...
        private final List<ColumnType> keyTypes;
        private final List<String> outputColumnNames;
        private final List<ColumnType> outputTypes;
        private final ListMultimap<MaterializedTuple, MaterializedTuple> keyToValues;

        private IndexedTable(List<String> keyColumnNames, List<ColumnType> keyTypes, List<String> outputColumnNames, List<ColumnType> outputTypes, ListMultimap<MaterializedTuple, MaterializedTuple> keyToValues)
        {
