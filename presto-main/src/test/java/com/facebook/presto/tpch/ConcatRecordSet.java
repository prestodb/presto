        ...
        implements RecordSet
{
    ...
    public ConcatRecordSet(Iterable<RecordSet> recordSets, List<ColumnType> types)
    {
            ...
            implements RecordCursor
    {
        ...
        private ConcatRecordCursor(Iterator<RecordCursor> iterator, List<ColumnType> types)
        {
