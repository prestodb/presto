...
public class TestDatabaseStorageManager
{
            ...
            throws IOException
    {
        ...
        RecordProjectOperator source = new RecordProjectOperator(records, createProjections(VARIABLE_BINARY, FIXED_INT_64));
        ...
        assertOperatorEquals(
                ...
                new RecordProjectOperator(records, createProjection(1, FIXED_INT_64)));
    }
            ...
            throws IOException
    {
        ...
        RecordProjectOperator source = new RecordProjectOperator(records, createProjections(VARIABLE_BINARY));
