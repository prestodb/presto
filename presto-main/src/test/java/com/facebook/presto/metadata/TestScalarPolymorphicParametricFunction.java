...
public class TestScalarPolymorphicParametricFunction
{
            ...
            throws Throwable
    {
        ...
        assertEquals(functionInfo.getSignature(), new Signature("foo", "bigint", INPUT_VARCHAR_SIGNATURE));
            ...
            throws Throwable
    {
        ...
        assertEquals(functionInfo.getSignature(), new Signature("foo", INPUT_VARCHAR_SIGNATURE, INPUT_VARCHAR_SIGNATURE));
