...
public class TestSignatureBinder
{
            ...
            throws Exception
    {
        ...
        assertThat(decimalVariadicBoundFunction)
                ...
                .withCoercion()
                .produces(new BoundVariables(
                        ImmutableMap.of("T", type("decimal(19,0)")),
                        ImmutableMap.of()
                ));
    }
    ...
    public void testBindUnknownToVariadic()
    {
        ...
        assertThat(rowFunction)
                .boundTo("unknown", "row<bigint>('a')")
                .withCoercion()
                .produces(new BoundVariables(
                        ImmutableMap.of("T", type("row<bigint>('a')")),
                        ImmutableMap.of()
                ));
            ...
            throws Exception
    {
        ...
        assertThat("map<T1,T2>", boundVariables, "map(double,bigint)");
        assertThat("row<T1,T2>('a','b')", boundVariables, "row<double,bigint>('a','b')");
