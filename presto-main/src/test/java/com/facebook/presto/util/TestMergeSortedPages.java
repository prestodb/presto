...
public class TestMergeSortedPages
{
            ...
            throws Exception
    {
        ...
        List<Type> types = ImmutableList.of(INTEGER);
        ContinuousWork<Page> mergedPages = MergeSortedPages.mergeSortedPages(
                ImmutableList.of(ContinuousWork.fromIterable(rowPagesBuilder(types)
                        .row(1)
                        .build())),
    ...
    private static MaterializedResult mergeSortedPages(
            ...
            throws Exception
    {
        List<ContinuousWork<Page>> pageProducers = sortedPages.stream()
                .map(ContinuousWork::fromIterable)
