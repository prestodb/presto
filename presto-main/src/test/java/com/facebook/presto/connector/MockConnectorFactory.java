            ...
            implements Connector
    {
                ...
                implements ConnectorMetadata
        {
            ...
            public ColumnMetadata getColumnMetadata(ConnectorSession session, ConnectorTableHandle tableHandle, ColumnHandle columnHandle)
            {
                ...
                return ColumnMetadata.builder(tpchColumnHandle.getColumnName(), tpchColumnHandle.getType()).build();
            }
            ...
            public Map<SchemaTableName, List<ColumnMetadata>> listTableColumns(ConnectorSession session, SchemaTablePrefix prefix)
            {
                return listTables(session, prefix.getSchemaName()).stream()
                        .collect(toImmutableMap(table -> table, table -> IntStream.range(0, 100)
                                .boxed()
                                .map(i -> ColumnMetadata.builder("column_" + i, createUnboundedVarcharType()).build())
