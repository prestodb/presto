...
public class TestFilterAndProjectOperator
{
    ...
    public void test()
    {
        ...
        Supplier<PageProcessor> processor = compiler.compilePageProcessor(TEST_SESSION, Optional.of(filter), ImmutableList.of(field0, add5));
    ...
    public void testMergeOutput()
    {
        ...
        ExpressionCompiler compiler = new ExpressionCompiler(metadata, new PageFunctionCompiler(metadata, 0));
        Supplier<PageProcessor> processor = compiler.compilePageProcessor(TEST_SESSION, Optional.of(filter), ImmutableList.of(field(1, BIGINT)));
