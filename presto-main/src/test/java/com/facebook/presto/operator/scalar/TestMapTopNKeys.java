...
public class TestMapTopNKeys
        extends AbstractTestFunctions
{
    @Test
    public void testBasic()
    {
        assertFunction("map_top_n_keys(MAP(ARRAY['x', 'y', 'z'], ARRAY[1, 2, 3]), 2, (x, y) -> IF(x < y, 1, IF(x = y, 0, -1)))", new ArrayType(createVarcharType(2)), asList("x", "y"));
