...
public class TestOperatorStats
{
    ...
    public static void assertExpectedOperatorStats(OperatorStats actual)
    {
        ...
        assertEquals(actual.getAddInputAllocation(), 123);
        assertEquals(actual.getRawInputDataSize(), 5);
        assertEquals(actual.getInputDataSize(), 6);
        ...
        assertEquals(actual.getGetOutputAllocation(), 234);
        assertEquals(actual.getOutputDataSize(), 12);
        assertEquals(actual.getOutputPositions(), 13);

        assertEquals(actual.getPhysicalWrittenDataSize(), 14);
        ...
        assertEquals(actual.getFinishAllocation(), 345);

        assertEquals(actual.getUserMemoryReservation(), 1_000_000_000L);
        assertEquals(actual.getRevocableMemoryReservation(), 20);
        assertEquals(actual.getSystemMemoryReservation(), 21);
        assertEquals(actual.getPeakUserMemoryReservation(), 22);
        assertEquals(actual.getPeakSystemMemoryReservation(), 23);
        assertEquals(actual.getPeakTotalMemoryReservation(), 24);
        assertEquals(actual.getSpilledDataSize(), 25);
    ...
    public void testMergeWithNonMergeableInfo()
    {
        ...
        assertEquals(actual.getAddInputAllocation(), 3 * 123);
        assertEquals(actual.getRawInputDataSize(), 3 * 5);
        assertEquals(actual.getInputDataSize(), 3 * 6);
        ...
        assertEquals(actual.getGetOutputAllocation(), 3 * 234);
        assertEquals(actual.getOutputDataSize(), 3 * 12);
        assertEquals(actual.getOutputPositions(), 3 * 13);

        assertEquals(actual.getPhysicalWrittenDataSize(), 3 * 14);
        ...
        assertEquals(actual.getFinishAllocation(), 3 * 345);

        assertEquals(actual.getUserMemoryReservation(), 3 * 1_000_000_000L);
        assertEquals(actual.getRevocableMemoryReservation(), 3 * 20);
        assertEquals(actual.getSystemMemoryReservation(), 3 * 21);
        assertEquals(actual.getPeakUserMemoryReservation(), 22);
        assertEquals(actual.getPeakSystemMemoryReservation(), 23);
        assertEquals(actual.getPeakTotalMemoryReservation(), 24);
        assertEquals(actual.getSpilledDataSize(), 3 * 25);
    ...
    public void testMergeWithMergeableInfo()
    {
        ...
        assertEquals(actual.getUserMemoryReservation(), 3 * 19);
        assertEquals(actual.getRevocableMemoryReservation(), 3 * 20);
        assertEquals(actual.getSystemMemoryReservation(), 3 * 21);
        assertEquals(actual.getPeakUserMemoryReservation(), 22);
        assertEquals(actual.getPeakSystemMemoryReservation(), 23);
