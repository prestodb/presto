...
public class MaterializedTupleRecordSet
            implements RecordSet
    {
        ...
        public MaterializedTupleRecordSet(Iterable<MaterializedTuple> tuples, List<ColumnType> types)
        {
                ...
                implements RecordCursor
        {
            ...
            private MaterializedTupleRecordCursor(Iterator<MaterializedTuple> iterator, List<ColumnType> types)
            {
