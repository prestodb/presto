    ...
    public void testRemainder()
    {
        ...
        for (int left : intLefts) {
            ...
            for (double right : doubleRights) {
                ...
                assertFunction("remainder(" + left + ", REAL '" + fr + "')", REAL, (fr - (left * Math.round(fr / left))));
            }
        }
        ...
        for (double left : doubleLefts) {
            ...
            for (long right : intRights) {
                float fl = (float) left;
                assertFunction("remainder(REAL '" + fl + "', " + right + ")", REAL, (right - (fl * Math.round(right / fl))));
            }
        }
        ...
        for (double left : doubleLefts) {
            ...
            for (double right : doubleRights) {
                float fl = (float) left;
                float fr = (float) right;
                assertFunction("remainder(REAL '" + fl + "', REAL '" + fr + "')", REAL, (fr - (fl * Math.round(fr / fl))));
            }
        }
    }
