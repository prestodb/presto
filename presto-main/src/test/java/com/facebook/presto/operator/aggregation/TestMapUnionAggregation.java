...
public class TestMapUnionAggregation
{
    ...
    public void testSimpleWithDuplicates()
    {
        ...
        FunctionHandle functionHandle = TYPE_AND_FUNCTION_MANAGER.lookupFunction(NAME, fromTypes(mapType));
        InternalAggregationFunction aggFunc = TYPE_AND_FUNCTION_MANAGER.getAggregateFunctionImplementation(functionHandle);
        assertAggregation(
                aggFunc,
        ...
        functionHandle = TYPE_AND_FUNCTION_MANAGER.lookupFunction(NAME, fromTypes(mapType));
        aggFunc = TYPE_AND_FUNCTION_MANAGER.getAggregateFunctionImplementation(functionHandle);
        assertAggregation(
                aggFunc,
