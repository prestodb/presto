...
public class BenchmarkLongSumBatchAggregation
{
            ...
            throws Throwable
    {
        ...
        data.setup();
        new BenchmarkLongSumBatchAggregation().sumAggregation(data);

        Options options = new OptionsBuilder()
                .verbosity(VerboseMode.NORMAL)
                .warmupMode(WarmupMode.BULK)
                .include(".*" + BenchmarkLongSumBatchAggregation.class.getSimpleName() + ".*")
                .build();
