...
public class TestMergeSortProcessor
{
            ...
            throws Exception
    {
        ...
        PageComparator comparator = new SimplePageComparator(types, sortChannels, sortOrder);
        MergeSortProcessor processor = new MergeSortProcessor(comparator, pageSuppliers, new AggregatedMemoryContext());
