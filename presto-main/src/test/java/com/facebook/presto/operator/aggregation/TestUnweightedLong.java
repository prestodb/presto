...
public class TestUnweightedLong
{
    ...
    public TestUnweightedLong()
    {
        ...
        InternalAggregationFunction function = functionManager.getAggregateFunctionImplementation(
                functionManager.lookupFunction("reservoir_sample", fromTypes(BIGINT, BIGINT)));
    ...
    private static Page makeInput(int numberOfBuckets)
    {
        ...
        for (int i = 0; i < 100; i++) {
            ...
            BIGINT.writeLong(builder.getBlockBuilder(1), 1); // value
        }
