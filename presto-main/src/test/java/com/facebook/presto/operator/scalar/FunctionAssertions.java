        ...
        implements Closeable
{
    ...
    {
        Map<NodeRef<Expression>, TypeWithName> expressionTypes = getExpressionTypes(session, metadata, SQL_PARSER, SYMBOL_TYPES, expression, emptyList(), WarningCollector.NOOP);
    ...
    private RowExpression toRowExpression(Expression projection, Map<NodeRef<Expression>, TypeWithName> expressionTypes, Map<VariableReferenceExpression, Integer> layout)
    {
