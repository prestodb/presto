...
import com.facebook.presto.operator.FilterAndProjectOperatorFactory;
...
import com.facebook.presto.operator.ScanFilterAndProjectOperatorFactory;
...
public final class FunctionAssertions
{
    ...
    private Operator interpretedFilterProject(Expression filter, Expression projection, ConnectorSession session)
    {
        ...
        OperatorFactory operatorFactory = new FilterAndProjectOperatorFactory(0, new GenericPageProcessor(filterFunction, ImmutableList.of(projectionFunction)), toTypes(ImmutableList.of(projectionFunction)));
