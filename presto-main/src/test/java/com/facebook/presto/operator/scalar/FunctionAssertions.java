...
public final class FunctionAssertions
{
    ...
    public static final Map<Input, Type> INPUT_TYPES = ImmutableMap.<Input, Type>builder()
    ...
    public static final Map<Symbol, Input> INPUT_MAPPING = ImmutableMap.<Symbol, Input>builder()
