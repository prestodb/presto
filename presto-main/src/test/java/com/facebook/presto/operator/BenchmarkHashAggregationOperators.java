...
public class BenchmarkHashAggregationOperators
{
            ...
            throws RunnerException
    {
        Options options = new OptionsBuilder()
                ...
                .include(".*" + BenchmarkHashAggregationOperators.class.getSimpleName() + ".*")
                .build();
    ...
    public static class Context
    {
        ...
        public void setup()
        {
            ...
            RowPagesBuilder pagesBuilder = RowPagesBuilder.rowPagesBuilder(true, ImmutableList.of(0), VARCHAR, BIGINT);
            for (int i = 0; i < TOTAL_PAGES; i++) {
                String groupKey = format("%s", i);
                ...
                else if (dataType.equals("rle")) {
                    pagesBuilder.addBlocksPage(createRLEBlock(groupKey, ROWS_PER_PAGE), createLongSequenceBlock(0, ROWS_PER_PAGE));
                }
            }
        ...
        private OperatorFactory createHashAggregationOperatorFactory(Optional<Integer> hashChannel)
        {
            ...
            return new HashAggregationOperatorFactory(
                    ...
                    false,
                    ImmutableList.of(generateAccumulatorFactory(COUNT, ImmutableList.of(1), Optional.empty()),
