...
public class TestHistogram
{
            ...
            throws Exception
    {
        ...
        aggFunc = metadata.getExactFunction(new Signature(NAME, mapType.getTypeSignature().toString(), StandardTypes.BIGINT)).getAggregationFunction();
        assertAggregation(
                aggFunc,
                1.0,
        ...
        aggFunc = metadata.getExactFunction(new Signature(NAME, mapType.getTypeSignature().toString(), StandardTypes.DOUBLE)).getAggregationFunction();
        assertAggregation(
                aggFunc,
                1.0,
        ...
        aggFunc = metadata.getExactFunction(new Signature(NAME, mapType.getTypeSignature().toString(), StandardTypes.BOOLEAN)).getAggregationFunction();
        assertAggregation(
                aggFunc,
                1.0,
            ...
            throws Exception
    {
        ...
        aggFunc = metadata.getExactFunction(new Signature(NAME, mapType.getTypeSignature().toString(), StandardTypes.TIMESTAMP_WITH_TIME_ZONE)).getAggregationFunction();
            ...
            throws Exception
    {
        ...
        InternalAggregationFunction aggFunc = metadata.getExactFunction(new Signature(NAME, mapType.getTypeSignature().toString(), arrayType.getTypeSignature().toString())).getAggregationFunction();
            ...
            throws Exception
    {
        ...
        InternalAggregationFunction aggFunc = metadata.getExactFunction(new Signature(NAME, mapType.getTypeSignature().toString(), innerMapType.getTypeSignature().toString())).getAggregationFunction();
            ...
            throws Exception
    {
        ...
        InternalAggregationFunction aggFunc = metadata.getExactFunction(new Signature(NAME, mapType.getTypeSignature().toString(), innerRowType.getTypeSignature().toString())).getAggregationFunction();
