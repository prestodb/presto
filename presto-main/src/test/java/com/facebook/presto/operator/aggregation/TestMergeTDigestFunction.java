        ...
        extends TestMergeStatisticalDigestFunction
{
    ...
    {
        SessionBuilder x = builder(session);
        boolean a = SystemSessionProperties.isTDigestEnabled(x.build());
        x.setSystemProperty("tdigest_enabled", "true");
        boolean t = SystemSessionProperties.isTDigestEnabled(x.build());
