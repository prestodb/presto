...
public class TestHashAggregationOperator
{
    ...
    public void testSpillerFailure()
    {
        ...
        DriverContext driverContext = createTaskContext(executor, TEST_SESSION, DataSize.valueOf("10B"), DataSize.valueOf("1MB"), DataSize.valueOf("1GB"), DataSize.valueOf("10B"))
                .addPipelineContext(true, true)
                .addDriverContext();
    ...
    {
        return createTaskContext(executor, TEST_SESSION, new DataSize(256, MEGABYTE), new DataSize(1, MEGABYTE), succinctBytes(memoryLimit), succinctBytes(systemMemoryLimit))
                .addPipelineContext(true, true)
                .addDriverContext();
    }
