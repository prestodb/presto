...
public class TestDriverStats
{
    ...
    public static void assertExpectedDriverStats(DriverStats actual)
    {
        ...
        assertEquals(actual.getUserMemoryReservation(), 6L);
        assertEquals(actual.getRevocableMemoryReservation(), 7L);
        assertEquals(actual.getSystemMemoryReservation(), 8L);
