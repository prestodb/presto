        ...
        extends AbstractTestFunctions
{
    ...
    public void testPageSource()
    {
        ...
        ScanFilterAndProjectOperator.ScanFilterAndProjectOperatorFactory factory = new ScanFilterAndProjectOperator.ScanFilterAndProjectOperatorFactory(
                ...
                new PlanNodeId("test"),
                new PlanNodeId("0"),
                (session, split, table, columns, runtimeStats) -> new FixedPageSource(ImmutableList.of(input)),
                cursorProcessor,
                pageProcessor,
    ...
    public void testPageSourceMergeOutput()
    {
        ...
        ScanFilterAndProjectOperator.ScanFilterAndProjectOperatorFactory factory = new ScanFilterAndProjectOperator.ScanFilterAndProjectOperatorFactory(
                ...
                new PlanNodeId("test"),
                new PlanNodeId("0"),
                (session, split, table, columns, runtimeStats) -> new FixedPageSource(input),
                cursorProcessor,
                pageProcessor,
                TESTING_TABLE_HANDLE,
                ImmutableList.of(),
    ...
    public void testPageSourceLazyLoad()
    {
        ...
        ScanFilterAndProjectOperator.ScanFilterAndProjectOperatorFactory factory = new ScanFilterAndProjectOperator.ScanFilterAndProjectOperatorFactory(
                ...
                new PlanNodeId("test"),
                new PlanNodeId("0"),
                (session, split, table, columns, runtimeStats) -> new SinglePagePageSource(input),
                cursorProcessor,
                () -> pageProcessor,
                TESTING_TABLE_HANDLE,
                ImmutableList.of(),
    ...
    public void testPageSourceLazyBlock()
    {
        ...
        ScanFilterAndProjectOperator.ScanFilterAndProjectOperatorFactory factory = new ScanFilterAndProjectOperator.ScanFilterAndProjectOperatorFactory(
                ...
                new PlanNodeId("test"),
                new PlanNodeId("0"),
                (session, split, table, columns, runtimeStats) -> pageSource,
                cursorProcessor,
                pageProcessor,
                TESTING_TABLE_HANDLE,
                ImmutableList.of(),
        ...
        assertEquals(operator.getOperatorContext().getOperatorStats().getRawInputDataSize(), expectedPage.getSizeInBytes());
    ...
    public void testRecordCursorSource()
    {
        ...
        ScanFilterAndProjectOperator.ScanFilterAndProjectOperatorFactory factory = new ScanFilterAndProjectOperator.ScanFilterAndProjectOperatorFactory(
                ...
                new PlanNodeId("test"),
                new PlanNodeId("0"),
                (session, split, table, columns, runtimeStats) -> new RecordPageSource(new PageRecordSet(ImmutableList.of(VARCHAR), input)),
                cursorProcessor,
                pageProcessor,
                TESTING_TABLE_HANDLE,
                ImmutableList.of(),
    ...
    public void testRecordCursorYield()
    {
        ...
        ScanFilterAndProjectOperator.ScanFilterAndProjectOperatorFactory factory = new ScanFilterAndProjectOperator.ScanFilterAndProjectOperatorFactory(
                ...
                new PlanNodeId("test"),
                new PlanNodeId("0"),
                (session, split, table, columns, runtimeStats) -> new RecordPageSource(new PageRecordSet(ImmutableList.of(BIGINT), input)),
                cursorProcessor,
                pageProcessor,
                TESTING_TABLE_HANDLE,
                ImmutableList.of(),
