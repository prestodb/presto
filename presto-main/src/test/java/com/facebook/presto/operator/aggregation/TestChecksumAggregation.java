...
import static com.facebook.presto.operator.aggregation.ChecksumAggregation.PRIME64;
...
public class TestChecksumAggregation
{
    ...
    public void testEmpty()
            throws Exception
    {
        InternalAggregationFunction booleanAgg = metadata.getExactFunction(new Signature("checksum", AGGREGATE, VARBINARY, BOOLEAN)).getAggregationFunction();
    ...
    public void testLong()
            throws Exception
    {
        InternalAggregationFunction longAgg = metadata.getExactFunction(new Signature("checksum", AGGREGATE, VARBINARY, BIGINT)).getAggregationFunction();
    ...
    public void testDouble()
            throws Exception
    {
        InternalAggregationFunction doubleAgg = metadata.getExactFunction(new Signature("checksum", AGGREGATE, VARBINARY, DOUBLE)).getAggregationFunction();
    ...
    public void testString()
            throws Exception
    {
        InternalAggregationFunction stringAgg = metadata.getExactFunction(new Signature("checksum", AGGREGATE, VARBINARY, VARCHAR)).getAggregationFunction();
            ...
            throws Exception
    {
        ...
        InternalAggregationFunction stringAgg = metadata.getExactFunction(new Signature("checksum", AGGREGATE, VarbinaryType.VARBINARY.getTypeSignature(), arrayType.getTypeSignature())).getAggregationFunction();
