...
public class BenchmarkCountColumnBatchAggregation
{
            ...
            throws Throwable
    {
        ...
        data.setup();
        new BenchmarkCountColumnBatchAggregation().countAggregation(data);

        Options options = new OptionsBuilder()
                .verbosity(VerboseMode.NORMAL)
                .warmupMode(WarmupMode.BULK)
                .include(".*" + BenchmarkCountColumnBatchAggregation.class.getSimpleName() + ".*")
                .build();
