...
import static com.facebook.presto.operator.scalar.JsonExtract.JsonValueJsonExtractorAbstract;
import static com.facebook.presto.operator.scalar.JsonExtract.ObjectFieldJsonExtractorAbstract;
import static com.facebook.presto.operator.scalar.JsonExtract.ScalarValueJsonExtractorAbstract;
        ...
        extends AbstractTestFunctions
{
    ...
    public void testScalarValueJsonExtractor()
            throws Exception
    {
        ScalarValueJsonExtractorAbstract extractor = new ScalarValueJsonExtractorAbstract();
    ...
    public void testJsonValueJsonExtractor()
            throws Exception
    {
        JsonValueJsonExtractorAbstract extractor = new JsonValueJsonExtractorAbstract();
    ...
    public void testArrayElementJsonExtractor()
            throws Exception
    {
        ObjectFieldJsonExtractorAbstract<Slice> firstExtractor = new ObjectFieldJsonExtractorAbstract<>("0", new ScalarValueJsonExtractorAbstract());
        ObjectFieldJsonExtractorAbstract<Slice> secondExtractor = new ObjectFieldJsonExtractorAbstract<>("1", new ScalarValueJsonExtractorAbstract());
    ...
    public void testObjectFieldJsonExtractor()
            throws Exception
    {
        ObjectFieldJsonExtractorAbstract<Slice> extractor = new ObjectFieldJsonExtractorAbstract<>("fuu", new ScalarValueJsonExtractorAbstract());
    ...
    {
        Slice value = JsonExtract.extract(Slices.utf8Slice(inputJson), generateExtractor(jsonPath, new ScalarValueJsonExtractorAbstract()), PROPERTIES_CANONICALIZED_EXTRACT_DISABLED);
    ...
    {
        Slice value = JsonExtract.extract(Slices.utf8Slice(inputJson), generateExtractor(jsonPath, new ScalarValueJsonExtractorAbstract()), PROPERTIES_CANONICALIZED_EXTRACT_ENABLED);
        return (value == null) ? null : value.toStringUtf8();
    }

    private static String doJsonExtractLegacy(String inputJson, String jsonPath)
    {
        Slice value = JsonExtract.extract(Slices.utf8Slice(inputJson), generateExtractor(jsonPath, new JsonValueJsonExtractorAbstract()), PROPERTIES_CANONICALIZED_EXTRACT_DISABLED);
        return (value == null) ? null : value.toStringUtf8();
    }

    private static String doJsonCanonicalizedExtract(String inputJson, String jsonPath)
    {
        Slice value = JsonExtract.extract(Slices.utf8Slice(inputJson), generateExtractor(jsonPath, new JsonValueJsonExtractorAbstract()), PROPERTIES_CANONICALIZED_EXTRACT_ENABLED);
        return (value == null) ? null : value.toStringUtf8();
    }
