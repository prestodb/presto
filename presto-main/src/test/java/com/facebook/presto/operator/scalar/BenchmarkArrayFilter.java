    ...
    public static class BenchmarkData
    {
        ...
        public void setup()
        {
            ...
            for (int i = 0; i < TYPES.size(); i++) {
                ...
                FunctionHandle functionHandle = typeAndFunctionManager.lookupFunction(name, fromTypeSignatures(arrayType.getTypeSignature(), parseTypeSignature("function(bigint,boolean)")));
