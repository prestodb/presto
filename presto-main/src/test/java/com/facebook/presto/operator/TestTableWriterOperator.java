...
import com.facebook.presto.operator.NoOpOperator.NoOpOperatorFactory;
...
public class TestTableWriterOperator
{
    ...
    private static final InternalAggregationFunction LONG_MAX = MetadataManager.createTestMetadataManager().getFunctionRegistry().getAggregateFunctionImplementation(
    ...
    public void testTableWriterInfo()
    {
        ...
        TableWriterOperator tableWriterOperator = (TableWriterOperator) createTableWriterOperator(
                pageSinkManager,
                new NoOpOperatorFactory(1, new PlanNodeId("test")),
    ...
    private Operator createTableWriterOperator(BlockingPageSink blockingPageSink)
    {
        ...
        return createTableWriterOperator(pageSinkManager, new NoOpOperatorFactory(1, new PlanNodeId("test")), ImmutableList.of(BIGINT, VARBINARY));
    }
