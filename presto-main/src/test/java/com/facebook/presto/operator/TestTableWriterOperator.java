...
public class TestTableWriterOperator
{
            ...
            throws Exception
    {
        ...
        InternalAggregationFunction longMaxFunction = typeAndFunctionManager.getAggregateFunctionImplementation(
                typeAndFunctionManager.lookupFunction("max", fromTypes(BIGINT)));
