...
public final class AggregationTestUtils
{
    ...
    {
        BiFunction<Object, Object, Void> equalAssertion = (actual, expected) -> {
        ...
        equalAssertion.apply(aggregation(function, confidence, pages), expectedValue);
        equalAssertion.apply(partialAggregation(function, confidence, pages), expectedValue);
        if (pages.length > 0) {
            equalAssertion.apply(groupedAggregation(function, confidence, pages), expectedValue);
            equalAssertion.apply(groupedPartialAggregation(function, confidence, pages), expectedValue);
            equalAssertion.apply(distinctAggregation(function, confidence, pages), expectedValue);
        }
    }
