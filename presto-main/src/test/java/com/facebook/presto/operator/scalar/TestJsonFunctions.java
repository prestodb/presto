...
public class TestJsonFunctions
{
    ...
    public void testJsonArrayContainsString()
    {
        ...
        functionAssertions.assertFunction("JSON_ARRAY_CONTAINS('[\"foo\", null]', null)", null);
    ...
    {
        functionAssertions.assertFunction("JSON_ARRAY_GET('[1]', 0)", Slices.utf8Slice(String.valueOf(1)));
        functionAssertions.assertFunction("JSON_ARRAY_GET('[2, 7, 4]', 1)", Slices.utf8Slice(String.valueOf(7)));
        functionAssertions.assertFunction("JSON_ARRAY_GET('[2, 7, 4, 6, 8, 1, 0]', 6)", Slices.utf8Slice(String.valueOf(0)));
        functionAssertions.assertFunction("JSON_ARRAY_GET('[]', 0)", null);
        functionAssertions.assertFunction("JSON_ARRAY_GET('[1, 3, 2]', 3)", null);
        functionAssertions.assertFunction("JSON_ARRAY_GET('[2, 7, 4, 6, 8, 1, 0]', -1)", Slices.utf8Slice(String.valueOf(0)));
        functionAssertions.assertFunction("JSON_ARRAY_GET('[2, 7, 4, 6, 8, 1, 0]', -2)", Slices.utf8Slice(String.valueOf(1)));
        functionAssertions.assertFunction("JSON_ARRAY_GET('[2, 7, 4, 6, 8, 1, 0]', -7)", Slices.utf8Slice(String.valueOf(2)));
        functionAssertions.assertFunction("JSON_ARRAY_GET('[2, 7, 4, 6, 8, 1, 0]', -8)", null);
    }

    @Test
    public void testJsonArrayGetString()
    {
        functionAssertions.assertFunction("JSON_ARRAY_GET('[\"jhfa\"]', 0)", "jhfa");
        functionAssertions.assertFunction("JSON_ARRAY_GET('[\"jhfa\", null]', 1)", null);
        functionAssertions.assertFunction("JSON_ARRAY_GET('[\"as\", \"fgs\", \"tehgf\"]', 1)", "fgs");
        functionAssertions.assertFunction("JSON_ARRAY_GET('[\"as\", \"fgs\", \"tehgf\", \"gjyj\", \"jut\"]', 4)", "jut");
    }

    @Test
    public void testJsonArrayGetDouble()
    {
        functionAssertions.assertFunction("JSON_ARRAY_GET('[3.14]', 0)", Slices.utf8Slice(String.valueOf(3.14)));
        functionAssertions.assertFunction("JSON_ARRAY_GET('[3.14, null]', 1)", null);
        functionAssertions.assertFunction("JSON_ARRAY_GET('[1.12, 3.54, 2.89]', 1)", Slices.utf8Slice(String.valueOf(3.54)));
        functionAssertions.assertFunction("JSON_ARRAY_GET('[0.58, 9.7, 7.6, 11.2, 5.02]', 4)", Slices.utf8Slice(String.valueOf(5.02)));
    }

    @Test
    public void testJsonArrayGetBoolean()
    {
        functionAssertions.assertFunction("JSON_ARRAY_GET('[true]', 0)", Slices.utf8Slice(String.valueOf(true)));
        functionAssertions.assertFunction("JSON_ARRAY_GET('[true, null]', 1)", null);
        functionAssertions.assertFunction("JSON_ARRAY_GET('[false, false, true]', 1)", Slices.utf8Slice(String.valueOf(false)));
    ...
    public void testJsonArrayContainsInvalid()
    {
        for (String value : new String[] {"'x'", "2.5", "8", "true", null}) {
            for (String array : new String[] {"", "123", "[", "[1,0,]", "[1,,0]"}) {
                functionAssertions.assertFunction(format("JSON_ARRAY_CONTAINS('%s', %s)", array, value), null);
            }
        }
    }
}
