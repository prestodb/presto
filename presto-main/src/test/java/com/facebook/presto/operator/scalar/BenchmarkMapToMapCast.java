...
public class BenchmarkMapToMapCast
{
    ...
    public static class BenchmarkData
    {
        ...
        public void setup()
        {
            ...
            FunctionHandle functionHandle = metadata.getTypeAndFunctionManager().lookupCast(CAST, mapType(DOUBLE, BIGINT).getTypeSignature(), mapType(BIGINT, DOUBLE).getTypeSignature());
