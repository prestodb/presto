...
public class BenchmarkCountColumnAggregation
{
            ...
            throws Throwable
    {
        ...
        data.setup();
        new BenchmarkCountColumnAggregation().countAggregation(data);

        Options options = new OptionsBuilder()
                .verbosity(VerboseMode.NORMAL)
                .warmupMode(WarmupMode.BULK)
                .include(".*" + BenchmarkCountColumnAggregation.class.getSimpleName() + ".*")
                .build();
    ...
    public void countAggregation(BenchmarkData data)
    {
    ...
    public static class BenchmarkData
    {
        ...
        public void setup()
        {
            ...
            JavaAggregationFunctionImplementation function = functionAndTypeManager.getJavaAggregateFunctionImplementation(
                    functionAndTypeManager.lookupFunction("count", fromTypes(elementType)));
