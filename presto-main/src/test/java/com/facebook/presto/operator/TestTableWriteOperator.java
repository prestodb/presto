...
@Test
public class TestTableWriteOperator
{
            ...
            throws Exception
    {
        ...
        OperatorContext context = driverContext.addOperatorContext(0, TableWriterOperator.class.getSimpleName());

        Operator operator = new TableWriterOperator(context, new MockConnectorPageSink(), ImmutableList.of(0), Optional.empty());
    ...
    private class MockConnectorPageSink
