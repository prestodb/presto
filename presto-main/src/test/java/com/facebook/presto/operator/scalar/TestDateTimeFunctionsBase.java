        ...
        extends AbstractTestFunctions
{
    ...
    protected TestDateTimeFunctionsBase(Session session)
    {
        super(session);
        this.session = session;
        TIMESTAMP = isLegacyTimestamp(session) ? LEGACY_TIMESTAMP : NEW_TIMESTAMP;
    }
    ...
    private static void assertCurrentDateAtInstant(TimeZoneKey timeZoneKey, long instant)
    {
        ...
        long dateTimeCalculation = currentDate(new TestingConnectorSession("test", Optional.empty(), timeZoneKey, US, instant, ImmutableList.of(), ImmutableMap.of(), false));
