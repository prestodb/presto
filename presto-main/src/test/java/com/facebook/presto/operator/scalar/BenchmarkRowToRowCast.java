...
public class BenchmarkRowToRowCast
{
    ...
    public static class BenchmarkData
    {
        ...
        public void setup()
        {
            ...
            FunctionHandle functionHandle = metadata.getTypeAndFunctionManager().lookupCast(CAST, RowType.anonymous(fromFieldTypes).getTypeSignature(), RowType.anonymous(toFieldTypes).getTypeSignature());
