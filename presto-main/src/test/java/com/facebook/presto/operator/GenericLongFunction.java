        ...
        extends SqlScalarFunction
{
    ...
    {
        super(new Signature("generic_long_" + requireNonNull(suffix, "suffix is null"), SCALAR, emptyList(), emptyList(), parseTypeSignature(BIGINT), singletonList(parseTypeSignature(BIGINT)), false));
