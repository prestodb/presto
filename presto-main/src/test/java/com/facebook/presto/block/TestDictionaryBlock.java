        ...
        extends AbstractTestBlock
{
    ...
    @Test
    public void testUnoptimizedSizeInBytes()
    {
        ...
        // Unoptimized size calculation accounts for 4bytes of offset and and 1byte of isNull. Therefore the expected unoptimized
        // size is 10 times the size of the underlying dictionary (VariableWidthBlock).
        assertEquals(dictionaryBlock.getUnoptimizedSizeInBytes(), dictionaryBlock.getDictionary().getSizeInBytes() * 10);
    }
