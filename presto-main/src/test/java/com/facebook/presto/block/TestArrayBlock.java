        ...
        extends AbstractTestBlock
{
    ...
    public void testSingleValueBlock()
    {
        ...
        // ArrayBlock's hold onto the offsets from builder. MapBlock copies the required portion of the offsets into a new array.
        // To test the single value block behavior, set the initialSize to 1.
    ...
    private long[][] createTestArray(int... entryCounts)
    {
