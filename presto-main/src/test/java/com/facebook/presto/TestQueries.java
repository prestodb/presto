...
public class TestQueries
{
    ...
    public void testOrderByLimit()
            throws Exception
    {
        assertQuery("SELECT custkey, orderstatus FROM ORDERS ORDER BY orderkey desc LIMIT 10");
    }
    ...
    public void testOrderByExpressionWithLimit()
            throws Exception
    {
        assertQuery("SELECT custkey, orderstatus FROM ORDERS ORDER BY orderkey + 1 desc LIMIT 10");
    }
    ...
    public void testGroupByOrderByLimit()
            throws Exception
    {
        assertQuery("SELECT custkey, sum(totalprice) FROM ORDERS GROUP BY custkey ORDER BY sum(totalprice) desc LIMIT 10");
    }
    ...
    public void testOrderBy()
            throws Exception
    {
        assertQuery("SELECT orderkey FROM orders ORDER BY orderstatus");
    }
