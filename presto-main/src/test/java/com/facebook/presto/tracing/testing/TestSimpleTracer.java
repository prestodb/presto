...
import com.facebook.presto.tracing.TracingException;
...
public class TestSimpleTracer
{
    ...
    public void testBlockErrors()
    {
        ...
        // Duplicate block
        expectThrows(TracingException.class, () -> {
        ...
        expectThrows(TracingException.class, () -> tracer.addPointToBlock("test-block", "Adding point to non-existing block"));
    }
}
