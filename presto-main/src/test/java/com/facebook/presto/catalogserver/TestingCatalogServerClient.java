        ...
        implements CatalogServerClient
{
    ...
    {
        return new MetadataEntry<>(false, true);
    }
    ...
    {
        return new MetadataEntry<>(true, true);
    }
    ...
    {
        return new MetadataEntry<>("{\"connectorId\":\"$info_schema@system\",\"connectorHandle\":{\"@type\":\"$info_schema\",\"catalogName\":\"system\"," +
                "\"schemaName\":\"information_schema\",\"tableName\":\"schemata\"},\"transaction\":{\"@type\":\"$info_schema\",\"transactionId\":" +
    ...
    {
        return new MetadataEntry<>("[\"tpch.sf1.nation\"]", true);
    }
    ...
    {
        return new MetadataEntry<>("[\"hive.tpch.eric\",\"hive.tpch.eric2\"]", true);
    }
    ...
    public MetadataEntry<String> getViews(TransactionInfo transactionInfo, SessionRepresentation session, QualifiedTablePrefix prefix)
    {
        return new MetadataEntry<>("{\"hive.tpch.eric\":{\"originalSql\":\"SELECT name\\nFROM\\n  tpch.sf1.nation\\n\",\"catalog\":\"hive\"," +
                "\"schema\":\"tpch\",\"columns\":[],\"owner\":\"ericn576\",\"runAsInvoker\":false}}", false);
    }
    ...
    public MetadataEntry<String> getView(TransactionInfo transactionInfo, SessionRepresentation session, QualifiedObjectName viewName)
    {
        return new MetadataEntry<>("{\"originalSql\":\"SELECT name\\nFROM\\n  tpch.sf1.nation\\n\",\"catalog\":\"hive\",\"schema\":\"tpch\"," +
                "\"columns\":[],\"owner\":\"ericn576\",\"runAsInvoker\":false}", false);
    }
    ...
    public MetadataEntry<String> getMaterializedView(TransactionInfo transactionInfo, SessionRepresentation session, QualifiedObjectName viewName)
    {
        return new MetadataEntry<>("{\"originalSql\":\"SELECT\\n  name\\n, nationkey\\nFROM\\n  test_customer_base\\n\",\"schema\":\"tpch\",\"table\":" +
                "\"eric\",\"baseTables\":[{\"schema\":\"tpch\",\"table\":\"test_customer_base\"}],\"owner\":\"ericn576\",\"columnMapping\":[{\"viewColumn\":" +
                ...
                "\"validRefreshColumns\":[\"nationkey\"]}", true);
    }
    ...
    {
        return new MetadataEntry<>("[\"hive.tpch.test_customer_base\"]", true);
    }
}
