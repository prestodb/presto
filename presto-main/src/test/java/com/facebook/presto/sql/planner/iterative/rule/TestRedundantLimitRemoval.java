        ...
        extends BaseRuleTest
{
    ...
    {
        tester().assertThat(new RemoveRedundantLimit(), new LogicalPropertiesProviderImpl())
                .on(p ->
                        p.limit(
                                10,
        ...
        tester().assertThat(ImmutableSet.of(new RemoveRedundantLimit()), new LogicalPropertiesProviderImpl())
    ...
    public void testFeatureDisabled()
    {
        ...
        newTester.assertThat(ImmutableSet.of(new RemoveRedundantLimit()), new LogicalPropertiesProviderImpl())
            .on("select totalprice from orders o inner join customer c on o.custkey = c.custkey where o.orderkey=10 limit 2")
            .validates(plan -> assertNodePresentInPlan(plan, LimitNode.class));
    }
}
