        ...
        extends BasePlanTest
{
                ...
                anyTree(
                        join(
                                ...
                                exchange(join(
                                        ...
                                        exchange(project(tableScan("part", ImmutableMap.of("PART_PK", "partkey")))))))));
    }
    ...
    {
        // Check that addition of dynamic filters does not hinder in join re-ordering
