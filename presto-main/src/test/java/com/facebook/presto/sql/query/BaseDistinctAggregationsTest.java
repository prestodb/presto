...
public interface BaseDistinctAggregationsTest
{
    @Test
    default void testGroupAllSingleDistinct(QueryAssertions assertions)
    {
    ...
    @Test
    default void testGroupBySingleDistinct(QueryAssertions assertions)
    {
        assertions.assertQuery(
    ...
    @Test
    default void testGroupingSetsSingleDistinct(QueryAssertions assertions)
    {
        assertions.assertQuery(
                "SELECT k, count(DISTINCT x) FROM " +
                        "(VALUES " +
    ...
    @Test
    default void testGroupAllMixedDistinct(QueryAssertions assertions)
    {
        assertions.assertQuery(
    ...
    @Test
    default void testMultipleInputs(QueryAssertions assertions)
    {
        assertions.assertQuery(
    ...
    @Test
    default void testMixedDistinctAndNonDistinct(QueryAssertions assertions)
    {
        assertions.assertQuery(
    ...
    @Test
    default void testMixedDistinctWithFilter(QueryAssertions assertions)
    {
        assertions.assertQuery(
                "SELECT " +
