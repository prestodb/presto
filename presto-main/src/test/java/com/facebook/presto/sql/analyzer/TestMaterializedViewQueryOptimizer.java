        ...
        extends AbstractAnalyzerTest
{
    ...
    public void testWithDistinct()
    {
        ...
        assertOptimizedQuery(baseQuerySql, baseQuerySql, ImmutableMap.of(BASE_TABLE_1, ImmutableMap.of(VIEW_1, originalViewSql)));
    }
    ...
    public void testWithTableAlias()
    {
        ...
        assertOptimizedQuery(baseQuerySql, expectedRewrittenSql, ImmutableMap.of(BASE_TABLE_1, ImmutableMap.of(VIEW_1, originalViewSql)));
        assertOptimizedQuery(baseQuerySqlWithAliasPartially1, expectedRewrittenSql, ImmutableMap.of(BASE_TABLE_1, ImmutableMap.of(VIEW_1, originalViewSql)));
        assertOptimizedQuery(baseQuerySqlWithAliasPartially2, expectedRewrittenSql, ImmutableMap.of(BASE_TABLE_1, ImmutableMap.of(VIEW_1, originalViewSql)));
        assertOptimizedQuery(baseQuerySqlFully, expectedRewrittenSql, ImmutableMap.of(BASE_TABLE_1, ImmutableMap.of(VIEW_1, originalViewSql)));
        assertOptimizedQuery(baseQuerySqlWithTablePrefix, expectedRewrittenSql, ImmutableMap.of(BASE_TABLE_1, ImmutableMap.of(VIEW_1, originalViewSql)));
        assertOptimizedQuery(baseQuerySql, expectedRewrittenSql, ImmutableMap.of(BASE_TABLE_1, ImmutableMap.of(VIEW_1, originalViewSqlWithAliasPartially)));
        assertOptimizedQuery(baseQuerySqlWithAliasPartially1, expectedRewrittenSql, ImmutableMap.of(BASE_TABLE_1, ImmutableMap.of(VIEW_1, originalViewSqlWithAliasPartially)));
        assertOptimizedQuery(baseQuerySqlWithAliasPartially2, expectedRewrittenSql, ImmutableMap.of(BASE_TABLE_1, ImmutableMap.of(VIEW_1, originalViewSqlWithAliasPartially)));
        assertOptimizedQuery(baseQuerySqlFully, expectedRewrittenSql, ImmutableMap.of(BASE_TABLE_1, ImmutableMap.of(VIEW_1, originalViewSqlWithAliasPartially)));
        assertOptimizedQuery(baseQuerySqlWithTablePrefix, expectedRewrittenSql, ImmutableMap.of(BASE_TABLE_1, ImmutableMap.of(VIEW_1, originalViewSqlWithAliasPartially)));
        assertOptimizedQuery(baseQuerySql, expectedRewrittenSql, ImmutableMap.of(BASE_TABLE_1, ImmutableMap.of(VIEW_1, originalViewSqlWithAliasFully)));
        assertOptimizedQuery(baseQuerySqlWithAliasPartially1, expectedRewrittenSql, ImmutableMap.of(BASE_TABLE_1, ImmutableMap.of(VIEW_1, originalViewSqlWithAliasFully)));
        assertOptimizedQuery(baseQuerySqlWithAliasPartially2, expectedRewrittenSql, ImmutableMap.of(BASE_TABLE_1, ImmutableMap.of(VIEW_1, originalViewSqlWithAliasFully)));
        assertOptimizedQuery(baseQuerySqlFully, expectedRewrittenSql, ImmutableMap.of(BASE_TABLE_1, ImmutableMap.of(VIEW_1, originalViewSqlWithAliasFully)));
        assertOptimizedQuery(baseQuerySqlWithTablePrefix, expectedRewrittenSql, ImmutableMap.of(BASE_TABLE_1, ImmutableMap.of(VIEW_1, originalViewSqlWithAliasFully)));
        assertOptimizedQuery(baseQuerySql, expectedRewrittenSql, ImmutableMap.of(BASE_TABLE_1, ImmutableMap.of(VIEW_1, originalViewSqlWithTablePrefix)));
        assertOptimizedQuery(baseQuerySqlWithAliasPartially1, expectedRewrittenSql, ImmutableMap.of(BASE_TABLE_1, ImmutableMap.of(VIEW_1, originalViewSqlWithTablePrefix)));
        assertOptimizedQuery(baseQuerySqlWithAliasPartially2, expectedRewrittenSql, ImmutableMap.of(BASE_TABLE_1, ImmutableMap.of(VIEW_1, originalViewSqlWithTablePrefix)));
        assertOptimizedQuery(baseQuerySqlFully, expectedRewrittenSql, ImmutableMap.of(BASE_TABLE_1, ImmutableMap.of(VIEW_1, originalViewSqlWithTablePrefix)));
        assertOptimizedQuery(baseQuerySqlWithTablePrefix, expectedRewrittenSql, ImmutableMap.of(BASE_TABLE_1, ImmutableMap.of(VIEW_1, originalViewSqlWithTablePrefix)));
    }
    ...
    public void testAggregationWithTableAlias()
    {
        ...
        assertOptimizedQuery(baseQuerySqlFully, expectedRewrittenSql, ImmutableMap.of(BASE_TABLE_1, ImmutableMap.of(VIEW_1, originalViewSql)));
        assertOptimizedQuery(baseQuerySqlWithTablePrefix, expectedRewrittenSql, ImmutableMap.of(BASE_TABLE_1, ImmutableMap.of(VIEW_1, originalViewSql)));
        assertOptimizedQuery(baseQuerySql, expectedRewrittenSql, ImmutableMap.of(BASE_TABLE_1, ImmutableMap.of(VIEW_1, originalViewSqlWithAliasPartially1)));
        assertOptimizedQuery(baseQuerySqlWithAliasPartially1, expectedRewrittenSql, ImmutableMap.of(BASE_TABLE_1, ImmutableMap.of(VIEW_1, originalViewSqlWithAliasPartially1)));
        assertOptimizedQuery(baseQuerySqlWithAliasPartially2, expectedRewrittenSql, ImmutableMap.of(BASE_TABLE_1, ImmutableMap.of(VIEW_1, originalViewSqlWithAliasPartially1)));
        assertOptimizedQuery(baseQuerySqlFully, expectedRewrittenSql, ImmutableMap.of(BASE_TABLE_1, ImmutableMap.of(VIEW_1, originalViewSqlWithAliasPartially1)));
        assertOptimizedQuery(baseQuerySqlWithTablePrefix, expectedRewrittenSql, ImmutableMap.of(BASE_TABLE_1, ImmutableMap.of(VIEW_1, originalViewSqlWithAliasPartially1)));
        assertOptimizedQuery(baseQuerySql, expectedRewrittenSql, ImmutableMap.of(BASE_TABLE_1, ImmutableMap.of(VIEW_1, originalViewSqlWithAliasPartially2)));
        assertOptimizedQuery(baseQuerySqlWithAliasPartially1, expectedRewrittenSql, ImmutableMap.of(BASE_TABLE_1, ImmutableMap.of(VIEW_1, originalViewSqlWithAliasPartially2)));
        assertOptimizedQuery(baseQuerySqlWithAliasPartially2, expectedRewrittenSql, ImmutableMap.of(BASE_TABLE_1, ImmutableMap.of(VIEW_1, originalViewSqlWithAliasPartially2)));
        assertOptimizedQuery(baseQuerySqlFully, expectedRewrittenSql, ImmutableMap.of(BASE_TABLE_1, ImmutableMap.of(VIEW_1, originalViewSqlWithAliasPartially2)));
        assertOptimizedQuery(baseQuerySqlWithTablePrefix, expectedRewrittenSql, ImmutableMap.of(BASE_TABLE_1, ImmutableMap.of(VIEW_1, originalViewSqlWithAliasPartially2)));
        assertOptimizedQuery(baseQuerySql, expectedRewrittenSql, ImmutableMap.of(BASE_TABLE_1, ImmutableMap.of(VIEW_1, originalViewSqlWithAliasFully)));
        assertOptimizedQuery(baseQuerySqlWithAliasPartially1, expectedRewrittenSql, ImmutableMap.of(BASE_TABLE_1, ImmutableMap.of(VIEW_1, originalViewSqlWithAliasFully)));
        assertOptimizedQuery(baseQuerySqlWithAliasPartially2, expectedRewrittenSql, ImmutableMap.of(BASE_TABLE_1, ImmutableMap.of(VIEW_1, originalViewSqlWithAliasFully)));
        assertOptimizedQuery(baseQuerySqlFully, expectedRewrittenSql, ImmutableMap.of(BASE_TABLE_1, ImmutableMap.of(VIEW_1, originalViewSqlWithAliasFully)));
    ...
    public void testFilterContainment()
    {
        ...
        assertOptimizedQuery(baseQuerySql, expectedRewrittenSql, ImmutableMap.of(BASE_TABLE_7, ImmutableMap.of(VIEW_1, originalViewSql)));
        ...
        assertOptimizedQuery(baseQuerySql, expectedRewrittenSql, ImmutableMap.of(BASE_TABLE_6, ImmutableMap.of(VIEW_1, originalViewSql)));
        ...
        assertOptimizedQuery(baseQuerySql, baseQuerySql, ImmutableMap.of(BASE_TABLE_6, ImmutableMap.of(VIEW_1, originalViewSql)));
    }

    @Test
    // This will fail due to mismatched decimal types without parse_decimal_literals_as_double property
    public void testFilterContainmentWithMismatchedDecimalTypes()
    {
        String originalViewSql = format("SELECT a, b FROM %s WHERE b > 5.0", BASE_TABLE_7);
        String baseQuerySql = format("SELECT a, b FROM %s WHERE b = 5.01", BASE_TABLE_7);
        String expectedRewrittenSql = format("SELECT a, b FROM %s WHERE b = 5.01", VIEW_1);
    ...
    public void multipleSubqueriesOptimizableFromSameView()
    {
        String subquery1 = format("SELECT a, b FROM %s", BASE_TABLE_1);
        String subquery2 = format("SELECT c FROM %s", BASE_TABLE_1);
        String viewSql = format("SELECT a, b, c FROM %s", BASE_TABLE_1);
        ...
        assertOptimizedQuery(baseQuerySql, expectedRewrittenSql, ImmutableMap.of(BASE_TABLE_1, ImmutableMap.of(VIEW_1, viewSql)));
    }
    ...
    {
        String subquery1 = format("SELECT a, b, sum(c) AS sum_c FROM %s WHERE b > 5 GROUP BY a, b", BASE_TABLE_1);

        String viewSql1 = subquery1;

        String baseQuerySql = format("SELECT a, b, sum(c) AS sum_c FROM (%s)", subquery1);
        ...
        assertOptimizedQuery(baseQuerySql, expectedRewrittenSql, ImmutableMap.of(BASE_TABLE_1, ImmutableMap.of(VIEW_1, viewSql1)));
    }
                ...
                .execute(TEST_SESSION, session -> {
                    ...
                    for (Map.Entry<String, Map<String, String>> baseToViewMap : viewQueries.entrySet()) {
                        ...
                        for (Map.Entry<String, String> viewNameToSqlMap : baseToViewMap.getValue().entrySet()) {
                            QualifiedObjectName viewName = QualifiedObjectName.valueOf("tpch.s1." + baseTableName);
                    ...
                    Query optimizedBaseToViewQuery = new MaterializedViewQueryOptimizer(
                            metadata,
                            session,
                            SQL_PARSER,
                            accessControl,
