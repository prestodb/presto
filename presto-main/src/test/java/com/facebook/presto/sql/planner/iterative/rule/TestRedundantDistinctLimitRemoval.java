        ...
        extends BaseRuleTest
{
    ...
    {
        tester().assertThat(new RemoveRedundantDistinctLimit(), new LogicalPropertiesProviderImpl())
                .on(p ->
                        p.distinctLimit(
                                10,
        ...
        tester().assertThat(ImmutableSet.of(new MergeLimitWithDistinct(), new RemoveRedundantDistinctLimit()), new LogicalPropertiesProviderImpl())
    ...
    public void testFeatureDisabled()
    {
        ...
        newTester.assertThat(ImmutableSet.of(new MergeLimitWithDistinct(), new RemoveRedundantDistinctLimit()), new LogicalPropertiesProviderImpl())
                .on("select distinct totalprice from orders o inner join customer c on o.custkey = c.custkey where o.orderkey=10 limit 2")
                .validates(plan -> assertNodePresentInPlan(plan, DistinctLimitNode.class));
    }
}
