...
public class PageProcessorBenchmark
{
    ...
    private final Map<String, TypeWithName> symbolTypes = new HashMap<>();
    ...
    public void setup()
    {
        ...
        for (int i = 0; i < columnCount; i++) {
            ...
            symbolTypes.put(variable.getName(), new TypeWithName(type));
    ...
    private RowExpression rowExpression(String value)
    {
        ...
        Map<NodeRef<Expression>, TypeWithName> expressionTypes = getExpressionTypes(TEST_SESSION, METADATA, SQL_PARSER, SemanticTypeProvider.copyOf(symbolTypes), expression, emptyList(), WarningCollector.NOOP);
