...
public class PageProcessorBenchmark
{
    ...
    private RowExpression rowExpression(String value)
    {
        ...
        RowExpression rowExpression = SqlToRowExpressionTranslator.translate(expression, expressionTypes, sourceLayout, METADATA.getTypeAndFunctionManager(), TEST_SESSION);
