        ...
        implements Closeable
{
    ...
    {
        return new RuleAssert(metadata, queryRunner.getStatsCalculators(), queryRunner.getEstimatedExchangesCostCalculator(), session, rule, transactionManager, accessControl);
    }
