...
public class TestInlineSqlFunctions
{
    ...
    {
        assertInlined(tester, "unittest.memory.add_1_int(x)", "transform(x, \"x$lambda\" -> \"x$lambda\" + 1)", ImmutableMap.of("x", SemanticType.from(new ArrayType(IntegerType.INTEGER))));
    }
    ...
    public void testInlineSqlFunctionCoercesConstantWithCast()
    {
        assertInlined(tester,
                ...
                ImmutableMap.of("x", SemanticType.from(new ArrayType(BigintType.BIGINT))));
    }
    ...
    public void testInlineBuiltinSqlFunction()
    {
        assertInlined(tester,
                ...
                ImmutableMap.of("x", SemanticType.from(new ArrayType(IntegerType.INTEGER))));
    }
    ...
    private void assertInlined(RuleTester tester, String inputSql, String expected, Map<String, SemanticType> variableTypes)
    {
