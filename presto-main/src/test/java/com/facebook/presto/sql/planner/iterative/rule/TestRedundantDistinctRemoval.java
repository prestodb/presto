        ...
        extends BaseRuleTest
{
    ...
    {
        tester().assertThat(ImmutableSet.of(new RemoveRedundantDistinct()), new LogicalPropertiesProviderImpl())
    ...
    public void testFeatureDisabled()
    {
        ...
        newTester.assertThat(ImmutableSet.of(new RemoveRedundantDistinct()), new LogicalPropertiesProviderImpl())
                .on("select distinct o.orderkey, l.linenumber from orders o inner join lineitem l on o.orderkey = l.orderkey where l.linenumber = 10")
                .validates(plan -> assertNodePresentInPlan(plan, AggregationNode.class));
    }
}
