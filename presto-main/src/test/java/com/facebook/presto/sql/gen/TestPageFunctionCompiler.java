...
public class TestPageFunctionCompiler
{
    ...
    public void testFailureDoesNotCorruptFutureResults()
    {
        ...
        Supplier<PageProjection> projectionSupplier = functionCompiler.compileProjection(TEST_SESSION, ADD_10_EXPRESSION, Optional.empty());
    ...
    public void testGeneratedClassName()
    {
        ...
        Supplier<PageProjection> projectionSupplier = functionCompiler.compileProjection(TEST_SESSION, ADD_10_EXPRESSION, Optional.of(classSuffix));
        PageProjection projection = projectionSupplier.get();
    ...
    public void testCache()
    {
        ...
        assertSame(
                cacheCompiler.compileProjection(TEST_SESSION, ADD_10_EXPRESSION, Optional.empty()),
                cacheCompiler.compileProjection(TEST_SESSION, ADD_10_EXPRESSION, Optional.empty()));
        assertSame(
                cacheCompiler.compileProjection(TEST_SESSION, ADD_10_EXPRESSION, Optional.of("hint")),
                cacheCompiler.compileProjection(TEST_SESSION, ADD_10_EXPRESSION, Optional.of("hint")));
        assertSame(
                cacheCompiler.compileProjection(TEST_SESSION, ADD_10_EXPRESSION, Optional.of("hint")),
                cacheCompiler.compileProjection(TEST_SESSION, ADD_10_EXPRESSION, Optional.of("hint2")));
        assertSame(
                cacheCompiler.compileProjection(TEST_SESSION, ADD_10_EXPRESSION, Optional.empty()),
                cacheCompiler.compileProjection(TEST_SESSION, ADD_10_EXPRESSION, Optional.of("hint2")));
        ...
        assertNotSame(
                noCacheCompiler.compileProjection(TEST_SESSION, ADD_10_EXPRESSION, Optional.empty()),
                noCacheCompiler.compileProjection(TEST_SESSION, ADD_10_EXPRESSION, Optional.empty()));
        assertNotSame(
                noCacheCompiler.compileProjection(TEST_SESSION, ADD_10_EXPRESSION, Optional.of("hint")),
                noCacheCompiler.compileProjection(TEST_SESSION, ADD_10_EXPRESSION, Optional.of("hint")));
        assertNotSame(
                noCacheCompiler.compileProjection(TEST_SESSION, ADD_10_EXPRESSION, Optional.of("hint")),
                noCacheCompiler.compileProjection(TEST_SESSION, ADD_10_EXPRESSION, Optional.of("hint2")));
        assertNotSame(
                noCacheCompiler.compileProjection(TEST_SESSION, ADD_10_EXPRESSION, Optional.empty()),
                noCacheCompiler.compileProjection(TEST_SESSION, ADD_10_EXPRESSION, Optional.of("hint2")));
    }
