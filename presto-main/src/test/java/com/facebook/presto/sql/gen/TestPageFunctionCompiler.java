...
public class TestPageFunctionCompiler
{
    ...
    public void testGeneratedClassName()
    {
        ...
        PageProjection projection = projectionSupplier.get();
        Work<List<Block>> work = projection.project(SESSION, new DriverYieldSignal(), createLongBlockPage(0), SelectedPositions.positionsRange(0, 1));
    ...
    {
        Work<List<Block>> work = projection.project(SESSION, new DriverYieldSignal(), page, selectedPositions);
