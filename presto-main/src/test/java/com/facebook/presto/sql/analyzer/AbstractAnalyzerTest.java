...
public class AbstractAnalyzerTest
{
    ...
    public void setup()
    {
        ...
        String viewData8 = JsonCodec.jsonCodec(ViewDefinition.class).toJson(
                new ViewDefinition(
                        "select a,b,c from t1",
                        Optional.of(TPCH_CATALOG),
                        Optional.of("s1"),
        ...
        ConnectorTableMetadata viewMetadata8 = new ConnectorTableMetadata(
                new SchemaTableName("s1", "v8"),
                ImmutableList.of(
                        new ColumnMetadata("a", BIGINT),
                        new ColumnMetadata("b", BIGINT),
                        new ColumnMetadata("c", BIGINT)));
        inSetupTransaction(session -> metadata.createView(session, TPCH_CATALOG, viewMetadata8, viewData8, false));

        String viewData9 = JsonCodec.jsonCodec(ViewDefinition.class).toJson(
                new ViewDefinition(
                        "select x, y, z from t13",
                        Optional.of(TPCH_CATALOG),
                        Optional.of("s1"),
                        ...
                        Optional.of("user"),
                        false));
        ConnectorTableMetadata viewMetadata9 = new ConnectorTableMetadata(
                new SchemaTableName("s1", "v9"),
                ImmutableList.of(
                        new ColumnMetadata("x", BIGINT),
                        new ColumnMetadata("y", BIGINT),
                        new ColumnMetadata("z", BIGINT)));
        ...
        String viewData10 = JsonCodec.jsonCodec(ViewDefinition.class).toJson(
                new ViewDefinition(
                        ...
                        Optional.empty(),
                        true));
        ConnectorTableMetadata viewMetadata10 = new ConnectorTableMetadata(
                new SchemaTableName("s1", "v10"),
                ImmutableList.of(
