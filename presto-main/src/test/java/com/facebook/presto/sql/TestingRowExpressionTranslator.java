...
public class TestingRowExpressionTranslator
{
    ...
    public RowExpression translate(String sql, Map<String, TypeWithName> types)
    {
    ...
    public RowExpression translateAndOptimize(Expression expression, Map<NodeRef<Expression>, TypeWithName> types)
    {
    ...
    Expression simplifyExpression(Expression expression)
    {
        ...
        Map<NodeRef<Expression>, TypeWithName> expressionTypes = getExpressionTypes(expression, SemanticTypeProvider.empty());
    ...
    private Map<NodeRef<Expression>, TypeWithName> getExpressionTypes(Expression expression, SemanticTypeProvider typeProvider)
    {
