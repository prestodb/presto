...
public class TestExpressionInterpreter
{
    ...
    private static final SemanticTypeProvider SYMBOL_TYPES = SemanticTypeProvider.viewOf(ImmutableMap.<String, TypeWithName>builder()
            ...
            .put("unbound_array", new TypeWithName(new ArrayType(BIGINT)))
...
//                "CAST(3.3 AS DECIMAL(20,10))");
    ...
    {
        Map<NodeRef<Expression>, TypeWithName> expressionTypes = getExpressionTypes(TEST_SESSION, METADATA, SQL_PARSER, SYMBOL_TYPES, expression, emptyList(), WarningCollector.NOOP);
