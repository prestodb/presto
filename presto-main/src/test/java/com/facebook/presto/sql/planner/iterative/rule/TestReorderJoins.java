...
public class TestReorderJoins
{
    ...
    public void setUp()
    {
        tester = new RuleTester(
                ...
                Optional.of(4));
        this.functionResolution = new FunctionResolution(tester.getMetadata().getTypeAndFunctionManager());
    }
                ...
                .on(p ->
                        p.join(
                                ...
                                Optional.of(comparisonRowExpression(LESS_THAN, variable("A1", BIGINT), call(
                                        RANDOM.toString(),
                                        tester.getMetadata().getTypeAndFunctionManager().resolveFunction(Optional.empty(), qualifyFunctionName(RANDOM), ImmutableList.of()),
                                        BIGINT,
                                        ImmutableList.of())))))
                .doesNotFire();
    }
