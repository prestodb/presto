        ...
        extends BaseRuleTest
{
    ...
    {
        tester = new RuleTester(emptyList(), ImmutableMap.of(USE_MARK_DISTINCT, Boolean.toString(false)), Optional.of(1), new TestTableConstraintsConnectorFactory(1));
    }
    ...
    public void singleTableTests()
    {
        ...
        tester().assertThat(ImmutableSet.of(new RemoveRedundantAggregateDistinct()), new LogicalPropertiesProviderImpl())
        ...
        tester().assertThat(ImmutableSet.of(), new LogicalPropertiesProviderImpl())
                .on("SELECT count(distinct linenumber), avg(distinct tax) FROM lineitem GROUP BY orderkey")
                .doesNotMatch(output(
                        node(ProjectNode.class,
                                aggregation(aggregations,
    ...
    public void complexQueryTests()
    {
        ...
        tester().assertThat
                (ImmutableSet.of(new MergeLimitWithDistinct(), new RemoveRedundantAggregateDistinct()), new LogicalPropertiesProviderImpl())
    ...
    {
        tester().assertThat(new RemoveRedundantDistinct(), new LogicalPropertiesProviderImpl())
                .on(p -> {
    ...
    public void testFeatureDisabled()
    {
        ...
        newTester.assertThat(ImmutableSet.of(new RemoveRedundantAggregateDistinct()), new LogicalPropertiesProviderImpl())
                .on("SELECT count(distinct linenumber), avg(distinct tax) FROM lineitem GROUP BY orderkey")
                .matches(output(
                        node(ProjectNode.class,
                                aggregation(aggregations,
