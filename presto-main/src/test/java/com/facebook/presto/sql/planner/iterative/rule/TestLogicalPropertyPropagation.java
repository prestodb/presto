...
import com.facebook.presto.sql.planner.iterative.EquivalenceClassProperty;
import com.facebook.presto.sql.planner.iterative.Key;
import com.facebook.presto.sql.planner.iterative.KeyProperty;
import com.facebook.presto.sql.planner.iterative.LogicalPropertiesImpl;
import com.facebook.presto.sql.planner.iterative.LogicalPropertiesProviderImpl;
import com.facebook.presto.sql.planner.iterative.MaxCardProperty;
        ...
        extends BaseRuleTest
{
    ...
    public final void setUp()
    {
        ...
        customerCustKeyVariable = new VariableReferenceExpression("c_custkey", BIGINT);
        customerNationKeyVariable = new VariableReferenceExpression("nationkey", BIGINT);
        customerCommentVariable = new VariableReferenceExpression("c_comment", VARCHAR);
        mktSegmentVariable = new VariableReferenceExpression("c_mktsegment", VARCHAR);
        acctBalVariable = new VariableReferenceExpression("c_acctbal", DOUBLE);
        ordersCustKeyVariable = new VariableReferenceExpression("o_custkey", BIGINT);
        ordersOrderKeyVariable = new VariableReferenceExpression("o_orderkey", BIGINT);
        ordersOrderPriorityVariable = new VariableReferenceExpression("o_orderpriority", VARCHAR);
        shipPriorityVariable = new VariableReferenceExpression("o_shippriority", INTEGER);
        ordersCommentVariable = new VariableReferenceExpression("o_comment", DOUBLE);
        lineitemOrderkeyVariable = new VariableReferenceExpression("l_orderkey", BIGINT);
        lineitemLinenumberVariable = new VariableReferenceExpression("l_linenumber", BIGINT);
        lineitemExtendedPriceVariable = new VariableReferenceExpression("l_extendedprice", DOUBLE);
    }
    ...
    void testValuesNodeLogicalProperties()
    {
        ...
        tester().assertThat(new NoOpRule(), new LogicalPropertiesProviderImpl())
                .on(p -> {
    ...
    void testFilterNodeLogicalProperties()
    {
        ...
        VariableReferenceExpression varA = new VariableReferenceExpression("A", BIGINT);
        VariableReferenceExpression varB = new VariableReferenceExpression("B", BIGINT);
        VariableReferenceExpression varC = new VariableReferenceExpression("C", BIGINT);
    ...
    {
        VariableReferenceExpression projectedCustKeyVariable = new VariableReferenceExpression("newcustkey", BIGINT);
        ...
        VariableReferenceExpression varA = new VariableReferenceExpression("A", BIGINT);
        VariableReferenceExpression varB = new VariableReferenceExpression("B", BIGINT);
        VariableReferenceExpression projectedVarA = new VariableReferenceExpression("A1", BIGINT);
        ...
        VariableReferenceExpression projectedA = new VariableReferenceExpression("A1", BIGINT);
        ...
        VariableReferenceExpression varC = new VariableReferenceExpression("C", BIGINT);
        VariableReferenceExpression varD = new VariableReferenceExpression("D", BIGINT);
        VariableReferenceExpression varE = new VariableReferenceExpression("E", BIGINT);
        VariableReferenceExpression varF = new VariableReferenceExpression("F", BIGINT);
        VariableReferenceExpression projectedB = new VariableReferenceExpression("B1", BIGINT);
        VariableReferenceExpression projectedC = new VariableReferenceExpression("C1", BIGINT);
        VariableReferenceExpression projectedD = new VariableReferenceExpression("D1", BIGINT);
        VariableReferenceExpression projectedE = new VariableReferenceExpression("E1", BIGINT);
        VariableReferenceExpression projectedF = new VariableReferenceExpression("F1", BIGINT);
    ...
    public void testJoinNodeLogicalProperties()
    {
        ...
        VariableReferenceExpression c1 = new VariableReferenceExpression("c1", BIGINT);
        VariableReferenceExpression c2 = new VariableReferenceExpression("c2", BIGINT);
        ...
        VariableReferenceExpression c3 = new VariableReferenceExpression("c1", BIGINT);
        VariableReferenceExpression c4 = new VariableReferenceExpression("c2", BIGINT);
        ...
        equivalenceClasses = new EquivalenceClassProperty();
        c = new VariableReferenceExpression("c", BIGINT);
        equivalenceClasses.update(c, customerCustKeyVariable);
        expectedLogicalProperties = new LogicalPropertiesImpl(
                equivalenceClasses,
                new MaxCardProperty(1L),
    ...
    {
        VariableReferenceExpression c = new VariableReferenceExpression("c", BIGINT);
        VariableReferenceExpression unique = new VariableReferenceExpression("unique", BIGINT);
