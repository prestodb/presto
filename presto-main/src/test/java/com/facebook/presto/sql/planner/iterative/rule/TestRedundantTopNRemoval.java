        ...
        extends BaseRuleTest
{
    ...
    {
        tester().assertThat(ImmutableSet.of(new MergeLimitWithSort(), new RemoveRedundantTopN()), new LogicalPropertiesProviderImpl())
        ...
        tester().assertThat(new RemoveRedundantTopN(), new LogicalPropertiesProviderImpl())
                .on(p ->
                        p.topN(
                                10,
        ...
        //negative tests
        tester().assertThat(ImmutableSet.of(new MergeLimitWithSort()), new LogicalPropertiesProviderImpl())
                .on("SELECT totalprice FROM orders WHERE orderkey = 10 ORDER BY totalprice LIMIT 10")
    ...
    public void testFeatureDisabled()
    {
        ...
        newTester.assertThat(ImmutableSet.of(new MergeLimitWithSort(), new RemoveRedundantTopN()), new LogicalPropertiesProviderImpl())
                .on("SELECT totalprice FROM orders WHERE orderkey = 10 ORDER BY totalprice LIMIT 10")
                .validates(plan -> assertNodePresentInPlan(plan, TopNNode.class));
    }
}
