    ...
    private List<PlanOptimizer> getMinimalOptimizers()
    {
        ...
        return ImmutableList.of(
                ...
                new IterativeOptimizer(
                        ...
                        queryRunner.getStatsCalculator(),
                        queryRunner.getCostCalculator(),
                        // TODO: @tdm enable the delegating row expression optimizer
                        new SimplifyRowExpressions(metadata, new ExpressionManager(new InMemoryNodeManager(), queryRunner.getFunctionAndTypeManager(), new NodeInfo("test"), new JsonCodecRowExpressionSerde(jsonCodec(RowExpression.class)))).rules()));
    }
