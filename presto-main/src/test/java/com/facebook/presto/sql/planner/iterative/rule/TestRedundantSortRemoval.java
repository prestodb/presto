        ...
        extends BaseRuleTest
{
    ...
    public void singleTableTests()
    {
        ...
        tester().assertThat(new RemoveRedundantSort(), new LogicalPropertiesProviderImpl())
                .on(p ->
                        p.sort(
        ...
        tester().assertThat(ImmutableSet.of(new RemoveRedundantSort()), new LogicalPropertiesProviderImpl())
    ...
    public void testFeatureDisabled()
    {
        ...
        newTester.assertThat(ImmutableSet.of(new RemoveRedundantSort()), new LogicalPropertiesProviderImpl())
                .on("select max(totalprice) from orders order by 1")
                .validates(plan -> assertNodePresentInPlan(plan, SortNode.class));
    }
}
