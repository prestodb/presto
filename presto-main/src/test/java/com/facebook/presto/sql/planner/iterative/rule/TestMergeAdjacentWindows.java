        ...
        extends BaseRuleTest
{
    ...
    private static final FunctionHandle SUM_FUNCTION_HANDLE = createTestMetadataManager().getTypeAndFunctionManager().lookupFunction("sum", fromTypes(DOUBLE));
    private static final FunctionHandle AVG_FUNCTION_HANDLE = createTestMetadataManager().getTypeAndFunctionManager().lookupFunction("avg", fromTypes(DOUBLE));
    private static final FunctionHandle LAG_FUNCTION_HANDLE = createTestMetadataManager().getTypeAndFunctionManager().lookupFunction("lag", fromTypes(DOUBLE));
