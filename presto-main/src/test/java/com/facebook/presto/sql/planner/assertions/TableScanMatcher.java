        ...
        implements Matcher
{
    ...
    private TableScanMatcher(String expectedTableName, Optional<Map<String, Domain>> expectedConstraint, Optional<Boolean> hasTableLayout, Optional<Set<ColumnHandle>> expectedColumnHandles)
    {
