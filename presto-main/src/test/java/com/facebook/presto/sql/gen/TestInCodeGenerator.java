...
public class TestInCodeGenerator
{
    ...
    public void testInteger()
    {
        ...
        values.add(new CallExpression(
                CAST.name(),
                typeAndFunctionManager.lookupCast(CAST, DOUBLE.getTypeSignature(), INTEGER.getTypeSignature()),
                INTEGER,
    ...
    public void testBigint()
    {
        ...
        values.add(new CallExpression(
                CAST.name(),
                typeAndFunctionManager.lookupCast(CAST, DOUBLE.getTypeSignature(), BIGINT.getTypeSignature()),
                BIGINT,
                Collections.singletonList(constant(12345678901234.0, DOUBLE))));
        assertEquals(checkSwitchGenerationCase(BIGINT, values), HASH_SWITCH);
