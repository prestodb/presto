...
public class TestFeaturesConfig
{
    ...
    public void testDefaults()
    {
        assertRecordedDefaults(ConfigAssertions.recordDefaults(FeaturesConfig.class)
                ...
                .setPayloadJoinOptimizationStrategy(FeaturesConfig.PayloadJoinOptimizationStrategy.DISABLED)
                .setJoinMinPayloadSize(new DataSize(1, GIGABYTE))
    ...
    public void testExplicitPropertyMappings()
    {
        Map<String, String> properties = new ImmutableMap.Builder<String, String>()
                ...
                .put("optimizer.payload-join-optimization-strategy", "COST_BASED")
                .put("optimizer.join-min-payload-size", "1MB")
        ...
        FeaturesConfig expected = new FeaturesConfig()
                ...
                .setPayloadJoinOptimizationStrategy(FeaturesConfig.PayloadJoinOptimizationStrategy.COST_BASED)
                .setJoinMinPayloadSize(new DataSize(1, MEGABYTE))
