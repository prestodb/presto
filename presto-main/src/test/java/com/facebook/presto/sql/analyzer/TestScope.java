...
public class TestScope
{
    ...
    public void test()
    {
        ...
        Field outerColumn1 = Field.newQualified(QualifiedName.of("outer", "column1"), Optional.of("c1"), BIGINT_TYPE, false, Optional.empty(), Optional.empty(), false);
        Field outerColumn2 = Field.newQualified(QualifiedName.of("outer", "column2"), Optional.of("c2"), BIGINT_TYPE, false, Optional.empty(), Optional.empty(), false);
        ...
        Field innerColumn2 = Field.newQualified(QualifiedName.of("inner", "column2"), Optional.of("c2"), BIGINT_TYPE, false, Optional.empty(), Optional.empty(), false);
        Field innerColumn3 = Field.newQualified(QualifiedName.of("inner", "column3"), Optional.of("c3"), BIGINT_TYPE, false, Optional.empty(), Optional.empty(), false);
