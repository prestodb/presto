...
public class TestQueryStateInfo
{
    ...
    public void testQueryStateInfoCreation()
    {
        ...
        assertEquals(progress.getCurrentMemoryBytes(), stats.getUserMemoryReservation());
        assertEquals(progress.getPeakMemoryBytes(), stats.getPeakUserMemoryReservation());
        assertEquals(progress.getPeakTotalMemoryBytes(), stats.getPeakTotalMemoryReservation());
        ...
        assertEquals(progress.getInputBytes(), stats.getRawInputDataSize());
