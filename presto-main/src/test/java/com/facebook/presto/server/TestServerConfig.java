...
public class TestServerConfig
{
    ...
    public void testDefaults()
    {
        assertRecordedDefaults(ConfigAssertions.recordDefaults(ServerConfig.class)
                ...
                .setEagerResultsFetchingFromQueuedStatementEnabled(true));
    }
    ...
    public void testExplicitPropertyMappings()
    {
        Map<String, String> properties = new ImmutableMap.Builder<String, String>()
                ...
                .put("eager-results-fetching-from-queued-statement", "false")
                .build();
        ...
        ServerConfig expected = new ServerConfig()
                ...
                .setEagerResultsFetchingFromQueuedStatementEnabled(false);
