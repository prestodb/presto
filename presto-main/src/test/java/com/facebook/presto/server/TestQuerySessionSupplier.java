...
public class TestQuerySessionSupplier
{
    ...
    public void testCreateSession()
    {
        ...
        Session session = sessionSupplier.createSessionBuilder(new QueryId("test_query_id"), null, null, context, warningCollectorFactory).build();
    ...
    public void testInvalidTimeZone()
    {
        ...
        sessionSupplier.createSessionBuilder(new QueryId("test_query_id"), null, null, context, warningCollectorFactory).build();
    }
}
