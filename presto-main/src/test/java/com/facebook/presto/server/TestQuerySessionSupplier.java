...
public class TestQuerySessionSupplier
{
    ...
    public void testCreateSession()
    {
        ...
        Session session = sessionSupplier.createSession(new QueryId("test_query_id"), context, TEST_RESOURCE_GROUP_ID);
    ...
    public void testInvalidTimeZone()
    {
        ...
        QuerySessionSupplier sessionSupplier = new QuerySessionSupplier(
                ...
                new AllowAllAccessControl(),
                new SessionPropertyManager());
        sessionSupplier.createSession(new QueryId("test_query_id"), context, TEST_RESOURCE_GROUP_ID);
    }
}
