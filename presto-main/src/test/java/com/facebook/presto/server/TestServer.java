...
public class TestServer
{
    ...
    {
        String retryUrl = "https://backup-cluster.example.com/v1/statement/queued/retry/abc123";
    ...
    @Test
    public void testCrossClusterRetryErrorCodeFiltering()
    {
        // Test that cross-cluster retry only happens for configured error codes
        // This test would need a way to inject specific errors to verify the behavior
        // For now, we just verify that the retry URL parameters are accepted
        String retryUrl = "https://backup-cluster.example.com/v1/statement/queued/retry";
        URI uri = HttpUriBuilder.uriBuilderFrom(server.getBaseUrl())
                .replacePath("/v1/statement")
                .addParameter("retryUrl", urlEncode(retryUrl))
        ...
        // The actual error code filtering is tested in unit tests
        // This integration test just verifies the parameters are accepted
    }
            ...
            throws Exception
    {
        ...
        try {
            ...
            System.out.println("Primary: " + server.getBaseUrl());
            System.out.println("Backup: " + backupServer.getBaseUrl());
