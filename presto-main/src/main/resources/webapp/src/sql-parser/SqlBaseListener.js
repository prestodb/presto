...
export default class SqlBaseListener extends antlr4.tree.ParseTreeListener {
	...
	// Enter a parse tree produced by SqlBaseParser#createType.
	enterCreateType(ctx) {
	}

	// Exit a parse tree produced by SqlBaseParser#createType.
	exitCreateType(ctx) {
	}
	...
	// Enter a parse tree produced by SqlBaseParser#alterFunction.
	enterAlterFunction(ctx) {
	}

	// Exit a parse tree produced by SqlBaseParser#alterFunction.
	exitAlterFunction(ctx) {
	}
	...
	enterShowCreateMaterializedView(ctx) {
	}

	// Exit a parse tree produced by SqlBaseParser#showCreateMaterializedView.
	exitShowCreateMaterializedView(ctx) {
	}


	// Enter a parse tree produced by SqlBaseParser#showCreateFunction.
	enterShowCreateFunction(ctx) {
	}

	// Exit a parse tree produced by SqlBaseParser#showCreateFunction.
	exitShowCreateFunction(ctx) {
	}
	...
	// Enter a parse tree produced by SqlBaseParser#tableVersion.
	enterTableVersion(ctx) {
	}

	// Exit a parse tree produced by SqlBaseParser#tableVersion.
	exitTableVersion(ctx) {
	}
