...
public class StaticFunctionNamespaceStore
{
    ...
    @Inject
    public StaticFunctionNamespaceStore(TypeAndFunctionManager typeAndFunctionManager, StaticFunctionNamespaceStoreConfig config)
    {
            ...
            throws Exception
    {
        ...
        typeAndFunctionManager.loadFunctionNamespaceManager(functionNamespaceManagerName, catalogName, properties);
