        ...
        implements Metadata
{
    ...
    {
        return delegate.getLayout(session, handle, isReplicatedReadsReplicated);
    }
    ...
    {
        return delegate.getAlternativeTableHandle(session, tableHandle, partitioningHandle, isReplicatedReadsReplicated);
    }
