...
{
    private static final File DEFAULT_BASE_STORAGE_DIR = new File("/tmp/presto-storage");
    private static final File DEFAULT_BASE_STAGING_DIR = new File("/tmp/presto-staging");
    ...
    public StorageManager(IDBI dbi, File baseStorageDir, File baseStagingDir)
    {
    ...
    @Inject
    public StorageManager(IDBI dbi)
    {
