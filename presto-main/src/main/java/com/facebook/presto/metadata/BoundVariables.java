...
{
    private final Map<String, SemanticType> typeVariables;
    private final Map<String, Long> longVariables;

    public BoundVariables(Map<String, SemanticType> typeVariables,
    ...
    public SemanticType getTypeVariable(String variableName)
    {
    ...
    public Map<String, SemanticType> getTypeVariables()
    {
    ...
    {
        private final Map<String, SemanticType> typeVariables = new HashMap<>();
        ...
        public Builder setTypeVariable(String variableName, SemanticType variableValue)
        {
