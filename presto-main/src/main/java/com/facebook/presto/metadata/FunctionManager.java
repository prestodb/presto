        ...
        implements FunctionMetadataManager
{
    ...
    public FunctionHandle resolveFunction(Session session, QualifiedName name, List<TypeSignatureProvider> parameterTypes)
    {
        ...
        StaticFunctionHandle resolvedFunction = (StaticFunctionHandle) staticFunctionNamespace.resolveFunction(name, parameterTypes);

        if (!isTDigestEnabled(session) && isTDigestFunction(resolvedFunction.getSignature().getName(), resolvedFunction.getSignature().getArgumentTypes())) {
