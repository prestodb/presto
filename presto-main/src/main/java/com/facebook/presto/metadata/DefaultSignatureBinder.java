...
public class DefaultSignatureBinder
        extends SignatureBinder
{
    protected final Map<String, TypeVariableConstraint> typeVariableConstraints;

    public DefaultSignatureBinder(TypeManager typeManager, Signature declaredSignature, boolean allowCoercion)
    {
        super(typeManager, declaredSignature, allowCoercion);
