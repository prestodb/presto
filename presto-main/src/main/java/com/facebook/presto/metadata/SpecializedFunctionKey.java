...
public class SpecializedFunctionKey
{
    ...
    public SpecializedFunctionKey(ParametricFunction function, Map<String, Type> boundTypeParameters, List<TypeSignature> parameterTypes)
    {
    ...
    public boolean equals(Object o)
    {
        ...
        return Objects.equals(boundTypeParameters, that.boundTypeParameters) &&
