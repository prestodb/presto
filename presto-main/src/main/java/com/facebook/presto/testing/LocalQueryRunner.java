        ...
        implements QueryRunner
{
    ...
    public Plan createPlan(Session session, @Language("SQL") String sql, List<PlanOptimizer> optimizers, Optimizer.PlanStage stage, WarningCollector warningCollector)
    {
        ...
        AnalyzerContext analyzerContext = getAnalyzerContext(queryAnalyzer, idAllocator, new PlanVariableAllocator(), session);
        ...
        Optimizer optimizer = new Optimizer(
                ...
                sqlParser,
                (PlanVariableAllocator) analyzerContext.getVariableAllocator(),
                idAllocator,
                warningCollector,
                statsCalculator,
                costCalculator,
