...
public class QueryResource
{
    ...
    @Inject
    public QueryResource(DispatcherQueryManager dispatcherQueryManager, QueryManager queryManager)
    {
        this.dispatcherQueryManager = requireNonNull(dispatcherQueryManager, "dispatcherQueryManager is null");
    ...
    public List<BasicQueryInfo> getAllQueryInfo(@QueryParam("state") String stateFilter)
    {
        ...
        for (BasicQueryInfo queryInfo : dispatcherQueryManager.getQueries()) {
