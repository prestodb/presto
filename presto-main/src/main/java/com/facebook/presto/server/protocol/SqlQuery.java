...
{
    private static final Logger log = Logger.get(SqlQuery.class);
    ...
    {
        SqlQuery result = new SqlQuery(queryId, sessionContext, query, queryManager, sessionPropertyManager, exchangeClient, dataProcessorExecutor, timeoutExecutor, blockEncodingSerde);
            ...
            implements QueryFactory<SqlQuery>
    {
        ...
        @Override
        public SqlQuery create(QueryId queryId, String query, SessionContext sessionContext)
        {
