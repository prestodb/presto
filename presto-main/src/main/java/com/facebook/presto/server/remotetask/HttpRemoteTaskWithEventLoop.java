        ...
        implements RemoteTask
{
    ...
    private final boolean taskUpdateRequestThriftTransportEnabled;
    private final boolean taskInfoResponseThriftTransportEnabled;
    ...
    private void sendUpdate()
    {
        safeExecuteOnEventLoop(() -> {
            ...
            requestBuilder = setTaskUpdateRequestContentTypeHeaders(taskUpdateRequestThriftTransportEnabled, binaryTransportEnabled, preparePost());
            requestBuilder = setTaskInfoAcceptTypeHeaders(taskInfoResponseThriftTransportEnabled, binaryTransportEnabled, requestBuilder);
            ...
            if (taskInfoResponseThriftTransportEnabled) {
