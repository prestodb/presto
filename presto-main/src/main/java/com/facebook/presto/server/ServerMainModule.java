...
import com.facebook.presto.server.thrift.ConnectorTransactionHandleThriftCodec;
        ...
        extends AbstractConfigurationAwareModule
{
    ...
    protected void setup(Binder binder)
    {
        ...
        thriftCodecBinder(binder).bindCustomThriftCodec(ConnectorTransactionHandleThriftCodec.class);
        ...
        jsonCodecBinder(binder).bindJsonCodec(Split.ConnectorSplitWrapper.class);
        jsonCodecBinder(binder).bindJsonCodec(Split.ConnectorTransactionHandleWrapper.class);
