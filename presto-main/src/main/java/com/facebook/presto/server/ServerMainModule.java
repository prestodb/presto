...
import com.facebook.presto.execution.TaskExecutionFactory;
import com.facebook.presto.execution.TaskExecutor;
import com.facebook.presto.execution.TaskInfo;
import com.facebook.presto.execution.TaskManager;
import com.facebook.presto.execution.TaskManagerConfig;
import com.facebook.presto.execution.TaskNotificationExecutor;
        ...
        extends AbstractConfigurationAwareModule
{
    ...
    protected void setup(Binder binder)
    {
        ...
        binder.bind(TaskExecutionFactory.class).to(SqlTaskExecutionFactory.class).in(Scopes.SINGLETON);
        binder.bind(TaskExecutor.class).in(Scopes.SINGLETON);
        newExporter(binder).export(TaskExecutor.class).withGeneratedName();
        binder.bind(TaskNotificationExecutor.class).in(Scopes.SINGLETON);
        newExporter(binder).export(TaskNotificationExecutor.class).withGeneratedName();
