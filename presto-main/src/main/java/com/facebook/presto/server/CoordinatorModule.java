...
import com.facebook.presto.execution.ReleaseSavepointTask;
...
import com.facebook.presto.execution.RollbackToSavepointTask;
import com.facebook.presto.execution.SavepointTask;
        ...
        extends AbstractConfigurationAwareModule
{
    ...
    protected void setup(Binder binder)
    {
        ...
        bindDataDefinitionTask(binder, executionBinder, Savepoint.class, SavepointTask.class);
        bindDataDefinitionTask(binder, executionBinder, RollbackToSavepoint.class, RollbackToSavepointTask.class);
        bindDataDefinitionTask(binder, executionBinder, ReleaseSavepoint.class, ReleaseSavepointTask.class);
