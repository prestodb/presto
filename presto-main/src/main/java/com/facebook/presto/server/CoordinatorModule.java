...
import com.facebook.presto.execution.CreateFunctionSchemaTask;
...
import com.facebook.presto.execution.DropFunctionSchemaTask;
        ...
        extends AbstractConfigurationAwareModule
{
    ...
    protected void setup(Binder binder)
    {
        ...
        bindDataDefinitionTask(binder, executionBinder, CreateFunctionSchema.class, CreateFunctionSchemaTask.class);
        bindDataDefinitionTask(binder, executionBinder, DropFunctionSchema.class, DropFunctionSchemaTask.class);
