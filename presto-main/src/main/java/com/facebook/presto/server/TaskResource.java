...
import static com.facebook.presto.tracing.TracingManager.getSpan;
...
public class TaskResource
{
            ...
            @HeaderParam("traceparent") String traceParent)
    {
        ...
        BaseSpan span = getSpan(traceParent, "POST /v1/task/{taskId}");
            ...
            @HeaderParam("traceparent") String traceParent)
    {
        ...
        BaseSpan span = getSpan(traceParent, "GET /v1/task/{taskId}");
