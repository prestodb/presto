...
public class TaskResource
{
    ...
    @GET
    @Path("{taskId}/status")
    @Consumes({APPLICATION_JSON, APPLICATION_JACKSON_SMILE, TYPE_BINARY, TYPE_COMPACT, TYPE_FBCOMPACT})
    @Produces({APPLICATION_JSON, APPLICATION_JACKSON_SMILE, TYPE_BINARY, TYPE_COMPACT, TYPE_FBCOMPACT})
