        ...
        extends ParametricScalar
{
    ...
    private static final Signature SIGNATURE = new Signature(FUNCTION_NAME, ImmutableList.of(typeParameter("T")), StandardTypes.VARCHAR,
            ImmutableList.of("array<T>", StandardTypes.VARCHAR),
            false, false);

    private static class ArrayJoinWithNullReplacement extends ParametricScalar
    {
        private final Signature signature = new Signature(FUNCTION_NAME, ImmutableList.of(typeParameter("T")), StandardTypes.VARCHAR,
    ...
    public static Slice arrayJoin(FunctionInfo castFunction, Type elementType, ConnectorSession session, Slice array, Slice delimiter) throws Throwable
    {
    ...
    public static Slice arrayJoin(FunctionInfo castFunction, Type elementType, ConnectorSession session, Slice array, Slice delimiter, Slice nullReplacement)
    {
        ...
        if (castFunction != null) { //can be null for the unknown type
