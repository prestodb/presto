        ...
        extends ParametricScalar
{
    ...
    public static Slice sort(final Type type, Slice encodedArray)
    {
        Block block = StructBuilder.readBlock(encodedArray.getInput());
        ...
        StructBuilder builder = StructBuilder.arrayBuilder(type);

        for (int position : positions) {
            builder.add(block, position);
        }
