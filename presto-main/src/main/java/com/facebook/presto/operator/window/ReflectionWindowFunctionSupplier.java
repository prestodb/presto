        ...
        extends AbstractWindowFunctionSupplier
{
    ...
    {
        this(new Signature(FullyQualifiedName.of(DEFAULT_NAMESPACE, name), WINDOW, returnType.getTypeSignature(), Lists.transform(argumentTypes, Type::getTypeSignature)), type);
    }
