        ...
        extends ScalarImplementationDependency
{
    ...
    @Override
    protected FunctionHandle getFunctionHandle(BoundVariables boundVariables, TypeAndFunctionManager typeAndFunctionManager)
    {
        return typeAndFunctionManager.lookupFunction(name, fromTypeSignatures(applyBoundVariables(argumentTypes, boundVariables)));
    }
