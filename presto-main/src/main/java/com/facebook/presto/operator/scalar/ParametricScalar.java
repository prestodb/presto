        ...
        extends SqlScalarFunction
{
    ...
    public BuiltInScalarFunctionImplementation specialize(BoundVariables boundVariables, int arity, TypeManager typeManager, FunctionAndTypeManager functionAndTypeManager)
    {
        ...
        if (implementations.getExactImplementations().containsKey(boundSignature)) {
            ...
            Optional<BuiltInScalarFunctionImplementation> scalarFunctionImplementation = implementation.specialize(boundSignature, boundVariables, typeManager, functionAndTypeManager);
