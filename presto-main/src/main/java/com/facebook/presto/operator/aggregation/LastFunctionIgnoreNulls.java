...
public class LastFunctionIgnoreNulls
        extends AbstractFirstLastFunction
{
    public static final LastFunctionIgnoreNulls LAST_FUNCTION_IGNORE_NULLS = new LastFunctionIgnoreNulls();

    public LastFunctionIgnoreNulls()
    {
        super(ImmutableList.of(parseTypeSignature("T"), parseTypeSignature(StandardTypes.BOOLEAN)), "last");
    }
    ...
    {
        return methodHandle(LastFunctionIgnoreNulls.class, "input", BlockState.class, Block.class, Block.class, int.class);
    }

    @Override
    protected MethodHandle getCombineFunction()
    {
        return methodHandle(LastFunctionIgnoreNulls.class, "combine", BlockState.class, BlockState.class);
    }
