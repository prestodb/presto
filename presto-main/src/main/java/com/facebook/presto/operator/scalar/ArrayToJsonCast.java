...
import static com.facebook.presto.type.ArrayType.stackRepresentationToObject;
        ...
        extends ParametricOperator
{
    ...
    public static Slice toJson(Type elementType, ConnectorSession session, Slice array)
    {
        Object object = stackRepresentationToObject(session, array.getInput(), elementType);
        try {
