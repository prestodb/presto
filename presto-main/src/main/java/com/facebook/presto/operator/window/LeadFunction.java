...
@WindowFunctionSignature(name = "lead", typeVariables = "T", returnType = "T", argumentTypes = "T")
@WindowFunctionSignature(name = "lead", typeVariables = "T", returnType = "T", argumentTypes = {"T", "bigint"})
@WindowFunctionSignature(name = "lead", typeVariables = "T", returnType = "T", argumentTypes = {"T", "bigint", "T"})
