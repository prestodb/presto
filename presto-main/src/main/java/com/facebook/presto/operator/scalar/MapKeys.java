        ...
        implements ParametricFunction
{
    ...
    private static final Signature SIGNATURE = new Signature("map_keys", SCALAR, ImmutableList.of(typeParameter("K"), typeParameter("V")), "array<K>", ImmutableList.of("map<K,V>"), false, false);
