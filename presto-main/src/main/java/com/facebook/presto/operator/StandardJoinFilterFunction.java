        ...
        implements JoinFilterFunction
{
    ...
    private final LongBigArray addresses;
    private final List<Page> pages;

    public StandardJoinFilterFunction(InternalJoinFilterFunction filterFunction, LongBigArray addresses, List<Page> pages)
    {
