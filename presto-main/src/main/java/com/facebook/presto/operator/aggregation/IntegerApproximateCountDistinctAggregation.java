...
public class IntegerApproximateCountDistinctAggregation
        extends SqlAggregationFunction
{
    public static final IntegerApproximateCountDistinctAggregation INTEGER_APPROXIMATE_COUNT_DISTINCT_AGGREGATION = new IntegerApproximateCountDistinctAggregation();
    private static final String NAME = "approx_distinct";
    private static final MethodHandle INPUT_FUNCTION = methodHandle(IntegerApproximateCountDistinctAggregation.class, "input", HyperLogLogState.class, long.class, double.class);
    private static final MethodHandle BLOCK_INPUT_FUNCTION = methodHandle(IntegerApproximateCountDistinctAggregation.class, "blockInput", HyperLogLogState.class, Block.class, Block.class);
    private static final MethodHandle COMBINE_FUNCTION = methodHandle(IntegerApproximateCountDistinctAggregation.class, "combine", HyperLogLogState.class, HyperLogLogState.class);
    private static final MethodHandle OUTPUT_FUNCTION = methodHandle(IntegerApproximateCountDistinctAggregation.class, "output", HyperLogLogState.class, BlockBuilder.class);

    public IntegerApproximateCountDistinctAggregation()
    {
        super(NAME,
                ImmutableList.of(),
                ImmutableList.of(),
                parseTypeSignature(StandardTypes.BIGINT),
                ImmutableList.of(parseTypeSignature(StandardTypes.INTEGER), parseTypeSignature(StandardTypes.DOUBLE)));
    }

    private static BuiltInAggregationFunctionImplementation generateAggregation(Type type)
    {
        DynamicClassLoader classLoader = new DynamicClassLoader(IntegerApproximateCountDistinctAggregation.class.getClassLoader());
