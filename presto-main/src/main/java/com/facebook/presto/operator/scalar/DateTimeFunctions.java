...
public final class DateTimeFunctions
{
    ...
    @ScalarFunction
    @SqlType(TimestampWithTimeZoneType.class)
    public static long atTimeZone(@SqlType(TimestampWithTimeZoneType.class) long timestampWithTimeZone, Slice zoneId)
    {
    ...
    @ScalarFunction
    @SqlType(TimestampWithTimeZoneType.class)
    public static long atTimeZone(@SqlType(TimestampWithTimeZoneType.class) long timestampWithTimeZone, @SqlType(IntervalDayTimeType.class) long zoneOffset)
    {
    ...
    private static long dateAdd(ISOChronology chronology, Slice unit, long value, long milliseconds)
    {
        ...
        switch (unitString) {
            ...
            case "quarter":
                return chronology.monthOfYear().add(milliseconds, intValue * 3);
            case "year":
