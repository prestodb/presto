        ...
        extends SqlAggregationFunction
{
    ...
    @Override
    public InternalAggregationFunction specialize(BoundVariables boundVariables, int arity, TypeAndFunctionManager typeAndFunctionManager)
    {
        Type inputType = getOnlyElement(applyBoundVariables(typeAndFunctionManager, getSignature().getArgumentTypes(), boundVariables));
        Type outputType = applyBoundVariables(typeAndFunctionManager, getSignature().getReturnType(), boundVariables);
