        ...
        extends SqlOperator
{
    ...
    public BuiltInScalarFunctionImplementation specialize(BoundVariables boundVariables, int arity, TypeAndFunctionManager typeAndFunctionManager)
    {
        ...
        Class<?> castOperatorClass = generateRowCast(fromType, toType, typeAndFunctionManager);
    ...
    private static Class<?> generateRowCast(Type fromType, Type toType, TypeAndFunctionManager typeAndFunctionManager)
    {
        ...
        for (int i = 0; i < toTypes.size(); i++) {
            FunctionHandle functionHandle = typeAndFunctionManager.lookupCast(CastType.CAST, fromTypes.get(i).getTypeSignature(), toTypes.get(i).getTypeSignature());
