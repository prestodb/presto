            ...
            implements OutputFactory
    {
                ...
                PagesSerdeFactory serdeFactory)
        {
            ...
            return new OptimizedPartitionedOutputOperatorFactory(
                    ...
                    types,
                    pagePreprocessor,
                    outputPartitioning.orElseThrow().getPartitionFunction(),
                    outputPartitioning.orElseThrow().getPartitionChannels(),
                    outputPartitioning.orElseThrow().getPartitionConstants(),
                    outputPartitioning.orElseThrow().isReplicateNullsAndAny(),
                    outputPartitioning.orElseThrow().getNullChannel(),
                    outputBuffer,
                    serdeFactory,
                    maxMemory);
        }
