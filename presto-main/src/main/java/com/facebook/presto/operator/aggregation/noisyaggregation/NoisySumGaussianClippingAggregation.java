...
public class NoisySumGaussianClippingAggregation
        extends SqlAggregationFunction
{
    ...
    {
        return "Calculates the sum over the input values where values are clipped to [lower, upper] range and then adds random Gaussian noise.";
    }
