        ...
        implements Operator
{
            ...
            implements OperatorFactory
    {
        ...
        public TableWriterOperatorFactory(int operatorId, RecordSink recordSink, List<Type> recordTypes, Optional<Integer> sampleWeightChannel)
        {
        ...
        public Operator createOperator(DriverContext driverContext)
        {
            ...
            return new TableWriterOperator(context, recordSink, recordTypes, sampleWeightChannel);
        }
    ...
    public TableWriterOperator(OperatorContext operatorContext, RecordSink recordSink, List<com.facebook.presto.sql.analyzer.Type> recordTypes, Optional<Integer> sampleWeightChannel)
    {
        this.operatorContext = checkNotNull(operatorContext, "operatorContext is null");
        this.recordSink = checkNotNull(recordSink, "recordSink is null");
        this.recordTypes = recordTypes;
        this.sampleWeightChannel = checkNotNull(sampleWeightChannel, "sampleWeightChannel is null");
        this.inputChannels = new int[recordTypes.size()];
