...
public class SamplingOperator
    ...
    public SamplingOperator(Operator source, double samplingRatio, ProjectionFunction... projections)
    {
        this(source, samplingRatio, ImmutableList.copyOf(projections));
    }

    public SamplingOperator(Operator source, double samplingRatio, List<ProjectionFunction> projections)
    {
    ...
    {
        return new SamplingIterator(source, samplingRatio, projections, operatorStats);
    }
    ...
    public static class SamplingIterator
        ...
        public SamplingIterator(PageIterator pageIterator, double samplingRatio, List<ProjectionFunction> projections, OperatorStats operatorStats)
        {
