        ...
        implements PositionLinks
{
            ...
            implements PositionLinks.FactoryBuilder
    {
        ...
        public FactoryBuilder(int size, PagesHashStrategy pagesHashStrategy, LongBigArray addresses)
        {
            this.size = size;
    ...
    public static FactoryBuilder builder(int size, PagesHashStrategy pagesHashStrategy, LongBigArray addresses)
    {
            ...
            implements IntComparator
    {
        ...
        PositionComparator(PagesHashStrategy pagesHashStrategy, LongBigArray addresses)
        {
            this.pagesHashStrategy = pagesHashStrategy;
            this.addresses = addresses;
        }
