        ...
        extends ParametricAggregation
{
    ...
    private static final MethodHandle OUTPUT_FUNCTION = methodHandle(MinBy.class, "output", Type.class, MaxOrMinByState.class, BlockBuilder.class);
    private static final MethodHandle INPUT_FUNCTION = methodHandle(MinBy.class, "input", Type.class, MaxOrMinByState.class, Block.class, Block.class, int.class);
    private static final MethodHandle COMBINE_FUNCTION = methodHandle(MinBy.class, "combine", Type.class, MaxOrMinByState.class, MaxOrMinByState.class);
