        ...
        implements Operator
{
    ...
    public void finish()
    {
        ...
        finishing = true;
        PagesSpatialIndexSupplier spatialIndex = index.createPagesSpatialIndex(operatorContext.getSession(), indexChannel, spatialRelationshipTest, filterFunctionFactory, outputChannels);
