...
public class RowNumberOperatorFactory
        implements OperatorFactory
{
    ...
    private static class RowNumberProcessor
            implements ProcessorBase, ProcessorInput<Page>, ProcessorPageOutput, ClusterBoundaryCallback
    {
        ...
        @Override
        public SimpleOperator.ProcessorState addInput(@Nullable Page page)
        {
            if (page == null) {
                return NEEDS_INPUT;
            }
        ...
        @Override
        public SimpleOperator.ProcessorState clusterBoundary()
        {
