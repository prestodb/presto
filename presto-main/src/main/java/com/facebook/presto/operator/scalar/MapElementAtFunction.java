        ...
        extends SqlScalarFunction
{
    ...
    public BuiltInScalarFunctionImplementation specialize(BoundVariables boundVariables, int arity, TypeAndFunctionManager typeAndFunctionManager)
    {
        ...
        MethodHandle keyEqualsMethod = typeAndFunctionManager.getBuiltInScalarFunctionImplementation(
                typeAndFunctionManager.resolveOperatorHandle(OperatorType.EQUAL, fromTypes(keyType, keyType))).getMethodHandle();
