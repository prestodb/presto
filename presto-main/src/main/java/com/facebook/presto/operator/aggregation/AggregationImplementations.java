...
public class AggregationImplementations
{
    ...
    private final Map<Signature, AggregationImplementation> exactImplementations;
    // These are implementations for when a type parameter binds to a specific native container type
    private final List<AggregationImplementation> specializedImplementations;
    // These are generic implementations
    private final List<AggregationImplementation> genericImplementations;

    public AggregationImplementations(Map<Signature, AggregationImplementation> exactImplementations, List<AggregationImplementation> specializedImplementations, List<AggregationImplementation> genericImplementations)
    {
    ...
    public List<AggregationImplementation> getGenericImplementations()
    {
        return genericImplementations;
    }

    public Map<Signature, AggregationImplementation> getExactImplementations()
    {
        return exactImplementations;
    }

    public List<AggregationImplementation> getSpecializedImplementations()
    {
