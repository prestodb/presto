        ...
        extends SqlAggregationFunction
{
    ...
    private static final MethodHandle SHORT_DECIMAL_INPUT_FUNCTION = methodHandle(NoisySumGaussianClippingRandomSeedAggregation.class, "inputShortDecimal", NoisySumState.class, Block.class, Block.class, Block.class, Block.class, Block.class, int.class);
    private static final MethodHandle LONG_DECIMAL_INPUT_FUNCTION = methodHandle(NoisySumGaussianClippingRandomSeedAggregation.class, "inputLongDecimal", NoisySumState.class, Block.class, Block.class, Block.class, Block.class, Block.class, int.class);
    private static final MethodHandle DOUBLE_INPUT_FUNCTION = methodHandle(NoisySumGaussianClippingRandomSeedAggregation.class, "inputDouble", NoisySumState.class, Block.class, Block.class, Block.class, Block.class, Block.class, int.class);
    private static final MethodHandle REAL_INPUT_FUNCTION = methodHandle(NoisySumGaussianClippingRandomSeedAggregation.class, "inputReal", NoisySumState.class, Block.class, Block.class, Block.class, Block.class, Block.class, int.class);
    private static final MethodHandle BIGINT_INPUT_FUNCTION = methodHandle(NoisySumGaussianClippingRandomSeedAggregation.class, "inputBigInt", NoisySumState.class, Block.class, Block.class, Block.class, Block.class, Block.class, int.class);
    private static final MethodHandle INTEGER_INPUT_FUNCTION = methodHandle(NoisySumGaussianClippingRandomSeedAggregation.class, "inputInteger", NoisySumState.class, Block.class, Block.class, Block.class, Block.class, Block.class, int.class);
    private static final MethodHandle SMALLINT_INPUT_FUNCTION = methodHandle(NoisySumGaussianClippingRandomSeedAggregation.class, "inputSmallInt", NoisySumState.class, Block.class, Block.class, Block.class, Block.class, Block.class, int.class);
    private static final MethodHandle TINYINT_INPUT_FUNCTION = methodHandle(NoisySumGaussianClippingRandomSeedAggregation.class, "inputTinyInt", NoisySumState.class, Block.class, Block.class, Block.class, Block.class, Block.class, int.class);

    private static final MethodHandle OUTPUT_FUNCTION = methodHandle(NoisySumGaussianClippingRandomSeedAggregation.class, "output", NoisySumState.class, BlockBuilder.class);

    private static final MethodHandle COMBINE_FUNCTION = methodHandle(NoisySumGaussianClippingRandomSeedAggregation.class, "combine", NoisySumState.class, NoisySumState.class);
    ...
    public static void inputShortDecimal(NoisySumState state, Block valueBlock, Block noiseScaleBlock, Block lowerBlock, Block upperBlock, Block randomSeedBlock, int position)
    {
    ...
    public static void inputLongDecimal(NoisySumState state, Block valueBlock, Block noiseScaleBlock, Block lowerBlock, Block upperBlock, Block randomSeedBlock, int position)
    {
        double value = unscaledDecimalToBigInteger(
    ...
    public static void inputDouble(NoisySumState state, Block valueBlock, Block noiseScaleBlock, Block lowerBlock, Block upperBlock, Block randomSeedBlock, int position)
    {
        double value = DOUBLE.getDouble(valueBlock, position);
        input(state, value, noiseScaleBlock, lowerBlock, upperBlock, randomSeedBlock, position);
    }

    public static void inputReal(NoisySumState state, Block valueBlock, Block noiseScaleBlock, Block lowerBlock, Block upperBlock, Block randomSeedBlock, int position)
    {
        double value = intBitsToFloat((int) REAL.getLong(valueBlock, position));
        input(state, value, noiseScaleBlock, lowerBlock, upperBlock, randomSeedBlock, position);
    }

    public static void inputBigInt(NoisySumState state, Block valueBlock, Block noiseScaleBlock, Block lowerBlock, Block upperBlock, Block randomSeedBlock, int position)
    {
        double value = BIGINT.getLong(valueBlock, position);
        input(state, value, noiseScaleBlock, lowerBlock, upperBlock, randomSeedBlock, position);
    }

    public static void inputInteger(NoisySumState state, Block valueBlock, Block noiseScaleBlock, Block lowerBlock, Block upperBlock, Block randomSeedBlock, int position)
    {
        double value = INTEGER.getLong(valueBlock, position);
        input(state, value, noiseScaleBlock, lowerBlock, upperBlock, randomSeedBlock, position);
    }

    public static void inputSmallInt(NoisySumState state, Block valueBlock, Block noiseScaleBlock, Block lowerBlock, Block upperBlock, Block randomSeedBlock, int position)
    {
        double value = SMALLINT.getLong(valueBlock, position);
        input(state, value, noiseScaleBlock, lowerBlock, upperBlock, randomSeedBlock, position);
    }

    public static void inputTinyInt(NoisySumState state, Block valueBlock, Block noiseScaleBlock, Block lowerBlock, Block upperBlock, Block randomSeedBlock, int position)
    {
        double value = TINYINT.getLong(valueBlock, position);
        input(state, value, noiseScaleBlock, lowerBlock, upperBlock, randomSeedBlock, position);
    }

    private static void input(NoisySumState state, double value, Block noiseScaleBlock, Block lowerBlock, Block upperBlock, Block randomSeedBlock, int position)
    {
        ...
        updateNoisySumState(state, value, noiseScale, lower, upper, randomSeed);
    }
