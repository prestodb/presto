...
{
    public static Provider<DoubleAverageAggregation> doubleAverageAggregation(final int channelIndex, final int field)
    {
        return new Provider<DoubleAverageAggregation>()
        {
            @Override
