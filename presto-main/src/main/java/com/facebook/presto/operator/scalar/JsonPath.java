...
public class JsonPath
{
    ...
    {
        return new JsonPath(JsonExtract.generateExtractor(pattern, new JsonExtract.ScalarValueJsonExtractorAbstract()),
                JsonExtract.generateExtractor(pattern, new JsonExtract.JsonValueJsonExtractorAbstract()),
                JsonExtract.generateExtractor(pattern, new JsonExtract.JsonSizeExtractorAbstract()));
    }
