        ...
        implements Operator
{
            ...
            implements OperatorFactory
    {
        ...
        public Operator createOperator(DriverContext driverContext)
        {
            ...
            return new ExplainAnalyzeOperator(operatorContext, queryPerformanceFetcher, typeAndFunctionManager, verbose);
        }
        ...
        {
            return new ExplainAnalyzeOperatorFactory(operatorId, planNodeId, queryPerformanceFetcher, typeAndFunctionManager, verbose);
        }
    }
    ...
    public Page getOutput()
    {
        ...
        String plan = textDistributedPlan(queryInfo.getOutputStage().get().getSubStages().get(0), typeAndFunctionManager, operatorContext.getSession(), verbose);
