        ...
        implements Operator
{
            ...
            implements OperatorFactory
    {
        ...
        public Operator createOperator(DriverContext driverContext)
        {
            ...
            return new ExplainAnalyzeOperator(operatorContext, queryPerformanceFetcher, functionManager, statsCalculator, costCalculator, verbose);
        }
        ...
        {
            return new ExplainAnalyzeOperatorFactory(operatorId, planNodeId, queryPerformanceFetcher, functionManager, statsCalculator, costCalculator, verbose);
        }
    }
    ...
    public Page getOutput()
    {
        ...
        String plan = textDistributedPlan(queryInfo.getOutputStage().get().getSubStages().get(0), functionManager, statsCalculator, costCalculator, operatorContext.getSession(), verbose);
