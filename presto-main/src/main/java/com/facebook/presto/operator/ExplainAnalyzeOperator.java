        ...
        implements Operator
{
            ...
            implements OperatorFactory
    {
        ...
        public ExplainAnalyzeOperatorFactory(int operatorId, PlanNodeId planNodeId, QueryPerformanceFetcher queryPerformanceFetcher, Metadata metadata, Lookup lookup, boolean verbose)
        {
        ...
        public Operator createOperator(DriverContext driverContext)
        {
            ...
            return new ExplainAnalyzeOperator(operatorContext, queryPerformanceFetcher, metadata, lookup, verbose);
        }
        ...
        {
            return new ExplainAnalyzeOperatorFactory(operatorId, planNodeId, queryPerformanceFetcher, metadata, lookup, verbose);
        }
    }
    ...
    public ExplainAnalyzeOperator(OperatorContext operatorContext, QueryPerformanceFetcher queryPerformanceFetcher, Metadata metadata, Lookup lookup, boolean verbose)
    {
    ...
    public Page getOutput()
    {
        ...
        String plan = textDistributedPlan(queryInfo.getOutputStage().get(), metadata, lookup, operatorContext.getSession(), verbose);
