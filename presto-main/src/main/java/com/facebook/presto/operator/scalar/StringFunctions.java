...
public final class StringFunctions
{
    ...
    @LiteralParameters("x")
    @SqlType("varchar(x)")
    public static Slice reverse(@ScalarPropagateSourceStats @SqlType("varchar(x)") Slice slice)
    {
    ...
    public static long stringPosition(
            @ScalarPropagateSourceStats(
                    ...
                    distinctValuesCount = USE_TYPE_WIDTH_VARCHAR) @SqlType("varchar(x)") Slice string,
    ...
    public static long stringPosition(
            @ScalarPropagateSourceStats(
                    ...
                    nullFraction = USE_SOURCE_STATS) @SqlType("varchar(x)") Slice string,
            @SqlType("varchar(y)") Slice substring,
    ...
    @LiteralParameters("x")
    @SqlType("varchar(x)")
    public static Slice leftTrim(@ScalarPropagateSourceStats @SqlType("varchar(x)") Slice slice)
    {
    ...
    @LiteralParameters("x")
    @SqlType("char(x)")
    public static Slice charLeftTrim(@ScalarPropagateSourceStats @SqlType("char(x)") Slice slice)
    {
        return SliceUtf8.leftTrim(slice);
    }
    ...
    @LiteralParameters("x")
    @SqlType("varchar(x)")
    public static Slice rightTrim(@ScalarPropagateSourceStats @SqlType("varchar(x)") Slice slice)
    {
    ...
    @LiteralParameters("x")
    @SqlType("char(x)")
    public static Slice charRightTrim(@ScalarPropagateSourceStats @SqlType("char(x)") Slice slice)
    {
    ...
    @LiteralParameters("x")
    @SqlType("varchar(x)")
    public static Slice trim(@ScalarPropagateSourceStats @SqlType("varchar(x)") Slice slice)
    {
    ...
    @LiteralParameters("x")
    @SqlType("char(x)")
    public static Slice charTrim(@ScalarPropagateSourceStats @SqlType("char(x)") Slice slice)
    {
        return trim(slice);
    }
    ...
    @LiteralParameters("x")
    @SqlType("varchar(x)")
    public static Slice leftTrim(@ScalarPropagateSourceStats @SqlType("varchar(x)") Slice slice, @SqlType(CodePointsType.NAME) int[] codePointsToTrim)
    {
    ...
    @LiteralParameters("x")
    @SqlType("char(x)")
    public static Slice charLeftTrim(@ScalarPropagateSourceStats @SqlType("char(x)") Slice slice, @SqlType(CodePointsType.NAME) int[] codePointsToTrim)
    {
    ...
    @LiteralParameters("x")
    @SqlType("varchar(x)")
    public static Slice rightTrim(@ScalarPropagateSourceStats @SqlType("varchar(x)") Slice slice, @SqlType(CodePointsType.NAME) int[] codePointsToTrim)
    {
    ...
    @LiteralParameters("x")
    @SqlType("char(x)")
    public static Slice charRightTrim(@ScalarPropagateSourceStats @SqlType("char(x)") Slice slice, @SqlType(CodePointsType.NAME) int[] codePointsToTrim)
    {
    ...
    public static Slice charTrim(
            @ScalarPropagateSourceStats @SqlType("char(x)") Slice slice,
            @SqlType(CodePointsType.NAME) int[] codePointsToTrim)
    {
    ...
    @LiteralParameters("x")
    @SqlType("varchar(x)")
    public static Slice lower(@ScalarPropagateSourceStats @SqlType("varchar(x)") Slice slice)
    {
    ...
    @LiteralParameters("x")
    @SqlType("char(x)")
    public static Slice charLower(@ScalarPropagateSourceStats @SqlType("char(x)") Slice slice)
    {
        return lower(slice);
    }
    ...
    @LiteralParameters("x")
    @SqlType("varchar(x)")
    public static Slice upper(@ScalarPropagateSourceStats @SqlType("varchar(x)") Slice slice)
    {
    ...
    @LiteralParameters("x")
    @SqlType("char(x)")
    public static Slice charUpper(@ScalarPropagateSourceStats @SqlType("char(x)") Slice slice)
    {
        return upper(slice);
    }
    ...
    public static Slice leftPad(
            @ScalarPropagateSourceStats(propagateAllStats = false, avgRowSize = SUM_ARGUMENTS) @SqlType("varchar(x)") Slice text,
    ...
    public static Slice rightPad(
            @ScalarPropagateSourceStats(propagateAllStats = false, avgRowSize = SUM_ARGUMENTS, nullFraction = SUM_ARGUMENTS) @SqlType("varchar(x)") Slice text,
            @SqlType(StandardTypes.BIGINT) long targetLength,
            @SqlType("varchar(y)") Slice padString)
    {
