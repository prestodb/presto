...
import com.facebook.presto.operator.aggregation.StatisticalQuantileDigest;
import com.facebook.presto.operator.aggregation.StatisticalTDigest;
        ...
        implements AccumulatorStateFactory<StatisticalDigestState>
{
    ...
    {
        return new StatisticalDigestStateFactory<QuantileDigest>((slice) -> new StatisticalQuantileDigest(new QuantileDigest(slice)));
    }
