...
public class AriaHash
{
    ...
    static boolean useBloomFilter;

    static boolean recycleTable;
                ...
                extends ExprContext
    {
        ...
        long hashRow(long row)
        {
            ...
            long h;
            // Refactor note: renamed variables to remove "__", also h gets reassigned, not deleting the code in case
            // it is in the middle of being refactored. TODO: cleanup
            long k1 = getLongUnchecked(kslice, koffset + 0);
            k1 *= 0xc6a4a7935bd1e995L;
            k1 ^= k1 >> 47;
            h = k1 * 0xc6a4a7935bd1e995L;

            long k0 = getLongUnchecked(kslice, koffset + 8);
            k0 *= 0xc6a4a7935bd1e995L;
            k0 ^= k0 >> 47;
            k0 *= 0xc6a4a7935bd1e995L;
            h ^= k0;
                ...
                extends ExprContext
    {
        ...
        AriaProbe(AriaLookupSource[] tables,
                  LocalPartitionGenerator partitionGenerator,
                  boolean reuseResult)
        {
            this.tables = tables;
        ...
        public void addInput(JoinProbe probe)
        {
            ...
            if (!hashPrecomputed) {
                for (int i = 0; i < candidateFill; ++i) {
                    ...
                    // Refactoring note: commented this block out since it is overriden
                    // Did not delete in case this code is in the middle of being worked on
                    // TODO: cleanup
                    long h;
        ...
        public Page getOutput()
        {
            ...
            for (; currentProbe + 3 < unrollFill; currentProbe += 4) {
                ...
                if (hits0 != 0) {
                    ...
                    match0 = getLongUnchecked(g0slice, g0offset + 0) == k1d[k1Map[row0]]
                ...
                if (hits1 != 0) {
                    ...
                    match1 = getLongUnchecked(g1slice, g1offset + 0) == k1d[k1Map[row1]]
                ...
                if (hits2 != 0) {
                    ...
                    match2 = getLongUnchecked(g2slice, g2offset + 0) == k1d[k1Map[row2]]
                ...
                if (hits3 != 0) {
                    ...
                    match3 = getLongUnchecked(g3slice, g3offset + 0) == k1d[k1Map[row3]]
