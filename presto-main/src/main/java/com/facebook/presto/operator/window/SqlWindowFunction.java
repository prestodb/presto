        ...
        extends BuiltInFunction
{
    ...
    public WindowFunctionSupplier specialize(BoundVariables boundVariables, int arity, TypeManager typeManager, FunctionAndTypeManager functionAndTypeManager)
    {
        return supplier;
    }
}
