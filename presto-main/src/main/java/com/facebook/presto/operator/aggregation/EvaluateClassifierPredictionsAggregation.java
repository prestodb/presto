        ...
        implements AggregationFunction
{
    ...
    {
        return ImmutableList.of(TupleInfo.Type.FIXED_INT_64, TupleInfo.Type.FIXED_INT_64);
    }
            ...
            implements Accumulator
    {
        ...
        public Block evaluateIntermediate()
        {
            ...
            return builder.append(createIntermediate(truePositives, falsePositives, trueNegatives, falseNegatives)).build();
        }
            ...
            implements GroupedAccumulator
    {
        ...
        {
            output.append(createIntermediate(truePositives.get(groupId), falsePositives.get(groupId), trueNegatives.get(groupId), falseNegatives.get(groupId))).build();
        }

        @Override
        public void evaluateFinal(int groupId, BlockBuilder output)
        {
            output.append(formatResults(truePositives.get(groupId), falsePositives.get(groupId), trueNegatives.get(groupId), falseNegatives.get(groupId)));
        }
    }
