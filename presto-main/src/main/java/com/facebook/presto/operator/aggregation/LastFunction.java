...
{
    public static final LastFunction LAST_FUNCTION = new LastFunction();

    public LastFunction()
    {
        super(ImmutableList.of(parseTypeSignature("T")), "last");
    }
    ...
    {
        return methodHandle(LastFunction.class, "input", BlockState.class, Block.class, int.class);
    }
