        ...
        extends ParametricOperator
{
    ...
    public FunctionInfo specialize(Map<String, Type> types, int arity, TypeManager typeManager, FunctionRegistry functionRegistry)
    {
        ...
        MethodHandle methodHandle = methodHandle(ArrayEqualOperator.class, "equals", MethodHandle.class, Type.class, Slice.class, Slice.class);
        MethodHandle method = methodHandle.bindTo(equalsFunction).bindTo(elementType);
    ...
    public static boolean equals(MethodHandle equalsFunction, Type type, Slice left, Slice right)
    {
        ...
        for (int i = 0; i < leftArray.getPositionCount(); i++) {
            ...
            try {
                if (!((Boolean) equalsFunction.invoke(leftElement, rightElement)).booleanValue()) {
                    return false;
                }
            }
            catch (Throwable t) {
