...
public class MarkDistinctHash
{
    ...
    public MarkDistinctHash(List<Type> types, int[] channels, int hashChannel)
    {
        this(types, channels, hashChannel, 10_000);
    }

    public MarkDistinctHash(List<Type> types, int[] channels, int hashChannel, int expectedDistinctValues)
    {
