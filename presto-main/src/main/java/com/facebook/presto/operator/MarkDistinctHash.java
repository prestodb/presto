...
public class MarkDistinctHash
{
    ...
    public MarkDistinctHash(List<TupleInfo.Type> types, int[] channels, MemoryManager memoryManager)
    {
        this(types, channels, memoryManager, 10_000);
    }

    public MarkDistinctHash(List<TupleInfo.Type> types, int[] channels, MemoryManager memoryManager, int expectedDistinctValues)
    {
