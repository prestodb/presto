        ...
        extends ParametricOperator
{
    ...
    public FunctionInfo specialize(Map<String, Type> types, int arity, TypeManager typeManager, FunctionRegistry functionRegistry)
    {
        ...
        MethodHandle methodHandle = methodHandle(ArrayGreaterThanOrEqualOperator.class, "greaterThanOrEqual", MethodHandle.class, Type.class, Slice.class, Slice.class);
        MethodHandle method = methodHandle.bindTo(greaterThanFunction).bindTo(elementType);
    ...
    public static boolean greaterThanOrEqual(MethodHandle greaterThanFunction, Type type, Slice left, Slice right)
    {
        ...
        while (index < len) {
            ...
            try {
                if (((Boolean) greaterThanFunction.invoke(leftElement, rightElement)).booleanValue()) {
                    return true;
                }
                if (((Boolean) greaterThanFunction.invoke(rightElement, leftElement)).booleanValue()) {
                    return false;
                }
            }
            catch (Throwable t) {
