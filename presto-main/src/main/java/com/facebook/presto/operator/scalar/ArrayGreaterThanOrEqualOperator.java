        ...
        extends ParametricOperator
{
    ...
    public FunctionInfo specialize(Map<String, Type> types, int arity, TypeManager typeManager, FunctionRegistry functionRegistry)
    {
        ...
        MethodHandle methodHandle = methodHandle(ArrayGreaterThanOrEqualOperator.class, "greaterThanOrEqual", MethodHandle.class, MethodHandle.class, Type.class, Slice.class, Slice.class);
    ...
    public static boolean greaterThanOrEqual(MethodHandle lessThanFunction, MethodHandle equalsFunction, Type type, Slice left, Slice right)
    {
