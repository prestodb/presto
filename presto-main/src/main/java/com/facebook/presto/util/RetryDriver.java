...
public class RetryDriver
{
    ...
    public RetryDriver allowing(Class<? extends Exception> clazz)
    {
        checkNotNull(clazz, "clazz is null");
        List<Class<? extends Exception>> exceptions = ImmutableList.<Class<? extends Exception>>builder().addAll(exceptionWhitelist).add(clazz).build();
