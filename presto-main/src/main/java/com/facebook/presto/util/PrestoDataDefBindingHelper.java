...
import com.facebook.presto.execution.DropBranchTask;
...
import com.facebook.presto.execution.DropTagTask;
...
public class PrestoDataDefBindingHelper
{
    ...
    static {
        ...
        dataDefBuilder.put(DropBranch.class, DropBranchTask.class);
        dataDefBuilder.put(DropTag.class, DropTagTask.class);
