...
public class PlanNodeStatistics
{
    ...
    private PlanNodeStatistics(Estimate outputRowCount, Estimate outputSizeInBytes)
    {
    ...
    public PlanNodeStatistics mapOutputRowCount(Function<Double, Double> mappingFunction)
    {
    ...
    public static final class Builder
    {
        ...
        {
            return new PlanNodeStatistics(outputRowCount, outputSizeInBytes);
        }
    }
}
