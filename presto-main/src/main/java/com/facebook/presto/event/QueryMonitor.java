...
public class QueryMonitor
{
    ...
    private static void logQueryTimeline(QueryInfo queryInfo)
    {
        try {
            QueryStats queryStats = queryInfo.getQueryStats();
            long queryStartTime = queryStats.getCreateTime().getMillis();
    ...
    {
        long queryStartTimeInMillis = queryInfo.getQueryStats().getCreateTime().getMillis();
        long queryEndTimeInMillis = queryInfo.getQueryStats().getEndTime().getMillis();
