        ...
        implements NodeManager
{
    ...
    {
        URI sidecarUri = UriBuilder.fromUri(nodeManager.getCurrentNode().getInternalUri())
                .port(1234)
                .build();
        return new InternalNode("sidecar-node-identifier", sidecarUri, nodeManager.getCurrentNode().getNodeVersion(), false, false, false, true);
    }
