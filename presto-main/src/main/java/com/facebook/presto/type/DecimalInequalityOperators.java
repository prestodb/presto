...
public class DecimalInequalityOperators
{
    ...
    private static SqlScalarFunction binaryOperator(OperatorType operatorType, MethodHandle getResultMethodHandle)
    {
        ...
        return SqlScalarFunction.builder(DecimalInequalityOperators.class)
                ...
                .implementation(b -> b
                        ...
                        .withPredicate(DecimalInequalityOperators::rescaledDecimalsFitLong)
    ...
    private static boolean rescaledDecimalsFitLong(SpecializeContext context)
    {
        ...
        return aPrecision + aRescaleFactor <= MAX_PRECISION_OF_LONG &&
                bPrecision + bRescaleFactor <= MAX_PRECISION_OF_LONG;
    }
