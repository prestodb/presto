...
public final class TypeJsonUtils
{
    ...
    private static final com.fasterxml.jackson.databind.type.MapType MAP_TYPE =
            OBJECT_MAPPER.getTypeFactory().constructMapType(Map.class, Object.class, Object.class);
    ...
    public static Map<Object, Object> getObjectMap(Slice slice)
    {
