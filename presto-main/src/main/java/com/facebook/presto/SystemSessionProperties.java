...
public final class SystemSessionProperties
{
    ...
    public static final String SKIP_NEW_SOURCE = "skip_new_source";
    ...
    public static boolean isEnableSkipNewSource(Session session)
    {
        return session.getSystemProperty(SKIP_NEW_SOURCE, Boolean.class);
    }
