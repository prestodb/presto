...
public final class SystemSessionProperties
{
    ...
    public static final String ROW_LEVEL_SECURITY_ENABLED = "row_level_security_enabled";
            ...
            FeaturesConfig featuresConfig)
    {
        sessionProperties = ImmutableList.of(
                ...
                booleanProperty(
                        ...
                        featuresConfig.isRowLevelSecurityEnabled(),
                        false));
    }
    ...
    public static boolean isRowLevelSecurityEnabled(Session session)
    {
        return session.getSystemProperty(ROW_LEVEL_SECURITY_ENABLED, Boolean.class);
    }
}
