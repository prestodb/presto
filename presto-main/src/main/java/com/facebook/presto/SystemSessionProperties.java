...
public final class SystemSessionProperties
{
    ...
    public static final String LEGACY_JSON_EXTRACT = "legacy_json_extract";
            ...
            HistoryBasedOptimizationConfig historyBasedOptimizationConfig)
    {
        sessionProperties = ImmutableList.of(
                ...
                booleanProperty(
                        LEGACY_JSON_EXTRACT,
                        "Keep the legacy json extract behavior, do not throw PrestoException when the input json after json path is invalid",
                        functionsConfig.isLegacyJsonExtract(),
                        true),
                booleanProperty(
    ...
    public static boolean isLegacyJsonExtract(Session session)
    {
        return session.getSystemProperty(LEGACY_JSON_EXTRACT, Boolean.class);
    }
}
