        ...
        implements SystemAccessControl
{
    ...
    @Override
    public Set<String> filterCatalogs(ConnectorSession sessions, Set<String> catalogs)
    {
        ImmutableSet.Builder<String> filteredCatalogs = ImmutableSet.builder();
        for (String catalog : catalogs) {
            if (canAccessCatalog(sessions.getIdentity(), catalog)) {
    ...
    {
        if (!canAccessCatalog(session.getIdentity(), catalogName)) {
