...
public class DispatcherConfig
{
    ...
    @Experimental
    @Config("dispatcher.experimental.remote-query-info.min-error-duration")
    ...
    @Experimental
    @Config("dispatcher.experimental.remote-query-info.refresh-max-wait")
    ...
    @Experimental
    @Config("dispatcher.experimental.remote-query-info.update-interval")
    ...
    @Experimental
    @Config("dispatcher.experimental.remote-query.max-callback-threads")
