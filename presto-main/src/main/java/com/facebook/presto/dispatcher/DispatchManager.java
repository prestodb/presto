...
public class DispatchManager
{
            ...
            SecurityConfig securityConfig)
    {
        ...
        this.analyzerProvider = requireNonNull(analyzerProvider, "analyzerFactory is null");
    ...
    private <C> void createQueryInternal(QueryId queryId, String slug, int retryCount, SessionContext sessionContext, String query, ResourceGroupManager<C> resourceGroupManager)
    {
        ...
        try {
            ...
            PreparedQuery preparedQuery = analyzerProvider.getQueryPreparer(getAnalyzerType(session)).prepareQuery(analyzerOptions, query, session.getPreparedStatements(), session.getWarningCollector());
