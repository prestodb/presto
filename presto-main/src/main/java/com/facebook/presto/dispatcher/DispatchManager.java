...
public class DispatchManager
{
     ...
     * @param analyzerProviderManager analyzer provider TODO
    ...
    private <C> void createQueryInternal(QueryId queryId, String slug, int retryCount, SessionContext sessionContext, String query, ResourceGroupManager<C> resourceGroupManager)
    {
        ...
        try {
            ...
            preparedQuery = analyzerProviderManager.getAnalyzerProvider(getAnalyzerType(session).name()).getQueryPreparer().prepareQuery(analyzerOptions, query, session.getPreparedStatements(), session.getWarningCollector());
