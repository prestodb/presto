...
@Path("/v1/catalog")
public class DynamicAddCatalogController
{
    ...
    private static final Logger log = Logger.get(DynamicAddCatalogController.class);
    private final ResponseParser responseParser;

    private DynamicAddCatalogController(CatalogManager catalogManager, ConnectorManager connectorManager, Announcer announcer, InternalNodeManager internalNodeManager, File catalogConfigurationDir, ResponseParser responseParser)
    {
    ...
    @Inject
    public DynamicAddCatalogController(CatalogManager catalogManager, ConnectorManager connectorManager, Announcer announcer, InternalNodeManager internalNodeManager, StaticCatalogStoreConfig config, ResponseParser responseParser)
    {
