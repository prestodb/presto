        ...
        implements TableHandle
{
    ...
    @JsonCreator
    public JdbcTableHandle(@JsonProperty("schemaName") String schemaName, @JsonProperty("tableName") String tableName)
    {
        this.schemaName = checkSchemaName(schemaName);
        this.tableName = checkTableName(tableName);
    }

    public JdbcTableHandle(SchemaTableName tableName)
    {
