...
public class ColumnsJdbcTable
        implements SystemTable
{
    public static final SchemaTableName JDBC_COLUMNS_TABLE_NAME = new SchemaTableName("jdbc", "columns");

    public static final ConnectorTableMetadata JDBC_COLUMNS_TABLE = tableMetadataBuilder(JDBC_COLUMNS_TABLE_NAME)
    ...
    @Inject
    public ColumnsJdbcTable(TaskManager taskManager, NodeInfo nodeInfo)
    {
    ...
    {
        return JDBC_COLUMNS_TABLE;
    }

    @Override
    public List<ColumnType> getColumnTypes()
    {
        return ImmutableList.copyOf(transform(JDBC_COLUMNS_TABLE.getColumns(), columnTypeGetter()));
    }

    @Override
    public RecordCursor cursor()
    {
        Builder table = InMemoryRecordSet.builder(JDBC_COLUMNS_TABLE);
