...
public class JdbcSchemaTableHandle
        implements TableHandle
{
    ...
    @JsonCreator
    public JdbcSchemaTableHandle(@JsonProperty("catalogName") String catalogName, @JsonProperty("schemaName") String schemaName, @JsonProperty("tableName") String tableName)
    {
    ...
    {
        return "jdbc_schema:" + catalogName + ":" + schemaName + ":" + tableName;
    }
    ...
    public boolean equals(Object obj)
    {
        ...
        final JdbcSchemaTableHandle other = (JdbcSchemaTableHandle) obj;
