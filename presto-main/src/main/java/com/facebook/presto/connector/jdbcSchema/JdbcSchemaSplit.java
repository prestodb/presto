...
public class JdbcSchemaSplit
        implements Split
{
    private final JdbcSchemaTableHandle tableHandle;
    private final Map<String, Object> filters;
    private final List<HostAddress> addresses;

    @JsonCreator
    public JdbcSchemaSplit(
            @JsonProperty("tableHandle") JdbcSchemaTableHandle tableHandle,
    ...
    @JsonProperty
    public JdbcSchemaTableHandle getTableHandle()
    {
        return tableHandle;
    }
