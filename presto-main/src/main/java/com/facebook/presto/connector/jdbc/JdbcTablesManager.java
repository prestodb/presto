...
//
public class JdbcTablesManager
{
    private final JdbcTablesMetadata metadata;
    private final JdbcSplitManager splitManager;
    private final JdbcDataStreamProvider dataStreamProvider;

    @Inject
    public JdbcTablesManager(JdbcTablesMetadata metadata, JdbcSplitManager splitManager, JdbcDataStreamProvider dataStreamProvider, Set<SystemTable> tables)
    {
