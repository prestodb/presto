...
public class JdbcTablesMetadata
        extends ReadOnlyConnectorMetadata
{
    ...
    {
        return tableHandle instanceof JdbcTableHandle && tables.containsKey(((JdbcTableHandle) tableHandle).getSchemaTableName());
    }

    private JdbcTableHandle checkTableHandle(TableHandle tableHandle)
    {
        checkNotNull(tableHandle, "tableHandle is null");
        checkArgument(tableHandle instanceof JdbcTableHandle, "tableHandle is not a jdbc table handle");
        JdbcTableHandle systemTableHandle = (JdbcTableHandle) tableHandle;
    ...
    public TableHandle getTableHandle(SchemaTableName tableName)
    {
        ...
        return new JdbcTableHandle(tableName);
    }

    @Override
    public ConnectorTableMetadata getTableMetadata(TableHandle tableHandle)
    {
        JdbcTableHandle systemTableHandle = checkTableHandle(tableHandle);
    ...
    public ColumnHandle getColumnHandle(TableHandle tableHandle, String columnName)
    {
        ...
        return new JdbcColumnHandle(columnName);
    }
    ...
    public ColumnMetadata getColumnMetadata(TableHandle tableHandle, ColumnHandle columnHandle)
    {
        ...
        checkArgument(columnHandle instanceof JdbcColumnHandle, "columnHandle is not an instance of SystemColumnHandle");
        String columnName = ((JdbcColumnHandle) columnHandle).getColumnName();
