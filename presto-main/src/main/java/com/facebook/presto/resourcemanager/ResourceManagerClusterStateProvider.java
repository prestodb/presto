...
{
    private final ConcurrentMap<String, NodeQueryState> nodeQueryStates = new ConcurrentHashMap<>();
    private final ConcurrentMap<String, InternalNodeState> nodeStatuses = new ConcurrentHashMap<>();
