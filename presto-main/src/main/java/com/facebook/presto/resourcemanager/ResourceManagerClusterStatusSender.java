        ...
        implements ClusterStatusSender
{
    ...
    private final DriftClient<com.facebook.presto.resourcemanager.thrift.ResourceManagerClient> thriftResourceManagerClient;
    private final ResourceManagerClient httpClient;
    ...
    public ResourceManagerClusterStatusSender(
            @ForResourceManager DriftClient<com.facebook.presto.resourcemanager.thrift.ResourceManagerClient> thriftResourceManagerClientProvider,
            ResourceManagerClient httpClientProvider,
    ...
    public ResourceManagerClusterStatusSender(
            DriftClient<com.facebook.presto.resourcemanager.thrift.ResourceManagerClient> thriftResourceManagerClient,
            ResourceManagerClient httpClient,
            InternalNodeManager internalNodeManager,
