...
public class DistributedClusterStatsResource
{
    ...
    public ClusterStatsResource.ClusterStats getClusterStats()
    {
        ...
        return new ClusterStatsResource.ClusterStats(runningQueries, blockedQueries, queuedQueries, activeNodes, runningDrivers, memoryReservation, totalInputRows, totalInputBytes, totalCpuTimeSecs);
    }
