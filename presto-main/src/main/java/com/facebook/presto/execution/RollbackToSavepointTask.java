        ...
        implements DataDefinitionTask<RollbackToSavepoint>
{
    ...
    @Override
    public CompletableFuture<?> execute(RollbackToSavepoint statement, TransactionManager transactionManager, Metadata metadata, AccessControl accessControl, QueryStateMachine stateMachine, List<Expression> parameters)
    {
