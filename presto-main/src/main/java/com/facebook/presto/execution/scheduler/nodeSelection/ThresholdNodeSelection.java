...
public class ThresholdNodeSelection
        implements NodeSelection
{
            ...
            NodeTaskMap nodeTaskMap)
    {
        ...
        this.randomCandidates = getRandomCandidates(maxTasksPerStage, nodeMap, nodeTaskMap, existingTasks);
    }
    ...
    private ResettableRandomizedIterator<InternalNode> getRandomCandidates(int limit, NodeMap nodeMap, NodeTaskMap nodeTaskMap, List<RemoteTask> existingTasks)
    {
