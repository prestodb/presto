...
@ThreadSafe
public class LocalNodeTaskMap
        implements NodeTaskMap
{
    private static final Logger log = Logger.get(LocalNodeTaskMap.class);
    private final ConcurrentHashMap<InternalNode, NodeTasks> nodeTasksMap = new ConcurrentHashMap<>();
    private final FinalizerService finalizerService;

    @Inject
    public LocalNodeTaskMap(FinalizerService finalizerService)
    {
    ...
    private static class NodeTasks
    {
        ...
        public LocalNodeStatsTracker createTaskStatsTrackers(TaskId taskId)
        {
            ...
            LocalNodeStatsTracker nodeStatsTracker = new LocalNodeStatsTracker(splitTracker, memoryUsageTracker::setValue, cpuUtilizationPercentageTracker::setValue);
    ...
    private static class LocalNodeStatsTracker
            implements NodeStatsTracker
    {
        ...
        public LocalNodeStatsTracker(Consumer<PartitionedSplitsInfo> splitSetter, LongConsumer memoryUsageSetter, CumulativeStatsConsumer cpuUsageSetter)
        {
