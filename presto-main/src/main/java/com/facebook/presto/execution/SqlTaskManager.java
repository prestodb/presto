        ...
        implements TaskManager, Closeable
{
    ...
    @GuardedBy("this")
    private final Object2LongMap<String> coordinatorToPoolAssignmentVersion = new Object2LongOpenHashMap<>();
    ...
    public synchronized void updateMemoryPoolAssignments(MemoryPoolAssignmentsRequest assignments)
    {
        ...
        if (assignmentVersion <= coordinatorToPoolAssignmentVersion.getOrDefault(assignmentCoordinatorId, Long.MIN_VALUE)) {
            return;
        }
        coordinatorToPoolAssignmentVersion.put(assignmentCoordinatorId, assignmentVersion);
