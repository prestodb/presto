        ...
        implements DataDefinitionTask<AddColumn>
{
    ...
    {
        checkArgument(!statement.getElements().isEmpty(), "no columns to add");
        ...
        accessControl.checkCanAddColumn(session.getIdentity(), tableName);
        ...
        metadata.addColumn(session, tableHandle.get(), columns);
    }
}
