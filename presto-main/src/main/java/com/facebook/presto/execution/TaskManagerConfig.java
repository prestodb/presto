...
public class TaskManagerConfig
{
    ...
    private int taskCreationBackpressureRetryAfterSeconds = 60;
    ...
    @Min(1)
    public int getTaskCreationBackpressureRetryAfterSeconds()
    {
        return taskCreationBackpressureRetryAfterSeconds;
    }

    @Config("task.task-creation-backpressure-retry-after")
    public TaskManagerConfig setTaskCreationBackpressureRetryAfterSeconds(int taskCreationBackpressureRetryAfterSeconds)
    {
        this.taskCreationBackpressureRetryAfterSeconds = taskCreationBackpressureRetryAfterSeconds;
        return this;
    }
