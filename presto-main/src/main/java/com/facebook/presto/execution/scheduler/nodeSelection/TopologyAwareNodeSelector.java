    ...
    public SplitPlacementResult computeAssignments(Set<Split> splits, List<RemoteTask> existingTasks)
    {
        ...
        for (Split split : splits) {
            if (split.getNodeSelectionStrategy() == HARD_AFFINITY) {
                List<InternalNode> candidateNodes = selectExactNodes(nodeMap, split.getPreferredNodes(nodeMap.getHostAndAddress()), includeCoordinator);
            ...
            for (HostAddress host : split.getPreferredNodes(nodeMap.getHostAndAddress())) {
