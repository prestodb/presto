        ...
        extends DataDefinitionExecution<T>
{
            ...
            implements QueryExecution.QueryExecutionFactory<DDLDefinitionExecution<?>>
    {
        ...
        public DDLDefinitionExecution<?> createQueryExecution(
                BuiltInQueryPreparer.BuiltInPreparedQuery builtInPreparedQuery,
                QueryStateMachine stateMachine,
                String slug,
                int retryCount,
        ...
        {
            return createDDLDefinitionExecution(builtInPreparedQuery.getStatement(), builtInPreparedQuery.getParameters(), stateMachine, slug, retryCount);
        }
