...
public class QueryManagerConfig
{
    ...
    private Duration requiredResourceManagersMaxWait = new Duration(5, TimeUnit.MINUTES);
    ...
    @ConfigDescription("Minimum number of active resource managers that must be available before a query will start")
    ...
    {
        return requiredResourceManagersMaxWait;
    }
    ...
    public QueryManagerConfig setRequiredResourceManagersMaxWait(Duration requiredResourceManagersMaxWait)
    {
        this.requiredResourceManagersMaxWait = requiredResourceManagersMaxWait;
        return this;
    }
