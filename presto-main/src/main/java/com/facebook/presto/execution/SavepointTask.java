        ...
        implements DataDefinitionTask<Savepoint>
{
    ...
    @Override
    public CompletableFuture<?> execute(Savepoint statement, TransactionManager transactionManager, Metadata metadata, AccessControl accessControl, QueryStateMachine stateMachine, List<Expression> parameters)
    {
