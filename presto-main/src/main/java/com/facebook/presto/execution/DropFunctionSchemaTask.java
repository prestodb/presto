...
public class DropFunctionSchemaTask
        implements DataDefinitionTask<DropFunctionSchema>
{
    @Override
    public String getName()
    {
        return "DROP FUNCTION SCHEMA";
    }

    @Override
    public ListenableFuture<?> execute(DropFunctionSchema statement,
                                       ...
                                       QueryStateMachine stateMachine, List<Expression> parameters)
    {
        ...
        metadata.getFunctionAndTypeManager().dropFunctionNamespace(catalogSchemaName, statement.isForce());
