...
public class QueryPreparer
{
    ...
    public PreparedQuery prepareQuery(AnalyzerOptions analyzerOptions, String query, WarningCollector warningCollector)
            throws ParsingException, PrestoException, SemanticException
    {
        ...
        return prepareQuery(analyzerOptions, wrappedStatement, warningCollector);
    }

    public PreparedQuery prepareQuery(AnalyzerOptions analyzerOptions, Statement wrappedStatement, WarningCollector warningCollector)
            throws ParsingException, PrestoException, SemanticException
    {
