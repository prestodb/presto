...
public class LocalClusterSizeMonitor
        implements ClusterSizeMonitor
{
    ...
    @Inject
    public LocalClusterSizeMonitor(InternalNodeManager nodeManager, NodeSchedulerConfig nodeSchedulerConfig, QueryManagerConfig queryManagerConfig)
    {
        this(
                nodeManager,
    ...
    public LocalClusterSizeMonitor(
