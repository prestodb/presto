...
public final class SqlToRowExpressionTranslator
{
    ...
    public static RowExpression translate(Expression expression, IdentityHashMap<Expression, Type> types, Metadata metadata, ConnectorSession session)
    {
    ...
    public static List<RowExpression> translate(List<Expression> expressions, IdentityHashMap<Expression, Type> types, Metadata metadata, ConnectorSession session)
    {
        ImmutableList.Builder<RowExpression> builder = ImmutableList.builder();
        for (Expression expression : expressions) {
            builder.add(translate(expression, types, metadata, session));
        }
