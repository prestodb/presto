...
public final class NullabilityAnalyzer
{
    ...
    public NullabilityAnalyzer(TypeAndFunctionManager typeAndFunctionManager, TypeManager typeManager)
    {
    ...
    public boolean mayReturnNullOnNonNullInput(RowExpression expression)
    {
        ...
        expression.accept(new RowExpressionVisitor(typeAndFunctionManager, typeManager, functionResolution), result);
        return result.get();
    }
            ...
            extends DefaultRowExpressionTraversalVisitor<AtomicBoolean>
    {
        ...
        public RowExpressionVisitor(TypeAndFunctionManager typeAndFunctionManager, TypeManager typeManager, FunctionResolution functionResolution)
        {
        ...
        {
            FunctionMetadata function = typeAndFunctionManager.getFunctionMetadata(call.getFunctionHandle());
