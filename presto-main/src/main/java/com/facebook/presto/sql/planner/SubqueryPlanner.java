...
class SubqueryPlanner
{
    ...
    private PlanBuilder appendInPredicateApplyNode(PlanBuilder subPlan, InPredicate inPredicate, boolean correlationAllowed)
    {
        ...
        translationMap.put(parametersReplaced, inPredicateSubquerySymbol);
        translationMap.put(inPredicate, inPredicateSubquerySymbol);

        return new PlanBuilder(translationMap,
                new ApplyNode(idAllocator.getNextId(),
                        subPlan.getRoot(),
                        subquery,
                        ImmutableMap.of(inPredicateSubquerySymbol, inPredicateSubqueryExpression),
    ...
    private PlanBuilder appendScalarSubqueryApplyNode(PlanBuilder subPlan, SubqueryExpression scalarSubquery, boolean correlationAllowed)
    {
        ...
        return appendScalarSubqueryApplyNode(
                subPlan,
    ...
    private PlanBuilder appendExistSubqueryApplyNode(PlanBuilder subPlan, ExistsPredicate existsPredicate, boolean correlationAllowed)
    {
        ...
        return appendScalarSubqueryApplyNode(subPlan, existsPredicate.getSubquery(), subqueryPlan, identityAssigments(subqueryPlan), correlationAllowed);
    }
    ...
    private PlanBuilder planQuantifiedEqualsAll(PlanBuilder subPlan, QuantifiedComparisonExpression quantifiedComparison, boolean correlationAllowed)
    {
        ...
        return appendScalarSubqueryApplyNode(subPlan, quantifiedComparison.getSubquery(), subqueryPlan, identityAssigments(subqueryPlan), correlationAllowed);
    }
    ...
    private PlanBuilder appendScalarSubqueryApplyNode(PlanBuilder subPlan, Node subquery, PlanNode subqueryNode, Map<Symbol, Expression> subqueryAssignments, boolean correlationAllowed)
    {
