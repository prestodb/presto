        ...
        extends ExpressionRewriteRuleSet
{
    ...
    static Expression rewrite(Expression expression, Session session, PlanVariableAllocator variableAllocator, Metadata metadata, LiteralEncoder literalEncoder, SqlParser sqlParser)
    {
        ...
        Map<NodeRef<Expression>, TypeWithName> expressionTypes = getExpressionTypes(session, metadata, sqlParser, SemanticTypeProvider.copyOf(variableAllocator.getTypes()), expression, emptyList(), WarningCollector.NOOP);
