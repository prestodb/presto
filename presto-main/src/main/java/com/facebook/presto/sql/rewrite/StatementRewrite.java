...
public final class StatementRewrite
{
            ...
            ValidQueryChecker validQueryChecker)
    {
        for (Rewrite rewrite : REWRITES) {
            node = requireNonNull(rewrite.rewrite(session, metadata, parser, queryExplainer, node, parameters, accessControl, validQueryChecker), "Statement rewrite returned null");
        }
        return node;
    }
