...
public class DesugarRowSubscriptRewriter
{
    ...
    public static Expression rewrite(Expression expression, Session session, TypeAnalyzer typeAnalyzer,
            SymbolAllocator symbolAllocator)
    {
        requireNonNull(typeAnalyzer, "typeAnalyzer is null");
        Map<NodeRef<Expression>, Type> expressionTypes = typeAnalyzer.getTypes(session, symbolAllocator.getTypes(),
                expression);
            ...
            extends ExpressionRewriter<Void>
    {
        ...
        @Override
        public Expression rewriteSubscriptExpression(SubscriptExpression node, Void context,
