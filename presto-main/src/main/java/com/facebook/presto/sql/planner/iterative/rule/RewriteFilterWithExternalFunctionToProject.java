        ...
        implements Rule<FilterNode>
{
    ...
    public RewriteFilterWithExternalFunctionToProject(TypeAndFunctionManager typeAndFunctionManager)
    {
    ...
    {
        if (!node.getPredicate().accept(new ExternalCallExpressionChecker(typeAndFunctionManager), null)) {
