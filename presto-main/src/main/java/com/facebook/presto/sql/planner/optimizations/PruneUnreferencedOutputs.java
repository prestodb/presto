        ...
        extends PlanOptimizer
{
            ...
            extends PlanRewriter<Set<Symbol>>
    {
        ...
        public PlanNode visitRowNumber(RowNumberNode node, RewriteContext<Set<Symbol>> context)
        {
            ...
            return new RowNumberNode(node.getId(), source, node.getPartitionBy(), node.getPrePartitionedInputs(), node.getRowNumberSymbol(), node.getMaxRowCountPerPartition(), node.getHashSymbol());
        }
