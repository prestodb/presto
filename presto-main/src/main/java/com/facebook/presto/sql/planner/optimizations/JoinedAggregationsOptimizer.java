...
import static com.facebook.presto.sql.planner.optimizations.HashGenerationOptimizer.getHashExpression;
        ...
        extends PlanOptimizer
{
    ...
    {
        return PlanRewriter.rewriteWith(new Optimizer(idAllocator, symbolAllocator), plan, null);
    }
            ...
            extends PlanRewriter<Void>
    {
        private static class PlanSummary
        {
                                ...
                                TupleDomain<ColumnHandle> predicate)
            {
                ...
                this.columnAssignments = ImmutableMap.copyOf(checkNotNull(columnAssignments, "columnAssignments is null"));
                this.tableOutputSymbols = ImmutableList.copyOf(checkNotNull(tableOutputSymbols, "tableOutputSymbols is null"));
                this.tableLayoutHandle = checkNotNull(tableLayoutHandle, "tableLayoutHandle is null");
            ...
            {
                this.projectTableScanAssignment = checkNotNull(projectTableScanAssignment, "projectTableScanAssignment is null");
            }
            ...
            {
                this.projectAggregationAssignment = checkNotNull(projectAggregationAssignment, "projectAggregationAssignment is null");
            }
        }
        ...
        private PlanNode buildPlan(JoinNode node, PlanSummary leftSummary, PlanSummary rightSummary)
        {
            ...
            if (leftSummary.getHashSymbol().isPresent() && rightSummary.getHashSymbol().isPresent()) {
                ...
                hashExpression = Optional.of(getHashExpression(groupByKeyOutputSymbols));
            }
