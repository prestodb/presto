        ...
        implements ExpressionOptimizer
{
    ...
    public DelegatingRowExpressionOptimizer(Metadata metadata, ExpressionOptimizerManager expressionOptimizerManager)
    {
        this(
                requireNonNull(metadata, "metadata is null"),
                requireNonNull(expressionOptimizerManager, "expressionManager is null").getExpressionOptimizer());
    }
