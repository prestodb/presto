...
public class ColumnExpressionCompiler
{
    private final CallSiteBinder callSiteBinder;
    private final CachedInstanceBinder cachedInstanceBinder;
    private final ColumnExpressionVisitor<BytecodeNode, Scope> fieldReferenceCompiler;
    ...
    ColumnExpressionCompiler(
            ...
            ColumnExpressionVisitor<BytecodeNode, Scope> fieldReferenceCompiler,
    ...
    public BytecodeNode compile(ColumnExpression columnExpression, Scope scope, Optional<Variable> outputBlockVariable)
    {
        return compile(columnExpression, scope, outputBlockVariable, Optional.empty());
    }
    ...
    public BytecodeNode compile(ColumnExpression columnExpression, Scope scope, Optional<Variable> outputBlockVariable, Optional<Class> lambdaInterface)
    {
        return columnExpression.accept(new Visitor(), new Context(scope, outputBlockVariable, lambdaInterface));
    }

    private class Visitor
            implements ColumnExpressionVisitor<BytecodeNode, Context>
    {
        @Override
