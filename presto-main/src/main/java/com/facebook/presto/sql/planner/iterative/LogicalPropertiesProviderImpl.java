...
{
    public LogicalPropertiesProviderImpl()
    {
    }
    ...
    {
        LogicalPropertiesImpl sourceProps = new LogicalPropertiesImpl.NoPropagateBuilder().build();
        LogicalPropertiesImpl.PropagateAndLimitBuilder propagateAndLimitBuilder = new LogicalPropertiesImpl.PropagateAndLimitBuilder(sourceProps, valuesNode.getRows().size());
    ...
    public LogicalProperties getFilterProperties(FilterNode filterNode)
    {
        ...
        LogicalPropertiesImpl.FilterBuilder logicalPropsBuilder = new LogicalPropertiesImpl.FilterBuilder(sourceProps, filterNode.getPredicate());
        return logicalPropsBuilder.build();
    }
    ...
    public LogicalProperties getJoinProperties(PlanNode node)
    {
        ...
        LogicalPropertiesImpl.JoinBuilder logicalPropsBuilder = new LogicalPropertiesImpl.JoinBuilder(leftProps, rightProps, joinNode.getCriteria(), joinNode.getType(), joinNode.getFilter(), joinNode.getOutputVariables());
        return logicalPropsBuilder.build();
    }
    ...
    public LogicalProperties getAssignUniqueIdProperties(PlanNode node)
    {
        ...
        LogicalPropertiesImpl.AggregationBuilder aggregationBuilder = new LogicalPropertiesImpl.AggregationBuilder(sourceProps, key, assignUniqueIdNode.getOutputVariables());
        return aggregationBuilder.build();
    }
    ...
    {
        LogicalPropertiesImpl.NoPropagateBuilder logicalPropsBuilder = new LogicalPropertiesImpl.NoPropagateBuilder();
        return logicalPropsBuilder.build();
    }
}
