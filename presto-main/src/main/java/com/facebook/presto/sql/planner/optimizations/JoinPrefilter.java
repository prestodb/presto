        ...
        implements PlanOptimizer
{
            ...
            extends SimplePlanRewriter<Void>
    {
        ...
        private boolean isWideColumn(VariableReferenceExpression variable)
        {
            return variable.getType().equals(VARCHAR) || (variable.getType() instanceof VarcharType && ((VarcharType) variable.getType()).getLengthSafe() > 8);
        }
