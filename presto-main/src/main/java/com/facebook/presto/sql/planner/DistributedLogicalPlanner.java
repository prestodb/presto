...
public class DistributedLogicalPlanner
{
            ...
            extends PlanVisitor<Void, SubPlanBuilder>
    {
        ...
        private SubPlanBuilder addDistributedAggregation(SubPlanBuilder plan, Map<Symbol, FunctionCall> aggregations, Map<Symbol, Signature> functions, List<Symbol> groupBy)
        {
            ...
            for (Map.Entry<Symbol, FunctionCall> entry : aggregations.entrySet()) {
                Signature functionHandle = functions.get(entry.getKey());
