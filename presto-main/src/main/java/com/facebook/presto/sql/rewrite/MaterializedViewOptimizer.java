...
import static com.facebook.presto.sql.rewrite.MaterializedViewOptimizerUtils.optimizeQueryUsingMaterializedView;
        ...
        implements StatementRewrite.Rewrite
{
    ...
    {
        return (Statement) new MaterializedViewOptimizer.Visitor(metadata, session, parser).process(node, null);
    }
