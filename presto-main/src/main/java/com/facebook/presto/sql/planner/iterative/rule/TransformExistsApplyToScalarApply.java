...
public class TransformExistsApplyToScalarApply
        implements Rule
{
    private final QualifiedName countName;
    private final FunctionCall countCall;
    ...
    public TransformExistsApplyToScalarApply(FunctionRegistry functionRegistry)
    {
        ...
        countName = QualifiedName.of("count");
        countCall = new FunctionCall(countName, ImmutableList.of());
        countSignature = functionRegistry.resolveFunction(countName, ImmutableList.of());
    }
    ...
    public Optional<PlanNode> apply(PlanNode node, Lookup lookup, PlanNodeIdAllocator idAllocator, SymbolAllocator symbolAllocator)
    {
        ...
        Symbol count = symbolAllocator.newSymbol(countName.toString(), BIGINT);
                        ...
                        new ProjectNode(
                                ...
                                new AggregationNode(
                                        ...
                                        new LimitNode(
                                                ...
                                                1,
                                                false),
                                        ImmutableMap.of(count, countCall),
