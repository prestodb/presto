...
public final class DomainTranslator
{
    ...
    public static Expression toPredicate(TupleDomain<ColumnHandle> tupleDomain, Map<ColumnHandle, Symbol> symbolTranslationMap)
    {
            ...
            extends AstVisitor<ExtractionResult, Boolean>
    {
        ...
        protected ExtractionResult visitLogicalBinaryExpression(LogicalBinaryExpression node, Boolean complement)
        {
            ...
            switch (type) {
                ...
                case OR:
                    TupleDomain<ColumnHandle> columnUnionedTupleDomain = leftResult.getTupleDomain().columnWiseUnion(rightResult.getTupleDomain());
