        ...
        implements ExpressionOptimizerProvider
{
    ...
    private void loadExpressionOptimizerFactory(Map<String, String> properties)
    {
        ...
        checkArgument(expressionManagerLoaded.compareAndSet(false, true), "ExpressionManager is already loaded");
        rowExpressionInterpreter.set(
                expressionOptimizerFactories.get(factoryName).createOptimizer(
                        properties,
