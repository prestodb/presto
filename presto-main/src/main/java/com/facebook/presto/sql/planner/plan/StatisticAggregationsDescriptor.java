...
public class StatisticAggregationsDescriptor<T>
{
            ...
            extends JsonSerializer<ColumnStatisticMetadata>
    {
        ...
        {
            return value.getStatisticType().name() + ":" + value.getColumnName() + ":" + value.getFunctionName();
        }
    }
            ...
            extends KeyDeserializer
    {
        ...
        static ColumnStatisticMetadata deserialize(String value)
        {
            ...
            return new ColumnStatisticMetadata(values[1], ColumnStatisticType.valueOf(values[0]), values[2]);
        }
    }
}
