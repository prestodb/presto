        ...
        extends InternalPlanNode
{
    ...
    {
        return new UpdateNode(getSourceLocation(), getId(), Optional.of(newChildren.stream().collect(onlyElement())), source, rowId, columnValueAndRowIdSymbols, outputVariables);
    }
}
