...
public final class ApplyNodeUtil
{
    ...
    private static boolean isSupportedSubqueryExpression(RowExpression expression)
    {
        ...
        return castToExpression(expression) instanceof InPredicate ||
                castToExpression(expression) instanceof ExistsPredicate ||
                castToExpression(expression) instanceof QuantifiedComparisonExpression;
    }
}
