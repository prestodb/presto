...
public class InnerRowExpressionInterpreter
        implements ExpressionInterpreter
{
    private final Metadata metadata;

    public InnerRowExpressionInterpreter(Metadata metadata)
    {
        this.metadata = requireNonNull(metadata, "metadata is null");
    }

    @Override
    public Object evaluateConstantRowExpression(RowExpression expression, ConnectorSession session)
    {
