        ...
        extends PlanOptimizer
{
            ...
            extends PlanVisitor<PreferredProperties, PlanWithProperties>
    {
        ...
        public PlanWithProperties visitProject(ProjectNode node, PreferredProperties preferred)
        {
            ...
            return rebaseAndDeriveProperties(node, planChild(node, PreferredProperties.derivePreferences(preferred, identities, Optional.empty(), Optional.<List<Symbol>>empty(), ImmutableList.of())));
        }
