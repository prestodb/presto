...
final class ExpressionTreeUtils
{
    ...
    {
        return extractExpressionsOfTypeUsingPredicate(nodes, FunctionCall.class, isAggregationPredicate(functionRegistry));
    }

    static List<FunctionCall> extractWindowFunctions(Iterable<? extends Node> nodes)
    {
        return extractExpressionsOfTypeUsingPredicate(nodes, FunctionCall.class, ExpressionTreeUtils::isWindowFunction);
    }
    ...
    private static <T extends Expression> List<T> extractExpressionsOfTypeUsingPredicate(
            Iterable<? extends Node> nodes,
            Class<T> clazz,
