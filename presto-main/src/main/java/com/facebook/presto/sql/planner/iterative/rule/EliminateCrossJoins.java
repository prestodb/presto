        ...
        implements Rule
{
    ...
    // TODO if the approach laid in PR is generally approved, move old EliminateCrossJoins optimizer's reused methods here,
    // so that the deprecated class can be easily removed.
}
