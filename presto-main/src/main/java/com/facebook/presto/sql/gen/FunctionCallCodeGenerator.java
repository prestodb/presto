...
public class FunctionCallCodeGenerator
{
    ...
    {
        TypeAndFunctionManager typeAndFunctionManager = context.getFunctionManager();
        ...
        return context.generateCall(
                typeAndFunctionManager.getFunctionMetadata(functionHandle).getName().getFunctionName(),
                function,
                argumentsBytecode,
