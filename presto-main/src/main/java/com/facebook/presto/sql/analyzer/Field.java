...
public class Field
{
    ...
    private final TypeWithName type;
    private final boolean hidden;
    private final boolean aliased;

    public static Field newUnqualified(String name, TypeWithName type)
    {
    ...
    public static Field newUnqualified(Optional<String> name, TypeWithName type)
    {
        requireNonNull(name, "name is null");
        requireNonNull(type, "type is null");
    ...
    public static Field newUnqualified(Optional<String> name, TypeWithName type, Optional<QualifiedObjectName> originTable, Optional<String> originColumn, boolean aliased)
    {
        requireNonNull(name, "name is null");
        requireNonNull(type, "type is null");
    ...
    public static Field newQualified(QualifiedName relationAlias, Optional<String> name, TypeWithName type, boolean hidden, Optional<QualifiedObjectName> originTable, Optional<String> originColumn, boolean aliased)
    {
    ...
    public Field(Optional<QualifiedName> relationAlias, Optional<String> name, TypeWithName type, boolean hidden, Optional<QualifiedObjectName> originTable, Optional<String> originColumnName, boolean aliased)
    {
        requireNonNull(relationAlias, "relationAlias is null");
        requireNonNull(name, "name is null");
        requireNonNull(type, "type is null");
