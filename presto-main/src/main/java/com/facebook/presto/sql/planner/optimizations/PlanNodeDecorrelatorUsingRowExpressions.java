...
public class PlanNodeDecorrelatorUsingRowExpressions
{
    ...
    public PlanNodeDecorrelatorUsingRowExpressions(PlanNodeIdAllocator idAllocator, VariableAllocator variableAllocator, Lookup lookup, LogicalRowExpressions logicalRowExpressions)
    {
            ...
            extends InternalPlanVisitor<Optional<DecorrelationResult>, Void>
    {
        ...
        public Optional<DecorrelationResult> visitFilter(FilterNode node, Void context)
        {
            ...
            Map<Boolean, List<RowExpression>> predicates = logicalRowExpressions.extractConjuncts(predicate).stream()
                    .collect(Collectors.partitioningBy(PlanNodeDecorrelatorUsingRowExpressions.DecorrelatingVisitor.this::isCorrelated));
