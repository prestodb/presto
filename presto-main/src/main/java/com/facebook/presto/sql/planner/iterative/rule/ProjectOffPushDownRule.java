        ...
        implements Rule<ProjectNode>
{
    ...
    protected abstract Optional<PlanNode> pushDownProjectOff(PlanNodeIdAllocator idAllocator, SymbolAllocator symbolAllocator, N targetNode, Set<Symbol> referencedOutputs);
}
