        ...
        implements Rule<TopNNode>
{
    ...
    public Result apply(TopNNode topNNode, Captures captures, Context context)
    {
        ...
        for (PlanNode source : unionNode.getSources()) {
            ...
            Set<Symbol> sourceOutputVariables = ImmutableSet.copyOf(source.getOutputSymbols());
            ...
            for (VariableReferenceExpression unionOutput : unionNode.getOutputVariables()) {
                ...
                VariableReferenceExpression unionInput = getLast(intersectVariableWithSymbol(inputVariables, sourceOutputVariables));
