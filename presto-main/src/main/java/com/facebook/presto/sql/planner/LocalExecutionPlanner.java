                ...
                List<VariableReferenceExpression> outputVariables)
        {
            ...
            try {
                if (columns != null) {
                    ...
                    Supplier<PageProcessor> pageProcessor = expressionCompiler.compilePageProcessor(session.getSqlFunctionProperties(), filterExpression, projections, isOptimizeCommonSubExpression(session), Optional.of(context.getStageExecutionId() + "_" + planNodeId));
