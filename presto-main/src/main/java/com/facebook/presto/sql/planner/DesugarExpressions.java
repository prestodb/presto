 ...
 */
public class DesugarExpressions
{
    private final PlanVariableAllocator variableAllocator;

    public DesugarExpressions(Collection<VariableReferenceExpression> variablres)
    {
        this.variableAllocator = new PlanVariableAllocator(variablres);
    }
