...
public final class Serialization
{
            ...
            extends JsonSerializer<VariableReferenceExpression>
    {
        ...
        public void serialize(VariableReferenceExpression value, JsonGenerator gen, SerializerProvider serializers)
                throws IOException
        {
            gen.writeFieldName(format("%s:%s", value.getName(), value.getType()));
        }
    }
            ...
            extends KeyDeserializer
    {
                ...
                throws IOException
        {
            ...
            return new VariableReferenceExpression(key.substring(0, p), typeManager.getType(parseTypeSignature(key.substring(p + 1))));
        }
    }
}
