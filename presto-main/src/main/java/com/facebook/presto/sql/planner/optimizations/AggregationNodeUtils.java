...
public class AggregationNodeUtils
{
    ...
    public static AggregationNode.Aggregation count(TypeAndFunctionManager typeAndFunctionManager)
    {
        return new AggregationNode.Aggregation(
                new CallExpression("count",
                        new FunctionResolution(typeAndFunctionManager).countFunction(),
                        BIGINT,
                        ImmutableList.of()),
                Optional.empty(),
                Optional.empty(),
