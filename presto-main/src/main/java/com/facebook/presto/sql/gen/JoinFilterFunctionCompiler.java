...
public class JoinFilterFunctionCompiler
{
    ...
    {
        JoinFilterFunction create(SqlFunctionProperties properties, LongBigArray addresses, List<Page> pages);
    }
            ...
            implements JoinFilterFunctionFactory
    {
        ...
        public IsolatedJoinFilterFunctionFactory(Class<? extends InternalJoinFilterFunction> internalJoinFilterFunction)
        {
            try {
                ...
                isolatedJoinFilterFunctionConstructor = isolatedJoinFilterFunction.getConstructor(InternalJoinFilterFunction.class, LongBigArray.class, List.class);
            }
        ...
        @Override
        public JoinFilterFunction create(SqlFunctionProperties properties, LongBigArray addresses, List<Page> pages)
        {
            try {
