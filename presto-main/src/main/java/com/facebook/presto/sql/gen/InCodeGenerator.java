        ...
        implements ByteCodeGenerator
{
    ...
    public ByteCodeNode generateExpression(Signature signature, ByteCodeGeneratorContext generatorContext, Type returnType, List<RowExpression> arguments)
    {
        ...
        if (constantValues.size() < 1000) {
            ...
            Set<?> fastutilConstantValuesSet = toFastutilHashSet(constantValues, javaType);
            Binding constant = generatorContext.getCallSiteBinder().bind(fastutilConstantValuesSet, fastutilConstantValuesSet.getClass());
            ...
            switchBlock = new Block()
                    ...
                    .append(new IfStatement()
                            .condition(new Block()
                                    ...
                                    .invokeStatic(FastutilSetHelper.class, "in", boolean.class, javaType.isPrimitive() ? javaType : Object.class, fastutilConstantValuesSet.getClass()))
                            .ifTrue(jump(match)));
        }
