        ...
        extends DefaultExpressionTraversalVisitor<Void, Analysis>
{
    ...
    public WindowFunctionValidator(TypeAndFunctionManager typeAndFunctionManager)
    {
    ...
    protected Void visitFunctionCall(FunctionCall functionCall, Analysis analysis)
    {
        ...
        FunctionMetadata functionMetadata = typeAndFunctionManager.getFunctionMetadata(analysis.getFunctionHandle(functionCall));
