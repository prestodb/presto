        ...
        implements PlanSanityChecker.Checker
{
            ...
            extends PlanVisitor<Void, Set<Symbol>>
    {
        ...
        public Void visitDelete(DeleteNode node, Set<Symbol> boundSymbols)
        {
            ...
            checkArgument(source.getOutputVariables().contains(node.getRowId()), "Invalid node. Row ID symbol (%s) is not in source plan output (%s)", node.getRowId(), node.getSource().getOutputSymbols());
