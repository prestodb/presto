        ...
        implements Rule<FilterNode>
{
    ...
    public RowExpression getCandidateArrayNotContainsExpression(RowExpression filterPredicate, List<VariableReferenceExpression> leftInput, List<VariableReferenceExpression> rightInput)
    {
    ...
    public Result apply(FilterNode node, Captures captures, Context context)
    {
        ...
        RowExpression arrayNotContainsExpression = getCandidateArrayNotContainsExpression(filterExpression, leftColumns, rightColumns);
        ...
        boolean arrayAtLeftInput = leftColumns.containsAll(VariablesExtractor.extractAll(array));
        ...
        VariableReferenceExpression keyVariable;
        if (element instanceof VariableReferenceExpression) {
            keyVariable = (VariableReferenceExpression) element;
        }
        else {
            keyVariable = context.getVariableAllocator().newVariable(element);
            newLeftNode = addProjections(newLeftNode, context.getIdAllocator(), ImmutableMap.of(keyVariable, element));
        }

        JoinNode.EquiJoinClause equiJoinClause = new JoinNode.EquiJoinClause(keyVariable, unnestVariable);
