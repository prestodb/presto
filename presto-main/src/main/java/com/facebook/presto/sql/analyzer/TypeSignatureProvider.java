...
public class TypeSignatureProvider
{
    ...
    private final Function<List<SemanticType>, TypeSignature> typeSignatureResolver;
    ...
    public TypeSignatureProvider(Function<List<SemanticType>, TypeSignature> typeSignatureResolver)
    {
    ...
    public TypeSignature getTypeSignature(List<SemanticType> boundTypeParameters)
    {
        checkState(hasDependency);
