...
public class SubPlanBuilder
{
    ...
    public SubPlanBuilder setHashOutputPartitioning(List<Symbol> partitionBy, int hashChannel)
    {
        ...
        this.hashChannel = Optional.of(hashChannel);
        return this;
    }

    public SubPlanBuilder setHashChannel(int hashChannel)
    {
        this.hashChannel = Optional.of(hashChannel);
        return this;
    }
    ...
    public SubPlan build()
    {
        ...
        PlanFragment fragment = new PlanFragment(id, root, Maps.filterKeys(allocator.getTypes(), in(dependencies)), distribution, partitionedSource, outputPartitioning, partitionBy, hashChannel.orNull());
