...
import com.facebook.presto.operator.NewInMemoryWindowOperator.NewInMemoryWindowOperatorFactory;
...
import com.facebook.presto.operator.NewSetBuilderOperator.NewSetSupplier;
import com.facebook.presto.operator.NewScanFilterAndProjectOperator.NewScanFilterAndProjectOperatorFactory;
import com.facebook.presto.operator.NewSourceOperatorFactory;
import com.facebook.presto.operator.NewTableScanOperator.NewTableScanOperatorFactory;
import com.facebook.presto.operator.NewTableWriterOperator.NewTableWriterOperatorFactory;
            ...
            extends PlanVisitor<LocalExecutionPlanContext, PhysicalOperation>
    {
                ...
                List<Symbol> outputSymbols)
        {
            ...
            try {
                ...
                if (columns != null) {
                    NewSourceOperatorFactory operatorFactory = compiler.compileScanFilterAndProjectOperator(
                            context.getNextOperatorId(),
                            sourceNode.getId(),
                            dataStreamProvider,
                            columns,
