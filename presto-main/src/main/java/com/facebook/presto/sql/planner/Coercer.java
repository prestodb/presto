...
public class Coercer
{
    ...
    public static Expression addCoercions(Expression expression, Map<NodeRef<Expression>, TypeWithName> coercions, Set<NodeRef<Expression>> typeOnlyCoercions)
    {
    ...
    {
        private final Map<NodeRef<Expression>, TypeWithName> coercions;
        private final Set<NodeRef<Expression>> typeOnlyCoercions;

        public Rewriter(Map<NodeRef<Expression>, TypeWithName> coercions, Set<NodeRef<Expression>> typeOnlyCoercions)
        {
        ...
        {
            TypeWithName target = coercions.get(NodeRef.of(expression));
