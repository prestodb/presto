        ...
        extends AstVisitor<Node, Void>
{
    ...
    {
        return SqlToRowExpressionTranslator.translate(expression, analyzeExpression(expression, scope).getExpressionTypes(), ImmutableMap.of(), metadata.getFunctionAndTypeManager(), session);
    }
