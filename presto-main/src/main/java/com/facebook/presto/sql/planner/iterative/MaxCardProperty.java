...
public class MaxCardProperty
{
     ...
     */
    public static boolean moreGeneral(MaxCardProperty maxCardProperty, MaxCardProperty otherMaxCardProperty)
    {
        return (!maxCardProperty.value.isPresent() && !otherMaxCardProperty.value.isPresent()) ||
                (maxCardProperty.value.isPresent() && (!otherMaxCardProperty.value.isPresent() || (otherMaxCardProperty.value.get() >= maxCardProperty.value.get())));
    }
    ...
    {
        return "{value=" +
                (this.value.isPresent() ? Long.valueOf(value.get()) : "null") +
                "}";
    }
}
