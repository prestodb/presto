        ...
        extends PlanOptimizer
{
            ...
            extends PlanNodeRewriter<Void>
    {
        ...
        {
            PlanNode source = planRewriter.rewrite(node.getSource(), context);
            Expression simplified = canonicalizeExpression(node.getPredicate());
            ...
            extends ExpressionRewriter<Void>
    {
        ...
        {
            Expression value = treeRewriter.defaultRewrite(node.getValue(), context);
        ...
        {
            Expression condition = treeRewriter.defaultRewrite(node.getCondition(), context);
            Expression trueValue = treeRewriter.defaultRewrite(node.getTrueValue(), context);

            Expression falseValue = null;
            if (node.getFalseValue().isPresent()) {
                falseValue = treeRewriter.defaultRewrite(node.getFalseValue().get(), context);
            }
        ...
        {
            Expression value = treeRewriter.defaultRewrite(node.getExpression(), context);
