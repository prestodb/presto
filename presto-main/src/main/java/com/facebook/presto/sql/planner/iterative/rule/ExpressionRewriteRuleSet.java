        ...
        implements RuleSet
{
            ...
            implements Rule<ProjectNode>
    {
        ...
        public Result apply(ProjectNode projectNode, Captures captures, Context context)
        {
            ...
            return Result.replace(new ProjectNode(projectNode.getId(), projectNode.getSource(), assignments));
        }
    }
            ...
            implements Rule<AggregationNode>
    {
        ...
        public Result apply(AggregationNode aggregationNode, Captures captures, Context context)
        {
            ...
            if (anyRewritten) {
                return Result.replace(new AggregationNode(
            ...
            implements Rule<FilterNode>
    {
        ...
        public Result apply(FilterNode filterNode, Captures captures, Context context)
        {
            ...
            return Result.replace(new FilterNode(filterNode.getId(), filterNode.getSource(), rewritten));
        }
    }
            ...
            implements Rule<TableScanNode>
    {
        ...
        public Result apply(TableScanNode tableScanNode, Captures captures, Context context)
        {
            ...
            if (!tableScanNode.getOriginalConstraint().equals(rewrittenOriginalContraint)) {
                return Result.replace(new TableScanNode(
                        tableScanNode.getId(),
            ...
            implements Rule<JoinNode>
    {
        ...
        public Result apply(JoinNode joinNode, Captures captures, Context context)
        {
            ...
            if (!joinNode.getFilter().equals(filter)) {
                return Result.replace(new JoinNode(
                        joinNode.getId(),
                        joinNode.getType(),
                        joinNode.getLeft(),
                        joinNode.getRight(),
            ...
            implements Rule<ValuesNode>
    {
        ...
        public Result apply(ValuesNode valuesNode, Captures captures, Context context)
        {
            ...
            if (anyRewritten) {
                return Result.replace(new ValuesNode(valuesNode.getId(), valuesNode.getOutputSymbols(), rows.build()));
            }
            return Result.empty();
        }
    }
            ...
            implements Rule<ApplyNode>
    {
        ...
        public Result apply(ApplyNode applyNode, Captures captures, Context context)
        {
            ...
            return Result.replace(new ApplyNode(
                    applyNode.getId(),
                    applyNode.getInput(),
