        ...
        implements PlanCanonicalInfoProvider
{
    ...
    private PlanStatistics getPlanStatisticsForTable(Session session, TableScanNode table)
    {
        ...
        planStatistics = new PlanStatistics(tableStatistics.getRowCount(), tableStatistics.getTotalSize(), 1, Estimate.unknown(), Estimate.unknown(), JoinNodeStatistics.empty());
