            ...
            extends SimplePlanRewriter<PlanNode>
    {
        ...
        public PlanNode visitApply(ApplyNode node, RewriteContext<PlanNode> context)
        {
            ...
            if (!rewrittenNode.getCorrelation().isEmpty()) {
                Optional<AggregationNode> scalarAggregation = searchPlanNodes(rewrittenNode.getSubquery())
                ...
                Symbol nonNull)
        {
            ...
            Optional<ProjectNode> subqueryProjection = searchPlanNodes(applyNode.getSubquery())
        ...
        {
            Optional<FilterNode> filter = searchPlanNodes(aggregationSource)
            ...
            if (!joinExpressions.build().isEmpty()) {
                ...
                aggregationSource = searchPlanNodes(aggregationSource)
