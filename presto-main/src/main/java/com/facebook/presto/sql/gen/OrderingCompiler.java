...
public class OrderingCompiler
{
    ...
    private static void generatePageIndexCompareTo(ClassDefinition classDefinition, CallSiteBinder callSiteBinder, List<Type> sortTypes, List<Integer> sortChannels, List<SortOrder> sortOrders)
    {
        ...
        Variable valueAddresses = scope.declareVariable(LongBigArray.class, "valueAddresses");
        compareToMethod
                .getBody()
                .comment("LongBigArray valueAddresses = pagesIndex.valueAddresses")
                .append(valueAddresses.set(pagesIndex.invoke("getValueAddresses", LongBigArray.class)));
        ...
        compareToMethod
                ...
                .append(leftPageAddress.set(valueAddresses.invoke("get", long.class, leftPosition.cast(long.class))));
        ...
        compareToMethod
                ...
                .append(rightPageAddress.set(valueAddresses.invoke("get", long.class, rightPosition.cast(long.class))));
