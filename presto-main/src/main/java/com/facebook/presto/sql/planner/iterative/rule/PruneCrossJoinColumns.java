        ...
        extends ProjectOffPushDownRule<JoinNode>
{
    ...
    {
        Optional<PlanNode> newLeft = restrictOutputs(idAllocator, symbolAllocator, joinNode.getLeft(), referencedOutputs);
        Optional<PlanNode> newRight = restrictOutputs(idAllocator, symbolAllocator, joinNode.getRight(), referencedOutputs);
