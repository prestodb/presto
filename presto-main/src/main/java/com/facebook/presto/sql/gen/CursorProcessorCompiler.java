        ...
        implements BodyCompiler<CursorProcessor>
{
    ...
    private void generateProcessMethod(ClassDefinition classDefinition, int projections)
    {
        ...
        LocalVariableDefinition cursorVariable = context.getVariable("cursor").getLocalVariableDefinition();
        LocalVariableDefinition countVariable = context.getVariable("count").getLocalVariableDefinition();
        LocalVariableDefinition pageBuilderVariable = context.getVariable("pageBuilder").getLocalVariableDefinition();

        LocalVariableDefinition completedPositionsVariable = context.declareVariable(int.class, "completedPositions");
