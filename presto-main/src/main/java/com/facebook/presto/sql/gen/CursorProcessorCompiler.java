        ...
        implements BodyCompiler
{
    ...
    @Override
    public void generateMethods(ClassDefinition classDefinition, CallSiteBinder callSiteBinder, ColumnExpression filter, List<ColumnExpression> projections)
    {
    ...
    private static ColumnExpressionVisitor<BytecodeNode, Scope> fieldReferenceCompiler(Variable cursorVariable)
    {
