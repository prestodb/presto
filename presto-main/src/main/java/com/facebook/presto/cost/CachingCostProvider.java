        ...
        implements CostProvider
{
    ...
    public CachingCostProvider(CostCalculator costCalculator, StatsProvider statsProvider, Optional<Memo> memo, Lookup lookup, Session session, Supplier<TypeProvider> types)
    {
