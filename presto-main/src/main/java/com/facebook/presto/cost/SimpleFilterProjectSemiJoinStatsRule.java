        ...
        extends SimpleStatsRule
{
    ...
    public SimpleFilterProjectSemiJoinStatsRule(StatsNormalizer normalizer, FilterStatsCalculator filterStatsCalculator, SemiJoinStatsCalculator semiJoinStatsCalculator)
    {
        super(normalizer);
    ...
    protected Optional<PlanNodeStatsEstimate> doCalculate(PlanNode node, StatsProvider sourceStats, Lookup lookup, Session session, Map<Symbol, Type> types)
    {
        ...
        if (nodeSource instanceof ProjectNode) {
            ...
            if (!(nodeSource instanceof SemiJoinNode)) {
                return Optional.empty();
            }
