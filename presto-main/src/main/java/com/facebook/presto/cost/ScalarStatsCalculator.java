...
public class ScalarStatsCalculator
{
            ...
            implements RowExpressionVisitor<VariableStatsEstimate, Void>
    {
        ...
        private VariableStatsEstimate computeStatsViaAnnotations(CallExpression call, Void context, FunctionMetadata functionMetadata)
        {
            if (isScalarFunctionStatsPropagationEnabled) {
                if (functionMetadata.hasStatsHeader() && call.getFunctionHandle() instanceof BuiltInFunctionHandle) {
                    Optional<ScalarFunctionStatsHeader> statsHeader = functionMetadata.getScalarFunctionStatsHeader();
        ...
        private VariableStatsEstimate computeCallStatistics(CallExpression call, Void context, ScalarFunctionStatsHeader scalarFunctionStatsHeader)
        {
            ...
            return ScalarStatsAnnotationProcessor.computeStatistics(input.getOutputRowCount(), call, sourceStatsList, scalarFunctionStatsHeader);
        }
