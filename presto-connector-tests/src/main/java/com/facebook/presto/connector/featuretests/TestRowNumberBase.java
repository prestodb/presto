...
@GeneratableConnectorTest(testName = "RowNumber")
@RequiredFeatures(requiredFeatures = {READ_DATA})
@Listeners({UnsupportedMethodInterceptor.class})
public abstract class TestRowNumberBase
        extends AbstractTestQueryFramework
{
    protected TestRowNumberBase(ConnectorTestHelper helper, int connectorTestCount)
    {
        super(helper.getQueryRunnerSupplier(), connectorTestCount);
    }
