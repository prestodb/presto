...
public interface BaseSpiTest
{
     ...
     * include creating and dropping the schemas. Classes implementing BaseSpiTest
            ...
            implements Closeable
    {
        ...
        public Table(BaseSpiTest test, ConnectorSession session, ConnectorTableMetadata tableMetadata)
        {
