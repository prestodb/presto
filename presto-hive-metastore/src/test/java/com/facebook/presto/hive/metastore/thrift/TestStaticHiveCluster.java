...
public class TestStaticHiveCluster
{
    ...
    private static final StaticMetastoreConfig CONFIG_WITH_FALLBACK_AND_HTTP_MODE = new StaticMetastoreConfig()
            .setMetastoreUris("https://default:8080");
    ...
    public void testFallbackHttpMetastoreFails()
    {
        ...
        assertCreateClientFails(cluster, "Failed connecting to Hive metastore: [https://default:8080]");
    }
    ...
    {
        String scheme = config.getMetastoreUris().get(0).getScheme();
        return new StaticHiveCluster(config, ("http".equalsIgnoreCase(scheme) || "https".equalsIgnoreCase(scheme)) ?
