...
public class TestStaticHiveCluster
{
             ...
             throws TException
    {
        ...
        assertEquals(cluster.createMetastoreClient(Optional.empty(), Optional.empty()), DEFAULT_CLIENT);
    }
             ...
             throws TException
    {
        ...
        assertEquals(cluster.createMetastoreClient(Optional.empty(), Optional.empty()), FALLBACK_CLIENT);
    }
    ...
    {
        try {
            cluster.createMetastoreClient(Optional.empty(), Optional.empty());
