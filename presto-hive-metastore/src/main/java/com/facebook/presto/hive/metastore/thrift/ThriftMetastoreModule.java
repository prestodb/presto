        ...
        extends AbstractConfigurationAwareModule
{
    ...
    protected void setup(Binder binder)
    {
        ...
        if (MetastoreDiscoveryType.DYNAMIC == buildConfigObject(DynamicMetastoreConfig.class).getMetastoreDiscoveryType()) {
            ...
            binder.bind(ThriftMetastoreUriFetcher.class).in(Scopes.SINGLETON);
        }
        else {
