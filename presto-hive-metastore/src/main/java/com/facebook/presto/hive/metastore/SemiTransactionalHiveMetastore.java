...
public class SemiTransactionalHiveMetastore
{
    ...
    {
        Map<String, List<DateTime>> lastDataCommitTimes = new HashMap<>();
        lastDataCommitTimes.put(resultKey, operationStats.getLastDataCommitTimes());
        return new HiveCommitHandle(new ConnectorId("Hive"), lastDataCommitTimes);
    }
    ...
    private class Committer
    {
        ...
        {
            HiveCommitHandle commitHandle = new HiveCommitHandle(new ConnectorId("Hive"), new HashMap<>());
