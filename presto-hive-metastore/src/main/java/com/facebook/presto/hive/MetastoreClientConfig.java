...
public class MetastoreClientConfig
{
    ...
    public MetastoreClientConfig setEnabledCaches(String caches)
    {
        ...
        this.enabledCaches = ImmutableSet.copyOf(transform(SPLITTER.split(caches), MetastoreCacheType::valueOf));
        return this;
    }
    ...
    public MetastoreClientConfig setDisabledCaches(String caches)
    {
        ...
        this.disabledCaches = ImmutableSet.copyOf(transform(SPLITTER.split(caches), MetastoreCacheType::valueOf));
        return this;
    }
