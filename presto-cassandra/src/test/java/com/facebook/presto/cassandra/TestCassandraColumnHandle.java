...
public class TestCassandraColumnHandle {
	private final JsonCodec<CassandraColumnHandle> codec = JsonCodec
			.jsonCodec(CassandraColumnHandle.class);

	@Test
	public void testRoundTrip() {
		CassandraColumnHandle expected = new CassandraColumnHandle("connector", "name", 42,
				CassandraType.FLOAT, null, true, false);
	...
	public void testRoundTrip2() {
		CassandraColumnHandle expected = new CassandraColumnHandle("connector", "name2", 1,
				CassandraType.MAP, ImmutableList.of(CassandraType.VARCHAR, CassandraType.UUID), false, true);
