...
public class TestCachingCassandraSchemaProvider {
	...
	public void setUp() throws Exception {
		...
		schemaProvider = new CachingCassandraSchemaProvider(mockSession, executor, new Duration(5,
				TimeUnit.MINUTES), new Duration(1, TimeUnit.MINUTES));
	}
	...
	public void testGetTable() throws Exception {
		final CassandraTableHandle tableHandle = new CassandraTableHandle(CONNECTOR_ID, TEST_SCHEMA, TEST_TABLE);
		assertEquals(mockSession.getAccessCount(), 0);
	...
	public void testInvalidDbGetTable() throws Exception {
		final CassandraTableHandle tableHandle = new CassandraTableHandle(CONNECTOR_ID, BAD_SCHEMA, TEST_TABLE);
	...
	public void testGetPartitions() throws Exception {
		final CassandraTableHandle tableHandle = new CassandraTableHandle(CONNECTOR_ID, TEST_SCHEMA, TEST_TABLE);
		assertEquals(mockSession.getAccessCount(), 0);
		final CassandraTable table = schemaProvider.getTable(tableHandle);
		assertNotNull(table);

		final String expectedList = "[column1 = 'testpartition1', column1 = 'testpartition2']";
