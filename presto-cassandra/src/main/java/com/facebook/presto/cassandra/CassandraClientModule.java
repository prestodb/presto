...
public class CassandraClientModule implements Module {
	...
	public void configure(Binder binder) {
		...
		newExporter(binder).export(CachingCassandraSchemaProvider.class).as(
				generatedNameOf(CachingCassandraSchemaProvider.class, connectorId));
	...
	@Singleton
	@Provides
	public ExecutorService createCachingCassandraSchemaExecutor(CassandraConnectorId clientId,
	...
	@Singleton
	@Provides
	public CassandraSession createCassandraSession(CassandraConnectorId connectorId,
