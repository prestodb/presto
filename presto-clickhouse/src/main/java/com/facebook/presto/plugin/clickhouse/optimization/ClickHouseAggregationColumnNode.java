...
public class ClickHouseAggregationColumnNode
{
    private final ExpressionType expressionType;
    private final VariableReferenceExpression outputColumn;

    public ClickHouseAggregationColumnNode(ExpressionType expressionType, VariableReferenceExpression outputColumn)
    {
    ...
    public static class GroupByColumnNode
            extends ClickHouseAggregationColumnNode
    {
