        ...
        extends TestFunctions
{
    ...
    {
        assertFunctionNoRewrite("array_except(ARRAY[], ARRAY[])", new ArrayType(UNKNOWN), ImmutableList.of());
    ...
    {
        assertFunctionNoRewrite("array_except(ARRAY[NULL], NULL)", new ArrayType(UNKNOWN), null);
        assertFunctionNoRewrite("array_except(NULL, NULL)", new ArrayType(UNKNOWN), null);
        assertFunctionNoRewrite("array_except(NULL, ARRAY[NULL])", new ArrayType(UNKNOWN), null);
        assertFunctionNoRewrite("array_except(ARRAY[NULL], ARRAY[NULL])", new ArrayType(UNKNOWN), ImmutableList.of());
        assertFunctionNoRewrite("array_except(ARRAY[], ARRAY[NULL])", new ArrayType(UNKNOWN), ImmutableList.of());
        assertFunctionNoRewrite("array_except(ARRAY[NULL], ARRAY[])", new ArrayType(UNKNOWN), singletonList(null));
    }
