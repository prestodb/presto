...
public class TestZOrder
{
    ...
    private static final ZValueRange[][] SEARCH_CURVE_RANGES = {
            {
                    new ZValueRange(ImmutableList.of(Optional.of(4)), ImmutableList.of(Optional.of(5))),
                    new ZValueRange(ImmutableList.of(Optional.of(2)), ImmutableList.of(Optional.of(3)))},
            {
                    new ZValueRange(ImmutableList.of(Optional.of(3)), ImmutableList.of(Optional.of(4))),
                    new ZValueRange(ImmutableList.of(Optional.of(3)), ImmutableList.of(Optional.of(4)))},
            {
                    new ZValueRange(ImmutableList.of(Optional.of(4)), ImmutableList.of(Optional.of(5))),
                    new ZValueRange(ImmutableList.of(Optional.of(0)), ImmutableList.of(Optional.of(3)))}};
    ...
    public void testZOrderSearchUnevenCurves()
    {
        ...
        List<ZValueRange> ranges = ImmutableList.of(
                new ZValueRange(ImmutableList.of(Optional.of(0)), ImmutableList.of(Optional.of(2))),
                new ZValueRange(ImmutableList.of(Optional.of(3)), ImmutableList.of(Optional.of(6))));
    ...
    public void testZOrderSearchCurveIntegers()
    {
        ...
        List<ZValueRange> ranges = ImmutableList.of(
                new ZValueRange(ImmutableList.of(Optional.empty()), ImmutableList.of(Optional.of(0))),
                new ZValueRange(ImmutableList.of(Optional.of(1)), ImmutableList.of(Optional.empty())),
                new ZValueRange(ImmutableList.of(Optional.of(7)), ImmutableList.of(Optional.of(9))));
    ...
    {
        List<Integer> bitPositions = ImmutableList.of(4);
        ZOrder zOrder = new ZOrder(bitPositions);

        List<ZValueRange> ranges = ImmutableList.of(new ZValueRange(ImmutableList.of(Optional.empty(), Optional.of(14)), ImmutableList.of(Optional.of(1), Optional.empty())));

        List<ZAddressRange<Integer>> addresses = zOrder.zOrderSearchCurveIntegers(ranges);

        assertEquals(addresses, ImmutableList.of(new ZAddressRange<>(0L, 1L), new ZAddressRange<>(14L, 15L)));

        bitPositions = ImmutableList.of(4, 2, 3);
        zOrder = new ZOrder(bitPositions);

        ranges = ImmutableList.of(
                new ZValueRange(ImmutableList.of(Optional.empty(), Optional.of(14)), ImmutableList.of(Optional.of(1), Optional.empty())),
                new ZValueRange(ImmutableList.of(Optional.of(2)), ImmutableList.of(Optional.empty())),
    ...
    public void testZOrderSearchCurveOutOfBounds()
    {
        ...
        List<ZValueRange> ranges = ImmutableList.of(new ZValueRange(ImmutableList.of(Optional.of(-1)), ImmutableList.of(Optional.of(-1))));
