        ...
        implements ConnectorPageSinkProvider
{
    ...
    public ConnectorPageSink createPageSink(ConnectorTransactionHandle transactionHandle, ConnectorSession session, ConnectorOutputTableHandle outputTableHandle)
    {
        ...
        return new BlackHolePageSink(executorService, blackHoleOutputTableHandle.getPageProcessingDelay().toMillis());
    }
    ...
    public ConnectorPageSink createPageSink(ConnectorTransactionHandle transactionHandle, ConnectorSession session, ConnectorInsertTableHandle insertTableHandle)
    {
        ...
        return new BlackHolePageSink(executorService, blackHoleInsertTableHandle.getPageProcessingDelay().toMillis());
    }
}
