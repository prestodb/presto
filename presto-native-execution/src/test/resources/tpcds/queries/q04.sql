WITH
  year_total AS (
   ...
   , "d_year" "dyear"
   , "round"("sum"((((("ss_ext_list_price" - "ss_ext_wholesale_cost") - "ss_ext_discount_amt") + "ss_ext_sales_price") / 2)), 2) "year_total"
   , 's' "sale_type"
   FROM
     customer
   , store_sales
...
UNION ALL    SELECT
   ...
   , "c_email_address" "customer_email_address"
   , "d_year" "dyear"
   , "round"("sum"((((("cs_ext_list_price" - "cs_ext_wholesale_cost") - "cs_ext_discount_amt") + "cs_ext_sales_price") / 2)), 2) "year_total"
   , 'c' "sale_type"
   FROM
     customer
   , catalog_sales
...
UNION ALL    SELECT
   ...
   , "c_email_address" "customer_email_address"
   , "d_year" "dyear"
   , "round"("sum"((((("ws_ext_list_price" - "ws_ext_wholesale_cost") - "ws_ext_discount_amt") + "ws_ext_sales_price") / 2)), 2) "year_total"
   , 'w' "sale_type"
   FROM
     customer
   , web_sales
