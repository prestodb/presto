...
FROM
  (
   SELECT
       "round"("avg"("ss_list_price"), 2) "b1_lp"
...
, (
   SELECT
       "round"("avg"("ss_list_price"), 2) "b2_lp"
...
, (
   SELECT
       "round"("avg"("ss_list_price"), 2) "b3_lp"
...
, (
   SELECT
       "round"("avg"("ss_list_price"), 2) "b4_lp"
...
, (
   SELECT
       "round"("avg"("ss_list_price"), 2) "b5_lp"
...
, (
   SELECT
       "round"("avg"("ss_list_price"), 2) "b6_lp"
