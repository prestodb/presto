...
, "round"("avg"("ws_quantity"), 2)
, "round"("avg"("wr_refunded_cash"), 2)
, "round"("avg"("wr_fee"), 2)
FROM
  web_sales
, web_returns
...
ORDER BY "substr"("r_reason_desc", 1, 20) ASC, "round"("avg"("ws_quantity"), 2) ASC, "round"("avg"("wr_refunded_cash"), 2) ASC, "round"("avg"("wr_fee"), 2) ASC
LIMIT 100
