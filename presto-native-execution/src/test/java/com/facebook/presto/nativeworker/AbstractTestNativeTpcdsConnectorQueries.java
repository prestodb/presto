        ...
        extends AbstractTestQueryFramework
{
    ...
    {
        Session session = getSession();
        assertQuery(session, "SELECT cc_call_center_sk, cc_name, cc_manager, cc_mkt_id FROM call_center");
        ...
        assertQuery(session, "SELECT c.c_customer_id, c.c_first_name, c.c_last_name FROM customer c " +
