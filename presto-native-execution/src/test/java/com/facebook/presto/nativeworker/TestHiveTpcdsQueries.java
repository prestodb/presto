        ...
        extends AbstractTestQueryFramework
{
    ...
    private Session hiveTpcdsSession;

    public TestHiveTpcdsQueries(boolean useThrift, String storageFormat)
    {
            ...
            throws Exception
    {
        ...
        return HiveExternalWorkerQueryRunner.createNativeQueryRunner(baseDataDir, prestoServerPath, Optional.ofNullable(workerCount).map(Integer::parseInt), cacheMaxSize,
                useThrift, storageFormat);
    }
    ...
    {
        String baseDataDir = System.getProperty("DATA_DIR");
        return HiveExternalWorkerQueryRunner.createJavaQueryRunner(Optional.of(Paths.get(baseDataDir)), storageFormat);
    }
    ...
    {
        if (hiveTpcdsSession == null) {
            hiveTpcdsSession = Session.builder(super.getSession())
                    .setSchema("tpcds").build();
        }

        return hiveTpcdsSession;
    }
