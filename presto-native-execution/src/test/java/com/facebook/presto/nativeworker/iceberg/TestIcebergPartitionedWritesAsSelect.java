...
public class TestIcebergPartitionedWritesAsSelect
        extends IcebergPartitionTestBase
{
    ...
    private void insertTestData(int repeatCounter)
    {
    ...
    private void insertTestDataWithMultipleDates(int repeatCounter)
    {
        for (int i = 0; i < repeatCounter; i++) {
            assertUpdate(format("INSERT INTO %s VALUES " +
    ...
    private void insertTestDataWithMultipleYears(int repeatCounter)
    {
        for (int i = 0; i < repeatCounter; i++) {
            assertUpdate(format("INSERT INTO %s VALUES " +
