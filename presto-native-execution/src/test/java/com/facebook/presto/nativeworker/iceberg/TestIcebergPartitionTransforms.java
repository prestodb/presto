...
public class TestIcebergPartitionTransforms
        extends IcebergPartitionTestBase
{
    ...
    private void testPartitionTransform(String transform, String dataType, String param)
    {
        ...
        PartitionInfo partitionInfo = collectPartitionInfo(transform, tableNames[0], tableNames[1], columnName);
        ...
        MaterializedResult mr = computeExpected(format("SELECT * FROM %s", tableNames[1]), ImmutableList.of());
        MaterializedResult mr2 = computeActual(format("SELECT * FROM %s", tableNames[0]));
        ...
        verifyPartitionTransform(transform, param, tableNames[0], tableNames[1], columnName, partitionInfo);
