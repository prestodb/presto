...
public class PrestoNativeQueryRunnerUtils
{
    ...
    public static NativeQueryRunnerParameters getNativeQueryRunnerParameters()
    {
        ...
        getProperty("CATALOG_TYPE").ifPresent(v -> runnerParams.put("iceberg.catalog.type", v.toUpperCase()));
        log.info("using CATALOG_TYPE %s", runnerParams.getOrDefault("iceberg.catalog.type", "HIVE"));
