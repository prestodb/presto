        ...
        extends AbstractTestQueryFramework
{
            ...
            throws InterruptedException
    {
        ...
        try {
            ...
            assertQueryFails("SELECT CAST('192.168.255.256' AS IPADDRESS)", ".*Cannot cast value to IPADDRESS.*");
            assertQueryFails("SELECT ip_prefix(CAST('192.168.255.255' AS IPADDRESS), 99)", ".*IPv4 subnet size must be in range \\[0, 32\\].*");
        }
        finally {
            dropTableIfExists(tmpTableName);
        }
