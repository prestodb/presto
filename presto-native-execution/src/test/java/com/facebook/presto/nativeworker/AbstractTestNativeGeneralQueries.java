        ...
        extends AbstractTestQueryFramework
{
    ...
    public void testStringFunctions()
    {
        ...
        // bit_length
        assertQuery("SELECT bit_length('') FROM (VALUES 1)");
        assertQuery("SELECT bit_length('hello') FROM (VALUES 1)");
        assertQuery("SELECT bit_length('hell o\u00EF') FROM (VALUES 1)");
        assertQuery("SELECT bit_length('\u4E2D123') FROM (VALUES 1)");
