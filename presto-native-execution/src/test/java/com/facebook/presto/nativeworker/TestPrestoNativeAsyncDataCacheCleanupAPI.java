        ...
        extends AbstractTestQueryFramework
{
    ...
    {
        return PrestoNativeQueryRunnerUtils.createQueryRunner(true, false, true);
    }
            ...
            throws Exception
    {
        ...
        for (InternalNode worker : workerNodes) {
            ...
            hits += metrics.get("velox_memory_cache_num_hits");
            entries += metrics.get("velox_memory_cache_num_entries");
        }
