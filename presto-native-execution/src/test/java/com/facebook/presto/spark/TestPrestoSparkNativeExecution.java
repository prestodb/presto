        ...
        extends AbstractTestQueryFramework
{
    ...
    public void testNativeExecutionWithProjection()
    {
        ...
        try {
            ...
            assertQueryFails(session, "SELECT from_utf8(to_utf8(cast(orderkey as varchar))) FROM test_order",
                    ".*Scalar function name not registered: presto.default.from_utf8.*");
