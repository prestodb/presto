...
class IdentityDataProcessor : public TableFunctionDataProcessor {
 public:
  explicit IdentityDataProcessor(const IdentityFunctionHandle* handle, memory::MemoryPool* pool)
      : TableFunctionDataProcessor("identity", pool, nullptr), handle_(handle) {}
