...
class TableFunctionPartition {
 public:
  ...
  /// Append pass-through columns to the output of the table function if
  /// there are any pass-through columns. The function output is expected to
  /// have only the proper output columns declared in the return type of
