...
SessionProperties::SessionProperties() {
  ...
  addSessionProperty(
      ...
      util::boolToString(c.exprEvalSimplified()));
  ...
  addSessionProperty(
      ...
      util::boolToString(c.joinSpillEnabled()));
  ...
  addSessionProperty(
      ...
      util::boolToString(c.windowSpillEnabled()));
  ...
  addSessionProperty(
      ...
      util::boolToString(c.writerSpillEnabled()));
  ...
  addSessionProperty(
      ...
      util::boolToString(c.rowNumberSpillEnabled()));
  ...
  addSessionProperty(
      ...
      util::boolToString(c.topNRowNumberSpillEnabled()));
  ...
  addSessionProperty(
      ...
      util::boolToString(c.validateOutputFromOperators()));
  ...
  addSessionProperty(
      ...
      util::boolToString(c.debugDisableExpressionsWithPeeling()));
  ...
  addSessionProperty(
      ...
      util::boolToString(c.debugDisableCommonSubExpressions()));
  ...
  addSessionProperty(
      ...
      util::boolToString(c.debugDisableExpressionsWithLazyInputs()));
  ...
  addSessionProperty(
      ...
      util::boolToString(c.selectiveNimbleReaderEnabled()));
  ...
  addSessionProperty(
      ...
      util::boolToString(c.queryTraceEnabled()));
  ...
  addSessionProperty(
      ...
      util::boolToString(c.aggregationMemoryCompactionReclaimEnabled()));
}
