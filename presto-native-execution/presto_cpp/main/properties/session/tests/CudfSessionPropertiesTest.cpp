...
TEST_F(CudfSessionPropertiesTest, validateMapping) {
  ...
  const std::unordered_map<std::string, std::string> expectedMappings = {
      {CudfSessionProperties::kCudfEnabled,
       cudf_velox::CudfQueryConfig::kCudfEnabledEntry.name},
      ...
      {CudfSessionProperties::kCudfMemoryResource,
       cudf_velox::CudfQueryConfig::kCudfMemoryResourceEntry.name},
      {CudfSessionProperties::kCudfMemoryPercent,
       cudf_velox::CudfQueryConfig::kCudfMemoryPercentEntry.name},
      {CudfSessionProperties::kCudfFunctionNamePrefix,
       cudf_velox::CudfQueryConfig::kCudfFunctionNamePrefixEntry.name},
      {CudfSessionProperties::kCudfAstExpressionEnabled,
       cudf_velox::CudfQueryConfig::kCudfAstExpressionEnabledEntry.name},
      {CudfSessionProperties::kCudfAstExpressionPriority,
       cudf_velox::CudfQueryConfig::kCudfAstExpressionPriorityEntry.name},
      {CudfSessionProperties::kCudfJitExpressionEnabled,
       cudf_velox::CudfQueryConfig::kCudfJitExpressionEnabledEntry.name},
      {CudfSessionProperties::kCudfJitExpressionPriority,
       cudf_velox::CudfQueryConfig::kCudfJitExpressionPriorityEntry.name},
      {CudfSessionProperties::kCudfAllowCpuFallback,
       cudf_velox::CudfQueryConfig::kCudfAllowCpuFallbackEntry.name},
      {CudfSessionProperties::kCudfLogFallback,
       cudf_velox::CudfQueryConfig::kCudfLogFallbackEntry.name},
  };
