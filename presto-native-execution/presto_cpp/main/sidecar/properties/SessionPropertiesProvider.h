...
/// Base class providing default implementations for session property management.
/// Subclasses can specialize initialization while inheriting common serialization
/// and configuration mapping functionality.
