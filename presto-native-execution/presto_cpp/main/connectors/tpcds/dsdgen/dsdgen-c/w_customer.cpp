...
int mk_w_customer(
  ...
  append_integer(C_FIRST_SHIPTO_DATE_ID, info, r->c_first_shipto_date_id);
  append_integer(C_FIRST_SALES_DATE_ID, info, r->c_first_sales_date_id);
  ...
  append_integer(C_LAST_REVIEW_DATE, info, r->c_last_review_date);
