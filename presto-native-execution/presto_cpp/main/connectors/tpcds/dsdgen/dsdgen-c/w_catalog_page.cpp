...
int mk_w_catalog_page(
  ...
  nCatalogPageMax =
      ((int)get_rowcount(CATALOG_PAGE, dsdGenContext) / CP_CATALOGS_PER_YEAR) /
  ...
  append_key(CP_START_DATE_ID, info, r->cp_start_date_id);
  append_key(CP_END_DATE_ID, info, r->cp_end_date_id);
