...
#include "presto_cpp/external/dsdgen/include/dsdgen-c/append_info.h"
#include "presto_cpp/external/dsdgen/include/dsdgen-c/config.h"
#include "presto_cpp/external/dsdgen/include/dsdgen-c/date.h"
#include "presto_cpp/external/dsdgen/include/dsdgen-c/nulls.h"
#include "presto_cpp/external/dsdgen/include/dsdgen-c/porting.h"
#include "velox/vector/FlatVector.h"

using namespace facebook::velox;
using namespace facebook::presto::connector::tpcds;
append_info* append_info_get(void* info_list, int table_id) {
  auto& append_vector =
      *((std::vector<std::unique_ptr<TpcdsTableDef>>*)info_list);
  return (append_info*)append_vector[table_id].get();
}

bool facebook::presto::connector::tpcds::TpcdsTableDef::IsNull(int32_t column) {
  return nullCheck(column, *dsdGenContext);
}

void append_row_start(append_info info) {
  auto append_info = (TpcdsTableDef*)info;
}
