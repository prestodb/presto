...
class ArrowFlightConnectorTest : public FlightWithServerTestBase {};
...
class ArrowFlightConnectorTestDefaultServer : public FlightWithServerTestBase {
 public:
  ArrowFlightConnectorTestDefaultServer()
      : FlightWithServerTestBase(std::make_shared<velox::config::ConfigBase>(
            std::unordered_map<std::string, std::string>{
                {ArrowFlightConfig::kDefaultServerHost, CONNECT_HOST},
