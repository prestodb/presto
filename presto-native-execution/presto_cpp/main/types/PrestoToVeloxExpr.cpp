...
std::string mapScalarFunction(const std::string& name) {
  ...
  static const std::unordered_map<std::string, std::string> kFunctionNames = {
      ...
      {"presto.default.$operator$add",
       addDefaultNamespacePrefix(prestoDefaultNamespacePrefix, "plus")},
      {"presto.default.$operator$between",
       addDefaultNamespacePrefix(prestoDefaultNamespacePrefix, "between")},
      {"presto.default.$operator$divide",
       addDefaultNamespacePrefix(prestoDefaultNamespacePrefix, "divide")},
      {"presto.default.$operator$equal",
       addDefaultNamespacePrefix(prestoDefaultNamespacePrefix, "eq")},
      {"presto.default.$operator$greater_than",
       addDefaultNamespacePrefix(prestoDefaultNamespacePrefix, "gt")},
      {"presto.default.$operator$greater_than_or_equal",
       addDefaultNamespacePrefix(prestoDefaultNamespacePrefix, "gte")},
      ...
      {"presto.default.$operator$less_than",
       addDefaultNamespacePrefix(prestoDefaultNamespacePrefix, "lt")},
      {"presto.default.$operator$less_than_or_equal",
       addDefaultNamespacePrefix(prestoDefaultNamespacePrefix, "lte")},
      {"presto.default.$operator$modulus",
       addDefaultNamespacePrefix(prestoDefaultNamespacePrefix, "mod")},
      {"presto.default.$operator$multiply",
       addDefaultNamespacePrefix(prestoDefaultNamespacePrefix, "multiply")},
      {"presto.default.$operator$negation",
       addDefaultNamespacePrefix(prestoDefaultNamespacePrefix, "negate")},
      {"presto.default.$operator$not_equal",
       addDefaultNamespacePrefix(prestoDefaultNamespacePrefix, "neq")},
      {"presto.default.$operator$subtract",
       addDefaultNamespacePrefix(prestoDefaultNamespacePrefix, "minus")},
      {"presto.default.$operator$subscript",
       addDefaultNamespacePrefix(prestoDefaultNamespacePrefix, "subscript")},
...
std::optional<TypedExprPtr> convertCastToVarcharWithMaxLength(
  ...
  return std::make_shared<CallTypedExpr>(
      ...
      addDefaultNamespacePrefix(prestoDefaultNamespacePrefix, "substr"));
}
...
std::optional<TypedExprPtr> tryConvertLiteralArray(
  ...
  static const std::string kFromBase64 =
      addDefaultNamespacePrefix(prestoDefaultNamespacePrefix, "from_base64");
...
std::optional<TypedExprPtr> VeloxExprConverter::tryConvertDate(
  ...
  static const std::string kDate =
      addDefaultNamespacePrefix(prestoDefaultNamespacePrefix, "date");
...
std::optional<TypedExprPtr> VeloxExprConverter::tryConvertLike(
  ...
  static const std::string kLike =
      addDefaultNamespacePrefix(prestoDefaultNamespacePrefix, "like");
  static const std::string kLikePatternType =
      addDefaultNamespacePrefix(prestoDefaultNamespacePrefix, "like_pattern");
