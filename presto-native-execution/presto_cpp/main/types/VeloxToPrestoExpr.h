...
/// RowExpression. The function `getRowExpression` is used to convert an
/// optimized velox core::TypedExpr to a Presto protocol::RowExpression:
...
class VeloxToPrestoExprConverter {
 public:
  ...
  RowExpressionPtr getRowExpression(const core::TypedExprPtr& expr);
 ...
 private:
  ...
  /// Helper function to get Presto protocol ConstantExpression from a velox
  /// constant expression.
  ...
  /// call expression.
  CallExpressionPtr getCallExpression(const core::CallTypedExpr* expr);
