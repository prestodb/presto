...
VeloxQueryPlanConverterBase::toVeloxQueryPlan(
  ...
  // TODO: handling of orderingScheme, do we need merge node (see line 392)?

  // TODO: set file name generator in TableWriteNode
  return std::make_shared<core::TableWriteNode>(
      node->id,
      inputColumns,
      inputColumns->names(),
      ...
      std::move(insertTableHandle),
      false, // TODO: this control writer count, should we have > 1?
      outputType,
      getCommitStrategy(),
      sourceVeloxPlan);
}
