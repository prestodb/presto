...
core::PlanNodePtr VeloxQueryPlanConverterBase::toVeloxQueryPlan(
  ...
  auto& partitioningScheme = node->partitioningScheme;
  auto connectorHandle = partitioningScheme.partitioning.handle.connectorHandle;
  bool scaleWriters = partitioningScheme.scaleWriters;
