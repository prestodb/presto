...
VeloxTransportType toVeloxTransportType(protocol::ExchangeNodeTransportType t) {
  switch (t) {
    case protocol::ExchangeNodeTransportType::HTTP:
      return VeloxTransportType::kHttp;
    case protocol::ExchangeNodeTransportType::UCX:
