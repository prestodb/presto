...
// More detailed tests for Presto TypeParser are in
// velox/functions/prestosql/types/parser/tests/TypeParserTest.
TEST_F(TypeParserTest, parseEnumTypes) {
  ...
  // When set to false, TypeParser will throw an unsupported error when it
  // receives an enum type.
  SystemConfig::instance()->setValue(
      std::string(SystemConfig::kEnumTypesEnabled), "false");
