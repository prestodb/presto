...
/// Base class to extend for concrete PrestoServer classes. Keep common
/// functionality in this class and move engine-specific functionality to
/// concrete child classes.
class PrestoServerBase {
 public:
  virtual ~PrestoServerBase();
 ...
 protected:
  explicit PrestoServerBase(const std::string& configDirectoryPath);

  /// Hook for derived PrestoServerBase implementations to add additional
  /// periodic tasks.
