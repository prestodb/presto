...
def main():
    # Preprocess thrift IDL generated by drift to remove "drift.recursive_reference=true" annotation.
    # This annotation is added by drift but errors for cpp ProtocolToThrift files generation.
