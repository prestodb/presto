...
struct TableFinishInfo {
  ...
  5: i64 statisticsWallTimeInNanos;
  6: i64 statisticsCpuTimeInNanos;
}
...
struct TableWriterInfo {
  ...
  5: i64 statisticsWallTimeInNanos;
  6: i64 statisticsCpuTimeInNanos;
  7: i64 validationCpuTimeInNanos;
}
...
struct DriverStats {
  ...
  25: i64 queuedTimeInNanos;
  26: i64 elapsedTimeInNanos;
  27: i64 totalScheduledTimeInNanos;
  28: i64 totalCpuTimeInNanos;
  29: i64 totalBlockedTimeInNanos;
  30: i64 rawInputReadTimeInNanos;
}
...
struct OperatorStats {
  ...
  49: i64 addInputWallInNanos;
  50: i64 addInputCpuInNanos;
  51: i64 getOutputWallInNanos;
  52: i64 getOutputCpuInNanos;
  53: i64 additionalCpuInNanos;
  54: i64 blockedWallInNanos;
  55: i64 finishWallInNanos;
  56: i64 finishCpuInNanos;
  57: i64 isBlockedWallInNanos;
  58: i64 isBlockedCpuInNanos;
}
