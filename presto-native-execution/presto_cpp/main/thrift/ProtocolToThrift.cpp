...
namespace facebook::presto::thrift {
  ...
  void toThrift(const facebook::presto::protocol::OperatorStats& operatorStats, thrift::OperatorStats& thriftOperatorStats) {
    ...
    toThrift(operatorStats.isBlockedWallInNanos, *thriftOperatorStats.isBlockedWallInNanos_ref());
    toThrift(operatorStats.isBlockedCpuInNanos, *thriftOperatorStats.isBlockedCpuInNanos_ref());
    ...
    toThrift(operatorStats.addInputWallInNanos, *thriftOperatorStats.addInputWallInNanos_ref());
    toThrift(operatorStats.addInputCpuInNanos, *thriftOperatorStats.addInputCpuInNanos_ref());
    ...
    toThrift(operatorStats.getOutputWallInNanos, *thriftOperatorStats.getOutputWallInNanos_ref());
    toThrift(operatorStats.getOutputCpuInNanos, *thriftOperatorStats.getOutputCpuInNanos_ref());
    ...
    toThrift(operatorStats.additionalCpuInNanos, *thriftOperatorStats.additionalCpuInNanos_ref());
    toThrift(operatorStats.blockedWallInNanos, *thriftOperatorStats.blockedWallInNanos_ref());
    toThrift(operatorStats.finishCalls, *thriftOperatorStats.finishCalls_ref());
    toThrift(operatorStats.finishWallInNanos, *thriftOperatorStats.finishWallInNanos_ref());
    toThrift(operatorStats.finishCpuInNanos, *thriftOperatorStats.finishCpuInNanos_ref());
  ...
  void toThrift(const facebook::presto::protocol::DriverStats& driverStats, thrift::DriverStats& thriftDriverStats) {
    ...
    toThrift(driverStats.queuedTimeInNanos, *thriftDriverStats.queuedTimeInNanos_ref());
    toThrift(driverStats.elapsedTimeInNanos, *thriftDriverStats.elapsedTimeInNanos_ref());
    ...
    toThrift(driverStats.totalScheduledTimeInNanos, *thriftDriverStats.totalScheduledTimeInNanos_ref());
    toThrift(driverStats.totalCpuTimeInNanos, *thriftDriverStats.totalCpuTimeInNanos_ref());
    toThrift(driverStats.totalBlockedTimeInNanos, *thriftDriverStats.totalBlockedTimeInNanos_ref());
    ...
    toThrift(driverStats.rawInputReadTimeInNanos, *thriftDriverStats.rawInputReadTimeInNanos_ref());
