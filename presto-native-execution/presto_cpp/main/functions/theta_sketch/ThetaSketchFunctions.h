...
#include "velox/velox/vector/BaseVector.h"
#include "velox/velox/vector/ComplexVector.h"
...
struct ThetaSketchSummaryFunction {
  ...
  FOLLY_ALWAYS_INLINE void call(
    ...
    result.copy_from(std::make_tuple(
        compactSketch.get_estimate(), compactSketch.get_theta(), compactSketch.get_upper_bound(1), compactSketch.get_lower_bound(1), compactSketch.get_num_retained()));
  }
};
} // namespace
