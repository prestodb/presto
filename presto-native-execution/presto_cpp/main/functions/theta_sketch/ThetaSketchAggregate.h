...
velox::exec::AggregateRegistrationResult registerThetaSketchAggregate(
  ...
  for (const auto& inputType :
       {"tinyint", "smallint", "integer", "bigint", "real", "double", "varchar", "date", "timestamp"}) {
          ...
          switch (inputType->kind()) {
            case velox::TypeKind::TINYINT:
              return std::make_unique<
                  velox::exec::SimpleAggregateAdapter<ThetaSketchAggregate<int8_t>>>(
            ...
            case velox::TypeKind::HUGEINT:
              return std::make_unique<
                  velox::exec::SimpleAggregateAdapter<ThetaSketchAggregate<velox::int128_t>>>(
                  step, argTypes, resultType);
            ...
            case velox::TypeKind::TIMESTAMP:
              return std::make_unique<
                  velox::exec::SimpleAggregateAdapter<ThetaSketchAggregate<typename velox::TypeTraits<velox::TypeKind::TIMESTAMP>::NativeType>>>(
                  step, argTypes, resultType);
            default:
              VELOX_FAIL(
