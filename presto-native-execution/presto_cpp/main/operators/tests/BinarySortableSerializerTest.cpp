...
class BinarySortableSerializerTest : public ::testing::Test,
 ...
 public:
  ...
  int lexicographicalCompare(RawBuffer* key1, RawBuffer* key2) {
  ...
  void serializeRow(
      ...
      size_t index,
      RawBuffer* out) {
    binarySortableSerializer.serialize(/*index=*/index, out);
  }
  ...
  int compareRowVector(
    ...
    BinarySortableSerializer binarySortableSerializer(rowVector, ordering, fields);
    ...
    serializeRow(binarySortableSerializer, /*index=*/0, &buffer1);
    serializeRow(binarySortableSerializer, /*index=*/1, &buffer2);

    return lexicographicalCompare(&buffer1, &buffer2);
  }
  ...
  int singleRowFieldCompare(
      ...
      const velox::core::SortOrder& ordering,
      const std::function<bool(velox::vector_size_t /* row */)>& isNullAt = nullptr) {
