...
public:
  explicit ExecutionFailureException(const std::string& message, protocol::ExecutionFailureInfo failureInfo)
     : VeloxException("", 1, "", "", message, velox::error_source::kErrorSourceSystem, velox::error_code::kUnknown, false),
