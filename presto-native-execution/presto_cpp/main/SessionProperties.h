...
class SessionProperty {
 public:
  ...
  bool operator==(const SessionProperty& other) const {
    return name_ == other.name_ && veloxConfigName_ == other.veloxConfigName_ &&
...
/// Maps native session properties to velox properties. Single source of truth
/// for all system session properties supported by the native worker, thus
/// differentiating them from Presto java based session properties.
