...
class VeloxPlanChecker {
 public:
  ...
  static bool isValidPlanNode(const velox::core::ProjectNode* node);
  static bool isValidPlanNode(const velox::core::FilterNode* node);
  static bool isValidPlanNode(const velox::core::HashJoinNode* node);
