...
TEST_F(SessionPropertiesTest, validateMapping) {
  const std::unordered_map<std::string, std::string> expectedMappings = {
      ...
      {SessionProperties::kLocalMergeSpillEnabled,
       core::QueryConfig::kLocalMergeSpillEnabled},
      {SessionProperties::kLocalMergeMaxNumMergeSources,
       core::QueryConfig::kLocalMergeMaxNumMergeSources},
