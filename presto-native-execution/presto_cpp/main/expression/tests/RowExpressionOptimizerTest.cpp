...
// RowExpressionOptimizerTest only tests for basic expression optimization via
// the 'v1/expressions' endpoint. End to end tests for different types of
// expressions can be found in the file TestDelegatingExpressionOptimizer.java
...
class RowExpressionOptimizerTest
 ...
 protected:
  ...
  std::shared_ptr<memory::MemoryPool> pool_{
      memory::memoryManager()->addLeafPool("RowExpressionOptimizerTest")};
};
