...
namespace facebook::presto::protocol {
struct ConnectorHistogram : public JsonEncodedSubclass {};
void to_json(json& j, const std::shared_ptr<ConnectorHistogram>& p);
void from_json(const json& j, std::shared_ptr<ConnectorHistogram>& p);
} // namespace facebook::presto::protocol
namespace facebook::presto::protocol {
...
struct VariableStatsEstimate {
  ...
  std::shared_ptr<ConnectorHistogram> histogram = {};
};
...
namespace facebook::presto::protocol {
struct UniformDistributionHistogram : public ConnectorHistogram {
  double lowValue = {};
  double highValue = {};

  UniformDistributionHistogram() noexcept;
};
void to_json(json& j, const UniformDistributionHistogram& p);
void from_json(const json& j, UniformDistributionHistogram& p);
} // namespace facebook::presto::protocol
namespace facebook::presto::protocol {
