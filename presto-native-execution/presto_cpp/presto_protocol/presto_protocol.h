...
namespace facebook::presto::protocol {
    ...
    void from_json(const json& j, std::shared_ptr<ConnectorMetadataUpdateHandle>& p);
}
namespace facebook::presto::protocol {
...
namespace facebook::presto::protocol {
    enum class HiveCompressionCodec {
        NONE,
        SNAPPY,
        GZIP,
        LZ4,
...
struct StatisticAggregations {
  std::vector<VariableReferenceExpression> outputVariables = {};
  Map<VariableReferenceExpression, Aggregation> aggregations = {};
...
namespace facebook::presto::protocol {
    struct Frame {
        ...
        std::shared_ptr<VariableReferenceExpression> sortKeyCoercedForFrameStartComparison = {};
        BoundType endType = {};
        std::shared_ptr<VariableReferenceExpression> endValue = {};
        std::shared_ptr<VariableReferenceExpression> sortKeyCoercedForFrameEndComparison = {};
