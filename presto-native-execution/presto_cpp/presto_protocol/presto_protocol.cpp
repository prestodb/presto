...
namespace facebook::presto::protocol {
    ...
    void to_json(json& j, const ConstantExpression& p) {
        j = json::object();
        j["@type"] = "constant";
        to_json_key(j, "valueBlock", p.valueBlock, "ConstantExpression", "Block", "valueBlock");
        to_json_key(j, "type", p.type, "ConstantExpression", "Type", "type");
    }

    void from_json(const json& j, ConstantExpression& p) {
        p._type = j["@type"];
        from_json_key(j, "valueBlock", p.valueBlock, "ConstantExpression", "Block", "valueBlock");
...
namespace facebook::presto::protocol {
    ...
    void to_json(json& j, const HiveFileSplit& p) {
        ...
        to_json_key(j, "fileSize", p.fileSize, "HiveFileSplit", "int64_t", "fileSize");
        to_json_key(j, "fileModifiedTime", p.fileModifiedTime, "HiveFileSplit", "int64_t", "fileModifiedTime");
        to_json_key(j, "extraFileInfo", p.extraFileInfo, "HiveFileSplit", "String", "extraFileInfo");
        to_json_key(j, "customSplitInfo", p.customSplitInfo, "HiveFileSplit", "Map<String, String>", "customSplitInfo");
    }
    ...
    void from_json(const json& j, HiveFileSplit& p) {
        ...
        from_json_key(j, "fileSize", p.fileSize, "HiveFileSplit", "int64_t", "fileSize");
        from_json_key(j, "fileModifiedTime", p.fileModifiedTime, "HiveFileSplit", "int64_t", "fileModifiedTime");
        from_json_key(j, "extraFileInfo", p.extraFileInfo, "HiveFileSplit", "String", "extraFileInfo");
        from_json_key(j, "customSplitInfo", p.customSplitInfo, "HiveFileSplit", "Map<String, String>", "customSplitInfo");
    }
}
namespace facebook::presto::protocol {
...
namespace facebook::presto::protocol {
    ...
    static const std::pair<Determinism, json>   
    Determinism_enum_table[] = {                // NOLINT: cert-err58-cpp
        { Determinism::DETERMINISTIC, "DETERMINISTIC" },
        { Determinism::NOT_DETERMINISTIC, "NOT_DETERMINISTIC" },
    };
    void to_json(json& j, const Determinism& e)                                                   
    {                                                                                           
        static_assert(std::is_enum<Determinism>::value, "Determinism must be an enum!");
        const auto* it = std::find_if(std::begin(Determinism_enum_table), std::end(Determinism_enum_table),
                               [e](const std::pair<Determinism, json>& ej_pair) -> bool
        {
            return ej_pair.first == e;
        });
        j = ((it != std::end(Determinism_enum_table)) ? it : std::begin(Determinism_enum_table))->second;
    }
    void from_json(const json& j, Determinism& e)
    {
        ...
        e = ((it != std::end(Determinism_enum_table)) ? it : std::begin(Determinism_enum_table))->first;
    }
}
namespace facebook::presto::protocol {
    //Loosly copied this here from NLOHMANN_JSON_SERIALIZE_ENUM()
    ...
    // NOLINTNEXTLINE: cppcoreguidelines-avoid-c-arrays
    static const std::pair<NullCallClause, json>   
    NullCallClause_enum_table[] = {                // NOLINT: cert-err58-cpp
        { NullCallClause::RETURNS_NULL_ON_NULL_INPUT, "RETURNS_NULL_ON_NULL_INPUT" },
        { NullCallClause::CALLED_ON_NULL_INPUT, "CALLED_ON_NULL_INPUT" }
    };
    void to_json(json& j, const NullCallClause& e)                                                   
    {                                                                                           
        static_assert(std::is_enum<NullCallClause>::value, "NullCallClause must be an enum!");
        const auto* it = std::find_if(std::begin(NullCallClause_enum_table), std::end(NullCallClause_enum_table),
                               [e](const std::pair<NullCallClause, json>& ej_pair) -> bool
        {
            return ej_pair.first == e;
        });
        j = ((it != std::end(NullCallClause_enum_table)) ? it : std::begin(NullCallClause_enum_table))->second;
    }
    void from_json(const json& j, NullCallClause& e)
    {
        ...
        e = ((it != std::end(NullCallClause_enum_table)) ? it : std::begin(NullCallClause_enum_table))->first;
    }
}
namespace facebook::presto::protocol {
    ...
    void to_json(json& j, const RoutineCharacteristics& p) {
        j = json::object();
        to_json_key(j, "language", p.language, "RoutineCharacteristics", "Language", "language");
        to_json_key(j, "determinism", p.determinism, "RoutineCharacteristics", "Determinism", "determinism");
        to_json_key(j, "nullCallClause", p.nullCallClause, "RoutineCharacteristics", "NullCallClause", "nullCallClause");
    }

    void from_json(const json& j, RoutineCharacteristics& p) {
        from_json_key(j, "language", p.language, "RoutineCharacteristics", "Language", "language");
        from_json_key(j, "determinism", p.determinism, "RoutineCharacteristics", "Determinism", "determinism");
        from_json_key(j, "nullCallClause", p.nullCallClause, "RoutineCharacteristics", "NullCallClause", "nullCallClause");
    }
}
/*
 * Licensed under the Apache License, Version 2.0 (the "License");
...
namespace facebook::presto::protocol {
    ...
    void from_json(const json& j, SplitContext& p) {
        from_json_key(j, "cacheable", p.cacheable, "SplitContext", "bool", "cacheable");
    }
}
/*
 * Licensed under the Apache License, Version 2.0 (the "License");
...
namespace facebook::presto::protocol {
    ...
    void to_json(json& j, const Split& p) {
        j = json::object();
        to_json_key(j, "connectorId", p.connectorId, "Split", "ConnectorId", "connectorId");
        to_json_key(j, "transactionHandle", p.transactionHandle, "Split", "ConnectorTransactionHandle", "transactionHandle");
        ...
        to_json_key(j, "splitContext", p.splitContext, "Split", "SplitContext", "splitContext");
    }

    void from_json(const json& j, Split& p) {
        from_json_key(j, "connectorId", p.connectorId, "Split", "ConnectorId", "connectorId");
        from_json_key(j, "transactionHandle", p.transactionHandle, "Split", "ConnectorTransactionHandle", "transactionHandle");
        ...
        from_json_key(j, "splitContext", p.splitContext, "Split", "SplitContext", "splitContext");
    }
}
namespace facebook::presto::protocol {
...
namespace facebook::presto::protocol {
    ...
    void to_json(json& j, const TaskSource& p) {
        j = json::object();
        to_json_key(j, "planNodeId", p.planNodeId, "TaskSource", "PlanNodeId", "planNodeId");
        to_json_key(j, "splits", p.splits, "TaskSource", "List<ScheduledSplit>", "splits");
        to_json_key(j, "noMoreSplitsForLifespan", p.noMoreSplitsForLifespan, "TaskSource", "List<Lifespan>", "noMoreSplitsForLifespan");
        to_json_key(j, "noMoreSplits", p.noMoreSplits, "TaskSource", "bool", "noMoreSplits");
    }

    void from_json(const json& j, TaskSource& p) {
        from_json_key(j, "planNodeId", p.planNodeId, "TaskSource", "PlanNodeId", "planNodeId");
        from_json_key(j, "splits", p.splits, "TaskSource", "List<ScheduledSplit>", "splits");
        from_json_key(j, "noMoreSplitsForLifespan", p.noMoreSplitsForLifespan, "TaskSource", "List<Lifespan>", "noMoreSplitsForLifespan");
...
namespace facebook::presto::protocol {
    ...
    void from_json(const json& j, std::shared_ptr<PlanNode>& p) {
        ...
        if ( type == "com.facebook.presto.sql.planner.plan.EnforceSingleRowNode" ) {
            std::shared_ptr<EnforceSingleRowNode> k = std::make_shared<EnforceSingleRowNode>();
            j.get_to(*k);
            p = std::static_pointer_cast<PlanNode>(k);
            return;
        }
        ...
        if ( type == "com.facebook.presto.sql.planner.plan.TopNRowNumberNode" ) {
            std::shared_ptr<TopNRowNumberNode> k = std::make_shared<TopNRowNumberNode>();
            j.get_to(*k);
            p = std::static_pointer_cast<PlanNode>(k);
            return;
        }
...
namespace facebook::presto::protocol {
    ...
    void to_json(json& j, const VariableReferenceExpression& p) {
        j = json::object();
        j["@type"] = "variable";
        to_json_key(j, "sourceLocation", p.sourceLocation, "VariableReferenceExpression", "SourceLocation", "sourceLocation");
        to_json_key(j, "name", p.name, "VariableReferenceExpression", "String", "name");
        to_json_key(j, "type", p.type, "VariableReferenceExpression", "Type", "type");
    }

    void from_json(const json& j, VariableReferenceExpression& p) {
        p._type = j["@type"];
        from_json_key(j, "sourceLocation", p.sourceLocation, "VariableReferenceExpression", "SourceLocation", "sourceLocation");
        from_json_key(j, "name", p.name, "VariableReferenceExpression", "String", "name");
        from_json_key(j, "type", p.type, "VariableReferenceExpression", "Type", "type");
    }
}
namespace facebook::presto::protocol {
    ...
    void to_json(json& j, const UnnestNode& p) {
        ...
        to_json_key(j, "replicateVariables", p.replicateVariables, "UnnestNode", "List<VariableReferenceExpression>", "replicateVariables");
        to_json_key(j, "unnestVariables", p.unnestVariables, "UnnestNode", "Map<VariableReferenceExpression, List<VariableReferenceExpression>>", "unnestVariables");
        to_json_key(j, "ordinalityVariable", p.ordinalityVariable, "UnnestNode", "VariableReferenceExpression", "ordinalityVariable");
    }
    ...
    void from_json(const json& j, UnnestNode& p) {
        ...
        from_json_key(j, "replicateVariables", p.replicateVariables, "UnnestNode", "List<VariableReferenceExpression>", "replicateVariables");
        from_json_key(j, "unnestVariables", p.unnestVariables, "UnnestNode", "Map<VariableReferenceExpression, List<VariableReferenceExpression>>", "unnestVariables");
        from_json_key(j, "ordinalityVariable", p.ordinalityVariable, "UnnestNode", "VariableReferenceExpression", "ordinalityVariable");
    }
}
namespace facebook::presto::protocol {
...
namespace facebook::presto::protocol {
    ...
    void to_json(json& j, const DwrfEncryptionMetadata& p) {
        j = json::object();
        to_json_key(j, "fieldToKeyData", p.fieldToKeyData, "DwrfEncryptionMetadata", "Map<String, String>", "fieldToKeyData");
        to_json_key(j, "extraMetadata", p.extraMetadata, "DwrfEncryptionMetadata", "Map<String, String>", "extraMetadata");
        to_json_key(j, "encryptionAlgorithm", p.encryptionAlgorithm, "DwrfEncryptionMetadata", "String", "encryptionAlgorithm");
        to_json_key(j, "encryptionProvider", p.encryptionProvider, "DwrfEncryptionMetadata", "String", "encryptionProvider");
    }

    void from_json(const json& j, DwrfEncryptionMetadata& p) {
        from_json_key(j, "fieldToKeyData", p.fieldToKeyData, "DwrfEncryptionMetadata", "Map<String, String>", "fieldToKeyData");
        from_json_key(j, "extraMetadata", p.extraMetadata, "DwrfEncryptionMetadata", "Map<String, String>", "extraMetadata");
        from_json_key(j, "encryptionAlgorithm", p.encryptionAlgorithm, "DwrfEncryptionMetadata", "String", "encryptionAlgorithm");
        from_json_key(j, "encryptionProvider", p.encryptionProvider, "DwrfEncryptionMetadata", "String", "encryptionProvider");
    }
}
namespace facebook::presto::protocol {
    ...
    void to_json(json& j, const EncryptionInformation& p) {
        j = json::object();
        to_json_key(j, "dwrfEncryptionMetadata", p.dwrfEncryptionMetadata, "EncryptionInformation", "DwrfEncryptionMetadata", "dwrfEncryptionMetadata");
    }

    void from_json(const json& j, EncryptionInformation& p) {
        from_json_key(j, "dwrfEncryptionMetadata", p.dwrfEncryptionMetadata, "EncryptionInformation", "DwrfEncryptionMetadata", "dwrfEncryptionMetadata");
    }
}
namespace facebook::presto::protocol {
    ...
    void from_json(const json& j, std::shared_ptr<RowExpression>& p) {
        ...
        if ( type == "constant" ) {
            std::shared_ptr<ConstantExpression> k = std::make_shared<ConstantExpression>();
            j.get_to(*k);
            p = std::static_pointer_cast<RowExpression>(k);
            return;
        }
        if ( type == "special" ) {
            std::shared_ptr<SpecialFormExpression> k = std::make_shared<SpecialFormExpression>();
            j.get_to(*k);
            p = std::static_pointer_cast<RowExpression>(k);
            return;
        }
        if ( type == "lambda" ) {
            std::shared_ptr<LambdaDefinitionExpression> k = std::make_shared<LambdaDefinitionExpression>();
            j.get_to(*k);
            p = std::static_pointer_cast<RowExpression>(k);
            return;
        }
        if ( type == "variable" ) {
            std::shared_ptr<VariableReferenceExpression> k = std::make_shared<VariableReferenceExpression>();
            j.get_to(*k);
            p = std::static_pointer_cast<RowExpression>(k);
            return;
        }
...
namespace facebook::presto::protocol {
    ...
    void from_json(const json& j, std::shared_ptr<FunctionHandle>& p) {
        ...
        if ( type == "$static" ) {
            std::shared_ptr<BuiltInFunctionHandle> k = std::make_shared<BuiltInFunctionHandle>();
            j.get_to(*k);
            p = std::static_pointer_cast<FunctionHandle>(k);
            return;
        }
        if ( type == "json_file" ) {
            std::shared_ptr<SqlFunctionHandle> k = std::make_shared<SqlFunctionHandle>();
            j.get_to(*k);
            p = std::static_pointer_cast<FunctionHandle>(k);
            return;
        }
...
namespace facebook::presto::protocol {
    ...
    void to_json(json& j, const CallExpression& p) {
        j = json::object();
        j["@type"] = "call";
        to_json_key(j, "sourceLocation", p.sourceLocation, "CallExpression", "SourceLocation", "sourceLocation");
        to_json_key(j, "displayName", p.displayName, "CallExpression", "String", "displayName");
        to_json_key(j, "functionHandle", p.functionHandle, "CallExpression", "FunctionHandle", "functionHandle");
        to_json_key(j, "returnType", p.returnType, "CallExpression", "Type", "returnType");
        to_json_key(j, "arguments", p.arguments, "CallExpression", "List<std::shared_ptr<RowExpression>>", "arguments");
    }

    void from_json(const json& j, CallExpression& p) {
        p._type = j["@type"];
        from_json_key(j, "sourceLocation", p.sourceLocation, "CallExpression", "SourceLocation", "sourceLocation");
        from_json_key(j, "displayName", p.displayName, "CallExpression", "String", "displayName");
        from_json_key(j, "functionHandle", p.functionHandle, "CallExpression", "FunctionHandle", "functionHandle");
        from_json_key(j, "returnType", p.returnType, "CallExpression", "Type", "returnType");
        from_json_key(j, "arguments", p.arguments, "CallExpression", "List<std::shared_ptr<RowExpression>>", "arguments");
    }
}
namespace facebook::presto::protocol {
    //Loosly copied this here from NLOHMANN_JSON_SERIALIZE_ENUM()
    ...
    // NOLINTNEXTLINE: cppcoreguidelines-avoid-c-arrays
    static const std::pair<SortOrder, json>   
    SortOrder_enum_table[] = {                // NOLINT: cert-err58-cpp
    ...
    {                                                                                           
        ...
        const auto* it = std::find_if(std::begin(SortOrder_enum_table), std::end(SortOrder_enum_table),
...
namespace facebook::presto::protocol {
    ...
    void to_json(json& j, const Ordering& p) {
        j = json::object();
        to_json_key(j, "variable", p.variable, "Ordering", "VariableReferenceExpression", "variable");
        to_json_key(j, "sortOrder", p.sortOrder, "Ordering", "SortOrder", "sortOrder");
    }

    void from_json(const json& j, Ordering& p) {
        from_json_key(j, "variable", p.variable, "Ordering", "VariableReferenceExpression", "variable");
        from_json_key(j, "sortOrder", p.sortOrder, "Ordering", "SortOrder", "sortOrder");
    }
}
namespace facebook::presto::protocol {
    ...
    void to_json(json& j, const OrderingScheme& p) {
        j = json::object();
        to_json_key(j, "orderBy", p.orderBy, "OrderingScheme", "List<Ordering>", "orderBy");
    }

    void from_json(const json& j, OrderingScheme& p) {
        from_json_key(j, "orderBy", p.orderBy, "OrderingScheme", "List<Ordering>", "orderBy");
    }
}
namespace facebook::presto::protocol {
    ...
    void to_json(json& j, const Aggregation& p) {
        ...
        to_json_key(j, "filter", p.filter, "Aggregation", "std::shared_ptr<RowExpression>", "filter");
        to_json_key(j, "orderBy", p.orderBy, "Aggregation", "OrderingScheme", "orderBy");
        to_json_key(j, "distinct", p.distinct, "Aggregation", "bool", "distinct");
        to_json_key(j, "mask", p.mask, "Aggregation", "VariableReferenceExpression", "mask");
        to_json_key(j, "functionHandle", p.functionHandle, "Aggregation", "FunctionHandle", "functionHandle");
        to_json_key(j, "arguments", p.arguments, "Aggregation", "List<std::shared_ptr<RowExpression>>", "arguments");
    }

    void from_json(const json& j, Aggregation& p) {
        from_json_key(j, "call", p.call, "Aggregation", "CallExpression", "call");
        from_json_key(j, "filter", p.filter, "Aggregation", "std::shared_ptr<RowExpression>", "filter");
        from_json_key(j, "orderBy", p.orderBy, "Aggregation", "OrderingScheme", "orderBy");
        from_json_key(j, "distinct", p.distinct, "Aggregation", "bool", "distinct");
        from_json_key(j, "mask", p.mask, "Aggregation", "VariableReferenceExpression", "mask");
        from_json_key(j, "functionHandle", p.functionHandle, "Aggregation", "FunctionHandle", "functionHandle");
        from_json_key(j, "arguments", p.arguments, "Aggregation", "List<std::shared_ptr<RowExpression>>", "arguments");
    }
}
namespace facebook::presto::protocol {
    //Loosly copied this here from NLOHMANN_JSON_SERIALIZE_ENUM()
    ...
    // NOLINTNEXTLINE: cppcoreguidelines-avoid-c-arrays
    static const std::pair<ColumnType, json>   
    ColumnType_enum_table[] = {                // NOLINT: cert-err58-cpp
    ...
    {                                                                                           
        ...
        const auto* it = std::find_if(std::begin(ColumnType_enum_table), std::end(ColumnType_enum_table),
...
namespace facebook::presto::protocol {
    ...
    void to_json(json& j, const HiveColumnHandle& p) {
        ...
        to_json_key(j, "hiveType", p.hiveType, "HiveColumnHandle", "HiveType", "hiveType");
        to_json_key(j, "typeSignature", p.typeSignature, "HiveColumnHandle", "TypeSignature", "typeSignature");
        to_json_key(j, "hiveColumnIndex", p.hiveColumnIndex, "HiveColumnHandle", "int", "hiveColumnIndex");
        ...
        to_json_key(j, "requiredSubfields", p.requiredSubfields, "HiveColumnHandle", "List<Subfield>", "requiredSubfields");
        to_json_key(j, "partialAggregation", p.partialAggregation, "HiveColumnHandle", "Aggregation", "partialAggregation");
    }

    void from_json(const json& j, HiveColumnHandle& p) {
        p._type = j["@type"];
        from_json_key(j, "name", p.name, "HiveColumnHandle", "String", "name");
        from_json_key(j, "hiveType", p.hiveType, "HiveColumnHandle", "HiveType", "hiveType");
        from_json_key(j, "typeSignature", p.typeSignature, "HiveColumnHandle", "TypeSignature", "typeSignature");
        from_json_key(j, "hiveColumnIndex", p.hiveColumnIndex, "HiveColumnHandle", "int", "hiveColumnIndex");
        ...
        from_json_key(j, "requiredSubfields", p.requiredSubfields, "HiveColumnHandle", "List<Subfield>", "requiredSubfields");
        from_json_key(j, "partialAggregation", p.partialAggregation, "HiveColumnHandle", "Aggregation", "partialAggregation");
    }
}
namespace facebook::presto::protocol {
...
namespace facebook::presto::protocol {
    ...
    void to_json(json& j, const EmptySplit& p) {
        j = json::object();
        j["@type"] = "$empty";
        to_json_key(j, "connectorId", p.connectorId, "EmptySplit", "ConnectorId", "connectorId");
    }

    void from_json(const json& j, EmptySplit& p) {
        p._type = j["@type"];
        from_json_key(j, "connectorId", p.connectorId, "EmptySplit", "ConnectorId", "connectorId");
    }
}
namespace facebook::presto::protocol {
    ...
    void to_json(json& j, const LongVariableConstraint& p) {
        ...
        to_json_key(j, "expression", p.expression, "LongVariableConstraint", "String", "expression");
    }

    void from_json(const json& j, LongVariableConstraint& p) {
        from_json_key(j, "name", p.name, "LongVariableConstraint", "String", "name");
        from_json_key(j, "expression", p.expression, "LongVariableConstraint", "String", "expression");
    }
}
namespace facebook::presto::protocol {
    //Loosly copied this here from NLOHMANN_JSON_SERIALIZE_ENUM()
    ...
    // NOLINTNEXTLINE: cppcoreguidelines-avoid-c-arrays
    static const std::pair<BufferState, json>   
    BufferState_enum_table[] = {                // NOLINT: cert-err58-cpp
    ...
    {                                                                                           
        ...
        const auto* it = std::find_if(std::begin(BufferState_enum_table), std::end(BufferState_enum_table),
...
namespace facebook::presto::protocol {
    ...
    void to_json(json& j, const FilterNode& p) {
        ...
        to_json_key(j, "predicate", p.predicate, "FilterNode", "RowExpression", "predicate");
    }
    ...
    void from_json(const json& j, FilterNode& p) {
        ...
        from_json_key(j, "predicate", p.predicate, "FilterNode", "RowExpression", "predicate");
    }
}
namespace facebook::presto::protocol {
    //Loosly copied this here from NLOHMANN_JSON_SERIALIZE_ENUM()
    ...
    // NOLINTNEXTLINE: cppcoreguidelines-avoid-c-arrays
    static const std::pair<JoinNodeType, json>   
    JoinNodeType_enum_table[] = {                // NOLINT: cert-err58-cpp
    ...
    {                                                                                           
        ...
        const auto* it = std::find_if(std::begin(JoinNodeType_enum_table), std::end(JoinNodeType_enum_table),
...
namespace facebook::presto::protocol {
    ...
    // NOLINTNEXTLINE: cppcoreguidelines-avoid-c-arrays
    static const std::pair<DistributionType, json>   
    DistributionType_enum_table[] = {                // NOLINT: cert-err58-cpp
    ...
    {                                                                                           
        ...
        const auto* it = std::find_if(std::begin(DistributionType_enum_table), std::end(DistributionType_enum_table),
...
namespace facebook::presto::protocol {
    ...
    void to_json(json& j, const EquiJoinClause& p) {
        j = json::object();
        to_json_key(j, "left", p.left, "EquiJoinClause", "VariableReferenceExpression", "left");
        to_json_key(j, "right", p.right, "EquiJoinClause", "VariableReferenceExpression", "right");
    }

    void from_json(const json& j, EquiJoinClause& p) {
        from_json_key(j, "left", p.left, "EquiJoinClause", "VariableReferenceExpression", "left");
        from_json_key(j, "right", p.right, "EquiJoinClause", "VariableReferenceExpression", "right");
    }
}
namespace facebook::presto::protocol {
    ...
    void to_json(json& j, const JoinNode& p) {
        ...
        to_json_key(j, "outputVariables", p.outputVariables, "JoinNode", "List<VariableReferenceExpression>", "outputVariables");
        to_json_key(j, "filter", p.filter, "JoinNode", "std::shared_ptr<RowExpression>", "filter");
        to_json_key(j, "leftHashVariable", p.leftHashVariable, "JoinNode", "VariableReferenceExpression", "leftHashVariable");
        to_json_key(j, "rightHashVariable", p.rightHashVariable, "JoinNode", "VariableReferenceExpression", "rightHashVariable");
        to_json_key(j, "distributionType", p.distributionType, "JoinNode", "DistributionType", "distributionType");
        to_json_key(j, "dynamicFilters", p.dynamicFilters, "JoinNode", "Map<String, VariableReferenceExpression>", "dynamicFilters");
    }
    ...
    void from_json(const json& j, JoinNode& p) {
        ...
        from_json_key(j, "outputVariables", p.outputVariables, "JoinNode", "List<VariableReferenceExpression>", "outputVariables");
        from_json_key(j, "filter", p.filter, "JoinNode", "std::shared_ptr<RowExpression>", "filter");
        from_json_key(j, "leftHashVariable", p.leftHashVariable, "JoinNode", "VariableReferenceExpression", "leftHashVariable");
        from_json_key(j, "rightHashVariable", p.rightHashVariable, "JoinNode", "VariableReferenceExpression", "rightHashVariable");
        from_json_key(j, "distributionType", p.distributionType, "JoinNode", "DistributionType", "distributionType");
        from_json_key(j, "dynamicFilters", p.dynamicFilters, "JoinNode", "Map<String, VariableReferenceExpression>", "dynamicFilters");
    }
}
namespace facebook::presto::protocol {
    ...
    void to_json(json& j, const MergeJoinNode& p) {
        ...
        to_json_key(j, "criteria", p.criteria, "MergeJoinNode", "List<JoinNode.EquiJoinClause>", "criteria");
        to_json_key(j, "outputVariables", p.outputVariables, "MergeJoinNode", "List<VariableReferenceExpression>", "outputVariables");
        to_json_key(j, "filter", p.filter, "MergeJoinNode", "std::shared_ptr<RowExpression>", "filter");
        to_json_key(j, "leftHashVariable", p.leftHashVariable, "MergeJoinNode", "VariableReferenceExpression", "leftHashVariable");
        to_json_key(j, "rightHashVariable", p.rightHashVariable, "MergeJoinNode", "VariableReferenceExpression", "rightHashVariable");
    }
    ...
    void from_json(const json& j, MergeJoinNode& p) {
        ...
        from_json_key(j, "criteria", p.criteria, "MergeJoinNode", "List<JoinNode.EquiJoinClause>", "criteria");
        from_json_key(j, "outputVariables", p.outputVariables, "MergeJoinNode", "List<VariableReferenceExpression>", "outputVariables");
        from_json_key(j, "filter", p.filter, "MergeJoinNode", "std::shared_ptr<RowExpression>", "filter");
        from_json_key(j, "leftHashVariable", p.leftHashVariable, "MergeJoinNode", "VariableReferenceExpression", "leftHashVariable");
        from_json_key(j, "rightHashVariable", p.rightHashVariable, "MergeJoinNode", "VariableReferenceExpression", "rightHashVariable");
    }
}
namespace facebook::presto::protocol {
    //Loosly copied this here from NLOHMANN_JSON_SERIALIZE_ENUM()
    ...
    {                                                                                           
        ...
        const auto* it = std::find_if(std::begin(SystemPartitionFunction_enum_table), std::end(SystemPartitionFunction_enum_table),
...
namespace facebook::presto::protocol {
    ...
    {                                                                                           
        ...
        const auto* it = std::find_if(std::begin(SystemPartitioning_enum_table), std::end(SystemPartitioning_enum_table),
...
namespace facebook::presto::protocol {
    ...
    void to_json(json& j, const TypeVariableConstraint& p) {
        ...
        to_json_key(j, "comparableRequired", p.comparableRequired, "TypeVariableConstraint", "bool", "comparableRequired");
        to_json_key(j, "orderableRequired", p.orderableRequired, "TypeVariableConstraint", "bool", "orderableRequired");
        to_json_key(j, "variadicBound", p.variadicBound, "TypeVariableConstraint", "String", "variadicBound");
        to_json_key(j, "nonDecimalNumericRequired", p.nonDecimalNumericRequired, "TypeVariableConstraint", "bool", "nonDecimalNumericRequired");
    }

    void from_json(const json& j, TypeVariableConstraint& p) {
        from_json_key(j, "name", p.name, "TypeVariableConstraint", "String", "name");
        from_json_key(j, "comparableRequired", p.comparableRequired, "TypeVariableConstraint", "bool", "comparableRequired");
        from_json_key(j, "orderableRequired", p.orderableRequired, "TypeVariableConstraint", "bool", "orderableRequired");
        from_json_key(j, "variadicBound", p.variadicBound, "TypeVariableConstraint", "String", "variadicBound");
        from_json_key(j, "nonDecimalNumericRequired", p.nonDecimalNumericRequired, "TypeVariableConstraint", "bool", "nonDecimalNumericRequired");
    }
}
namespace facebook::presto::protocol {
...
namespace facebook::presto::protocol {
    ...
    void to_json(json& j, const MemoryPoolInfo& p) {
        ...
        to_json_key(j, "queryMemoryAllocations", p.queryMemoryAllocations, "MemoryPoolInfo", "Map<QueryId, List<MemoryAllocation>>", "queryMemoryAllocations");
        to_json_key(j, "queryMemoryRevocableReservations", p.queryMemoryRevocableReservations, "MemoryPoolInfo", "Map<QueryId, Long>", "queryMemoryRevocableReservations");
    }
    ...
    void from_json(const json& j, MemoryPoolInfo& p) {
        ...
        from_json_key(j, "queryMemoryReservations", p.queryMemoryReservations, "MemoryPoolInfo", "Map<QueryId, Long>", "queryMemoryReservations");
        from_json_key(j, "queryMemoryAllocations", p.queryMemoryAllocations, "MemoryPoolInfo", "Map<QueryId, List<MemoryAllocation>>", "queryMemoryAllocations");
        from_json_key(j, "queryMemoryRevocableReservations", p.queryMemoryRevocableReservations, "MemoryPoolInfo", "Map<QueryId, Long>", "queryMemoryRevocableReservations");
    }
}
/*
 * Licensed under the Apache License, Version 2.0 (the "License");
...
namespace facebook::presto::protocol {
    ...
    void to_json(json& j, const MemoryInfo& p) {
        j = json::object();
        to_json_key(j, "totalNodeMemory", p.totalNodeMemory, "MemoryInfo", "DataSize", "totalNodeMemory");
        to_json_key(j, "pools", p.pools, "MemoryInfo", "Map<MemoryPoolId, MemoryPoolInfo>", "pools");
    }

    void from_json(const json& j, MemoryInfo& p) {
        from_json_key(j, "totalNodeMemory", p.totalNodeMemory, "MemoryInfo", "DataSize", "totalNodeMemory");
        from_json_key(j, "pools", p.pools, "MemoryInfo", "Map<MemoryPoolId, MemoryPoolInfo>", "pools");
    }
}
namespace facebook::presto::protocol {
    //Loosly copied this here from NLOHMANN_JSON_SERIALIZE_ENUM()
    ...
    // NOLINTNEXTLINE: cppcoreguidelines-avoid-c-arrays
    static const std::pair<Bound, json>   
    Bound_enum_table[] = {                // NOLINT: cert-err58-cpp
        { Bound::BELOW, "BELOW" },
    ...
    {                                                                                           
        ...
        const auto* it = std::find_if(std::begin(Bound_enum_table), std::end(Bound_enum_table),
                               [e](const std::pair<Bound, json>& ej_pair) -> bool
        {
            return ej_pair.first == e;
        });
        j = ((it != std::end(Bound_enum_table)) ? it : std::begin(Bound_enum_table))->second;
    }
    void from_json(const json& j, Bound& e)
    {
        ...
        e = ((it != std::end(Bound_enum_table)) ? it : std::begin(Bound_enum_table))->first;
    }
}
namespace facebook::presto::protocol {
...
namespace facebook::presto::protocol {
    ...
    void from_json(const json& j, SortedRangeSet& p) {
        ...
        from_json_key(j, "ranges", p.ranges, "SortedRangeSet", "List<Range>", "ranges");
    }
}
namespace facebook::presto::protocol {
    ...
    void to_json(json& j, const GroupingSetDescriptor& p) {
        j = json::object();
        to_json_key(j, "groupingKeys", p.groupingKeys, "GroupingSetDescriptor", "List<VariableReferenceExpression>", "groupingKeys");
    ...
    void from_json(const json& j, GroupingSetDescriptor& p) {
        from_json_key(j, "groupingKeys", p.groupingKeys, "GroupingSetDescriptor", "List<VariableReferenceExpression>", "groupingKeys");
...
namespace facebook::presto::protocol {
    ...
    // NOLINTNEXTLINE: cppcoreguidelines-avoid-c-arrays
    static const std::pair<RuntimeUnit, json>   
    RuntimeUnit_enum_table[] = {                // NOLINT: cert-err58-cpp
    ...
    {                                                                                           
        static_assert(std::is_enum<RuntimeUnit>::value, "RuntimeUnit must be an enum!");
        const auto* it = std::find_if(std::begin(RuntimeUnit_enum_table), std::end(RuntimeUnit_enum_table),
                               [e](const std::pair<RuntimeUnit, json>& ej_pair) -> bool
        {
            return ej_pair.first == e;
        });
        j = ((it != std::end(RuntimeUnit_enum_table)) ? it : std::begin(RuntimeUnit_enum_table))->second;
    }
    void from_json(const json& j, RuntimeUnit& e)
    {
        ...
        e = ((it != std::end(RuntimeUnit_enum_table)) ? it : std::begin(RuntimeUnit_enum_table))->first;
    }
}
namespace facebook::presto::protocol {
...
namespace facebook::presto::protocol {
    ...
    void to_json(json& j, const ResourceEstimates& p) {
        ...
        to_json_key(j, "peakMemory", p.peakMemory, "ResourceEstimates", "DataSize", "peakMemory");
        to_json_key(j, "peakTaskMemory", p.peakTaskMemory, "ResourceEstimates", "DataSize", "peakTaskMemory");
    }
    ...
    void from_json(const json& j, ResourceEstimates& p) {
        ...
        from_json_key(j, "peakMemory", p.peakMemory, "ResourceEstimates", "DataSize", "peakMemory");
        from_json_key(j, "peakTaskMemory", p.peakTaskMemory, "ResourceEstimates", "DataSize", "peakTaskMemory");
    }
}
namespace facebook::presto::protocol {
    //Loosly copied this here from NLOHMANN_JSON_SERIALIZE_ENUM()
    ...
    // NOLINTNEXTLINE: cppcoreguidelines-avoid-c-arrays
    static const std::pair<SelectedRoleType, json>   
    SelectedRoleType_enum_table[] = {                // NOLINT: cert-err58-cpp
    ...
    {                                                                                           
        ...
        const auto* it = std::find_if(std::begin(SelectedRoleType_enum_table), std::end(SelectedRoleType_enum_table),
...
namespace facebook::presto::protocol {
    ...
    // NOLINTNEXTLINE: cppcoreguidelines-avoid-c-arrays
    static const std::pair<FunctionKind, json>   
    FunctionKind_enum_table[] = {                // NOLINT: cert-err58-cpp
    ...
    {                                                                                           
        ...
        const auto* it = std::find_if(std::begin(FunctionKind_enum_table), std::end(FunctionKind_enum_table),
...
namespace facebook::presto::protocol {
    ...
    void to_json(json& j, const Signature& p) {
        ...
        to_json_key(j, "typeVariableConstraints", p.typeVariableConstraints, "Signature", "List<TypeVariableConstraint>", "typeVariableConstraints");
        to_json_key(j, "longVariableConstraints", p.longVariableConstraints, "Signature", "List<LongVariableConstraint>", "longVariableConstraints");
        to_json_key(j, "returnType", p.returnType, "Signature", "TypeSignature", "returnType");
        to_json_key(j, "argumentTypes", p.argumentTypes, "Signature", "List<TypeSignature>", "argumentTypes");
        to_json_key(j, "variableArity", p.variableArity, "Signature", "bool", "variableArity");
    }
    ...
    void from_json(const json& j, Signature& p) {
        ...
        from_json_key(j, "typeVariableConstraints", p.typeVariableConstraints, "Signature", "List<TypeVariableConstraint>", "typeVariableConstraints");
        from_json_key(j, "longVariableConstraints", p.longVariableConstraints, "Signature", "List<LongVariableConstraint>", "longVariableConstraints");
        from_json_key(j, "returnType", p.returnType, "Signature", "TypeSignature", "returnType");
        from_json_key(j, "argumentTypes", p.argumentTypes, "Signature", "List<TypeSignature>", "argumentTypes");
        from_json_key(j, "variableArity", p.variableArity, "Signature", "bool", "variableArity");
    }
}
namespace facebook::presto::protocol {
    ...
    void to_json(json& j, const SqlInvokedFunction& p) {
        j = json::object();
        to_json_key(j, "parameters", p.parameters, "SqlInvokedFunction", "List<Parameter>", "parameters");
        to_json_key(j, "description", p.description, "SqlInvokedFunction", "String", "description");
        to_json_key(j, "routineCharacteristics", p.routineCharacteristics, "SqlInvokedFunction", "RoutineCharacteristics", "routineCharacteristics");
        to_json_key(j, "body", p.body, "SqlInvokedFunction", "String", "body");
        to_json_key(j, "signature", p.signature, "SqlInvokedFunction", "Signature", "signature");
        to_json_key(j, "functionId", p.functionId, "SqlInvokedFunction", "SqlFunctionId", "functionId");
    }

    void from_json(const json& j, SqlInvokedFunction& p) {
        from_json_key(j, "parameters", p.parameters, "SqlInvokedFunction", "List<Parameter>", "parameters");
        from_json_key(j, "description", p.description, "SqlInvokedFunction", "String", "description");
        from_json_key(j, "routineCharacteristics", p.routineCharacteristics, "SqlInvokedFunction", "RoutineCharacteristics", "routineCharacteristics");
        from_json_key(j, "body", p.body, "SqlInvokedFunction", "String", "body");
        from_json_key(j, "signature", p.signature, "SqlInvokedFunction", "Signature", "signature");
        from_json_key(j, "functionId", p.functionId, "SqlInvokedFunction", "SqlFunctionId", "functionId");
    }
}
namespace facebook::presto::protocol {
    ...
    void to_json(json& j, const SessionRepresentation& p) {
        ...
        to_json_key(j, "startTime", p.startTime, "SessionRepresentation", "int64_t", "startTime");
        to_json_key(j, "systemProperties", p.systemProperties, "SessionRepresentation", "Map<String, String>", "systemProperties");
        to_json_key(j, "catalogProperties", p.catalogProperties, "SessionRepresentation", "Map<ConnectorId, Map<String, String>>", "catalogProperties");
        to_json_key(j, "unprocessedCatalogProperties", p.unprocessedCatalogProperties, "SessionRepresentation", "Map<String, Map<String, String>>", "unprocessedCatalogProperties");
        to_json_key(j, "roles", p.roles, "SessionRepresentation", "Map<String, SelectedRole>", "roles");
        to_json_key(j, "preparedStatements", p.preparedStatements, "SessionRepresentation", "Map<String, String>", "preparedStatements");
        to_json_key(j, "sessionFunctions", p.sessionFunctions, "SessionRepresentation", "Map<SqlFunctionId, SqlInvokedFunction>", "sessionFunctions");
    }
    ...
    void from_json(const json& j, SessionRepresentation& p) {
        ...
        from_json_key(j, "startTime", p.startTime, "SessionRepresentation", "int64_t", "startTime");
        from_json_key(j, "systemProperties", p.systemProperties, "SessionRepresentation", "Map<String, String>", "systemProperties");
        from_json_key(j, "catalogProperties", p.catalogProperties, "SessionRepresentation", "Map<ConnectorId, Map<String, String>>", "catalogProperties");
        from_json_key(j, "unprocessedCatalogProperties", p.unprocessedCatalogProperties, "SessionRepresentation", "Map<String, Map<String, String>>", "unprocessedCatalogProperties");
        from_json_key(j, "roles", p.roles, "SessionRepresentation", "Map<String, SelectedRole>", "roles");
        from_json_key(j, "preparedStatements", p.preparedStatements, "SessionRepresentation", "Map<String, String>", "preparedStatements");
        from_json_key(j, "sessionFunctions", p.sessionFunctions, "SessionRepresentation", "Map<SqlFunctionId, SqlInvokedFunction>", "sessionFunctions");
    }
}
namespace facebook::presto::protocol {
    ...
    void from_json(const json& j, std::shared_ptr<ExecutionWriterTarget>& p) {
        ...
        try {
          type = p->getSubclassKey(j);
            ...
            throw ParseError(std::string(e.what()) + " ExecutionWriterTarget  ExecutionWriterTarget");
        }
...
namespace facebook::presto::protocol {
    ...
    void to_json(json& j, const TableHandle& p) {
        j = json::object();
        to_json_key(j, "connectorId", p.connectorId, "TableHandle", "ConnectorId", "connectorId");
        ...
        to_json_key(j, "connectorTableLayout", p.connectorTableLayout, "TableHandle", "ConnectorTableLayoutHandle", "connectorTableLayout");
    }

    void from_json(const json& j, TableHandle& p) {
        from_json_key(j, "connectorId", p.connectorId, "TableHandle", "ConnectorId", "connectorId");
        ...
        from_json_key(j, "connectorTableLayout", p.connectorTableLayout, "TableHandle", "ConnectorTableLayoutHandle", "connectorTableLayout");
    }
}
namespace facebook::presto::protocol {
    ...
    void to_json(json& j, const DeleteScanInfo& p) {
        ...
        to_json_key(j, "tableHandle", p.tableHandle, "DeleteScanInfo", "TableHandle", "tableHandle");
    }

    void from_json(const json& j, DeleteScanInfo& p) {
        from_json_key(j, "id", p.id, "DeleteScanInfo", "PlanNodeId", "id");
        from_json_key(j, "tableHandle", p.tableHandle, "DeleteScanInfo", "TableHandle", "tableHandle");
    }
}
namespace facebook::presto::protocol {
    ...
    void to_json(json& j, const AnalyzeTableHandle& p) {
        j = json::object();
        to_json_key(j, "connectorId", p.connectorId, "AnalyzeTableHandle", "ConnectorId", "connectorId");
        to_json_key(j, "transactionHandle", p.transactionHandle, "AnalyzeTableHandle", "ConnectorTransactionHandle", "transactionHandle");
        to_json_key(j, "connectorHandle", p.connectorHandle, "AnalyzeTableHandle", "ConnectorTableHandle", "connectorHandle");
    }

    void from_json(const json& j, AnalyzeTableHandle& p) {
        from_json_key(j, "connectorId", p.connectorId, "AnalyzeTableHandle", "ConnectorId", "connectorId");
        from_json_key(j, "transactionHandle", p.transactionHandle, "AnalyzeTableHandle", "ConnectorTransactionHandle", "transactionHandle");
        from_json_key(j, "connectorHandle", p.connectorHandle, "AnalyzeTableHandle", "ConnectorTableHandle", "connectorHandle");
    }
}
namespace facebook::presto::protocol {
    ...
    void to_json(json& j, const TableWriteInfo& p) {
        j = json::object();
        to_json_key(j, "writerTarget", p.writerTarget, "TableWriteInfo", "ExecutionWriterTarget", "writerTarget");
        to_json_key(j, "analyzeTableHandle", p.analyzeTableHandle, "TableWriteInfo", "AnalyzeTableHandle", "analyzeTableHandle");
        to_json_key(j, "deleteScanInfo", p.deleteScanInfo, "TableWriteInfo", "DeleteScanInfo", "deleteScanInfo");
    }

    void from_json(const json& j, TableWriteInfo& p) {
        from_json_key(j, "writerTarget", p.writerTarget, "TableWriteInfo", "ExecutionWriterTarget", "writerTarget");
        from_json_key(j, "analyzeTableHandle", p.analyzeTableHandle, "TableWriteInfo", "AnalyzeTableHandle", "analyzeTableHandle");
        from_json_key(j, "deleteScanInfo", p.deleteScanInfo, "TableWriteInfo", "DeleteScanInfo", "deleteScanInfo");
    }
}
namespace facebook::presto::protocol {
    //Loosly copied this here from NLOHMANN_JSON_SERIALIZE_ENUM()
    ...
    StageExecutionStrategy_enum_table[] = {                // NOLINT: cert-err58-cpp
        ...
        { StageExecutionStrategy::FIXED_LIFESPAN_SCHEDULE_GROUPED_EXECUTION, "FIXED_LIFESPAN_SCHEDULE_GROUPED_EXECUTION" },
        { StageExecutionStrategy::DYNAMIC_LIFESPAN_SCHEDULE_GROUPED_EXECUTION, "DYNAMIC_LIFESPAN_SCHEDULE_GROUPED_EXECUTION" },
        { StageExecutionStrategy::RECOVERABLE_GROUPED_EXECUTION, "RECOVERABLE_GROUPED_EXECUTION" }
    };
    void to_json(json& j, const StageExecutionStrategy& e)                                                   
    {                                                                                           
        static_assert(std::is_enum<StageExecutionStrategy>::value, "StageExecutionStrategy must be an enum!");
        const auto* it = std::find_if(std::begin(StageExecutionStrategy_enum_table), std::end(StageExecutionStrategy_enum_table),
                               [e](const std::pair<StageExecutionStrategy, json>& ej_pair) -> bool
        {
            return ej_pair.first == e;
        });
        j = ((it != std::end(StageExecutionStrategy_enum_table)) ? it : std::begin(StageExecutionStrategy_enum_table))->second;
    }
    void from_json(const json& j, StageExecutionStrategy& e)
    {
        ...
        e = ((it != std::end(StageExecutionStrategy_enum_table)) ? it : std::begin(StageExecutionStrategy_enum_table))->first;
    }
}
namespace facebook::presto::protocol {
    ...
    void to_json(json& j, const StageExecutionDescriptor& p) {
        j = json::object();
        to_json_key(j, "stageExecutionStrategy", p.stageExecutionStrategy, "StageExecutionDescriptor", "StageExecutionStrategy", "stageExecutionStrategy");
        to_json_key(j, "groupedExecutionScanNodes", p.groupedExecutionScanNodes, "StageExecutionDescriptor", "List<PlanNodeId>", "groupedExecutionScanNodes");
        to_json_key(j, "totalLifespans", p.totalLifespans, "StageExecutionDescriptor", "int", "totalLifespans");
    }

    void from_json(const json& j, StageExecutionDescriptor& p) {
        from_json_key(j, "stageExecutionStrategy", p.stageExecutionStrategy, "StageExecutionDescriptor", "StageExecutionStrategy", "stageExecutionStrategy");
        from_json_key(j, "groupedExecutionScanNodes", p.groupedExecutionScanNodes, "StageExecutionDescriptor", "List<PlanNodeId>", "groupedExecutionScanNodes");
        from_json_key(j, "totalLifespans", p.totalLifespans, "StageExecutionDescriptor", "int", "totalLifespans");
    }
}
namespace facebook::presto::protocol {
    //Loosly copied this here from NLOHMANN_JSON_SERIALIZE_ENUM()
    ...
    // NOLINTNEXTLINE: cppcoreguidelines-avoid-c-arrays
    static const std::pair<Locality, json>   
    Locality_enum_table[] = {                // NOLINT: cert-err58-cpp
    ...
    {                                                                                           
        ...
        const auto* it = std::find_if(std::begin(Locality_enum_table), std::end(Locality_enum_table),
                               [e](const std::pair<Locality, json>& ej_pair) -> bool
        {
            return ej_pair.first == e;
        });
        j = ((it != std::end(Locality_enum_table)) ? it : std::begin(Locality_enum_table))->second;
    }
    void from_json(const json& j, Locality& e)
    {
        ...
        e = ((it != std::end(Locality_enum_table)) ? it : std::begin(Locality_enum_table))->first;
    }
}
namespace facebook::presto::protocol {
    ...
    void to_json(json& j, const Assignments& p) {
        j = json::object();
        to_json_key(j, "assignments", p.assignments, "Assignments", "Map<VariableReferenceExpression, std::shared_ptr<RowExpression>>", "assignments");
    }

    void from_json(const json& j, Assignments& p) {
        from_json_key(j, "assignments", p.assignments, "Assignments", "Map<VariableReferenceExpression, std::shared_ptr<RowExpression>>", "assignments");
    }
}
namespace facebook::presto::protocol {
    ...
    void from_json(const json& j, ProjectNode& p) {
        ...
        from_json_key(j, "locality", p.locality, "ProjectNode", "Locality", "locality");
    }
}
namespace facebook::presto::protocol {
    ...
    void to_json(json& j, const MarkDistinctNode& p) {
        ...
        to_json_key(j, "markerVariable", p.markerVariable, "MarkDistinctNode", "VariableReferenceExpression", "markerVariable");
        to_json_key(j, "distinctVariables", p.distinctVariables, "MarkDistinctNode", "List<VariableReferenceExpression>", "distinctVariables");
        to_json_key(j, "hashVariable", p.hashVariable, "MarkDistinctNode", "VariableReferenceExpression", "hashVariable");
    }

    void from_json(const json& j, MarkDistinctNode& p) {
        p._type = j["@type"];
        from_json_key(j, "id", p.id, "MarkDistinctNode", "PlanNodeId", "id");
        from_json_key(j, "source", p.source, "MarkDistinctNode", "PlanNode", "source");
        from_json_key(j, "markerVariable", p.markerVariable, "MarkDistinctNode", "VariableReferenceExpression", "markerVariable");
        from_json_key(j, "distinctVariables", p.distinctVariables, "MarkDistinctNode", "List<VariableReferenceExpression>", "distinctVariables");
        from_json_key(j, "hashVariable", p.hashVariable, "MarkDistinctNode", "VariableReferenceExpression", "hashVariable");
    }
}
namespace facebook::presto::protocol {
    //Loosly copied this here from NLOHMANN_JSON_SERIALIZE_ENUM()
    ...
    {                                                                                           
        ...
        const auto* it = std::find_if(std::begin(AggregationNodeStep_enum_table), std::end(AggregationNodeStep_enum_table),
...
namespace facebook::presto::protocol {
    ...
    void to_json(json& j, const AggregationNode& p) {
        ...
        to_json_key(j, "aggregations", p.aggregations, "AggregationNode", "Map<VariableReferenceExpression, Aggregation>", "aggregations");
        to_json_key(j, "groupingSets", p.groupingSets, "AggregationNode", "GroupingSetDescriptor", "groupingSets");
        to_json_key(j, "preGroupedVariables", p.preGroupedVariables, "AggregationNode", "List<VariableReferenceExpression>", "preGroupedVariables");
        to_json_key(j, "step", p.step, "AggregationNode", "AggregationNodeStep", "step");
        to_json_key(j, "hashVariable", p.hashVariable, "AggregationNode", "VariableReferenceExpression", "hashVariable");
        to_json_key(j, "groupIdVariable", p.groupIdVariable, "AggregationNode", "VariableReferenceExpression", "groupIdVariable");
    }
    ...
    void from_json(const json& j, AggregationNode& p) {
        ...
        from_json_key(j, "aggregations", p.aggregations, "AggregationNode", "Map<VariableReferenceExpression, Aggregation>", "aggregations");
        from_json_key(j, "groupingSets", p.groupingSets, "AggregationNode", "GroupingSetDescriptor", "groupingSets");
        from_json_key(j, "preGroupedVariables", p.preGroupedVariables, "AggregationNode", "List<VariableReferenceExpression>", "preGroupedVariables");
        from_json_key(j, "step", p.step, "AggregationNode", "AggregationNodeStep", "step");
        from_json_key(j, "hashVariable", p.hashVariable, "AggregationNode", "VariableReferenceExpression", "hashVariable");
        from_json_key(j, "groupIdVariable", p.groupIdVariable, "AggregationNode", "VariableReferenceExpression", "groupIdVariable");
    }
}
/*
 * Licensed under the Apache License, Version 2.0 (the "License");
...
namespace facebook::presto::protocol {
    ...
    void to_json(json& j, const PartitioningHandle& p) {
        j = json::object();
        to_json_key(j, "connectorId", p.connectorId, "PartitioningHandle", "ConnectorId", "connectorId");
    ...
    void from_json(const json& j, PartitioningHandle& p) {
        from_json_key(j, "connectorId", p.connectorId, "PartitioningHandle", "ConnectorId", "connectorId");
...
namespace facebook::presto::protocol {
    ...
    void to_json(json& j, const Partitioning& p) {
        ...
        to_json_key(j, "arguments", p.arguments, "Partitioning", "List<std::shared_ptr<RowExpression>>", "arguments");
    }

    void from_json(const json& j, Partitioning& p) {
        from_json_key(j, "handle", p.handle, "Partitioning", "PartitioningHandle", "handle");
        from_json_key(j, "arguments", p.arguments, "Partitioning", "List<std::shared_ptr<RowExpression>>", "arguments");
    }
}
namespace facebook::presto::protocol {
    ...
    void to_json(json& j, const PartitioningScheme& p) {
        ...
        to_json_key(j, "outputLayout", p.outputLayout, "PartitioningScheme", "List<VariableReferenceExpression>", "outputLayout");
        to_json_key(j, "hashColumn", p.hashColumn, "PartitioningScheme", "VariableReferenceExpression", "hashColumn");
    ...
    void from_json(const json& j, PartitioningScheme& p) {
        ...
        from_json_key(j, "outputLayout", p.outputLayout, "PartitioningScheme", "List<VariableReferenceExpression>", "outputLayout");
        from_json_key(j, "hashColumn", p.hashColumn, "PartitioningScheme", "VariableReferenceExpression", "hashColumn");
...
namespace facebook::presto::protocol {
    ...
    void to_json(json& j, const VariableStatsEstimate& p) {
        j = json::object();
        to_json_key(j, "lowValue", p.lowValue, "VariableStatsEstimate", "double", "lowValue");
        to_json_key(j, "highValue", p.highValue, "VariableStatsEstimate", "double", "highValue");
        to_json_key(j, "nullsFraction", p.nullsFraction, "VariableStatsEstimate", "double", "nullsFraction");
        to_json_key(j, "averageRowSize", p.averageRowSize, "VariableStatsEstimate", "double", "averageRowSize");
        to_json_key(j, "distinctValuesCount", p.distinctValuesCount, "VariableStatsEstimate", "double", "distinctValuesCount");
    }

    void from_json(const json& j, VariableStatsEstimate& p) {
        from_json_key(j, "lowValue", p.lowValue, "VariableStatsEstimate", "double", "lowValue");
        from_json_key(j, "highValue", p.highValue, "VariableStatsEstimate", "double", "highValue");
        from_json_key(j, "nullsFraction", p.nullsFraction, "VariableStatsEstimate", "double", "nullsFraction");
        from_json_key(j, "averageRowSize", p.averageRowSize, "VariableStatsEstimate", "double", "averageRowSize");
        from_json_key(j, "distinctValuesCount", p.distinctValuesCount, "VariableStatsEstimate", "double", "distinctValuesCount");
    }
}
namespace facebook::presto::protocol {
    ...
    void to_json(json& j, const PlanNodeStatsEstimate& p) {
        ...
        to_json_key(j, "totalSize", p.totalSize, "PlanNodeStatsEstimate", "double", "totalSize");
        to_json_key(j, "confident", p.confident, "PlanNodeStatsEstimate", "bool", "confident");
        to_json_key(j, "variableStatistics", p.variableStatistics, "PlanNodeStatsEstimate", "Map<VariableReferenceExpression, VariableStatsEstimate>", "variableStatistics");
    }
    ...
    void from_json(const json& j, PlanNodeStatsEstimate& p) {
        ...
        from_json_key(j, "totalSize", p.totalSize, "PlanNodeStatsEstimate", "double", "totalSize");
        from_json_key(j, "confident", p.confident, "PlanNodeStatsEstimate", "bool", "confident");
        from_json_key(j, "variableStatistics", p.variableStatistics, "PlanNodeStatsEstimate", "Map<VariableReferenceExpression, VariableStatsEstimate>", "variableStatistics");
    }
}
namespace facebook::presto::protocol {
...
namespace facebook::presto::protocol {
    ...
    void to_json(json& j, const DistributionSnapshot& p) {
        j = json::object();
        to_json_key(j, "maxError", p.maxError, "DistributionSnapshot", "double", "maxError");
    ...
    void from_json(const json& j, DistributionSnapshot& p) {
        from_json_key(j, "maxError", p.maxError, "DistributionSnapshot", "double", "maxError");
...
namespace facebook::presto::protocol {
    ...
    // NOLINTNEXTLINE: cppcoreguidelines-avoid-c-arrays
    static const std::pair<BlockedReason, json>   
    BlockedReason_enum_table[] = {                // NOLINT: cert-err58-cpp
    ...
    {                                                                                           
        ...
        const auto* it = std::find_if(std::begin(BlockedReason_enum_table), std::end(BlockedReason_enum_table),
...
namespace facebook::presto::protocol {
    ...
    void to_json(json& j, const OperatorStats& p) {
        ...
        to_json_key(j, "stageExecutionId", p.stageExecutionId, "OperatorStats", "int", "stageExecutionId");
        ...
        to_json_key(j, "addInputAllocation", p.addInputAllocation, "OperatorStats", "DataSize", "addInputAllocation");
        to_json_key(j, "rawInputDataSize", p.rawInputDataSize, "OperatorStats", "DataSize", "rawInputDataSize");
        to_json_key(j, "rawInputPositions", p.rawInputPositions, "OperatorStats", "int64_t", "rawInputPositions");
        ...
        to_json_key(j, "getOutputAllocation", p.getOutputAllocation, "OperatorStats", "DataSize", "getOutputAllocation");
        ...
        to_json_key(j, "additionalCpu", p.additionalCpu, "OperatorStats", "Duration", "additionalCpu");
        ...
        to_json_key(j, "finishAllocation", p.finishAllocation, "OperatorStats", "DataSize", "finishAllocation");
        ...
        to_json_key(j, "systemMemoryReservation", p.systemMemoryReservation, "OperatorStats", "DataSize", "systemMemoryReservation");
        to_json_key(j, "peakUserMemoryReservation", p.peakUserMemoryReservation, "OperatorStats", "DataSize", "peakUserMemoryReservation");
        to_json_key(j, "peakSystemMemoryReservation", p.peakSystemMemoryReservation, "OperatorStats", "DataSize", "peakSystemMemoryReservation");
        ...
        to_json_key(j, "runtimeStats", p.runtimeStats, "OperatorStats", "RuntimeStats", "runtimeStats");
    }

    void from_json(const json& j, OperatorStats& p) {
        from_json_key(j, "stageId", p.stageId, "OperatorStats", "int", "stageId");
        from_json_key(j, "stageExecutionId", p.stageExecutionId, "OperatorStats", "int", "stageExecutionId");
        ...
        from_json_key(j, "addInputAllocation", p.addInputAllocation, "OperatorStats", "DataSize", "addInputAllocation");
        from_json_key(j, "rawInputDataSize", p.rawInputDataSize, "OperatorStats", "DataSize", "rawInputDataSize");
        from_json_key(j, "rawInputPositions", p.rawInputPositions, "OperatorStats", "int64_t", "rawInputPositions");
        ...
        from_json_key(j, "getOutputAllocation", p.getOutputAllocation, "OperatorStats", "DataSize", "getOutputAllocation");
        ...
        from_json_key(j, "additionalCpu", p.additionalCpu, "OperatorStats", "Duration", "additionalCpu");
        ...
        from_json_key(j, "finishAllocation", p.finishAllocation, "OperatorStats", "DataSize", "finishAllocation");
        ...
        from_json_key(j, "systemMemoryReservation", p.systemMemoryReservation, "OperatorStats", "DataSize", "systemMemoryReservation");
        from_json_key(j, "peakUserMemoryReservation", p.peakUserMemoryReservation, "OperatorStats", "DataSize", "peakUserMemoryReservation");
        from_json_key(j, "peakSystemMemoryReservation", p.peakSystemMemoryReservation, "OperatorStats", "DataSize", "peakSystemMemoryReservation");
        ...
        from_json_key(j, "runtimeStats", p.runtimeStats, "OperatorStats", "RuntimeStats", "runtimeStats");
    }
}
namespace facebook::presto::protocol {
    ...
    void to_json(json& j, const DriverStats& p) {
        ...
        to_json_key(j, "systemMemoryReservation", p.systemMemoryReservation, "DriverStats", "DataSize", "systemMemoryReservation");
        ...
        to_json_key(j, "totalAllocation", p.totalAllocation, "DriverStats", "DataSize", "totalAllocation");
    ...
    void from_json(const json& j, DriverStats& p) {
        from_json_key(j, "lifespan", p.lifespan, "DriverStats", "Lifespan", "lifespan");
        ...
        from_json_key(j, "systemMemoryReservation", p.systemMemoryReservation, "DriverStats", "DataSize", "systemMemoryReservation");
        ...
        from_json_key(j, "totalAllocation", p.totalAllocation, "DriverStats", "DataSize", "totalAllocation");
...
namespace facebook::presto::protocol {
    ...
    void to_json(json& j, const PipelineStats& p) {
        ...
        to_json_key(j, "queuedPartitionedSplitsWeight", p.queuedPartitionedSplitsWeight, "PipelineStats", "int64_t", "queuedPartitionedSplitsWeight");
        ...
        to_json_key(j, "runningPartitionedSplitsWeight", p.runningPartitionedSplitsWeight, "PipelineStats", "int64_t", "runningPartitionedSplitsWeight");
        ...
        to_json_key(j, "userMemoryReservationInBytes", p.userMemoryReservationInBytes, "PipelineStats", "int64_t", "userMemoryReservationInBytes");
        to_json_key(j, "revocableMemoryReservationInBytes", p.revocableMemoryReservationInBytes, "PipelineStats", "int64_t", "revocableMemoryReservationInBytes");
        to_json_key(j, "systemMemoryReservationInBytes", p.systemMemoryReservationInBytes, "PipelineStats", "int64_t", "systemMemoryReservationInBytes");
        ...
        to_json_key(j, "totalScheduledTimeInNanos", p.totalScheduledTimeInNanos, "PipelineStats", "int64_t", "totalScheduledTimeInNanos");
        to_json_key(j, "totalCpuTimeInNanos", p.totalCpuTimeInNanos, "PipelineStats", "int64_t", "totalCpuTimeInNanos");
        to_json_key(j, "totalBlockedTimeInNanos", p.totalBlockedTimeInNanos, "PipelineStats", "int64_t", "totalBlockedTimeInNanos");
        ...
        to_json_key(j, "totalAllocationInBytes", p.totalAllocationInBytes, "PipelineStats", "int64_t", "totalAllocationInBytes");
        to_json_key(j, "rawInputDataSizeInBytes", p.rawInputDataSizeInBytes, "PipelineStats", "int64_t", "rawInputDataSizeInBytes");
        to_json_key(j, "rawInputPositions", p.rawInputPositions, "PipelineStats", "int64_t", "rawInputPositions");
        to_json_key(j, "processedInputDataSizeInBytes", p.processedInputDataSizeInBytes, "PipelineStats", "int64_t", "processedInputDataSizeInBytes");
        to_json_key(j, "processedInputPositions", p.processedInputPositions, "PipelineStats", "int64_t", "processedInputPositions");
        to_json_key(j, "outputDataSizeInBytes", p.outputDataSizeInBytes, "PipelineStats", "int64_t", "outputDataSizeInBytes");
        to_json_key(j, "outputPositions", p.outputPositions, "PipelineStats", "int64_t", "outputPositions");
        to_json_key(j, "physicalWrittenDataSizeInBytes", p.physicalWrittenDataSizeInBytes, "PipelineStats", "int64_t", "physicalWrittenDataSizeInBytes");
    ...
    void from_json(const json& j, PipelineStats& p) {
        ...
        from_json_key(j, "queuedPartitionedSplitsWeight", p.queuedPartitionedSplitsWeight, "PipelineStats", "int64_t", "queuedPartitionedSplitsWeight");
        ...
        from_json_key(j, "runningPartitionedSplitsWeight", p.runningPartitionedSplitsWeight, "PipelineStats", "int64_t", "runningPartitionedSplitsWeight");
        ...
        from_json_key(j, "userMemoryReservationInBytes", p.userMemoryReservationInBytes, "PipelineStats", "int64_t", "userMemoryReservationInBytes");
        from_json_key(j, "revocableMemoryReservationInBytes", p.revocableMemoryReservationInBytes, "PipelineStats", "int64_t", "revocableMemoryReservationInBytes");
        from_json_key(j, "systemMemoryReservationInBytes", p.systemMemoryReservationInBytes, "PipelineStats", "int64_t", "systemMemoryReservationInBytes");
        ...
        from_json_key(j, "totalScheduledTimeInNanos", p.totalScheduledTimeInNanos, "PipelineStats", "int64_t", "totalScheduledTimeInNanos");
        from_json_key(j, "totalCpuTimeInNanos", p.totalCpuTimeInNanos, "PipelineStats", "int64_t", "totalCpuTimeInNanos");
        from_json_key(j, "totalBlockedTimeInNanos", p.totalBlockedTimeInNanos, "PipelineStats", "int64_t", "totalBlockedTimeInNanos");
        ...
        from_json_key(j, "totalAllocationInBytes", p.totalAllocationInBytes, "PipelineStats", "int64_t", "totalAllocationInBytes");
        from_json_key(j, "rawInputDataSizeInBytes", p.rawInputDataSizeInBytes, "PipelineStats", "int64_t", "rawInputDataSizeInBytes");
        from_json_key(j, "rawInputPositions", p.rawInputPositions, "PipelineStats", "int64_t", "rawInputPositions");
        from_json_key(j, "processedInputDataSizeInBytes", p.processedInputDataSizeInBytes, "PipelineStats", "int64_t", "processedInputDataSizeInBytes");
        from_json_key(j, "processedInputPositions", p.processedInputPositions, "PipelineStats", "int64_t", "processedInputPositions");
        from_json_key(j, "outputDataSizeInBytes", p.outputDataSizeInBytes, "PipelineStats", "int64_t", "outputDataSizeInBytes");
        from_json_key(j, "outputPositions", p.outputPositions, "PipelineStats", "int64_t", "outputPositions");
        from_json_key(j, "physicalWrittenDataSizeInBytes", p.physicalWrittenDataSizeInBytes, "PipelineStats", "int64_t", "physicalWrittenDataSizeInBytes");
...
namespace facebook::presto::protocol {
    ...
    void to_json(json& j, const HiveMetadataUpdateHandle& p) {
        j = json::object();
        j["@type"] = "hive";
        to_json_key(j, "requestId", p.requestId, "HiveMetadataUpdateHandle", "UUID", "requestId");
        to_json_key(j, "schemaTableName", p.schemaTableName, "HiveMetadataUpdateHandle", "SchemaTableName", "schemaTableName");
        to_json_key(j, "partitionName", p.partitionName, "HiveMetadataUpdateHandle", "String", "partitionName");
        to_json_key(j, "fileName", p.fileName, "HiveMetadataUpdateHandle", "String", "fileName");
    }

    void from_json(const json& j, HiveMetadataUpdateHandle& p) {
        p._type = j["@type"];
        from_json_key(j, "requestId", p.requestId, "HiveMetadataUpdateHandle", "UUID", "requestId");
        from_json_key(j, "schemaTableName", p.schemaTableName, "HiveMetadataUpdateHandle", "SchemaTableName", "schemaTableName");
        from_json_key(j, "partitionName", p.partitionName, "HiveMetadataUpdateHandle", "String", "partitionName");
        from_json_key(j, "fileName", p.fileName, "HiveMetadataUpdateHandle", "String", "fileName");
    }
}
namespace facebook::presto::protocol {
...
namespace facebook::presto::protocol {
    ...
    void to_json(json& j, const SqlFunctionHandle& p) {
        j = json::object();
        j["@type"] = "json_file";
        to_json_key(j, "functionId", p.functionId, "SqlFunctionHandle", "SqlFunctionId", "functionId");
        to_json_key(j, "version", p.version, "SqlFunctionHandle", "String", "version");
    }

    void from_json(const json& j, SqlFunctionHandle& p) {
        p._type = j["@type"];
        from_json_key(j, "functionId", p.functionId, "SqlFunctionHandle", "SqlFunctionId", "functionId");
        from_json_key(j, "version", p.version, "SqlFunctionHandle", "String", "version");
    }
}
/*
 * Licensed under the Apache License, Version 2.0 (the "License");
...
namespace facebook::presto::protocol {
    ...
    void to_json(json& j, const InsertTableHandle& p) {
        j = json::object();
        to_json_key(j, "connectorId", p.connectorId, "InsertTableHandle", "ConnectorId", "connectorId");
    ...
    void from_json(const json& j, InsertTableHandle& p) {
        from_json_key(j, "connectorId", p.connectorId, "InsertTableHandle", "ConnectorId", "connectorId");
...
namespace facebook::presto::protocol {
    ...
    void to_json(json& j, const RefreshMaterializedViewHandle& p) {
        j = json::object();
        to_json_key(j, "handle", p.handle, "RefreshMaterializedViewHandle", "InsertTableHandle", "handle");
        to_json_key(j, "schemaTableName", p.schemaTableName, "RefreshMaterializedViewHandle", "SchemaTableName", "schemaTableName");
    }

    void from_json(const json& j, RefreshMaterializedViewHandle& p) {
        from_json_key(j, "handle", p.handle, "RefreshMaterializedViewHandle", "InsertTableHandle", "handle");
        from_json_key(j, "schemaTableName", p.schemaTableName, "RefreshMaterializedViewHandle", "SchemaTableName", "schemaTableName");
    }
}
namespace facebook::presto::protocol {
    //Loosly copied this here from NLOHMANN_JSON_SERIALIZE_ENUM()
    ...
    // NOLINTNEXTLINE: cppcoreguidelines-avoid-c-arrays
    static const std::pair<BufferType, json>   
    BufferType_enum_table[] = {                // NOLINT: cert-err58-cpp
    ...
    {                                                                                           
        ...
        const auto* it = std::find_if(std::begin(BufferType_enum_table), std::end(BufferType_enum_table),
...
namespace facebook::presto::protocol {
    ...
    void to_json(json& j, const TaskUpdateRequest& p) {
        ...
        to_json_key(j, "fragment", p.fragment, "TaskUpdateRequest", "String", "fragment");
        to_json_key(j, "sources", p.sources, "TaskUpdateRequest", "List<TaskSource>", "sources");
        to_json_key(j, "outputIds", p.outputIds, "TaskUpdateRequest", "OutputBuffers", "outputIds");
        to_json_key(j, "tableWriteInfo", p.tableWriteInfo, "TaskUpdateRequest", "TableWriteInfo", "tableWriteInfo");
    }
    ...
    void from_json(const json& j, TaskUpdateRequest& p) {
        ...
        from_json_key(j, "fragment", p.fragment, "TaskUpdateRequest", "String", "fragment");
        from_json_key(j, "sources", p.sources, "TaskUpdateRequest", "List<TaskSource>", "sources");
        from_json_key(j, "outputIds", p.outputIds, "TaskUpdateRequest", "OutputBuffers", "outputIds");
        from_json_key(j, "tableWriteInfo", p.tableWriteInfo, "TaskUpdateRequest", "TableWriteInfo", "tableWriteInfo");
    }
}
namespace facebook::presto::protocol {
    ...
    void to_json(json& j, const BatchTaskUpdateRequest& p) {
        j = json::object();
        to_json_key(j, "taskUpdateRequest", p.taskUpdateRequest, "BatchTaskUpdateRequest", "TaskUpdateRequest", "taskUpdateRequest");
        to_json_key(j, "shuffleWriteInfo", p.shuffleWriteInfo, "BatchTaskUpdateRequest", "String", "shuffleWriteInfo");
    }

    void from_json(const json& j, BatchTaskUpdateRequest& p) {
        from_json_key(j, "taskUpdateRequest", p.taskUpdateRequest, "BatchTaskUpdateRequest", "TaskUpdateRequest", "taskUpdateRequest");
        from_json_key(j, "shuffleWriteInfo", p.shuffleWriteInfo, "BatchTaskUpdateRequest", "String", "shuffleWriteInfo");
    }
}
namespace facebook::presto::protocol {
    //Loosly copied this here from NLOHMANN_JSON_SERIALIZE_ENUM()
    ...
    // NOLINTNEXTLINE: cppcoreguidelines-avoid-c-arrays
    static const std::pair<Order, json>   
    Order_enum_table[] = {                // NOLINT: cert-err58-cpp
    ...
    {                                                                                           
        ...
        const auto* it = std::find_if(std::begin(Order_enum_table), std::end(Order_enum_table),
...
namespace facebook::presto::protocol {
    ...
    {                                                                                           
        static_assert(std::is_enum<BucketFunctionType>::value, "BucketFunctionType must be an enum!");
        const auto* it = std::find_if(std::begin(BucketFunctionType_enum_table), std::end(BucketFunctionType_enum_table),
                               [e](const std::pair<BucketFunctionType, json>& ej_pair) -> bool
        {
            return ej_pair.first == e;
        });
        j = ((it != std::end(BucketFunctionType_enum_table)) ? it : std::begin(BucketFunctionType_enum_table))->second;
    }
    void from_json(const json& j, BucketFunctionType& e)
    {
        ...
        e = ((it != std::end(BucketFunctionType_enum_table)) ? it : std::begin(BucketFunctionType_enum_table))->first;
    }
}
namespace facebook::presto::protocol {
    ...
    void to_json(json& j, const HiveBucketProperty& p) {
        ...
        to_json_key(j, "bucketFunctionType", p.bucketFunctionType, "HiveBucketProperty", "BucketFunctionType", "bucketFunctionType");
    ...
    void from_json(const json& j, HiveBucketProperty& p) {
        ...
        from_json_key(j, "bucketFunctionType", p.bucketFunctionType, "HiveBucketProperty", "BucketFunctionType", "bucketFunctionType");
        from_json_key(j, "types", p.types, "HiveBucketProperty", "List<Type>", "types");
    }
}
namespace facebook::presto::protocol {
    //Loosly copied this here from NLOHMANN_JSON_SERIALIZE_ENUM()
    ...
    // NOLINTNEXTLINE: cppcoreguidelines-avoid-c-arrays
    static const std::pair<WriteMode, json>   
    WriteMode_enum_table[] = {                // NOLINT: cert-err58-cpp
    ...
    {                                                                                           
        ...
        const auto* it = std::find_if(std::begin(WriteMode_enum_table), std::end(WriteMode_enum_table),
...
namespace facebook::presto::protocol {
    ...
    // NOLINTNEXTLINE: cppcoreguidelines-avoid-c-arrays
    static const std::pair<TableType, json>   
    TableType_enum_table[] = {                // NOLINT: cert-err58-cpp
        { TableType::NEW, "NEW" },
    ...
    {                                                                                           
        ...
        const auto* it = std::find_if(std::begin(TableType_enum_table), std::end(TableType_enum_table),
                               [e](const std::pair<TableType, json>& ej_pair) -> bool
        {
            return ej_pair.first == e;
        });
        j = ((it != std::end(TableType_enum_table)) ? it : std::begin(TableType_enum_table))->second;
    }
    void from_json(const json& j, TableType& e)
    {
        ...
        e = ((it != std::end(TableType_enum_table)) ? it : std::begin(TableType_enum_table))->first;
    }
}
namespace facebook::presto::protocol {
    ...
    void to_json(json& j, const LocationHandle& p) {
        ...
        to_json_key(j, "tempPath", p.tempPath, "LocationHandle", "String", "tempPath");
        to_json_key(j, "tableType", p.tableType, "LocationHandle", "TableType", "tableType");
    ...
    void from_json(const json& j, LocationHandle& p) {
        ...
        from_json_key(j, "tempPath", p.tempPath, "LocationHandle", "String", "tempPath");
        from_json_key(j, "tableType", p.tableType, "LocationHandle", "TableType", "tableType");
...
namespace facebook::presto::protocol {
    ...
    {                                                                                           
        static_assert(std::is_enum<HiveCompressionCodec>::value, "HiveCompressionCodec must be an enum!");
        const auto* it = std::find_if(std::begin(HiveCompressionCodec_enum_table), std::end(HiveCompressionCodec_enum_table),
                               [e](const std::pair<HiveCompressionCodec, json>& ej_pair) -> bool
        {
            return ej_pair.first == e;
        });
        j = ((it != std::end(HiveCompressionCodec_enum_table)) ? it : std::begin(HiveCompressionCodec_enum_table))->second;
    }
    void from_json(const json& j, HiveCompressionCodec& e)
    {
        ...
        e = ((it != std::end(HiveCompressionCodec_enum_table)) ? it : std::begin(HiveCompressionCodec_enum_table))->first;
    }
}
/*
 * Licensed under the Apache License, Version 2.0 (the "License");
...
namespace facebook::presto::protocol {
    ...
    // NOLINTNEXTLINE: cppcoreguidelines-avoid-c-arrays
    static const std::pair<PrestoTableType, json>   
    PrestoTableType_enum_table[] = {                // NOLINT: cert-err58-cpp
    ...
    {                                                                                           
        static_assert(std::is_enum<PrestoTableType>::value, "PrestoTableType must be an enum!");
        const auto* it = std::find_if(std::begin(PrestoTableType_enum_table), std::end(PrestoTableType_enum_table),
                               [e](const std::pair<PrestoTableType, json>& ej_pair) -> bool
        {
            return ej_pair.first == e;
        });
        j = ((it != std::end(PrestoTableType_enum_table)) ? it : std::begin(PrestoTableType_enum_table))->second;
    }
    void from_json(const json& j, PrestoTableType& e)
    {
        ...
        e = ((it != std::end(PrestoTableType_enum_table)) ? it : std::begin(PrestoTableType_enum_table))->first;
    }
}
namespace facebook::presto::protocol {
...
namespace facebook::presto::protocol {
    ...
    void to_json(json& j, const Storage& p) {
        ...
        to_json_key(j, "parameters", p.parameters, "Storage", "Map<String, String>", "parameters");
    }
    ...
    void from_json(const json& j, Storage& p) {
        ...
        from_json_key(j, "parameters", p.parameters, "Storage", "Map<String, String>", "parameters");
    }
}
namespace facebook::presto::protocol {
...
namespace facebook::presto::protocol {
    ...
    void to_json(json& j, const Table& p) {
        ...
        to_json_key(j, "tableType", p.tableType, "Table", "PrestoTableType", "tableType");
    ...
    void from_json(const json& j, Table& p) {
        ...
        from_json_key(j, "tableType", p.tableType, "Table", "PrestoTableType", "tableType");
...
namespace facebook::presto::protocol {
    ...
    void to_json(json& j, const HiveInsertTableHandle& p) {
        ...
        to_json_key(j, "preferredOrderingColumns", p.preferredOrderingColumns, "HiveInsertTableHandle", "List<SortingColumn>", "preferredOrderingColumns");
        to_json_key(j, "tableStorageFormat", p.tableStorageFormat, "HiveInsertTableHandle", "HiveStorageFormat", "tableStorageFormat");
        to_json_key(j, "partitionStorageFormat", p.partitionStorageFormat, "HiveInsertTableHandle", "HiveStorageFormat", "partitionStorageFormat");
        to_json_key(j, "actualStorageFormat", p.actualStorageFormat, "HiveInsertTableHandle", "HiveStorageFormat", "actualStorageFormat");
        to_json_key(j, "compressionCodec", p.compressionCodec, "HiveInsertTableHandle", "HiveCompressionCodec", "compressionCodec");
        to_json_key(j, "encryptionInformation", p.encryptionInformation, "HiveInsertTableHandle", "EncryptionInformation", "encryptionInformation");
    }
    ...
    void from_json(const json& j, HiveInsertTableHandle& p) {
        ...
        from_json_key(j, "preferredOrderingColumns", p.preferredOrderingColumns, "HiveInsertTableHandle", "List<SortingColumn>", "preferredOrderingColumns");
        from_json_key(j, "tableStorageFormat", p.tableStorageFormat, "HiveInsertTableHandle", "HiveStorageFormat", "tableStorageFormat");
        from_json_key(j, "partitionStorageFormat", p.partitionStorageFormat, "HiveInsertTableHandle", "HiveStorageFormat", "partitionStorageFormat");
        from_json_key(j, "actualStorageFormat", p.actualStorageFormat, "HiveInsertTableHandle", "HiveStorageFormat", "actualStorageFormat");
        from_json_key(j, "compressionCodec", p.compressionCodec, "HiveInsertTableHandle", "HiveCompressionCodec", "compressionCodec");
        from_json_key(j, "encryptionInformation", p.encryptionInformation, "HiveInsertTableHandle", "EncryptionInformation", "encryptionInformation");
    }
}
namespace facebook::presto::protocol {
...
namespace facebook::presto::protocol {
    ...
    void to_json(json& j, const LambdaDefinitionExpression& p) {
        j = json::object();
        j["@type"] = "lambda";
        to_json_key(j, "sourceLocation", p.sourceLocation, "LambdaDefinitionExpression", "SourceLocation", "sourceLocation");
        to_json_key(j, "argumentTypes", p.argumentTypes, "LambdaDefinitionExpression", "List<Type>", "argumentTypes");
        to_json_key(j, "arguments", p.arguments, "LambdaDefinitionExpression", "List<String>", "arguments");
        to_json_key(j, "body", p.body, "LambdaDefinitionExpression", "RowExpression", "body");
    }

    void from_json(const json& j, LambdaDefinitionExpression& p) {
        p._type = j["@type"];
        from_json_key(j, "sourceLocation", p.sourceLocation, "LambdaDefinitionExpression", "SourceLocation", "sourceLocation");
        from_json_key(j, "argumentTypes", p.argumentTypes, "LambdaDefinitionExpression", "List<Type>", "argumentTypes");
        from_json_key(j, "arguments", p.arguments, "LambdaDefinitionExpression", "List<String>", "arguments");
        from_json_key(j, "body", p.body, "LambdaDefinitionExpression", "RowExpression", "body");
    }
}
namespace facebook::presto::protocol {
    ...
    void to_json(json& j, const RowNumberNode& p) {
        ...
        to_json_key(j, "partitionBy", p.partitionBy, "RowNumberNode", "List<VariableReferenceExpression>", "partitionBy");
        to_json_key(j, "rowNumberVariable", p.rowNumberVariable, "RowNumberNode", "VariableReferenceExpression", "rowNumberVariable");
        to_json_key(j, "maxRowCountPerPartition", p.maxRowCountPerPartition, "RowNumberNode", "Integer", "maxRowCountPerPartition");
        to_json_key(j, "hashVariable", p.hashVariable, "RowNumberNode", "VariableReferenceExpression", "hashVariable");
    }
    ...
    void from_json(const json& j, RowNumberNode& p) {
        ...
        from_json_key(j, "partitionBy", p.partitionBy, "RowNumberNode", "List<VariableReferenceExpression>", "partitionBy");
        from_json_key(j, "rowNumberVariable", p.rowNumberVariable, "RowNumberNode", "VariableReferenceExpression", "rowNumberVariable");
        from_json_key(j, "maxRowCountPerPartition", p.maxRowCountPerPartition, "RowNumberNode", "Integer", "maxRowCountPerPartition");
        from_json_key(j, "hashVariable", p.hashVariable, "RowNumberNode", "VariableReferenceExpression", "hashVariable");
    }
}
/*
 * Licensed under the Apache License, Version 2.0 (the "License");
...
namespace facebook::presto::protocol {
    ...
    void to_json(json& j, const TaskStats& p) {
        ...
        to_json_key(j, "elapsedTimeInNanos", p.elapsedTimeInNanos, "TaskStats", "int64_t", "elapsedTimeInNanos");
        to_json_key(j, "queuedTimeInNanos", p.queuedTimeInNanos, "TaskStats", "int64_t", "queuedTimeInNanos");
        ...
        to_json_key(j, "queuedPartitionedSplitsWeight", p.queuedPartitionedSplitsWeight, "TaskStats", "int64_t", "queuedPartitionedSplitsWeight");
        ...
        to_json_key(j, "runningPartitionedSplitsWeight", p.runningPartitionedSplitsWeight, "TaskStats", "int64_t", "runningPartitionedSplitsWeight");
        ...
        to_json_key(j, "cumulativeTotalMemory", p.cumulativeTotalMemory, "TaskStats", "double", "cumulativeTotalMemory");
        to_json_key(j, "userMemoryReservationInBytes", p.userMemoryReservationInBytes, "TaskStats", "int64_t", "userMemoryReservationInBytes");
        to_json_key(j, "revocableMemoryReservationInBytes", p.revocableMemoryReservationInBytes, "TaskStats", "int64_t", "revocableMemoryReservationInBytes");
        to_json_key(j, "systemMemoryReservationInBytes", p.systemMemoryReservationInBytes, "TaskStats", "int64_t", "systemMemoryReservationInBytes");
        to_json_key(j, "peakTotalMemoryInBytes", p.peakTotalMemoryInBytes, "TaskStats", "int64_t", "peakTotalMemoryInBytes");
        to_json_key(j, "peakUserMemoryInBytes", p.peakUserMemoryInBytes, "TaskStats", "int64_t", "peakUserMemoryInBytes");
        to_json_key(j, "peakNodeTotalMemoryInBytes", p.peakNodeTotalMemoryInBytes, "TaskStats", "int64_t", "peakNodeTotalMemoryInBytes");
        to_json_key(j, "totalScheduledTimeInNanos", p.totalScheduledTimeInNanos, "TaskStats", "int64_t", "totalScheduledTimeInNanos");
        to_json_key(j, "totalCpuTimeInNanos", p.totalCpuTimeInNanos, "TaskStats", "int64_t", "totalCpuTimeInNanos");
        to_json_key(j, "totalBlockedTimeInNanos", p.totalBlockedTimeInNanos, "TaskStats", "int64_t", "totalBlockedTimeInNanos");
        ...
        to_json_key(j, "totalAllocationInBytes", p.totalAllocationInBytes, "TaskStats", "int64_t", "totalAllocationInBytes");
        to_json_key(j, "rawInputDataSizeInBytes", p.rawInputDataSizeInBytes, "TaskStats", "int64_t", "rawInputDataSizeInBytes");
        to_json_key(j, "rawInputPositions", p.rawInputPositions, "TaskStats", "int64_t", "rawInputPositions");
        to_json_key(j, "processedInputDataSizeInBytes", p.processedInputDataSizeInBytes, "TaskStats", "int64_t", "processedInputDataSizeInBytes");
        to_json_key(j, "processedInputPositions", p.processedInputPositions, "TaskStats", "int64_t", "processedInputPositions");
        to_json_key(j, "outputDataSizeInBytes", p.outputDataSizeInBytes, "TaskStats", "int64_t", "outputDataSizeInBytes");
        to_json_key(j, "outputPositions", p.outputPositions, "TaskStats", "int64_t", "outputPositions");
        to_json_key(j, "physicalWrittenDataSizeInBytes", p.physicalWrittenDataSizeInBytes, "TaskStats", "int64_t", "physicalWrittenDataSizeInBytes");
        to_json_key(j, "fullGcCount", p.fullGcCount, "TaskStats", "int", "fullGcCount");
        to_json_key(j, "fullGcTimeInMillis", p.fullGcTimeInMillis, "TaskStats", "int64_t", "fullGcTimeInMillis");
        to_json_key(j, "pipelines", p.pipelines, "TaskStats", "List<PipelineStats>", "pipelines");
        to_json_key(j, "runtimeStats", p.runtimeStats, "TaskStats", "RuntimeStats", "runtimeStats");
    }
    ...
    void from_json(const json& j, TaskStats& p) {
        ...
        from_json_key(j, "elapsedTimeInNanos", p.elapsedTimeInNanos, "TaskStats", "int64_t", "elapsedTimeInNanos");
        from_json_key(j, "queuedTimeInNanos", p.queuedTimeInNanos, "TaskStats", "int64_t", "queuedTimeInNanos");
        ...
        from_json_key(j, "queuedPartitionedSplitsWeight", p.queuedPartitionedSplitsWeight, "TaskStats", "int64_t", "queuedPartitionedSplitsWeight");
        ...
        from_json_key(j, "runningPartitionedSplitsWeight", p.runningPartitionedSplitsWeight, "TaskStats", "int64_t", "runningPartitionedSplitsWeight");
        ...
        from_json_key(j, "cumulativeTotalMemory", p.cumulativeTotalMemory, "TaskStats", "double", "cumulativeTotalMemory");
        from_json_key(j, "userMemoryReservationInBytes", p.userMemoryReservationInBytes, "TaskStats", "int64_t", "userMemoryReservationInBytes");
        from_json_key(j, "revocableMemoryReservationInBytes", p.revocableMemoryReservationInBytes, "TaskStats", "int64_t", "revocableMemoryReservationInBytes");
        from_json_key(j, "systemMemoryReservationInBytes", p.systemMemoryReservationInBytes, "TaskStats", "int64_t", "systemMemoryReservationInBytes");
        from_json_key(j, "peakTotalMemoryInBytes", p.peakTotalMemoryInBytes, "TaskStats", "int64_t", "peakTotalMemoryInBytes");
        from_json_key(j, "peakUserMemoryInBytes", p.peakUserMemoryInBytes, "TaskStats", "int64_t", "peakUserMemoryInBytes");
        from_json_key(j, "peakNodeTotalMemoryInBytes", p.peakNodeTotalMemoryInBytes, "TaskStats", "int64_t", "peakNodeTotalMemoryInBytes");
        from_json_key(j, "totalScheduledTimeInNanos", p.totalScheduledTimeInNanos, "TaskStats", "int64_t", "totalScheduledTimeInNanos");
        from_json_key(j, "totalCpuTimeInNanos", p.totalCpuTimeInNanos, "TaskStats", "int64_t", "totalCpuTimeInNanos");
        from_json_key(j, "totalBlockedTimeInNanos", p.totalBlockedTimeInNanos, "TaskStats", "int64_t", "totalBlockedTimeInNanos");
        ...
        from_json_key(j, "totalAllocationInBytes", p.totalAllocationInBytes, "TaskStats", "int64_t", "totalAllocationInBytes");
        from_json_key(j, "rawInputDataSizeInBytes", p.rawInputDataSizeInBytes, "TaskStats", "int64_t", "rawInputDataSizeInBytes");
        from_json_key(j, "rawInputPositions", p.rawInputPositions, "TaskStats", "int64_t", "rawInputPositions");
        from_json_key(j, "processedInputDataSizeInBytes", p.processedInputDataSizeInBytes, "TaskStats", "int64_t", "processedInputDataSizeInBytes");
        from_json_key(j, "processedInputPositions", p.processedInputPositions, "TaskStats", "int64_t", "processedInputPositions");
        from_json_key(j, "outputDataSizeInBytes", p.outputDataSizeInBytes, "TaskStats", "int64_t", "outputDataSizeInBytes");
        from_json_key(j, "outputPositions", p.outputPositions, "TaskStats", "int64_t", "outputPositions");
        from_json_key(j, "physicalWrittenDataSizeInBytes", p.physicalWrittenDataSizeInBytes, "TaskStats", "int64_t", "physicalWrittenDataSizeInBytes");
        from_json_key(j, "fullGcCount", p.fullGcCount, "TaskStats", "int", "fullGcCount");
        from_json_key(j, "fullGcTimeInMillis", p.fullGcTimeInMillis, "TaskStats", "int64_t", "fullGcTimeInMillis");
        from_json_key(j, "pipelines", p.pipelines, "TaskStats", "List<PipelineStats>", "pipelines");
        from_json_key(j, "runtimeStats", p.runtimeStats, "TaskStats", "RuntimeStats", "runtimeStats");
    }
}
namespace facebook::presto::protocol {
...
namespace facebook::presto::protocol {
    ...
    // NOLINTNEXTLINE: cppcoreguidelines-avoid-c-arrays
    static const std::pair<Step, json>   
    Step_enum_table[] = {                // NOLINT: cert-err58-cpp
        { Step::SINGLE, "SINGLE" },
    ...
    {                                                                                           
        ...
        const auto* it = std::find_if(std::begin(Step_enum_table), std::end(Step_enum_table),
...
namespace facebook::presto::protocol {
    ...
    void to_json(json& j, const TpchPartitioningHandle& p) {
        ...
        to_json_key(j, "totalRows", p.totalRows, "TpchPartitioningHandle", "int64_t", "totalRows");
    }

    void from_json(const json& j, TpchPartitioningHandle& p) {
        p._type = j["@type"];
        from_json_key(j, "table", p.table, "TpchPartitioningHandle", "String", "table");
        from_json_key(j, "totalRows", p.totalRows, "TpchPartitioningHandle", "int64_t", "totalRows");
    }
}
/*
 * Licensed under the Apache License, Version 2.0 (the "License");
...
namespace facebook::presto::protocol {
    ...
    void to_json(json& j, const HiveTableLayoutHandle& p) {
        j = json::object();
        j["@type"] = "hive";
        to_json_key(j, "schemaTableName", p.schemaTableName, "HiveTableLayoutHandle", "SchemaTableName", "schemaTableName");
        to_json_key(j, "tablePath", p.tablePath, "HiveTableLayoutHandle", "String", "tablePath");
        to_json_key(j, "partitionColumns", p.partitionColumns, "HiveTableLayoutHandle", "List<HiveColumnHandle>", "partitionColumns");
        to_json_key(j, "dataColumns", p.dataColumns, "HiveTableLayoutHandle", "List<Column>", "dataColumns");
        to_json_key(j, "tableParameters", p.tableParameters, "HiveTableLayoutHandle", "Map<String, String>", "tableParameters");
        to_json_key(j, "domainPredicate", p.domainPredicate, "HiveTableLayoutHandle", "TupleDomain<Subfield>", "domainPredicate");
        to_json_key(j, "remainingPredicate", p.remainingPredicate, "HiveTableLayoutHandle", "RowExpression", "remainingPredicate");
        to_json_key(j, "predicateColumns", p.predicateColumns, "HiveTableLayoutHandle", "Map<String, HiveColumnHandle>", "predicateColumns");
        to_json_key(j, "partitionColumnPredicate", p.partitionColumnPredicate, "HiveTableLayoutHandle", "TupleDomain<std::shared_ptr<ColumnHandle>>", "partitionColumnPredicate");
        to_json_key(j, "bucketHandle", p.bucketHandle, "HiveTableLayoutHandle", "HiveBucketHandle", "bucketHandle");
        to_json_key(j, "bucketFilter", p.bucketFilter, "HiveTableLayoutHandle", "HiveBucketFilter", "bucketFilter");
        to_json_key(j, "pushdownFilterEnabled", p.pushdownFilterEnabled, "HiveTableLayoutHandle", "bool", "pushdownFilterEnabled");
        to_json_key(j, "layoutString", p.layoutString, "HiveTableLayoutHandle", "String", "layoutString");
        to_json_key(j, "requestedColumns", p.requestedColumns, "HiveTableLayoutHandle", "List<HiveColumnHandle>", "requestedColumns");
        to_json_key(j, "partialAggregationsPushedDown", p.partialAggregationsPushedDown, "HiveTableLayoutHandle", "bool", "partialAggregationsPushedDown");
        to_json_key(j, "appendRowNumber", p.appendRowNumber, "HiveTableLayoutHandle", "bool", "appendRowNumber");
        to_json_key(j, "footerStatsUnreliable", p.footerStatsUnreliable, "HiveTableLayoutHandle", "bool", "footerStatsUnreliable");
    }

    void from_json(const json& j, HiveTableLayoutHandle& p) {
        p._type = j["@type"];
        from_json_key(j, "schemaTableName", p.schemaTableName, "HiveTableLayoutHandle", "SchemaTableName", "schemaTableName");
        from_json_key(j, "tablePath", p.tablePath, "HiveTableLayoutHandle", "String", "tablePath");
        from_json_key(j, "partitionColumns", p.partitionColumns, "HiveTableLayoutHandle", "List<HiveColumnHandle>", "partitionColumns");
        from_json_key(j, "dataColumns", p.dataColumns, "HiveTableLayoutHandle", "List<Column>", "dataColumns");
        from_json_key(j, "tableParameters", p.tableParameters, "HiveTableLayoutHandle", "Map<String, String>", "tableParameters");
        from_json_key(j, "domainPredicate", p.domainPredicate, "HiveTableLayoutHandle", "TupleDomain<Subfield>", "domainPredicate");
        from_json_key(j, "remainingPredicate", p.remainingPredicate, "HiveTableLayoutHandle", "RowExpression", "remainingPredicate");
        from_json_key(j, "predicateColumns", p.predicateColumns, "HiveTableLayoutHandle", "Map<String, HiveColumnHandle>", "predicateColumns");
        from_json_key(j, "partitionColumnPredicate", p.partitionColumnPredicate, "HiveTableLayoutHandle", "TupleDomain<std::shared_ptr<ColumnHandle>>", "partitionColumnPredicate");
        from_json_key(j, "bucketHandle", p.bucketHandle, "HiveTableLayoutHandle", "HiveBucketHandle", "bucketHandle");
        from_json_key(j, "bucketFilter", p.bucketFilter, "HiveTableLayoutHandle", "HiveBucketFilter", "bucketFilter");
        from_json_key(j, "pushdownFilterEnabled", p.pushdownFilterEnabled, "HiveTableLayoutHandle", "bool", "pushdownFilterEnabled");
        from_json_key(j, "layoutString", p.layoutString, "HiveTableLayoutHandle", "String", "layoutString");
        from_json_key(j, "requestedColumns", p.requestedColumns, "HiveTableLayoutHandle", "List<HiveColumnHandle>", "requestedColumns");
        from_json_key(j, "partialAggregationsPushedDown", p.partialAggregationsPushedDown, "HiveTableLayoutHandle", "bool", "partialAggregationsPushedDown");
        from_json_key(j, "appendRowNumber", p.appendRowNumber, "HiveTableLayoutHandle", "bool", "appendRowNumber");
        from_json_key(j, "footerStatsUnreliable", p.footerStatsUnreliable, "HiveTableLayoutHandle", "bool", "footerStatsUnreliable");
    }
}
/*
 * Licensed under the Apache License, Version 2.0 (the "License");
...
namespace facebook::presto::protocol {
    ...
    void to_json(json& j, const MetadataUpdates& p) {
        j = json::object();
        to_json_key(j, "connectorId", p.connectorId, "MetadataUpdates", "ConnectorId", "connectorId");
        to_json_key(j, "metadataUpdates", p.metadataUpdates, "MetadataUpdates", "List<std::shared_ptr<ConnectorMetadataUpdateHandle>>", "metadataUpdates");
    }

    void from_json(const json& j, MetadataUpdates& p) {
        from_json_key(j, "connectorId", p.connectorId, "MetadataUpdates", "ConnectorId", "connectorId");
        from_json_key(j, "metadataUpdates", p.metadataUpdates, "MetadataUpdates", "List<std::shared_ptr<ConnectorMetadataUpdateHandle>>", "metadataUpdates");
    }
}
namespace facebook::presto::protocol {
    //Loosly copied this here from NLOHMANN_JSON_SERIALIZE_ENUM()
    ...
    // NOLINTNEXTLINE: cppcoreguidelines-avoid-c-arrays
    static const std::pair<ErrorType, json>   
    ErrorType_enum_table[] = {                // NOLINT: cert-err58-cpp
    ...
    {                                                                                           
        ...
        const auto* it = std::find_if(std::begin(ErrorType_enum_table), std::end(ErrorType_enum_table),
...
namespace facebook::presto::protocol {
    ...
    // NOLINTNEXTLINE: cppcoreguidelines-avoid-c-arrays
    static const std::pair<ErrorCause, json>   
    ErrorCause_enum_table[] = {                // NOLINT: cert-err58-cpp
    ...
    {                                                                                           
        ...
        const auto* it = std::find_if(std::begin(ErrorCause_enum_table), std::end(ErrorCause_enum_table),
                               [e](const std::pair<ErrorCause, json>& ej_pair) -> bool
        {
            return ej_pair.first == e;
        });
        j = ((it != std::end(ErrorCause_enum_table)) ? it : std::begin(ErrorCause_enum_table))->second;
    }
    void from_json(const json& j, ErrorCause& e)
    {
        ...
        e = ((it != std::end(ErrorCause_enum_table)) ? it : std::begin(ErrorCause_enum_table))->first;
    }
}
namespace facebook::presto::protocol {
    ...
    void to_json(json& j, const ExecutionFailureInfo& p) {
        ...
        to_json_key(j, "errorCause", p.errorCause, "ExecutionFailureInfo", "ErrorCause", "errorCause");
    }
    ...
    void from_json(const json& j, ExecutionFailureInfo& p) {
        ...
        from_json_key(j, "errorCause", p.errorCause, "ExecutionFailureInfo", "ErrorCause", "errorCause");
    }
}
namespace facebook::presto::protocol {
    //Loosly copied this here from NLOHMANN_JSON_SERIALIZE_ENUM()
    ...
    // NOLINTNEXTLINE: cppcoreguidelines-avoid-c-arrays
    static const std::pair<TaskState, json>   
    TaskState_enum_table[] = {                // NOLINT: cert-err58-cpp
    ...
    {                                                                                           
        ...
        const auto* it = std::find_if(std::begin(TaskState_enum_table), std::end(TaskState_enum_table),
...
namespace facebook::presto::protocol {
    ...
    void to_json(json& j, const TaskStatus& p) {
        j = json::object();
        to_json_key(j, "taskInstanceIdLeastSignificantBits", p.taskInstanceIdLeastSignificantBits, "TaskStatus", "int64_t", "taskInstanceIdLeastSignificantBits");
        to_json_key(j, "taskInstanceIdMostSignificantBits", p.taskInstanceIdMostSignificantBits, "TaskStatus", "int64_t", "taskInstanceIdMostSignificantBits");
        ...
        to_json_key(j, "completedDriverGroups", p.completedDriverGroups, "TaskStatus", "List<Lifespan>", "completedDriverGroups");
        ...
        to_json_key(j, "outputBufferUtilization", p.outputBufferUtilization, "TaskStatus", "double", "outputBufferUtilization");
        to_json_key(j, "outputBufferOverutilized", p.outputBufferOverutilized, "TaskStatus", "bool", "outputBufferOverutilized");
        to_json_key(j, "physicalWrittenDataSizeInBytes", p.physicalWrittenDataSizeInBytes, "TaskStatus", "int64_t", "physicalWrittenDataSizeInBytes");
        to_json_key(j, "memoryReservationInBytes", p.memoryReservationInBytes, "TaskStatus", "int64_t", "memoryReservationInBytes");
        to_json_key(j, "systemMemoryReservationInBytes", p.systemMemoryReservationInBytes, "TaskStatus", "int64_t", "systemMemoryReservationInBytes");
        to_json_key(j, "peakNodeTotalMemoryReservationInBytes", p.peakNodeTotalMemoryReservationInBytes, "TaskStatus", "int64_t", "peakNodeTotalMemoryReservationInBytes");
        to_json_key(j, "fullGcCount", p.fullGcCount, "TaskStatus", "int64_t", "fullGcCount");
        to_json_key(j, "fullGcTimeInMillis", p.fullGcTimeInMillis, "TaskStatus", "int64_t", "fullGcTimeInMillis");
        to_json_key(j, "totalCpuTimeInNanos", p.totalCpuTimeInNanos, "TaskStatus", "int64_t", "totalCpuTimeInNanos");
        to_json_key(j, "taskAgeInMillis", p.taskAgeInMillis, "TaskStatus", "int64_t", "taskAgeInMillis");
        to_json_key(j, "queuedPartitionedSplitsWeight", p.queuedPartitionedSplitsWeight, "TaskStatus", "int64_t", "queuedPartitionedSplitsWeight");
        to_json_key(j, "runningPartitionedSplitsWeight", p.runningPartitionedSplitsWeight, "TaskStatus", "int64_t", "runningPartitionedSplitsWeight");
    }

    void from_json(const json& j, TaskStatus& p) {
        from_json_key(j, "taskInstanceIdLeastSignificantBits", p.taskInstanceIdLeastSignificantBits, "TaskStatus", "int64_t", "taskInstanceIdLeastSignificantBits");
        from_json_key(j, "taskInstanceIdMostSignificantBits", p.taskInstanceIdMostSignificantBits, "TaskStatus", "int64_t", "taskInstanceIdMostSignificantBits");
        ...
        from_json_key(j, "completedDriverGroups", p.completedDriverGroups, "TaskStatus", "List<Lifespan>", "completedDriverGroups");
        ...
        from_json_key(j, "outputBufferUtilization", p.outputBufferUtilization, "TaskStatus", "double", "outputBufferUtilization");
        from_json_key(j, "outputBufferOverutilized", p.outputBufferOverutilized, "TaskStatus", "bool", "outputBufferOverutilized");
        from_json_key(j, "physicalWrittenDataSizeInBytes", p.physicalWrittenDataSizeInBytes, "TaskStatus", "int64_t", "physicalWrittenDataSizeInBytes");
        from_json_key(j, "memoryReservationInBytes", p.memoryReservationInBytes, "TaskStatus", "int64_t", "memoryReservationInBytes");
        from_json_key(j, "systemMemoryReservationInBytes", p.systemMemoryReservationInBytes, "TaskStatus", "int64_t", "systemMemoryReservationInBytes");
        from_json_key(j, "peakNodeTotalMemoryReservationInBytes", p.peakNodeTotalMemoryReservationInBytes, "TaskStatus", "int64_t", "peakNodeTotalMemoryReservationInBytes");
        from_json_key(j, "fullGcCount", p.fullGcCount, "TaskStatus", "int64_t", "fullGcCount");
        from_json_key(j, "fullGcTimeInMillis", p.fullGcTimeInMillis, "TaskStatus", "int64_t", "fullGcTimeInMillis");
        from_json_key(j, "totalCpuTimeInNanos", p.totalCpuTimeInNanos, "TaskStatus", "int64_t", "totalCpuTimeInNanos");
        from_json_key(j, "taskAgeInMillis", p.taskAgeInMillis, "TaskStatus", "int64_t", "taskAgeInMillis");
        from_json_key(j, "queuedPartitionedSplitsWeight", p.queuedPartitionedSplitsWeight, "TaskStatus", "int64_t", "queuedPartitionedSplitsWeight");
        from_json_key(j, "runningPartitionedSplitsWeight", p.runningPartitionedSplitsWeight, "TaskStatus", "int64_t", "runningPartitionedSplitsWeight");
    }
}
namespace facebook::presto::protocol {
    ...
    void to_json(json& j, const TaskInfo& p) {
        ...
        to_json_key(j, "metadataUpdates", p.metadataUpdates, "TaskInfo", "MetadataUpdates", "metadataUpdates");
    ...
    void from_json(const json& j, TaskInfo& p) {
        ...
        from_json_key(j, "metadataUpdates", p.metadataUpdates, "TaskInfo", "MetadataUpdates", "metadataUpdates");
...
namespace facebook::presto::protocol {
    ...
    void to_json(json& j, const TpchSplit& p) {
        ...
        to_json_key(j, "addresses", p.addresses, "TpchSplit", "List<HostAddress>", "addresses");
        to_json_key(j, "predicate", p.predicate, "TpchSplit", "TupleDomain<std::shared_ptr<ColumnHandle>>", "predicate");
    }
    ...
    void from_json(const json& j, TpchSplit& p) {
        ...
        from_json_key(j, "addresses", p.addresses, "TpchSplit", "List<HostAddress>", "addresses");
        from_json_key(j, "predicate", p.predicate, "TpchSplit", "TupleDomain<std::shared_ptr<ColumnHandle>>", "predicate");
    }
}
namespace facebook::presto::protocol {
    //Loosly copied this here from NLOHMANN_JSON_SERIALIZE_ENUM()
    ...
    // NOLINTNEXTLINE: cppcoreguidelines-avoid-c-arrays
    static const std::pair<BoundType, json>   
    BoundType_enum_table[] = {                // NOLINT: cert-err58-cpp
    ...
    {                                                                                           
        ...
        const auto* it = std::find_if(std::begin(BoundType_enum_table), std::end(BoundType_enum_table),
                               [e](const std::pair<BoundType, json>& ej_pair) -> bool
        {
            return ej_pair.first == e;
        });
        j = ((it != std::end(BoundType_enum_table)) ? it : std::begin(BoundType_enum_table))->second;
    }
    void from_json(const json& j, BoundType& e)
    {
        ...
        e = ((it != std::end(BoundType_enum_table)) ? it : std::begin(BoundType_enum_table))->first;
    }
}
namespace facebook::presto::protocol {
    //Loosly copied this here from NLOHMANN_JSON_SERIALIZE_ENUM()
    ...
    // NOLINTNEXTLINE: cppcoreguidelines-avoid-c-arrays
    static const std::pair<WindowType, json>   
    WindowType_enum_table[] = {                // NOLINT: cert-err58-cpp
    ...
    {                                                                                           
        ...
        const auto* it = std::find_if(std::begin(WindowType_enum_table), std::end(WindowType_enum_table),
                               [e](const std::pair<WindowType, json>& ej_pair) -> bool
        {
            return ej_pair.first == e;
        });
        j = ((it != std::end(WindowType_enum_table)) ? it : std::begin(WindowType_enum_table))->second;
    }
    void from_json(const json& j, WindowType& e)
    {
        ...
        e = ((it != std::end(WindowType_enum_table)) ? it : std::begin(WindowType_enum_table))->first;
    }
}
namespace facebook::presto::protocol {
    ...
    void to_json(json& j, const Frame& p) {
        ...
        to_json_key(j, "startValue", p.startValue, "Frame", "VariableReferenceExpression", "startValue");
        to_json_key(j, "sortKeyCoercedForFrameStartComparison", p.sortKeyCoercedForFrameStartComparison, "Frame", "VariableReferenceExpression", "sortKeyCoercedForFrameStartComparison");
        to_json_key(j, "endType", p.endType, "Frame", "BoundType", "endType");
        to_json_key(j, "endValue", p.endValue, "Frame", "VariableReferenceExpression", "endValue");
        to_json_key(j, "sortKeyCoercedForFrameEndComparison", p.sortKeyCoercedForFrameEndComparison, "Frame", "VariableReferenceExpression", "sortKeyCoercedForFrameEndComparison");
        to_json_key(j, "originalStartValue", p.originalStartValue, "Frame", "String", "originalStartValue");
        to_json_key(j, "originalEndValue", p.originalEndValue, "Frame", "String", "originalEndValue");
    }
    ...
    void from_json(const json& j, Frame& p) {
        ...
        from_json_key(j, "startValue", p.startValue, "Frame", "VariableReferenceExpression", "startValue");
        from_json_key(j, "sortKeyCoercedForFrameStartComparison", p.sortKeyCoercedForFrameStartComparison, "Frame", "VariableReferenceExpression", "sortKeyCoercedForFrameStartComparison");
        from_json_key(j, "endType", p.endType, "Frame", "BoundType", "endType");
        from_json_key(j, "endValue", p.endValue, "Frame", "VariableReferenceExpression", "endValue");
        from_json_key(j, "sortKeyCoercedForFrameEndComparison", p.sortKeyCoercedForFrameEndComparison, "Frame", "VariableReferenceExpression", "sortKeyCoercedForFrameEndComparison");
        from_json_key(j, "originalStartValue", p.originalStartValue, "Frame", "String", "originalStartValue");
        from_json_key(j, "originalEndValue", p.originalEndValue, "Frame", "String", "originalEndValue");
    }
}
namespace facebook::presto::protocol {
    ...
    void to_json(json& j, const TableToPartitionMapping& p) {
        j = json::object();
        to_json_key(j, "tableToPartitionColumns", p.tableToPartitionColumns, "TableToPartitionMapping", "Map<Integer, Integer>", "tableToPartitionColumns");
        to_json_key(j, "partitionSchemaDifference", p.partitionSchemaDifference, "TableToPartitionMapping", "Map<Integer, Column>", "partitionSchemaDifference");
    }

    void from_json(const json& j, TableToPartitionMapping& p) {
        from_json_key(j, "tableToPartitionColumns", p.tableToPartitionColumns, "TableToPartitionMapping", "Map<Integer, Integer>", "tableToPartitionColumns");
        from_json_key(j, "partitionSchemaDifference", p.partitionSchemaDifference, "TableToPartitionMapping", "Map<Integer, Column>", "partitionSchemaDifference");
    }
}
namespace facebook::presto::protocol {
    //Loosly copied this here from NLOHMANN_JSON_SERIALIZE_ENUM()
    ...
    // NOLINTNEXTLINE: cppcoreguidelines-avoid-c-arrays
    static const std::pair<CacheQuotaScope, json>   
    CacheQuotaScope_enum_table[] = {                // NOLINT: cert-err58-cpp
    ...
    {                                                                                           
        static_assert(std::is_enum<CacheQuotaScope>::value, "CacheQuotaScope must be an enum!");
        const auto* it = std::find_if(std::begin(CacheQuotaScope_enum_table), std::end(CacheQuotaScope_enum_table),
                               [e](const std::pair<CacheQuotaScope, json>& ej_pair) -> bool
        {
            return ej_pair.first == e;
        });
        j = ((it != std::end(CacheQuotaScope_enum_table)) ? it : std::begin(CacheQuotaScope_enum_table))->second;
    }
    void from_json(const json& j, CacheQuotaScope& e)
    {
        ...
        e = ((it != std::end(CacheQuotaScope_enum_table)) ? it : std::begin(CacheQuotaScope_enum_table))->first;
    }
}
namespace facebook::presto::protocol {
    ...
    void to_json(json& j, const CacheQuotaRequirement& p) {
        j = json::object();
        to_json_key(j, "cacheQuotaScope", p.cacheQuotaScope, "CacheQuotaRequirement", "CacheQuotaScope", "cacheQuotaScope");
        to_json_key(j, "quota", p.quota, "CacheQuotaRequirement", "DataSize", "quota");
    }

    void from_json(const json& j, CacheQuotaRequirement& p) {
        from_json_key(j, "cacheQuotaScope", p.cacheQuotaScope, "CacheQuotaRequirement", "CacheQuotaScope", "cacheQuotaScope");
        from_json_key(j, "quota", p.quota, "CacheQuotaRequirement", "DataSize", "quota");
    }
}
namespace facebook::presto::protocol {
    //Loosly copied this here from NLOHMANN_JSON_SERIALIZE_ENUM()
    ...
    {                                                                                           
        static_assert(std::is_enum<NodeSelectionStrategy>::value, "NodeSelectionStrategy must be an enum!");
        const auto* it = std::find_if(std::begin(NodeSelectionStrategy_enum_table), std::end(NodeSelectionStrategy_enum_table),
                               [e](const std::pair<NodeSelectionStrategy, json>& ej_pair) -> bool
        {
            return ej_pair.first == e;
        });
        j = ((it != std::end(NodeSelectionStrategy_enum_table)) ? it : std::begin(NodeSelectionStrategy_enum_table))->second;
    }
    void from_json(const json& j, NodeSelectionStrategy& e)
    {
        ...
        e = ((it != std::end(NodeSelectionStrategy_enum_table)) ? it : std::begin(NodeSelectionStrategy_enum_table))->first;
    }
}
namespace facebook::presto::protocol {
...
namespace facebook::presto::protocol {
    ...
    void to_json(json& j, const HiveSplit& p) {
        j = json::object();
        j["@type"] = "hive";
        to_json_key(j, "fileSplit", p.fileSplit, "HiveSplit", "HiveFileSplit", "fileSplit");
        ...
        to_json_key(j, "nodeSelectionStrategy", p.nodeSelectionStrategy, "HiveSplit", "NodeSelectionStrategy", "nodeSelectionStrategy");
        to_json_key(j, "partitionDataColumnCount", p.partitionDataColumnCount, "HiveSplit", "int", "partitionDataColumnCount");
        ...
        to_json_key(j, "cacheQuota", p.cacheQuota, "HiveSplit", "CacheQuotaRequirement", "cacheQuota");
        to_json_key(j, "encryptionMetadata", p.encryptionMetadata, "HiveSplit", "EncryptionInformation", "encryptionMetadata");
        to_json_key(j, "redundantColumnDomains", p.redundantColumnDomains, "HiveSplit", "List<std::shared_ptr<ColumnHandle>>", "redundantColumnDomains");
        to_json_key(j, "splitWeight", p.splitWeight, "HiveSplit", "SplitWeight", "splitWeight");
    }

    void from_json(const json& j, HiveSplit& p) {
        p._type = j["@type"];
        from_json_key(j, "fileSplit", p.fileSplit, "HiveSplit", "HiveFileSplit", "fileSplit");
        ...
        from_json_key(j, "nodeSelectionStrategy", p.nodeSelectionStrategy, "HiveSplit", "NodeSelectionStrategy", "nodeSelectionStrategy");
        from_json_key(j, "partitionDataColumnCount", p.partitionDataColumnCount, "HiveSplit", "int", "partitionDataColumnCount");
        from_json_key(j, "tableToPartitionMapping", p.tableToPartitionMapping, "HiveSplit", "TableToPartitionMapping", "tableToPartitionMapping");
        ...
        from_json_key(j, "cacheQuota", p.cacheQuota, "HiveSplit", "CacheQuotaRequirement", "cacheQuota");
        from_json_key(j, "encryptionMetadata", p.encryptionMetadata, "HiveSplit", "EncryptionInformation", "encryptionMetadata");
        from_json_key(j, "redundantColumnDomains", p.redundantColumnDomains, "HiveSplit", "List<std::shared_ptr<ColumnHandle>>", "redundantColumnDomains");
...
namespace facebook::presto::protocol {
    ...
    void to_json(json& j, const EnforceSingleRowNode& p) {
        ...
        to_json_key(j, "source", p.source, "EnforceSingleRowNode", "PlanNode", "source");
    }

    void from_json(const json& j, EnforceSingleRowNode& p) {
        p._type = j["@type"];
        from_json_key(j, "id", p.id, "EnforceSingleRowNode", "PlanNodeId", "id");
        from_json_key(j, "source", p.source, "EnforceSingleRowNode", "PlanNode", "source");
    }
}
namespace facebook::presto::protocol {
...
namespace facebook::presto::protocol {
    ...
    void to_json(json& j, const TableScanNode& p) {
        ...
        to_json_key(j, "outputVariables", p.outputVariables, "TableScanNode", "List<VariableReferenceExpression>", "outputVariables");
        to_json_key(j, "assignments", p.assignments, "TableScanNode", "Map<VariableReferenceExpression, std::shared_ptr<ColumnHandle>>", "assignments");
    }
    ...
    void from_json(const json& j, TableScanNode& p) {
        ...
        from_json_key(j, "outputVariables", p.outputVariables, "TableScanNode", "List<VariableReferenceExpression>", "outputVariables");
        from_json_key(j, "assignments", p.assignments, "TableScanNode", "Map<VariableReferenceExpression, std::shared_ptr<ColumnHandle>>", "assignments");
    }
}
namespace facebook::presto::protocol {
    ...
    void to_json(json& j, const DeleteHandle& p) {
        ...
        to_json_key(j, "schemaTableName", p.schemaTableName, "DeleteHandle", "SchemaTableName", "schemaTableName");
    }

    void from_json(const json& j, DeleteHandle& p) {
        p._type = j["@type"];
        from_json_key(j, "handle", p.handle, "DeleteHandle", "TableHandle", "handle");
        from_json_key(j, "schemaTableName", p.schemaTableName, "DeleteHandle", "SchemaTableName", "schemaTableName");
    }
}
namespace facebook::presto::protocol {
...
namespace facebook::presto::protocol {
    ...
    void to_json(json& j, const EquatableValueSet& p) {
        ...
        to_json_key(j, "whiteList", p.whiteList, "EquatableValueSet", "bool", "whiteList");
    ...
    void from_json(const json& j, EquatableValueSet& p) {
        ...
        from_json_key(j, "whiteList", p.whiteList, "EquatableValueSet", "bool", "whiteList");
...
namespace facebook::presto::protocol {
    ...
    void to_json(json& j, const TpchTableLayoutHandle& p) {
        ...
        to_json_key(j, "predicate", p.predicate, "TpchTableLayoutHandle", "TupleDomain<std::shared_ptr<ColumnHandle>>", "predicate");
    }
    ...
    void from_json(const json& j, TpchTableLayoutHandle& p) {
        ...
        from_json_key(j, "predicate", p.predicate, "TpchTableLayoutHandle", "TupleDomain<std::shared_ptr<ColumnHandle>>", "predicate");
    }
}
namespace facebook::presto::protocol {
    ...
    void to_json(json& j, const Specification& p) {
        j = json::object();
        to_json_key(j, "partitionBy", p.partitionBy, "Specification", "List<VariableReferenceExpression>", "partitionBy");
        to_json_key(j, "orderingScheme", p.orderingScheme, "Specification", "OrderingScheme", "orderingScheme");
    }

    void from_json(const json& j, Specification& p) {
        from_json_key(j, "partitionBy", p.partitionBy, "Specification", "List<VariableReferenceExpression>", "partitionBy");
        from_json_key(j, "orderingScheme", p.orderingScheme, "Specification", "OrderingScheme", "orderingScheme");
    }
}
namespace facebook::presto::protocol {
    ...
    void to_json(json& j, const AssignUniqueId& p) {
        ...
        to_json_key(j, "idVariable", p.idVariable, "AssignUniqueId", "VariableReferenceExpression", "idVariable");
    }
    ...
    void from_json(const json& j, AssignUniqueId& p) {
        ...
        from_json_key(j, "idVariable", p.idVariable, "AssignUniqueId", "VariableReferenceExpression", "idVariable");
    }
}
namespace facebook::presto::protocol {
    ...
    void to_json(json& j, const InsertHandle& p) {
        j = json::object();
        j["@type"] = "InsertHandle";
        to_json_key(j, "handle", p.handle, "InsertHandle", "InsertTableHandle", "handle");
        to_json_key(j, "schemaTableName", p.schemaTableName, "InsertHandle", "SchemaTableName", "schemaTableName");
    }

    void from_json(const json& j, InsertHandle& p) {
        p._type = j["@type"];
        from_json_key(j, "handle", p.handle, "InsertHandle", "InsertTableHandle", "handle");
        from_json_key(j, "schemaTableName", p.schemaTableName, "InsertHandle", "SchemaTableName", "schemaTableName");
    }
}
namespace facebook::presto::protocol {
    ...
    void to_json(json& j, const HiveOutputTableHandle& p) {
        ...
        to_json_key(j, "partitionStorageFormat", p.partitionStorageFormat, "HiveOutputTableHandle", "HiveStorageFormat", "partitionStorageFormat");
        to_json_key(j, "actualStorageFormat", p.actualStorageFormat, "HiveOutputTableHandle", "HiveStorageFormat", "actualStorageFormat");
        ...
        to_json_key(j, "preferredOrderingColumns", p.preferredOrderingColumns, "HiveOutputTableHandle", "List<SortingColumn>", "preferredOrderingColumns");
        to_json_key(j, "tableOwner", p.tableOwner, "HiveOutputTableHandle", "String", "tableOwner");
        to_json_key(j, "additionalTableParameters", p.additionalTableParameters, "HiveOutputTableHandle", "Map<String, String>", "additionalTableParameters");
        to_json_key(j, "encryptionInformation", p.encryptionInformation, "HiveOutputTableHandle", "EncryptionInformation", "encryptionInformation");
    }
    ...
    void from_json(const json& j, HiveOutputTableHandle& p) {
        ...
        from_json_key(j, "partitionStorageFormat", p.partitionStorageFormat, "HiveOutputTableHandle", "HiveStorageFormat", "partitionStorageFormat");
        from_json_key(j, "actualStorageFormat", p.actualStorageFormat, "HiveOutputTableHandle", "HiveStorageFormat", "actualStorageFormat");
        from_json_key(j, "compressionCodec", p.compressionCodec, "HiveOutputTableHandle", "HiveCompressionCodec", "compressionCodec");
        ...
        from_json_key(j, "preferredOrderingColumns", p.preferredOrderingColumns, "HiveOutputTableHandle", "List<SortingColumn>", "preferredOrderingColumns");
        from_json_key(j, "tableOwner", p.tableOwner, "HiveOutputTableHandle", "String", "tableOwner");
        from_json_key(j, "additionalTableParameters", p.additionalTableParameters, "HiveOutputTableHandle", "Map<String, String>", "additionalTableParameters");
        from_json_key(j, "encryptionInformation", p.encryptionInformation, "HiveOutputTableHandle", "EncryptionInformation", "encryptionInformation");
    }
}
namespace facebook::presto::protocol {
    //Loosly copied this here from NLOHMANN_JSON_SERIALIZE_ENUM()
    ...
    // NOLINTNEXTLINE: cppcoreguidelines-avoid-c-arrays
    static const std::pair<LimitNodeStep, json>   
    LimitNodeStep_enum_table[] = {                // NOLINT: cert-err58-cpp
        { LimitNodeStep::PARTIAL, "PARTIAL" },
        { LimitNodeStep::FINAL, "FINAL" }
    };
    void to_json(json& j, const LimitNodeStep& e)                                                   
    {                                                                                           
        static_assert(std::is_enum<LimitNodeStep>::value, "LimitNodeStep must be an enum!");
        const auto* it = std::find_if(std::begin(LimitNodeStep_enum_table), std::end(LimitNodeStep_enum_table),
                               [e](const std::pair<LimitNodeStep, json>& ej_pair) -> bool
        {
            return ej_pair.first == e;
        });
        j = ((it != std::end(LimitNodeStep_enum_table)) ? it : std::begin(LimitNodeStep_enum_table))->second;
    }
    void from_json(const json& j, LimitNodeStep& e)
    {
        ...
        e = ((it != std::end(LimitNodeStep_enum_table)) ? it : std::begin(LimitNodeStep_enum_table))->first;
    }
}
namespace facebook::presto::protocol {
...
namespace facebook::presto::protocol {
    ...
    void to_json(json& j, const DistinctLimitNode& p) {
        ...
        to_json_key(j, "distinctVariables", p.distinctVariables, "DistinctLimitNode", "List<VariableReferenceExpression>", "distinctVariables");
        to_json_key(j, "hashVariable", p.hashVariable, "DistinctLimitNode", "VariableReferenceExpression", "hashVariable");
        to_json_key(j, "timeoutMillis", p.timeoutMillis, "DistinctLimitNode", "int", "timeoutMillis");
    }
    ...
    void from_json(const json& j, DistinctLimitNode& p) {
        ...
        from_json_key(j, "distinctVariables", p.distinctVariables, "DistinctLimitNode", "List<VariableReferenceExpression>", "distinctVariables");
        from_json_key(j, "hashVariable", p.hashVariable, "DistinctLimitNode", "VariableReferenceExpression", "hashVariable");
        from_json_key(j, "timeoutMillis", p.timeoutMillis, "DistinctLimitNode", "int", "timeoutMillis");
    }
}
namespace facebook::presto::protocol {
    //Loosly copied this here from NLOHMANN_JSON_SERIALIZE_ENUM()
    ...
    // NOLINTNEXTLINE: cppcoreguidelines-avoid-c-arrays
    static const std::pair<ExchangeNodeType, json>   
    ExchangeNodeType_enum_table[] = {                // NOLINT: cert-err58-cpp
    ...
    {                                                                                           
        ...
        const auto* it = std::find_if(std::begin(ExchangeNodeType_enum_table), std::end(ExchangeNodeType_enum_table),
...
namespace facebook::presto::protocol {
    ...
    // NOLINTNEXTLINE: cppcoreguidelines-avoid-c-arrays
    static const std::pair<ExchangeNodeScope, json>   
    ExchangeNodeScope_enum_table[] = {                // NOLINT: cert-err58-cpp
    ...
    {                                                                                           
        ...
        const auto* it = std::find_if(std::begin(ExchangeNodeScope_enum_table), std::end(ExchangeNodeScope_enum_table),
...
namespace facebook::presto::protocol {
    ...
    void to_json(json& j, const ExchangeNode& p) {
        ...
        to_json_key(j, "inputs", p.inputs, "ExchangeNode", "List<List<VariableReferenceExpression>>", "inputs");
        to_json_key(j, "ensureSourceOrdering", p.ensureSourceOrdering, "ExchangeNode", "bool", "ensureSourceOrdering");
    ...
    void from_json(const json& j, ExchangeNode& p) {
        ...
        from_json_key(j, "inputs", p.inputs, "ExchangeNode", "List<List<VariableReferenceExpression>>", "inputs");
        from_json_key(j, "ensureSourceOrdering", p.ensureSourceOrdering, "ExchangeNode", "bool", "ensureSourceOrdering");
...
namespace facebook::presto::protocol {
    ...
    void to_json(json& j, const RemoteTransactionHandle& p) {
        j = json::object();
        j["@type"] = "$remote";
        to_json_key(j, "dummy", p.dummy, "RemoteTransactionHandle", "String", "dummy");
    }

    void from_json(const json& j, RemoteTransactionHandle& p) {
        p._type = j["@type"];
        from_json_key(j, "dummy", p.dummy, "RemoteTransactionHandle", "String", "dummy");
    }
}
/*
 * Licensed under the Apache License, Version 2.0 (the "License");
...
namespace facebook::presto::protocol {
    ...
    void to_json(json& j, const OutputTableHandle& p) {
        j = json::object();
        to_json_key(j, "connectorId", p.connectorId, "OutputTableHandle", "ConnectorId", "connectorId");
    ...
    void from_json(const json& j, OutputTableHandle& p) {
        from_json_key(j, "connectorId", p.connectorId, "OutputTableHandle", "ConnectorId", "connectorId");
...
namespace facebook::presto::protocol {
    ...
    void to_json(json& j, const CreateHandle& p) {
        j = json::object();
        j["@type"] = "CreateHandle";
        to_json_key(j, "handle", p.handle, "CreateHandle", "OutputTableHandle", "handle");
        to_json_key(j, "schemaTableName", p.schemaTableName, "CreateHandle", "SchemaTableName", "schemaTableName");
    }

    void from_json(const json& j, CreateHandle& p) {
        p._type = j["@type"];
        from_json_key(j, "handle", p.handle, "CreateHandle", "OutputTableHandle", "handle");
        from_json_key(j, "schemaTableName", p.schemaTableName, "CreateHandle", "SchemaTableName", "schemaTableName");
    }
}
namespace facebook::presto::protocol {
    //Loosly copied this here from NLOHMANN_JSON_SERIALIZE_ENUM()
    ...
    // NOLINTNEXTLINE: cppcoreguidelines-avoid-c-arrays
    static const std::pair<Form, json>   
    Form_enum_table[] = {                // NOLINT: cert-err58-cpp
        { Form::IF, "IF" },
    ...
    {                                                                                           
        ...
        const auto* it = std::find_if(std::begin(Form_enum_table), std::end(Form_enum_table),
                               [e](const std::pair<Form, json>& ej_pair) -> bool
        {
            return ej_pair.first == e;
        });
        j = ((it != std::end(Form_enum_table)) ? it : std::begin(Form_enum_table))->second;
    }
    void from_json(const json& j, Form& e)
    {
        ...
        e = ((it != std::end(Form_enum_table)) ? it : std::begin(Form_enum_table))->first;
    }
}
namespace facebook::presto::protocol {
    ...
    void to_json(json& j, const SpecialFormExpression& p) {
        j = json::object();
        j["@type"] = "special";
        to_json_key(j, "sourceLocation", p.sourceLocation, "SpecialFormExpression", "SourceLocation", "sourceLocation");
        to_json_key(j, "form", p.form, "SpecialFormExpression", "Form", "form");
        to_json_key(j, "returnType", p.returnType, "SpecialFormExpression", "Type", "returnType");
        to_json_key(j, "arguments", p.arguments, "SpecialFormExpression", "List<std::shared_ptr<RowExpression>>", "arguments");
    }

    void from_json(const json& j, SpecialFormExpression& p) {
        p._type = j["@type"];
        from_json_key(j, "sourceLocation", p.sourceLocation, "SpecialFormExpression", "SourceLocation", "sourceLocation");
        from_json_key(j, "form", p.form, "SpecialFormExpression", "Form", "form");
        from_json_key(j, "returnType", p.returnType, "SpecialFormExpression", "Type", "returnType");
        from_json_key(j, "arguments", p.arguments, "SpecialFormExpression", "List<std::shared_ptr<RowExpression>>", "arguments");
    }
}
namespace facebook::presto::protocol {
...
namespace facebook::presto::protocol {
    ...
    void to_json(json& j, const ValuesNode& p) {
        j = json::object();
        j["@type"] = ".ValuesNode";
        to_json_key(j, "location", p.location, "ValuesNode", "SourceLocation", "location");
        to_json_key(j, "id", p.id, "ValuesNode", "PlanNodeId", "id");
        to_json_key(j, "outputVariables", p.outputVariables, "ValuesNode", "List<VariableReferenceExpression>", "outputVariables");
        to_json_key(j, "rows", p.rows, "ValuesNode", "List<List<std::shared_ptr<RowExpression>>>", "rows");
        to_json_key(j, "valuesNodeLabel", p.valuesNodeLabel, "ValuesNode", "String", "valuesNodeLabel");
    }

    void from_json(const json& j, ValuesNode& p) {
        p._type = j["@type"];
        from_json_key(j, "location", p.location, "ValuesNode", "SourceLocation", "location");
        from_json_key(j, "id", p.id, "ValuesNode", "PlanNodeId", "id");
        from_json_key(j, "outputVariables", p.outputVariables, "ValuesNode", "List<VariableReferenceExpression>", "outputVariables");
        from_json_key(j, "rows", p.rows, "ValuesNode", "List<List<std::shared_ptr<RowExpression>>>", "rows");
        from_json_key(j, "valuesNodeLabel", p.valuesNodeLabel, "ValuesNode", "String", "valuesNodeLabel");
    }
}
namespace facebook::presto::protocol {
...
namespace facebook::presto::protocol {
    ...
    void to_json(json& j, const Function& p) {
        j = json::object();
        to_json_key(j, "functionCall", p.functionCall, "Function", "CallExpression", "functionCall");
        to_json_key(j, "frame", p.frame, "Function", "Frame", "frame");
        to_json_key(j, "ignoreNulls", p.ignoreNulls, "Function", "bool", "ignoreNulls");
    }

    void from_json(const json& j, Function& p) {
        from_json_key(j, "functionCall", p.functionCall, "Function", "CallExpression", "functionCall");
        from_json_key(j, "frame", p.frame, "Function", "Frame", "frame");
        from_json_key(j, "ignoreNulls", p.ignoreNulls, "Function", "bool", "ignoreNulls");
    }
}
namespace facebook::presto::protocol {
    ...
    void to_json(json& j, const WindowNode& p) {
        ...
        to_json_key(j, "sourceLocation", p.sourceLocation, "WindowNode", "SourceLocation", "sourceLocation");
        to_json_key(j, "id", p.id, "WindowNode", "PlanNodeId", "id");
        to_json_key(j, "source", p.source, "WindowNode", "PlanNode", "source");
        to_json_key(j, "specification", p.specification, "WindowNode", "Specification", "specification");
        to_json_key(j, "windowFunctions", p.windowFunctions, "WindowNode", "Map<VariableReferenceExpression, Function>", "windowFunctions");
        to_json_key(j, "hashVariable", p.hashVariable, "WindowNode", "VariableReferenceExpression", "hashVariable");
        to_json_key(j, "prePartitionedInputs", p.prePartitionedInputs, "WindowNode", "List<VariableReferenceExpression>", "prePartitionedInputs");
        to_json_key(j, "preSortedOrderPrefix", p.preSortedOrderPrefix, "WindowNode", "int", "preSortedOrderPrefix");
    }

    void from_json(const json& j, WindowNode& p) {
        p._type = j["@type"];
        from_json_key(j, "sourceLocation", p.sourceLocation, "WindowNode", "SourceLocation", "sourceLocation");
        from_json_key(j, "id", p.id, "WindowNode", "PlanNodeId", "id");
        from_json_key(j, "source", p.source, "WindowNode", "PlanNode", "source");
        from_json_key(j, "specification", p.specification, "WindowNode", "Specification", "specification");
        from_json_key(j, "windowFunctions", p.windowFunctions, "WindowNode", "Map<VariableReferenceExpression, Function>", "windowFunctions");
        from_json_key(j, "hashVariable", p.hashVariable, "WindowNode", "VariableReferenceExpression", "hashVariable");
        from_json_key(j, "prePartitionedInputs", p.prePartitionedInputs, "WindowNode", "List<VariableReferenceExpression>", "prePartitionedInputs");
        from_json_key(j, "preSortedOrderPrefix", p.preSortedOrderPrefix, "WindowNode", "int", "preSortedOrderPrefix");
    }
}
namespace facebook::presto::protocol {
    ...
    void to_json(json& j, const OutputNode& p) {
        ...
        to_json_key(j, "columnNames", p.columnNames, "OutputNode", "List<String>", "columnNames");
        to_json_key(j, "outputVariables", p.outputVariables, "OutputNode", "List<VariableReferenceExpression>", "outputVariables");
    }
    ...
    void from_json(const json& j, OutputNode& p) {
        ...
        from_json_key(j, "columnNames", p.columnNames, "OutputNode", "List<String>", "columnNames");
        from_json_key(j, "outputVariables", p.outputVariables, "OutputNode", "List<VariableReferenceExpression>", "outputVariables");
    }
}
namespace facebook::presto::protocol {
    ...
    void to_json(json& j, const GroupIdNode& p) {
        ...
        to_json_key(j, "groupingSets", p.groupingSets, "GroupIdNode", "List<List<VariableReferenceExpression>>", "groupingSets");
        to_json_key(j, "groupingColumns", p.groupingColumns, "GroupIdNode", "Map<VariableReferenceExpression, VariableReferenceExpression>", "groupingColumns");
        to_json_key(j, "aggregationArguments", p.aggregationArguments, "GroupIdNode", "List<VariableReferenceExpression>", "aggregationArguments");
    ...
    void from_json(const json& j, GroupIdNode& p) {
        ...
        from_json_key(j, "groupingSets", p.groupingSets, "GroupIdNode", "List<List<VariableReferenceExpression>>", "groupingSets");
        from_json_key(j, "groupingColumns", p.groupingColumns, "GroupIdNode", "Map<VariableReferenceExpression, VariableReferenceExpression>", "groupingColumns");
        from_json_key(j, "aggregationArguments", p.aggregationArguments, "GroupIdNode", "List<VariableReferenceExpression>", "aggregationArguments");
...
namespace facebook::presto::protocol {
    ...
    void to_json(json& j, const RemoteSplit& p) {
        ...
        to_json_key(j, "remoteSourceTaskId", p.remoteSourceTaskId, "RemoteSplit", "TaskId", "remoteSourceTaskId");
    }

    void from_json(const json& j, RemoteSplit& p) {
        p._type = j["@type"];
        from_json_key(j, "location", p.location, "RemoteSplit", "Location", "location");
        from_json_key(j, "remoteSourceTaskId", p.remoteSourceTaskId, "RemoteSplit", "TaskId", "remoteSourceTaskId");
    }
}
namespace facebook::presto::protocol {
    ...
    void to_json(json& j, const TopNRowNumberNode& p) {
        ...
        to_json_key(j, "specification", p.specification, "TopNRowNumberNode", "Specification", "specification");
        to_json_key(j, "rowNumberVariable", p.rowNumberVariable, "TopNRowNumberNode", "VariableReferenceExpression", "rowNumberVariable");
        to_json_key(j, "maxRowCountPerPartition", p.maxRowCountPerPartition, "TopNRowNumberNode", "int", "maxRowCountPerPartition");
        to_json_key(j, "partial", p.partial, "TopNRowNumberNode", "bool", "partial");
        to_json_key(j, "hashVariable", p.hashVariable, "TopNRowNumberNode", "VariableReferenceExpression", "hashVariable");
    }

    void from_json(const json& j, TopNRowNumberNode& p) {
        p._type = j["@type"];
        from_json_key(j, "id", p.id, "TopNRowNumberNode", "PlanNodeId", "id");
        from_json_key(j, "source", p.source, "TopNRowNumberNode", "PlanNode", "source");
        from_json_key(j, "specification", p.specification, "TopNRowNumberNode", "Specification", "specification");
        from_json_key(j, "rowNumberVariable", p.rowNumberVariable, "TopNRowNumberNode", "VariableReferenceExpression", "rowNumberVariable");
        from_json_key(j, "maxRowCountPerPartition", p.maxRowCountPerPartition, "TopNRowNumberNode", "int", "maxRowCountPerPartition");
        from_json_key(j, "partial", p.partial, "TopNRowNumberNode", "bool", "partial");
        from_json_key(j, "hashVariable", p.hashVariable, "TopNRowNumberNode", "VariableReferenceExpression", "hashVariable");
    }
}
namespace facebook::presto::protocol {
    ...
    void to_json(json& j, const SemiJoinNode& p) {
        ...
        to_json_key(j, "filteringSource", p.filteringSource, "SemiJoinNode", "PlanNode", "filteringSource");
        to_json_key(j, "sourceJoinVariable", p.sourceJoinVariable, "SemiJoinNode", "VariableReferenceExpression", "sourceJoinVariable");
        to_json_key(j, "filteringSourceJoinVariable", p.filteringSourceJoinVariable, "SemiJoinNode", "VariableReferenceExpression", "filteringSourceJoinVariable");
        to_json_key(j, "semiJoinOutput", p.semiJoinOutput, "SemiJoinNode", "VariableReferenceExpression", "semiJoinOutput");
        to_json_key(j, "sourceHashVariable", p.sourceHashVariable, "SemiJoinNode", "VariableReferenceExpression", "sourceHashVariable");
        to_json_key(j, "filteringSourceHashVariable", p.filteringSourceHashVariable, "SemiJoinNode", "VariableReferenceExpression", "filteringSourceHashVariable");
        to_json_key(j, "distributionType", p.distributionType, "SemiJoinNode", "DistributionType", "distributionType");
        to_json_key(j, "dynamicFilters", p.dynamicFilters, "SemiJoinNode", "Map<String, VariableReferenceExpression>", "dynamicFilters");
    }
    ...
    void from_json(const json& j, SemiJoinNode& p) {
        ...
        from_json_key(j, "filteringSource", p.filteringSource, "SemiJoinNode", "PlanNode", "filteringSource");
        from_json_key(j, "sourceJoinVariable", p.sourceJoinVariable, "SemiJoinNode", "VariableReferenceExpression", "sourceJoinVariable");
        from_json_key(j, "filteringSourceJoinVariable", p.filteringSourceJoinVariable, "SemiJoinNode", "VariableReferenceExpression", "filteringSourceJoinVariable");
        from_json_key(j, "semiJoinOutput", p.semiJoinOutput, "SemiJoinNode", "VariableReferenceExpression", "semiJoinOutput");
        from_json_key(j, "sourceHashVariable", p.sourceHashVariable, "SemiJoinNode", "VariableReferenceExpression", "sourceHashVariable");
        from_json_key(j, "filteringSourceHashVariable", p.filteringSourceHashVariable, "SemiJoinNode", "VariableReferenceExpression", "filteringSourceHashVariable");
        from_json_key(j, "distributionType", p.distributionType, "SemiJoinNode", "DistributionType", "distributionType");
        from_json_key(j, "dynamicFilters", p.dynamicFilters, "SemiJoinNode", "Map<String, VariableReferenceExpression>", "dynamicFilters");
    }
}
namespace facebook::presto::protocol {
    ...
    void to_json(json& j, const RemoteSourceNode& p) {
        ...
        to_json_key(j, "outputVariables", p.outputVariables, "RemoteSourceNode", "List<VariableReferenceExpression>", "outputVariables");
        to_json_key(j, "ensureSourceOrdering", p.ensureSourceOrdering, "RemoteSourceNode", "bool", "ensureSourceOrdering");
    ...
    void from_json(const json& j, RemoteSourceNode& p) {
        ...
        from_json_key(j, "outputVariables", p.outputVariables, "RemoteSourceNode", "List<VariableReferenceExpression>", "outputVariables");
        from_json_key(j, "ensureSourceOrdering", p.ensureSourceOrdering, "RemoteSourceNode", "bool", "ensureSourceOrdering");
...
namespace facebook::presto::protocol {
    ...
    void to_json(json& j, const HivePartitioningHandle& p) {
        ...
        to_json_key(j, "bucketFunctionType", p.bucketFunctionType, "HivePartitioningHandle", "BucketFunctionType", "bucketFunctionType");
        to_json_key(j, "hiveTypes", p.hiveTypes, "HivePartitioningHandle", "List<HiveType>", "hiveTypes");
        to_json_key(j, "types", p.types, "HivePartitioningHandle", "List<Type>", "types");
    }
    ...
    void from_json(const json& j, HivePartitioningHandle& p) {
        ...
        from_json_key(j, "bucketFunctionType", p.bucketFunctionType, "HivePartitioningHandle", "BucketFunctionType", "bucketFunctionType");
        from_json_key(j, "hiveTypes", p.hiveTypes, "HivePartitioningHandle", "List<HiveType>", "hiveTypes");
        from_json_key(j, "types", p.types, "HivePartitioningHandle", "List<Type>", "types");
    }
}
namespace facebook::presto::protocol {
    ...
    void to_json(json& j, const BuiltInFunctionHandle& p) {
        j = json::object();
        j["@type"] = "$static";
        to_json_key(j, "signature", p.signature, "BuiltInFunctionHandle", "Signature", "signature");
    }

    void from_json(const json& j, BuiltInFunctionHandle& p) {
        p._type = j["@type"];
        from_json_key(j, "signature", p.signature, "BuiltInFunctionHandle", "Signature", "signature");
    }
}
namespace facebook::presto::protocol {
    //Loosly copied this here from NLOHMANN_JSON_SERIALIZE_ENUM()
    ...
    // NOLINTNEXTLINE: cppcoreguidelines-avoid-c-arrays
    static const std::pair<NodeState, json>   
    NodeState_enum_table[] = {                // NOLINT: cert-err58-cpp
    ...
    {                                                                                           
        ...
        const auto* it = std::find_if(std::begin(NodeState_enum_table), std::end(NodeState_enum_table),
