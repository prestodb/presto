...
struct OperatorStats {
  ...
  int64_t isBlockedWallInNanos = {};
  int64_t isBlockedCpuInNanos = {};
  int64_t isBlockedAllocationInBytes = {};
  int64_t addInputCalls = {};
  int64_t addInputWallInNanos = {};
  int64_t addInputCpuInNanos = {};
  ...
  int64_t getOutputWallInNanos = {};
  int64_t getOutputCpuInNanos = {};
  ...
  int64_t additionalCpuInNanos = {};
  int64_t blockedWallInNanos = {};
  int64_t finishCalls = {};
  int64_t finishWallInNanos = {};
  int64_t finishCpuInNanos = {};
...
struct DriverStats {
  ...
  int64_t rawInputDataSizeInBytes = {};
  int64_t rawInputPositions = {};
  int64_t rawInputReadTimeInNanos = {};
