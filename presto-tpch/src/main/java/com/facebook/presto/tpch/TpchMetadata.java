...
{
    public static final int TPCH_MAX_BEFORE_DOT_DIGITS = 6;
    ...
    private static ConnectorTableMetadata getTableMetadata(String schemaName, TpchTable<?> tpchTable, TypeSignature numericTypeSignature)
    {
        ...
        for (TpchColumn<? extends TpchEntity> column : tpchTable.getColumns()) {
            columns.add(new ColumnMetadata(column.getColumnName(), getPrestoType(column.getType(), numericTypeSignature)));
        }
