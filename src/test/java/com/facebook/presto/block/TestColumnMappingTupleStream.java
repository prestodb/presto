...
public class TestColumnMappingTupleStream
{
    ...
    private UncompressedTupleStream baseTupleStream;

    @BeforeMethod(alwaysRun = true)
    public void setUp() throws Exception
    {
        tupleInfo = new TupleInfo(DOUBLE, FIXED_INT_64, VARIABLE_BINARY);
        baseTupleStream = new UncompressedTupleStream(tupleInfo,
    ...
    public void testMultiColumnExtraction() throws Exception
    {
        ...
        UncompressedTupleStream expectedTupleStream = new UncompressedTupleStream(expectedTupleInfo,
                new BlockBuilder(0, expectedTupleInfo)
