...
public class UncompressedBlockSerdeTest
{
    @Test
            ...
            throws Exception
    {
        ...
        ImmutableList<ValueBlock> inputBlocks = ImmutableList.of(block);
        UncompressedBlockSerde.write(inputBlocks.iterator(), out);
