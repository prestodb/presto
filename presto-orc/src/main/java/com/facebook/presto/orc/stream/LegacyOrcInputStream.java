...
public final class LegacyOrcInputStream
        extends OrcInputStream
{
            ...
            long sliceInputRetainedSizeInBytes)
    {
        ...
        this.bufferMemoryUsage = systemMemoryContext.newLocalMemoryContext(LegacyOrcInputStream.class.getSimpleName());
        checkArgument(sliceInputRetainedSizeInBytes >= 0, "sliceInputRetainedSizeInBytes is negative");
        systemMemoryContext.newLocalMemoryContext(LegacyOrcInputStream.class.getSimpleName()).setBytes(sliceInputRetainedSizeInBytes);
