...
public class OrcWriteValidation
{
    ...
    public class StatisticsValidation
    {
        ...
        public List<ColumnStatistics> build()
        {
            ...
            if (rowCount > 0) {
                statisticsBuilders.add(ColumnStatistics.createColumnStatistics(rowCount, 0, null, null, null, null, null, null, null, null));
            ...
            implements StatisticsBuilder
    {
        ...
        {
            return ColumnStatistics.createColumnStatistics(rowCount, 0, null, null, null, null, null, null, null, null);
        }
    }
