        ...
        implements StreamReader
{
            ...
            throws IOException
    {
        ...
        for (int keyIndex = 0; keyIndex < valueStreamReaders.size(); keyIndex++) {
            ...
            for (int mapIndex = 0; mapIndex < nextBatchSize; mapIndex++) {
                mapsContainingKey += inMapVectors[keyIndex] == null || inMapVectors[keyIndex][mapIndex] ? 1 : 0;
            }
        ...
        // Tracks how many maps each key has been present in so far
        ...
        for (int mapIndex = 0; mapIndex < nextBatchSize; mapIndex++) {
            // Tracks how many keys are present in the current map
            int mapLength = 0;
            ...
            throws IOException
    {
        ...
        inMapVectors = new boolean[inMapStreamSources.size()][];
        readOffset = 0;
        nextBatchSize = 0;
