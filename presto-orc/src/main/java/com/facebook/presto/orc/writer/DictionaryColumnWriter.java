        ...
        implements ColumnWriter, DictionaryColumn
{
            ...
            throws IOException
    {
        ...
        for (int i = 0; i < rowGroups.size(); i++) {
            ...
            List<Integer> positions = createSliceColumnPositionList(columnWriterOptions.getCompressionKind() != NONE, dataCheckpoint, presentCheckpoint, dwrfFlatMapCheckpoint);
