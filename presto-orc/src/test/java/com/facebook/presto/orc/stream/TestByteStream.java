        ...
        extends AbstractTestValueStream<Byte, ByteStreamCheckpoint, ByteOutputStream, ByteInputStream>
{
    ...
    @Override
    protected ByteOutputStream createValueOutputStream(CompressionKind compressionKind)
    {
        return new ByteOutputStream(compressionKind, COMPRESSION_BLOCK_SIZE);
    }
    ...
    @Override
    protected ByteInputStream createValueStream(Slice slice, boolean orcOptimizedReaderEnabled, CompressionKind compressionKind)
            throws OrcCorruptionException
    {
        ...
        return new ByteInputStream(createOrcInputStream(ORC_DATA_SOURCE_ID, slice.getInput(), orcDecompressor, newSimpleAggregatedMemoryContext(), slice.getRetainedSize(), orcOptimizedReaderEnabled));
    }
