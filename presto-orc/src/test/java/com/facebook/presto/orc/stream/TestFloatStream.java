        ...
        extends AbstractTestValueStream<Float, FloatStreamCheckpoint, FloatOutputStream, FloatInputStream>
{
    ...
    @Override
    protected FloatOutputStream createValueOutputStream(CompressionKind compressionKind)
    {
        return new FloatOutputStream(compressionKind, COMPRESSION_BLOCK_SIZE);
    }
    ...
    @Override
    protected FloatInputStream createValueStream(Slice slice, boolean orcOptimizedReaderEnabled, CompressionKind compressionKind)
            throws OrcCorruptionException
    {
        ...
        return new FloatInputStream(createOrcInputStream(ORC_DATA_SOURCE_ID, slice.getInput(), orcDecompressor, newSimpleAggregatedMemoryContext(), slice.getRetainedSize(), orcOptimizedReaderEnabled));
    }
