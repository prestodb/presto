...
public class TestLongDecode
{
            ...
            throws IOException
    {
        ...
        long readValueNew = readVInt(signed, new LegacyOrcInputStream(new OrcDataSourceId("test"), hiveBytes.getInput(), Optional.empty(), newSimpleAggregatedMemoryContext(), hiveBytes.getRetainedSize()));
