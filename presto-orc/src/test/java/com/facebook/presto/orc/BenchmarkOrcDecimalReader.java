...
public class BenchmarkOrcDecimalReader
{
    ...
    public static class BenchmarkData
    {
                ...
                throws Exception
        {
            ...
            writeOrcColumn(dataPath, ORC_12, NONE, javaHiveDecimalObjectInspector, crateDecimalValues().iterator());
        }
        ...
        private List<SqlDecimal> crateDecimalValues()
        {
            List<SqlDecimal> values = new ArrayList<>();
            for (int i = 0; i < 500000; ++i) {
                values.add(new SqlDecimal(BigInteger.valueOf(i), 10, 5));
                values.add(new SqlDecimal(BigInteger.valueOf(-i), 10, 5));
            }
            return values;
        }
