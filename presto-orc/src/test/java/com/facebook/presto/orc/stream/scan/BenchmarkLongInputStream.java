...
import com.facebook.presto.orc.stream.scan.AbstractTestLongStreamScan.PositionsType;
import com.facebook.presto.orc.stream.scan.AbstractTestLongStreamScan.TestResultsConsumer;
...
import static com.facebook.presto.orc.stream.scan.AbstractTestLongStream.COMPRESSION_BLOCK_SIZE;
import static com.facebook.presto.orc.stream.scan.AbstractTestLongStreamScan.getAllPositions;
...
public class BenchmarkLongInputStream
{
    ...
    public static class BenchmarkData
    {
        ...
        public void setup()
                throws IOException
        {
            inputStream = createValueStream(CompressionKind.valueOf(compressionKind), Encoding.valueOf(encoding), isBufferBacked);
        }
    }
    ...
    private static LongInputStream createValueStream(CompressionKind kind, Encoding encoding, boolean isBufferBacked)
            throws IOException
    {
