        ...
        extends AbstractTestValueStream<Long, LongStreamCheckpoint, LongOutputStreamDwrf, LongInputStreamDwrf>
{
            ...
            throws OrcCorruptionException
    {
        ...
        return new LongInputStreamDwrf(new OrcInputStream(ORC_DATA_SOURCE_ID, slice.getInput(), orcDecompressor, new AggregatedMemoryContext().localContextSupplier()), LONG, true, true);
    }
