        ...
        extends AbstractTestValueStream<Long, LongStreamCheckpoint, LongOutputStreamDwrf, LongInputStreamDwrf>
{
    ...
    {
        return new LongOutputStreamDwrf(LZ4, COMPRESSION_BLOCK_SIZE, true, DATA);
    }
    ...
    {
        Optional<OrcDecompressor> orcDecompressor = createOrcDecompressor(ORC_DATA_SOURCE_ID, LZ4, COMPRESSION_BLOCK_SIZE);
