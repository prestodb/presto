...
public class TestOrcBloomFilters
{
            ...
            throws Exception
    {
        ...
        assertTrue(checkInBloomFilter(bloomFilter, new Date(), TIMESTAMP), "unsupported type Date should always return true");
    }
            ...
            throws Exception
    {
        ...
        assertTrue(checkInBloomFilter(bloomFilter, new Date(), null), "unsupported type Date should always return true");
    }
            ...
            throws Exception
    {
        ...
        for (Map.Entry<Type, Object> testValue : testValues.entrySet()) {
            ...
            Collection<Object> objects = TupleDomainOrcPredicate.extractDiscreteValues(predicateDomain.getValues()).get();
            ...
            throws Exception
    {
        ...
        TupleDomain<String> effectivePredicate = TupleDomain.fromColumnDomains(Optional.<List<TupleDomain.ColumnDomain<String>>>of(ImmutableList.of(column0)));
        TupleDomain<String> emptyEffectivePredicate = TupleDomain.fromColumnDomains(Optional.<List<TupleDomain.ColumnDomain<String>>>of(ImmutableList.of()));
