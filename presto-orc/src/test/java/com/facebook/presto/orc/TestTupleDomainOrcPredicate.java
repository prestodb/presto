...
public class TestTupleDomainOrcPredicate
{
    ...
    private static ColumnStatistics booleanColumnStats(Long numberOfValues, Long trueValueCount)
    {
        ...
        return ColumnStatistics.createColumnStatistics(numberOfValues, 2L, booleanStatistics, null, null, null, null, null, null, null);
    }
    ...
    {
        return ColumnStatistics.createColumnStatistics(numberOfValues, 9L, null, new IntegerStatistics(minimum, maximum, null), null, null, null, null, null, null);
    }
    ...
    {
        return ColumnStatistics.createColumnStatistics(numberOfValues, 9L, null, null, new DoubleStatistics(minimum, maximum), null, null, null, null, null);
    }
    ...
    private static ColumnStatistics stringColumnStats(Long numberOfValues, String minimum, String maximum)
    {
        ...
        return ColumnStatistics.createColumnStatistics(numberOfValues, 10L, null, null, null, new StringStatistics(minimumSlice, maximumSlice, 100L), null, null, null, null);
    }
    ...
    {
        return ColumnStatistics.createColumnStatistics(numberOfValues, 5L, null, null, null, null, new DateStatistics(minimum, maximum), null, null, null);
    }
    ...
    private static ColumnStatistics decimalColumnStats(Long numberOfValues, String minimum, String maximum)
    {
        ...
        return ColumnStatistics.createColumnStatistics(numberOfValues, 9L, null, null, null, null, null, new DecimalStatistics(minimumDecimal, maximumDecimal, SHORT_DECIMAL_VALUE_BYTES), null, null);
    }
    ...
    {
        // sum and minAverageValueSizeInBytes are not used in this test; they could be arbitrary numbers
        return ColumnStatistics.createColumnStatistics(numberOfValues, 10L, null, null, null, null, null, null, new BinaryStatistics(100L), null);
    }
