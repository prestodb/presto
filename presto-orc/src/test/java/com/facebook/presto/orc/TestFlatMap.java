...
public class TestFlatMap
{
    ...
    public void testTimestamp()
            throws Exception
    {
        runTest("test_flat_map/flat_map_timestamp.dwrf",
                IntegerType.INTEGER,
                TimestampType.TIMESTAMP,
                ExpectedValuesBuilder.get(Function.identity(), TestFlatMap::intToTimestamp));
    }

    @Test
    public void testTimestampWithNull()
            throws Exception
    {
        runTest("test_flat_map/flat_map_timestamp_with_null.dwrf",
                IntegerType.INTEGER,
                TimestampType.TIMESTAMP,
                ExpectedValuesBuilder.get(Function.identity(), TestFlatMap::intToTimestamp).setNullValuesFrequency(SOME));
    }
