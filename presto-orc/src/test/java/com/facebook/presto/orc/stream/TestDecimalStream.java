...
public class TestDecimalStream
{
    ...
    {
        return new LegacyOrcInputStream(new OrcDataSourceId(source), new BasicSliceInput(Slices.wrappedBuffer(bytes)), Optional.empty(), newSimpleAggregatedMemoryContext(), bytes.length);
    }
