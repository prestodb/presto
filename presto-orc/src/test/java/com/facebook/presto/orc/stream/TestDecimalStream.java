...
public class TestDecimalStream
{
    ...
    {
        return new OrcInputStream(new OrcDataSourceId(source), new BasicSliceInput(Slices.wrappedBuffer(bytes)), Optional.empty(), new AggregatedMemoryContext().localContextSupplier());
    }
