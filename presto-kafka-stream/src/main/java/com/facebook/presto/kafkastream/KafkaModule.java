        ...
        implements Module
{
    ...
    public KafkaModule(String connectorId, TypeManager typeManager)
    {
    ...
    public void configure(Binder binder)
    {
        ...
        binder.bind(KafkaMetadataClient.class).in(Scopes.SINGLETON);
        binder.bind(KafkaSplitManager.class).in(Scopes.SINGLETON);
        binder.bind(KafkaKStreamConsumerManager.class).in(Scopes.SINGLETON);
        binder.bind(KafkaRecordSetProvider.class).in(Scopes.SINGLETON);
        binder.bind(KafkaIndexProvider.class).in(Scopes.SINGLETON);
        configBinder(binder).bindConfig(KafkaConfig.class);

        jsonBinder(binder).addDeserializerBinding(Type.class).to(TypeDeserializer.class);
        jsonCodecBinder(binder).bindMapJsonCodec(String.class, KafkaConfigBean.class);
    }
