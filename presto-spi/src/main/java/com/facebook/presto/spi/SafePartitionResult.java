 ...
 */
public class SafePartitionResult<CH extends ConnectorColumnHandle, P extends ConnectorPartition>
{
    private final List<P> partitions;
    private final TupleDomain<CH> undeterminedTupleDomain;

    public SafePartitionResult(List<P> partitions, TupleDomain<CH> undeterminedTupleDomain)
    {
        this.partitions = requireNonNull(partitions, "partitions is null");
        this.undeterminedTupleDomain = requireNonNull(undeterminedTupleDomain, "undeterminedTupleDomain is null");
    }

    public List<P> getPartitions()
    {
        return partitions;
    }

    public TupleDomain<CH> getUndeterminedTupleDomain()
    {
