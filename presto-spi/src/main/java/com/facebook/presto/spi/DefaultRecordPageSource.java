...
public class DefaultRecordPageSource
        implements RecordPageSource
{
    ...
    public DefaultRecordPageSource(RecordSet recordSet)
    {
        this(requireNonNull(recordSet, "recordSet is null").getColumnTypes(), recordSet.cursor());
    }

            public DefaultRecordPageSource(List<Type> types, RecordCursor cursor)
    {
