        ...
        implements ThriftSerializable
{
    ...
    public TableHandle(ThriftTableHandle thriftTableHandle)
    {
        this(new ConnectorId(thriftTableHandle.getConnectorId()),
                ...
                thriftTableHandle.getLayout().map(handle -> (ConnectorTableLayoutHandle) ConnectorTableLayoutHandleAdapter.fromThrift(handle)));
    }
    ...
    public ThriftTableHandle toThrift()
    {
        ...
        layout.map(handle -> (ThriftConnectorTableLayoutHandle) handle.toThriftInterface()).ifPresent(thriftTableHandle::setLayout);
