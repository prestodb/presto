...
public class SslContextProvider
{
    ...
    private SSLContext createSSLContext() throws GeneralSecurityException, IOException
    {
        ...
        // Load TrustStore if configured, otherwise use system default (null)
        ...
        if (truststorePath.isPresent()) {
            ...
            log.debug("No custom truststore configured, using system default");
        }
    ...
    private X509TrustManager createTrustManager(KeyStore truststore) throws GeneralSecurityException
    {
        ...
        // If no custom truststore is provided, use system default (pass null)
        // If a custom truststore is provided but empty, that's an error
        if (truststore != null) {
            try {
