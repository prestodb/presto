        ...
        extends PlanNode
{
    ...
    public abstract static class WriterTarget
    {
        ...
        public abstract Optional<List<OutputColumn>> getOutputColumns();
            ...
            extends WriterTarget
    {
        ...
        public CreateName(ConnectorId connectorId, ConnectorTableMetadata tableMetadata, Optional<NewTableLayout> layout, Optional<List<OutputColumn>> columns)
        {
            ...
            extends WriterTarget
    {
        ...
        public InsertReference(TableHandle handle, SchemaTableName schemaTableName, Optional<List<OutputColumn>> columns)
        {
