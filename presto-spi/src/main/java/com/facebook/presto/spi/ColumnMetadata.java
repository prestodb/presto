...
public class ColumnMetadata
{
    ...
    private final DerivedColumnSpec derivedColumnSpec;
    ...
    protected ColumnMetadata(Builder builder)
    {
        this(builder.name,
                ...
                builder.hidden,
                builder.properties,
                builder.derivedColumnSpec.orElse(null));
    }
    ...
    {
        return Optional.ofNullable(derivedColumnSpec);
    }
    ...
    public static class Builder
    {
        ...
        public Builder setDerivedColumnSpec(DerivedColumnSpec derivedColumnSpec)
        {
            this.derivedColumnSpec = Optional.ofNullable(derivedColumnSpec);
            return this;
        }
