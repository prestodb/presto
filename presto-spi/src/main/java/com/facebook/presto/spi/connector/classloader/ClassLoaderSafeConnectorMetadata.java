        ...
        implements ConnectorMetadata
{
    ...
    @Override
    public Map<NestedField, ColumnHandle> getNestedColumnHandles(ConnectorSession session, ConnectorTableHandle tableHandle, Collection<NestedField> nestedField)
    {
        try (ThreadContextClassLoader ignored = new ThreadContextClassLoader(classLoader)) {
            return delegate.getNestedColumnHandles(session, tableHandle, nestedField);
        }
    }
