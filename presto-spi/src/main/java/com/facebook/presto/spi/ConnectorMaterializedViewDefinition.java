...
public final class ConnectorMaterializedViewDefinition
{
    ...
    @JsonIgnore
    private Optional<Map<TableColumn, TableColumn>> viewToBaseColumnMap;
    ...
    @JsonIgnore
    public Optional<Map<TableColumn, TableColumn>> getViewToBaseColumnMap()
    {
        return viewToBaseColumnMap;
    }

    @JsonIgnore
    public void setViewToBaseColumnMap(Map<TableColumn, TableColumn> viewToBaseColumnMap)
    {
        this.viewToBaseColumnMap = Optional.of(requireNonNull(viewToBaseColumnMap, "viewToBaseColumnMap is null"));
    }
    ...
    public static final class TableColumn
    {
        ...
        @JsonIgnore
        public TableColumn(SchemaTableName table, ColumnMetadata columnMetadata)
        {
            this.table = requireNonNull(table, "table is null");
            this.columnMetadata = requireNonNull(columnMetadata, "column is null");
        }
        ...
        public boolean equals(Object obj)
        {
            ...
            return Objects.equals(this.table, other.table) &&
                    Objects.equals(this.columnMetadata, other.columnMetadata);
        }
    }
}
