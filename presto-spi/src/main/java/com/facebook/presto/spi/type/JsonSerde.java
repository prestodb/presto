...
public class JsonSerde
{
    ...
    public static boolean isValidJsonObjectKeyType(Type type)
    {
        return isValidJsonObjectKeyType(type.getTypeSignature());
    }

    public static boolean isValidJsonObjectKeyType(TypeSignature typeSignature)
    {
