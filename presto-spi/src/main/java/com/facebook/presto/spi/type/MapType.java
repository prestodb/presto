        ...
        extends AbstractType
{
    ...
    {
        Block leftMapBlock = leftBlock.getObject(leftPosition);
        Block rightMapBlock = rightBlock.getObject(rightPosition);
    ...
    public Object getObjectValue(ConnectorSession session, Block block, int position)
    {
        ...
        Block singleMapBlock = block.getObject(position);
