...
public class ExtractRowExpression
        extends IntermediateFormRowExpression
{
    private final Function function;
    private final Integer precision;

    public ExtractRowExpression(Optional<SourceLocation> sourceLocation, Function function, Integer precision)
    {
    ...
    public boolean equals(Object other)
    {
        ...
        ExtractRowExpression obj = (ExtractRowExpression) other;
