...
public class SelectedRole
{
    ...
    {
        this(Type.createType(thriftSelectedRole.getType()), thriftSelectedRole.getRole());
    }

    public ThriftSelectedRole toThrift()
    {
        ThriftSelectedRole role = new ThriftSelectedRole(this.getType().toThrift());
        this.role.ifPresent(role::setRole);
        return role;
    }
