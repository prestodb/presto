...
public final class SelectionCriteria
{
    ...
    private final Optional<ZonedDateTime> querySessionStartTime;
    ...
    public SelectionCriteria(
            ...
            Optional<ZonedDateTime> querySessionStartTime,
    ...
    public Optional<ZonedDateTime> getQuerySessionStartTime()
    {
