...
public interface SafeSplitManager<TH extends ConnectorTableHandle, CH extends ConnectorColumnHandle, S extends ConnectorSplit, P extends ConnectorPartition>
{
    /**
     ...
     */
    SafePartitionResult<CH, P> getPartitions(TH table, TupleDomain<CH> tupleDomain);

    /**
     * Gets the Splits for the specified Partitions in the indicated table.
     */
    SafeSplitSource<S> getPartitionSplits(TH table, List<P> partitions);
}
