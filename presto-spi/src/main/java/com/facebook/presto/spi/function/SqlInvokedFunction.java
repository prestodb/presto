        ...
        implements SqlFunction
{
    ...
    private final SqlFunctionVisibility functionVisibility;
    ...
    public SqlInvokedFunction(
            ...
            @JsonProperty("functionVisibility") SqlFunctionVisibility functionVisibility,
    ...
    {
        this(functionName, parameters, emptyList(), returnType, description, routineCharacteristics, body, PUBLIC, false, version, SCALAR, Optional.empty());
    }
    ...
    {
        this(functionName, parameters, emptyList(), returnType, description, routineCharacteristics, body, PUBLIC, false, version, kind, aggregationMetadata);
    }
            ...
            Optional<AggregationFunctionMetadata> aggregationMetadata)
    {
        ...
        this.signature = new Signature(functionName, kind, typeVariableConstraints, emptyList(), returnType, argumentTypes, variableArity);
    ...
    public boolean hasSameDefinitionAs(SqlInvokedFunction function)
    {
        ...
        return Objects.equals(parameters, function.parameters)
                ...
                && Objects.equals(functionVisibility, function.functionVisibility)
    ...
    public boolean equals(Object obj)
    {
        ...
        return Objects.equals(parameters, o.parameters)
                ...
                && Objects.equals(functionVisibility, o.functionVisibility)
    ...
    public int hashCode()
    {
        return Objects.hash(parameters, description, routineCharacteristics, body, functionVisibility, variableArity, signature, functionId, functionHandle);
    }
