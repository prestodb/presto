        ...
        implements SqlFunction
{
    ...
    public SqlInvokedFunction(ThriftSqlInvokedFunction thriftFunction)
    {
        this(new Signature(thriftFunction.getSignature()).getName(),
                ...
                thriftFunction.getAggregationMetadata().map(AggregationFunctionMetadata::new),
                thriftFunction.getFunctionHandle().map(SqlFunctionHandle::new));
    }
    ...
    public ThriftSqlInvokedFunction toThrift()
    {
        ...
        this.functionHandle.map(SqlFunctionHandle::toThrift).ifPresent(thriftSqlInvokedFunction::setFunctionHandle);
        this.aggregationMetadata.map(AggregationFunctionMetadata::toThrift).ifPresent(thriftSqlInvokedFunction::setAggregationMetadata);
