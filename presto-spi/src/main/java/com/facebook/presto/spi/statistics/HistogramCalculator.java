...
public class HistogramCalculator
{
    ...
    {
        boolean openHigh = !range.isLowInclusive();
        boolean openLow = !range.isHighInclusive();
    ...
    private static boolean fuzzyEquals(double a, double b, double eps)
    {
        return Math.copySign(a - b, 1.0) <= eps
