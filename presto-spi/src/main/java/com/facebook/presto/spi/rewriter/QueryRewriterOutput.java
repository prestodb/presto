...
public class QueryRewriterOutput
{
    ...
    private QueryRewriterOutput(String queryId, String originalQuery, String rewrittenQuery, Map<String, String> sessionProperties)
    {
    ...
    public static class Builder
    {
        ...
        public QueryRewriterOutput build()
        {
            ...
            return new QueryRewriterOutput(queryId, originalQuery, rewrittenQuery, sessionProperties);
        }
    }
}
