...
public class TestUnscaledDecimal128Arithmetic
{
    ...
    {
        assertEquals(toStringDestructive(unscaledDecimal(0)), "0");
    ...
    private void assertAddReturnOverflow(BigInteger left, BigInteger right)
    {
        ...
        BigInteger actual = Decimals.decodeUnscaledValue(result);
    ...
    private static void assertDivideAllSigns(Slice dividend, int dividendRescaleFactor, Slice divisor, int divisorRescaleFactor)
    {
        ...
        assertDivide(dividend, dividendRescaleFactor, negateConstructive(divisor), divisorRescaleFactor);
        assertDivide(negateConstructive(dividend), dividendRescaleFactor, divisor, divisorRescaleFactor);
        assertDivide(negateConstructive(dividend), dividendRescaleFactor, negateConstructive(divisor), divisorRescaleFactor);
    }
