        ...
        extends TestHistogram
{
    ...
    public void testAddDisjunction()
    {
        ...
        assertEquals(ranges(constrained).get(0), com.facebook.presto.common.predicate.Range.range(DOUBLE, 0d, true, 2d, false));
        constrained = disjunction(constrained, rangeOpen(1d, 10d));
        assertEquals(ranges(constrained).size(), 1);
        assertEquals(ranges(constrained).get(0), com.facebook.presto.common.predicate.Range.range(DOUBLE, 0d, true, 10d, false));
        constrained = disjunction(constrained, com.facebook.presto.common.predicate.Range.range(DOUBLE, 50d, true, 100d, false));
        assertEquals(ranges(constrained).size(), 2);
        assertEquals(ranges(constrained).get(0), com.facebook.presto.common.predicate.Range.range(DOUBLE, 0d, true, 10d, false));
        assertEquals(ranges(constrained).get(1), com.facebook.presto.common.predicate.Range.range(DOUBLE, 50d, true, 100d, false));
    }
    ...
    public void testAddConjunction()
    {
        ...
        constrained = conjunction(constrained, com.facebook.presto.common.predicate.Range.lessThanOrEqual(DOUBLE, 50d));
        assertEquals(ranges(constrained).size(), 1);
        assertEquals(ranges(constrained).get(0), com.facebook.presto.common.predicate.Range.range(DOUBLE, 10d, false, 50d, true));
        constrained = conjunction(constrained, com.facebook.presto.common.predicate.Range.greaterThanOrEqual(DOUBLE, 25d));
        assertEquals(ranges(constrained).size(), 1);
    ...
    {
        return com.facebook.presto.common.predicate.Range.range(DOUBLE, low, false, high, false);
    }

    private static com.facebook.presto.common.predicate.Range rangeClosed(double low, double high)
    {
        return com.facebook.presto.common.predicate.Range.range(DOUBLE, low, true, high, true);
    }
