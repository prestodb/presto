        ...
        implements ScalarFunctionInvoker
{
    ...
    public static HiveScalarFunctionInvoker create(Class<?> cls, QualifiedObjectName name, List<TypeSignature> arguments, TypeManager typeManager)
    {
        ...
        try {
            ...
            ObjectInputDecoder[] argumentDecoders = argumentTypes.stream()
                    .map(argumentsType -> ObjectInputDecoders.create(argumentsType, typeManager))
                    .toArray(ObjectInputDecoder[]::new);
            ObjectEncoder objectEncoder = ObjectEncoders.create(resultType, resultInspector);
                                     ...
                                     ObjectEncoder objectEncoder)
    {
        ...
        this.argumentDecoders = argumentDecoders;
