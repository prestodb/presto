...
public final class ObjectInputDecoders
{
    ...
    public static ObjectInputDecoder create(Type type, TypeManager typeManager)
    {
    ...
    {
        return BlockInputDecoders.create(ObjectInspectors.create(type, typeManager), type);
    }

    private static class RowObjectInputDecoder
    ...
    private static class ArrayObjectInputDecoder
            implements ObjectInputDecoder
    {
    ...
    private static class MapObjectInputDecoder
            implements ObjectInputDecoder
    {
