...
public final class HiveAccumulatorMethodHandles
{
    ...
    @InputFunction
    public static void input(HiveAccumulatorInvoker invoker, BlockInputDecoder decoder, HiveAccumulatorState state, Block block, int position)
    {
        invoker.iterate(state, decoder.decode(block, position));
    }
