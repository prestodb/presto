...
public class BlockInputDecoders
{
    private BlockInputDecoders()
    {
    }

    public static BlockInputDecoder create(ObjectInspector inspector, Type type)
    {
    ...
    private static BlockInputDecoder createForList(ListObjectInspector inspector, ArrayType arrayType)
    {
        ...
        BlockInputDecoder decoder = create(elementInspector, elementType);
        return (b, i) -> {
            if (b.isNull(i)) {
                return null;
            }
    ...
    private static BlockInputDecoder createForMap(MapObjectInspector inspector, MapType mapType)
    {
        ...
        BlockInputDecoder keyDecoder = create(keyInspector, keyType);
        BlockInputDecoder valueDecoder = create(valueInspector, valueType);
        return (b, i) -> {
            if (b.isNull(i)) {
                return null;
            }
