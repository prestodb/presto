        ...
        extends AbstractTestExpressionInterpreter
{
    ...
    /// TODO: IN list with variables will not be constant folded in Velox.
    @Override
    @Test
    public void testIn()
    {
...
//        assertRowExpressionEquals(SERIALIZABLE, "'%' LIKE 'z%'", "false");
    ...
    /// Native expression optimizer evaluates non-deterministic function `random()` to return a ConstantExpression
    ...
    public void testNonDeterministicFunctionCall()
    {
        ...
        RowExpression value = evaluate("random()");
