...
public class TestNativeExpressionOptimizer
{
            ...
            throws Exception
    {
        ...
        FunctionResolution functionResolution = new FunctionResolution(getMetadata().getFunctionAndTypeManager().getFunctionAndTypeResolver());
        expressionOptimizer = getExpressionOptimizer(getMetadata(), new HandleResolver());
    }
...
//        assertEquals(evaluate("reduce(ARRAY[1, 5], 0, (x, y) -> x + y, x -> x)", true), 6L);
    ...
    @Test(expectedExceptions = PrestoException.class, enabled = false)
...
//        optimize("interval '3' year * unbound_integer");
    ...
    private void assertLike(byte[] value, String pattern, boolean expected)
    {
        ...
        assertEquals(optimizeRowExpression(predicate, EVALUATED), constant(expected, BOOLEAN));
    }
