...
public final class SidecarRetryDriver
{
     ...
     * @param maxFailureInterval maximum duration to retry transient failures before giving up
     ...
     */
    public static <T> T executeWithRetry(Callable<T> operation, Duration maxFailureInterval, String description, Supplier<PrestoException> failureWrapperSupplier)
    {
