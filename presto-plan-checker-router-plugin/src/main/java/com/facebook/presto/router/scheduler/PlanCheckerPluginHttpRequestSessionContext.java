...
public class PlanCheckerPluginHttpRequestSessionContext
{
    ...
    public PlanCheckerPluginHttpRequestSessionContext(Map<String, List<String>> headerMap, SqlParserOptions sqlParserOptions, Principal userPrincipal, String remoteUserAddr)
    {
        ...
        remoteUserAddress = !isNullOrEmpty(getHeader(X_FORWARDED_FOR)) ? getHeader(PRESTO_SOURCE) : remoteUserAddr;
    ...
    public static Map<String, String> getResourceEstimates(PlanCheckerPluginHttpRequestSessionContext sessionContext)
    {
    ...
    public static Map<String, String> getSerializedSessionFunctions(PlanCheckerPluginHttpRequestSessionContext sessionContext)
    {
