        ...
        extends AbstractTestQueries
{
            ...
            throws Exception
    {
        assertUpdate("CREATE TABLE presto_test_parameterized_varchar AS SELECT " +
                "CAST('a' AS varchar(200)) text_a," +
                "CAST('b' AS varchar(9999)) text_b," +
                "CAST('c' AS varchar(10000)) text_c," +
                "CAST('d' AS varchar(10001)) text_d," +
                "CAST('e' AS varchar(65535)) text_e," +
                "CAST('f' AS varchar(65536)) text_f," +
                "CAST('g' AS varchar(16777215)) text_g," +
                "CAST('h' AS varchar(16777216)) text_h," +
                "CAST('i' AS varchar(" + VarcharType.MAX_LENGTH + ")) text_i," +
        ...
        assertEquals(materializedRows.getTypes().get(0), createVarcharType(200));
        assertEquals(materializedRows.getTypes().get(1), createVarcharType(9999));
        assertEquals(materializedRows.getTypes().get(2), createVarcharType(10000));
        assertEquals(materializedRows.getTypes().get(3), createVarcharType(65535));
        assertEquals(materializedRows.getTypes().get(4), createVarcharType(65535));
        assertEquals(materializedRows.getTypes().get(5), createVarcharType(16777215));
        assertEquals(materializedRows.getTypes().get(6), createVarcharType(16777215));
        ...
        assertEquals(materializedRows.getTypes().get(9), createUnboundedVarcharType());
        ...
        assertEquals(row.getField(8), "i");
        assertEquals(row.getField(9), "unbounded");
